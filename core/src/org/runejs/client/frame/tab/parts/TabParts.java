package org.runejs.client.frame.tab.parts;
...
public class TabParts {
    ...
    private static void CreateParts() {
        ...
        TabParts.combat = new ImageRGB(Base64.getDecoder().decode(combat), Game.gameCanvas);
        TabParts.emotes = new ImageRGB(Base64.getDecoder().decode(emotes), Game.gameCanvas);
        TabParts.equipment = new ImageRGB(Base64.getDecoder().decode(equipment), Game.gameCanvas);
        TabParts.friends = new ImageRGB(Base64.getDecoder().decode(friends), Game.gameCanvas);
        TabParts.ignores = new ImageRGB(Base64.getDecoder().decode(ignores), Game.gameCanvas);
        TabParts.inventory = new ImageRGB(Base64.getDecoder().decode(inventory), Game.gameCanvas);
        TabParts.large_left_right = new ImageRGB(Base64.getDecoder().decode(large_left_right), Game.gameCanvas);
        TabParts.large_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(large_left_right_hovered), Game.gameCanvas);
        TabParts.large_left_right_selected = new ImageRGB(Base64.getDecoder().decode(large_left_right_selected), Game.gameCanvas);
        TabParts.large_middle = new ImageRGB(Base64.getDecoder().decode(large_middle), Game.gameCanvas);
        TabParts.large_middle_hovered = new ImageRGB(Base64.getDecoder().decode(large_middle_hovered), Game.gameCanvas);
        TabParts.large_middle_selected = new ImageRGB(Base64.getDecoder().decode(large_middle_selected), Game.gameCanvas);
        TabParts.logout = new ImageRGB(Base64.getDecoder().decode(logout), Game.gameCanvas);
        TabParts.logout_small = new ImageRGB(Base64.getDecoder().decode(logout_small), Game.gameCanvas);
        TabParts.magic = new ImageRGB(Base64.getDecoder().decode(magic), Game.gameCanvas);
        TabParts.medium_left_right = new ImageRGB(Base64.getDecoder().decode(medium_left_right), Game.gameCanvas);
        TabParts.medium_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(medium_left_right_hovered), Game.gameCanvas);
        TabParts.medium_left_right_selected = new ImageRGB(Base64.getDecoder().decode(medium_left_right_selected), Game.gameCanvas);
        TabParts.medium_middle = new ImageRGB(Base64.getDecoder().decode(medium_middle), Game.gameCanvas);
        TabParts.medium_middle_hovered = new ImageRGB(Base64.getDecoder().decode(medium_middle_hovered), Game.gameCanvas);
        TabParts.medium_middle_selected = new ImageRGB(Base64.getDecoder().decode(medium_middle_selected), Game.gameCanvas);
        TabParts.music = new ImageRGB(Base64.getDecoder().decode(music), Game.gameCanvas);
        TabParts.options = new ImageRGB(Base64.getDecoder().decode(options), Game.gameCanvas);
        TabParts.prayer = new ImageRGB(Base64.getDecoder().decode(prayer), Game.gameCanvas);
        TabParts.quests = new ImageRGB(Base64.getDecoder().decode(quests), Game.gameCanvas);
        TabParts.side_border_bottom = new ImageRGB(Base64.getDecoder().decode(side_border_bottom), Game.gameCanvas);
        TabParts.side_border_bottom_selected = new ImageRGB(Base64.getDecoder().decode(side_border_bottom_selected), Game.gameCanvas);
        TabParts.side_border_edge_bottom_left = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_left), Game.gameCanvas);
        TabParts.side_border_edge_bottom_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_left_selected), Game.gameCanvas);
        TabParts.side_border_edge_bottom_right = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_right), Game.gameCanvas);
        TabParts.side_border_edge_bottom_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_right_selected), Game.gameCanvas);
        TabParts.side_border_edge_top_left = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_left), Game.gameCanvas);
        TabParts.side_border_edge_top_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_left_selected), Game.gameCanvas);
        TabParts.side_border_edge_top_right = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_right), Game.gameCanvas);
        TabParts.side_border_edge_top_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_right_selected), Game.gameCanvas);
        TabParts.side_border_left = new ImageRGB(Base64.getDecoder().decode(side_border_left), Game.gameCanvas);
        TabParts.side_border_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_left_selected), Game.gameCanvas);
        TabParts.side_border_middle = new ImageRGB(Base64.getDecoder().decode(side_border_middle), Game.gameCanvas);
        TabParts.side_border_right = new ImageRGB(Base64.getDecoder().decode(side_border_right), Game.gameCanvas);
        TabParts.side_border_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_right_selected), Game.gameCanvas);
        TabParts.side_border_top = new ImageRGB(Base64.getDecoder().decode(side_border_top), Game.gameCanvas);
        TabParts.side_border_top_selected = new ImageRGB(Base64.getDecoder().decode(side_border_top_selected), Game.gameCanvas);
        TabParts.small_left_right = new ImageRGB(Base64.getDecoder().decode(small_left_right), Game.gameCanvas);
        TabParts.small_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(small_left_right_hovered), Game.gameCanvas);
        TabParts.small_left_right_selected = new ImageRGB(Base64.getDecoder().decode(small_left_right_selected), Game.gameCanvas);
        TabParts.small_middle = new ImageRGB(Base64.getDecoder().decode(small_middle), Game.gameCanvas);
        TabParts.small_middle_hovered = new ImageRGB(Base64.getDecoder().decode(small_middle_hovered), Game.gameCanvas);
        TabParts.small_middle_selected = new ImageRGB(Base64.getDecoder().decode(small_middle_selected), Game.gameCanvas);
        TabParts.stats = new ImageRGB(Base64.getDecoder().decode(stats), Game.gameCanvas);
        TabParts.stone_bottom_left_selected = new ImageRGB(Base64.getDecoder().decode(stone_bottom_left_selected), Game.gameCanvas);
        TabParts.stone_bottom_right_selected = new ImageRGB(Base64.getDecoder().decode(stone_bottom_right_selected), Game.gameCanvas);
        TabParts.stone_middle_selected = new ImageRGB(Base64.getDecoder().decode(stone_middle_selected), Game.gameCanvas);
        TabParts.stone_top_left_selected = new ImageRGB(Base64.getDecoder().decode(stone_top_left_selected), Game.gameCanvas);
        TabParts.stone_top_right_selected = new ImageRGB(Base64.getDecoder().decode(stone_top_right_selected), Game.gameCanvas);
        TabParts.side_panel_background = new ImageRGB(Base64.getDecoder().decode(side_panel_background), Game.gameCanvas);
        TabParts.side_panel_edge_left = new ImageRGB(Base64.getDecoder().decode(side_panel_edge_left), Game.gameCanvas);
        TabParts.side_panel_edge_right = new ImageRGB(Base64.getDecoder().decode(side_panel_edge_right), Game.gameCanvas);
        TabParts.tabs_bottom_row = new ImageRGB(Base64.getDecoder().decode(tabs_bottom_row), Game.gameCanvas);
        TabParts.tab_stone_middle = new ImageRGB(Base64.getDecoder().decode(tab_stone_middle), Game.gameCanvas);
        TabParts.tab_stone_middle_selected = new ImageRGB(Base64.getDecoder().decode(tab_stone_middle_selected), Game.gameCanvas);
        TabParts.tabs_top_row = new ImageRGB(Base64.getDecoder().decode(tabs_top_row), Game.gameCanvas);
        TabParts.setup = true;
