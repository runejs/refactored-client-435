...
public class SoundSystem {
	...
	public static void addObjectSounds(int arg0, int arg2, int arg3, int arg4, GameObjectDefinition arg5) {
		...
		SoundSystem.objectSounds.addLast(class40_sub2);
	...
	public static void clearObjectSounds() {
		for (ObjectSound class40_sub2 = (ObjectSound) SoundSystem.objectSounds.peekFirst(); class40_sub2 != null; class40_sub2 = (ObjectSound) SoundSystem.objectSounds.pollFirst()) {
