 ...
 */
public class WidgetV1ItemInteractionOutboundMessage implements OutboundMessage {
    /**
    ...
    /**
     * Creates a new {@link WidgetV1ItemInteractionOutboundMessage}.
     ...
     */
    public WidgetV1ItemInteractionOutboundMessage(int option, int widgetId, int containerId, int slot, int itemId) {
        this.option = option;
