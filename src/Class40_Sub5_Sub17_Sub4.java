...
public abstract class Class40_Sub5_Sub17_Sub4 extends Class40_Sub5_Sub17
{
    ...
    public static void method781(int arg0, int arg1, int arg2, int arg3,
				 int arg4, int arg5) {
	if (arg0 == 1850) {
	    anInt3084++;
	    int i = NPC.aClass2_3301
			.method122(arg1, arg2, arg5);
	    if (i != 0) {
		int i_0_ = NPC.aClass2_3301
			       .method141(arg1, arg2, arg5, i);
		int i_1_ = 0x1f & i_0_;
		...
		int[] is = (Class40_Sub5_Sub13.aClass40_Sub5_Sub14_Sub4_2765
			    .anIntArray2955);
		Class40_Sub5_Sub8 class40_sub5_sub8
		    = Class40_Sub4.method535(i_5_, (byte) 126);
		if (class40_sub5_sub8.anInt2537 != -1) {
			...
			= (Class40_Sub5_Sub2.aClass40_Sub5_Sub14_Sub2Array2301
			   [class40_sub5_sub8.anInt2537]);
		    if (class40_sub5_sub14_sub2 != null) {
			int i_6_ = ((-class40_sub5_sub14_sub2.anInt2921
				     + class40_sub5_sub8.anInt2503 * 4)
				    / 2);
			int i_7_ = ((class40_sub5_sub8.anInt2515 * 4
				     + -class40_sub5_sub14_sub2.anInt2926)
				    / 2);
			class40_sub5_sub14_sub2.method692
			    (48 - -(4 * arg2) - -i_6_,
			     i_7_ + (48 - -((104 + -arg5
					     - class40_sub5_sub8.anInt2515)
					    * 4)));
		    }
		} else {
	    ...
	    i = NPC.aClass2_3301.method110(arg1, arg2,
								    arg5);
	    if (i != 0) {
		int i_8_ = NPC.aClass2_3301
			       .method141(arg1, arg2, arg5, i);
		int i_9_ = 0x7fff & i >> 1891879118;
		int i_10_ = (i_8_ & 0xf4) >> -474347930;
		Class40_Sub5_Sub8 class40_sub5_sub8
		    = Class40_Sub4.method535(i_9_, (byte) 124);
		int i_11_ = i_8_ & 0x1f;
		if (class40_sub5_sub8.anInt2537 != -1) {
		    IndexedColorSprite class40_sub5_sub14_sub2
			= (Class40_Sub5_Sub2.aClass40_Sub5_Sub14_Sub2Array2301
			   [class40_sub5_sub8.anInt2537]);
		    if (class40_sub5_sub14_sub2 != null) {
			int i_12_ = ((-class40_sub5_sub14_sub2.anInt2926
				      + class40_sub5_sub8.anInt2515 * 4)
				     / 2);
			int i_13_ = ((class40_sub5_sub8.anInt2503 * 4
				      + -class40_sub5_sub14_sub2.anInt2921)
				     / 2);
			class40_sub5_sub14_sub2.method692
			    (i_13_ + arg2 * 4 + 48,
			     48 - (-(4 * (-arg5
		    ...
		    int[] is = (Class40_Sub5_Sub13
				.aClass40_Sub5_Sub14_Sub4_2765.anIntArray2955);
		    int i_14_ = 15658734;
		    if ((i ^ 0xffffffff) < -1)
			i_14_ = 15597568;
	    ...
	    i = NPC.aClass2_3301.method93(arg1, arg2,
								   arg5);
	    if ((i ^ 0xffffffff) != -1) {
		int i_16_ = (i & 0x1fffd9fb) >> 1370061614;
		Class40_Sub5_Sub8 class40_sub5_sub8
		    = Class40_Sub4.method535(i_16_, (byte) 123);
		if ((class40_sub5_sub8.anInt2537 ^ 0xffffffff) != 0) {
		    IndexedColorSprite class40_sub5_sub14_sub2
			= (Class40_Sub5_Sub2.aClass40_Sub5_Sub14_Sub2Array2301
			   [class40_sub5_sub8.anInt2537]);
		    if (class40_sub5_sub14_sub2 != null) {
			int i_17_ = ((-class40_sub5_sub14_sub2.anInt2921
				      + class40_sub5_sub8.anInt2503 * 4)
				     / 2);
			int i_18_ = ((-class40_sub5_sub14_sub2.anInt2926
				      + 4 * class40_sub5_sub8.anInt2515)
				     / 2);
			class40_sub5_sub14_sub2.method692
			    (4 * arg2 + 48 + i_17_,
			     i_18_ + ((104
				       - (arg5 - -class40_sub5_sub8.anInt2515))
				      * 4) + 48);
		    }
		}
	    }
	...
	try {
	    ...
	    if (anInt3141 != -1
		&& (Class68_Sub1.method1050(anInt3141, arg1 ^ ~0x5d).anInt2476
		    == 1))
		anInt3141 = -1;
	    if (anInt3109 < 9)
		anInt3109++;
	...
	if ((i ^ 0xffffffff) != -1) {
		...
		int i_22_
		    = Cache.outgoingbuffer.putBits(3, (byte) -65);
		Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
		    .method782(i_22_, (byte) -96, false);
		int i_23_
		    = Cache.outgoingbuffer.putBits(1, (byte) -65);
		...
		int i_24_
		    = Cache.outgoingbuffer.putBits(3, (byte) -65);
		Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
		    .method782(i_24_, (byte) -96, true);
		int i_25_
		    = Cache.outgoingbuffer.putBits(3, (byte) -65);
		Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
		    .method782(i_25_, (byte) -96, true);
		int i_26_
		    = Cache.outgoingbuffer.putBits(1, (byte) -65);
		...
		int i_27_
		    = Cache.outgoingbuffer.putBits(1, (byte) -65);
		Player.anInt3267
		    = Cache.outgoingbuffer.putBits(2, (byte) -65);
		int i_28_
		    = Cache.outgoingbuffer.putBits(1, (byte) -65);
		if (i_28_ == 1)
		    Class24.anIntArray578[anInt3153++] = 2047;
		int i_29_
		    = Cache.outgoingbuffer.putBits(7, (byte) -65);
		int i_30_
		    = Cache.outgoingbuffer.putBits(7, (byte) -65);
		Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760.method787
		    (i_30_, -7717, (i_27_ ^ 0xffffffff) == -2, i_29_);
	    } else if (arg0 != true)
	...
	try {
	    if ((anInt3141 ^ 0xffffffff) != 0
		&& Class68_Sub1.method1050(anInt3141, 2).anInt2476 == 1)
		anInt3141 = -1;
	    anInt3076++;
	    if (!arg2) {
		int i = -anIntArray3088[0] + arg3;
		int i_31_ = -anIntArray3135[0] + arg0;
		if (i >= -8 && (i ^ 0xffffffff) >= -9 && i_31_ >= -8
		    && (i_31_ ^ 0xffffffff) >= -9) {
		    if (anInt3109 < 9)
			anInt3109++;
		    for (int i_32_ = anInt3109; (i_32_ ^ 0xffffffff) < -1;
			 i_32_--) {
			anIntArray3088[i_32_] = anIntArray3088[-1 + i_32_];
			anIntArray3135[i_32_] = anIntArray3135[-1 + i_32_];
			aBooleanArray3072[i_32_]
			    = aBooleanArray3072[i_32_ + -1];
		    }
    ...
    public static void method789(int arg0, int arg1, int arg2, int arg3,
				 int arg4, int arg5) {
	try {
	    anInt3147++;
	    if ((Class51.anInt1202 ^ 0xffffffff) != (arg3 ^ 0xffffffff)
		|| arg2 != Class17.anInt448
		|| ((arg5 ^ 0xffffffff) != (Class40_Sub6.anInt2120
					    ^ 0xffffffff)
		...
		for (int i_36_ = 0; (i_36_ ^ 0xffffffff) > -32769; i_36_++) {
			...
			for (int i_37_ = 0; i_37_ < 10; i_37_++) {
			    class40_sub5_sub17_sub4_sub2.anIntArray3088[i_37_]
				-= i_34_;
			    class40_sub5_sub17_sub4_sub2.anIntArray3135[i_37_]
				-= i_35_;
			}
		...
		for (int i_38_ = 0; i_38_ < 2048; i_38_++) {
			...
			= aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i_38_];
		    if (class40_sub5_sub17_sub4_sub1 != null) {
			for (int i_39_ = 0; (i_39_ ^ 0xffffffff) > -11;
			     i_39_++) {
			    class40_sub5_sub17_sub4_sub1.anIntArray3088[i_39_]
				-= i_34_;
			    class40_sub5_sub17_sub4_sub1.anIntArray3135[i_39_]
				-= i_35_;
			}
		...
		int i_40_ = 0;
		Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
		    .method787(arg4, -7717, false, arg0);
		int i_41_ = 104;
		int i_42_ = 1;
		...
		for (int i_46_ = i_40_;
		     (i_46_ ^ 0xffffffff) != (i_41_ ^ 0xffffffff);
		     i_46_ += i_42_) {
		    for (int i_47_ = i_44_;
			 (i_47_ ^ 0xffffffff) != (i_43_ ^ 0xffffffff);
			 i_47_ += i_45_) {
			int i_48_ = i_34_ + i_46_;
			int i_49_ = i_35_ + i_47_;
			for (int i_50_ = 0; (i_50_ ^ 0xffffffff) > -5;
			     i_50_++) {
			    if ((i_48_ ^ 0xffffffff) > -1 || i_49_ < 0
				|| i_48_ >= 104 || i_49_ >= 104)
				Class10.aClass45ArrayArrayArray357[i_50_]
				    [i_46_][i_47_]
				    = null;
			    else
				Class10.aClass45ArrayArrayArray357[i_50_]
		...
		for (Class40_Sub3 class40_sub3
		     ...
		     class40_sub3 != null;
		     class40_sub3 = ((Class40_Sub3)
				     Class45.aClass45_1064.method909(-4))) {
		    class40_sub3.anInt2038 -= i_35_;
		    class40_sub3.anInt2039 -= i_34_;
		    if ((class40_sub3.anInt2039 ^ 0xffffffff) > -1
			|| (class40_sub3.anInt2038 ^ 0xffffffff) > -1
			|| class40_sub3.anInt2039 >= 104
			|| (class40_sub3.anInt2038 ^ 0xffffffff) <= -105)
