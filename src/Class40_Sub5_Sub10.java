...
public class Class40_Sub5_Sub10 extends SubNode {
    ...
    public static Class40_Sub5_Sub1 method626(int arg0, int arg1, int arg2) {
        try {
            ...
            Class40_Sub5_Sub1 class40_sub5_sub1
                    = ((Class40_Sub5_Sub1)
                    Class17.aClass9_449.method231(l, (byte) 72));
            if (class40_sub5_sub1 != null)
                return class40_sub5_sub1;
            byte[] is = (Class56.aClass6_Sub1_1323.method170
                    (Class40_Sub5_Sub17_Sub2.aClass1_3044,
                            (Class40_Sub5_Sub17_Sub6.method832
                                    (53, new RSString[]{HashTable.method334(arg1, -1),
                                            SubNode.aClass1_2084,
                                            HashTable.method334(arg0, -1)})),
                            1));
            if (arg2 <= 4)
                return null;
            ...
            while (class40_sub1.offset
                    < -12 + class40_sub1.payload.length) {
                int i_1_ = class40_sub1.method469(65280);
                if (i_1_ != 3) {
                    if (i_1_ >= 100 || i_1_ == 21 || (i_1_ ^ 0xffffffff) == -39
                            || i_1_ == 39)
                        class40_sub5_sub1.anIntArray2262[i_0_]
                                = class40_sub1.method468(false);
                    else
                        class40_sub5_sub1.anIntArray2262[i_0_]
                                = class40_sub1.method491(-4750);
                } else
                    class40_sub5_sub1.aClass1Array2270[i_0_]
                            = class40_sub1.getRSString(-10721);
    ...
    public static RSString method627(int arg0, int arg1, int arg2,
                                     RSString[] arg3) {
        try {
            anInt2608++;
            int i = 0;
            ...
            for (int i_5_ = 0; i_5_ < arg1; i_5_++) {
                ...
                Class18.method278(class1.aByteArray1692, 0, is, i_4_,
                        class1.anInt1680);
    ...
    public boolean method623(boolean arg0) {
        try {
            ...
            boolean bool = arg0;
            for (int i = 0;
                 (i ^ 0xffffffff) > (anIntArray2600.length ^ 0xffffffff);
                 i++) {
                if (!Class27.aClass6_654.method173(anIntArray2600[i],
                        (byte) -10, 0))
                    bool = false;
            }
            return bool;
    ...
    public boolean method624(boolean arg0) {
        try {
            ...
            if (arg0 != false)
                return false;
            for (/**/; i < 5; i++) {
                if (anIntArray2610[i] != -1
                        && !Class27.aClass6_654.method173(anIntArray2610[i],
                        (byte) -10, 0))
                    bool = false;
            }
            return bool;
                    ...
                    if (arg1 != 3) {
                        if (arg1 < 40 || arg1 >= 50) {
                            if (arg1 >= 50 && (arg1 ^ 0xffffffff) > -61)
                                anIntArray2594[-50 + arg1]
                                        = arg0.method469(65280);
                            else if (arg1 >= 60 && arg1 < 70)
                                anIntArray2610[-60 + arg1]
                                        = arg0.method469(arg2 + 63881);
                        } else
        ...
        try {
            ...
            for (int i_8_ = 0; i_8_ < 6; i_8_++) {
                if (anIntArray2586[i_8_] == 0)
                    break;
                class40_sub5_sub17_sub5.method803(anIntArray2586[i_8_],
                        anIntArray2594[i_8_]);
            }
    ...
    public Model method630(boolean arg0) {
        try {
            ...
            if (anIntArray2600 == null)
                return null;
            Model[] class40_sub5_sub17_sub5s
                    = new Model[anIntArray2600.length];
            for (int i = 0; i < anIntArray2600.length; i++)
                class40_sub5_sub17_sub5s[i]
                        = Model.method830(Class27.aClass6_654,
                        anIntArray2600[i], 0);
            Model class40_sub5_sub17_sub5;
            ...
            for (int i = 0; (i ^ 0xffffffff) > -7; i++) {
                if (anIntArray2586[i] == 0)
                    break;
                class40_sub5_sub17_sub5.method803(anIntArray2586[i],
                        anIntArray2594[i]);
            }
            return class40_sub5_sub17_sub5;
        } catch (RuntimeException runtimeexception) {
