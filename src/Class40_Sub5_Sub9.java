/* Class40_Sub5_Sub9 - Decompiled by JODE
...
public class Class40_Sub5_Sub9 extends SubNode {
    ...
    public static int method614(byte arg0, int arg1, int arg2, int arg3) {
        try {
            ...
            anInt2572++;
            int i_7_ = 256 + -arg3;
            return (((arg3 * (0xff00 & arg2) + i_7_ * (0xff00 & arg1)
                    & 0xff0000)
                    + (~0xff00ff
                    & (0xff00ff & arg1) * i_7_ - -(arg3
                    * (0xff00ff & arg2))))
                    >> -794214296);
    ...
    public static void method617(long arg0, byte arg1) {
        try {
            anInt2569++;
            if (arg0 != 0L) {
                if ((Class40_Sub5_Sub17_Sub3.anInt3060 >= 100
                        && (Class44.anInt1049 ^ 0xffffffff) != -2)
                        || ((Class40_Sub5_Sub17_Sub3.anInt3060 ^ 0xffffffff)
                        <= -201))
                    Class44.method895(94, 0, Class59.aClass1_1399,
                            Class66.aClass1_1567);
                else {
                    if (arg1 >= -2)
                        aClass6_Sub1_2571 = null;
                    RSString class1
                            = Class60.method991(-23, arg0).method85(-4305);
                    for (int i = 0; Class40_Sub5_Sub17_Sub3.anInt3060 > i;
                         i++) {
                        if ((arg0 ^ 0xffffffffffffffffL)
                                == (Class59.aLongArray1397[i]
                                ^ 0xffffffffffffffffL)) {
                            Class44.method895(62, 0,
                                    (Class40_Sub5_Sub17_Sub6
                                            .method832
                                                    (-124,
                                                            (new RSString[]
                                                                    {class1,
                                                                            Class62.aClass1_1465}))),
                                    Class66.aClass1_1567);
                            return;
                        }
                    }
                    for (int i = 0;
                         (i ^ 0xffffffff) > (Class42.anInt1008 ^ 0xffffffff);
                         i++) {
                        if ((arg0 ^ 0xffffffffffffffffL)
                                == (Class53.aLongArray1267[i]
                                ^ 0xffffffffffffffffL)) {
                            Class44.method895(126, 0,
                                    (Class40_Sub5_Sub17_Sub6
                                            .method832
                                                    (75,
                                                            (new RSString[]
                                                                    {Class44.aClass1_1038,
                                                                            class1,
                                                                            Class39.aClass1_917}))),
                                    Class66.aClass1_1567);
                            return;
