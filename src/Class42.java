...
public class Class42 {
    ...
    public Class42(int[] arg0) {
        try {
            int i;
            for (i = 1;
                 (((arg0.length >> -2026619711) + arg0.length ^ 0xffffffff)
                         <= (i ^ 0xffffffff));
                 i <<= 1) {
                /* empty */
            }
            anIntArray996 = new int[i - -i];
            for (int i_8_ = 0; (i - -i ^ 0xffffffff) < (i_8_ ^ 0xffffffff);
                 i_8_++)
                anIntArray996[i_8_] = -1;
            for (int i_9_ = 0;
                 (arg0.length ^ 0xffffffff) < (i_9_ ^ 0xffffffff); i_9_++) {
                int i_10_;
                for (i_10_ = arg0[i_9_] & i - 1;
                     anIntArray996[i_10_ + (i_10_ + 1)] != -1;
                     i_10_ = i_10_ + 1 & -1 + i) {
                    /* empty */
                }
    ...
    public static void method885(Class6 arg0, boolean arg1, Class6 arg2,
                                 int arg3) {
        try {
    ...
    public static void method886(int arg0, int arg1, boolean arg2, byte[] arg3,
                                 int arg4) {
        try {
            anInt1007++;
            if (arg0 == 0 && Class5.aClass22_189 != null) {
                if ((Class62.anInt1450 ^ 0xffffffff) > -1) {
                    ...
                    if (Class62.anInt1450 != 0) {
                        int i = Class29.method372(arg0 ^ 0x60,
                                Class62.anInt1450);
                        i -= Class39.anInt909;
    ...
    public static int method888(int arg0, byte arg1, int arg2) {
        try {
            int i = (-128
                    + Class4.method160(arg0 - -45365, 15177, 4, 91923 + arg2)
                    - (-(Class4.method160(arg0 - -10294, 15177, 2,
                    37821 + arg2) - 128
                    >> -463135775)
                    + -(-128 + Class4.method160(arg0, 15177, 1, arg2)
                    >> 252161186)));
    ...
    public static void method889(int arg0) {
        try {
            ...
            while (Cache.outgoingbuffer
                    .method510(121, Class40_Sub5_Sub12.packetsize)
                    >= 27) {
                int i
                        = Cache.outgoingbuffer.putBits(15, (byte) -65);
                ...
                int i_3_
                        = (Class40_Sub5_Sub17_Sub1.anIntArray2987
                        [Cache.outgoingbuffer.putBits(3,
                        (byte) -65)]);
                if (bool)
                    class40_sub5_sub17_sub4_sub2.anInt3118 = i_3_;
                int i_4_
                        = Cache.outgoingbuffer.putBits(5, (byte) -65);
                if (i_4_ > 15)
                    i_4_ -= 32;
                int i_5_
                        = Cache.outgoingbuffer.putBits(5, (byte) -65);
                ...
                if ((i_6_ ^ 0xffffffff) == -2)
                    Class24.anIntArray578[Class40_Sub5_Sub17_Sub4.anInt3153++]
                            = i;
                int i_7_
                        = Cache.outgoingbuffer.putBits(1, (byte) -65);
                class40_sub5_sub17_sub4_sub2.aClass40_Sub5_Sub5_3300
                        = Landscape.method932((byte) -121,
                ...
                class40_sub5_sub17_sub4_sub2.anInt3075
                        = (class40_sub5_sub17_sub4_sub2.aClass40_Sub5_Sub5_3300
                        .anInt2418);
                class40_sub5_sub17_sub4_sub2.method787
                        ((Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                        .anIntArray3135[0]) + i_5_,
                                -7717, (i_7_ ^ 0xffffffff) == -2,
                                (Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                        .anIntArray3088[0]) - -i_4_);
            }
