...
public class Class29
{
    ...
    public static RSString aClass1_670 = Class58.method978(-11538, "@or3@");
    public static RSString aClass1_671 = Class58.method978(-11538, "mapscene");
    public static int anInt672;
    public static int anInt673 = -1;
    public static RSString aClass1_674 = Class58.method978(-11538, " x");
	...
	try {
		...
		&& (arg2 ^ 0xffffffff) == (ItemDefinition.anInt2850
					   ^ 0xffffffff))
		return true;
	    if ((arg1 ^ 0xffffffff) == -2
		&& (Class3.anInt163 ^ 0xffffffff) == (arg2 ^ 0xffffffff))
		return true;
	    if (((arg1 ^ 0xffffffff) == -3 || (arg1 ^ 0xffffffff) == -4)
		&& Class55.anInt1296 == arg2)
		return true;
	    if (arg0 != 8247)
		return true;
	    return false;
	...
	try {
	    ...
	    if (arg0 <= 92)
		method372(4, 3);
	    return (int) (0.5 + (Math.log(0.00390625 * (double) arg1)
				 * 868.5889638065036));
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
				   "l.C(" + arg0 + ',' + arg1 + ')');
	...
	try {
		...
		Player class40_sub5_sub17_sub4_sub1
		    = (Class40_Sub5_Sub17_Sub4
		       .aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i_2_]);
		int i_3_
		...
		if (i_3_ == 0) {
		    ...
		    int i_4_
			= Cache.outgoingbuffer.putBits(2,
								  (byte) -65);
		    if ((i_4_ ^ 0xffffffff) == -1) {
			Class57.anIntArray1334[Class60.anInt1407++] = i_2_;
			class40_sub5_sub17_sub4_sub1.anInt3134
			    = Node.anInt926;
