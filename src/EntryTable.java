...
public class EntryTable extends Node
{
	...
	if (anIntArray2139 != null) {
		...
		if (anIntArray2141 == null
		    || anIntArray2141.length < anIntArray2139.length)
		...
		for (int i_3_ = 0; i_3_ < i_0_; i_3_++) {
		    ...
		    anIntArray2141[i_3_ + i_0_ + i_0_]
			= anIntArray2139[i_4_ + i_0_ + i_0_];
		    anIntArray2141[i_3_ + i_0_ + i_0_ + i_0_]
			= anIntArray2139[i_4_ + i_0_ + i_0_ + i_0_];
		}
		...
		for (int i_8_ = 0; i_8_ < i_5_; i_8_ += i) {
			...
			anIntArray2141[i_10_ + i_5_]
			    = anIntArray2139[i_11_ + i_5_];
			anIntArray2141[i_10_ + i_5_ + i_5_]
			    = anIntArray2139[i_11_ + i_5_ + i_5_];
			anIntArray2141[i_10_ + i_5_ + i_5_ + i_5_]
			    = anIntArray2139[i_11_ + i_5_ + i_5_ + i_5_];
		    }
		}
		int[] is = anIntArray2139;
		anIntArray2139 = anIntArray2141;
    ...
    public boolean method869(double arg0, int arg1, Class6 arg2) {
	...
	for (int i_12_ = 0; i_12_ < anIntArray2144.length; i_12_++) {
		...
		= Class40_Sub5_Sub17_Sub2.method769(2, arg2,
						    anIntArray2144[i_12_]);
		...
		for (int i_17_ = 0; i_17_ < is_13_.length; i_17_++) {
			...
			i_18_ &= 0xff;
			is_13_[i_17_] = (i_15_ * i_18_ >> 8 & 0xff00ff
					 | i_16_ * i_18_ & 0xff00);
		    }
		}
	    }
		...
		is_13_[i_19_]
		    = R3D.method707(is_13_[i_19_], arg0);
	    int i_20_;
	    if (i_12_ == 0)
		i_20_ = 0;
	    else
		...
		} else if (class40_sub5_sub14_sub2.anInt2921 == 64
			   && arg1 == 128) {
		    int i_22_ = 0;
		    for (int i_23_ = 0; i_23_ < arg1; i_23_++) {
			for (int i_24_ = 0; i_24_ < arg1; i_24_++)
			    anIntArray2139[i_22_++]
				= is_13_[(is[(i_24_ >> 1) + (i_23_ >> 1 << 6)]
					  & 0xff)];
		    }
		} else if (class40_sub5_sub14_sub2.anInt2921 == 128
			   && arg1 == 64) {
		    int i_25_ = 0;
		    for (int i_26_ = 0; i_26_ < arg1; i_26_++) {
			for (int i_27_ = 0; i_27_ < arg1; i_27_++)
			    anIntArray2139[i_25_++]
				= is_13_[(is[(i_27_ << 1) + (i_26_ << 1 << 7)]
					  & 0xff)];
		    }
		} else
	...
	anInt2137 = arg0.method469(65280);
	aBoolean2143 = arg0.method468(false) == 1;
	int i = arg0.method468(false);
	if (i < 1 || i > 4)
	    throw new RuntimeException();
	anIntArray2144 = new int[i];
	for (int i_30_ = 0; i_30_ < i; i_30_++)
	    anIntArray2144[i_30_] = arg0.method469(65280);
	if (i > 1) {
	    anIntArray2140 = new int[i - 1];
	    for (int i_31_ = 0; i_31_ < i - 1; i_31_++)
		anIntArray2140[i_31_] = arg0.method468(false);
	}
	if (i > 1) {
	    anIntArray2138 = new int[i - 1];
	    for (int i_32_ = 0; i_32_ < i - 1; i_32_++)
		anIntArray2138[i_32_] = arg0.method468(false);
	}
	anIntArray2145 = new int[i];
	for (int i_33_ = 0; i_33_ < i; i_33_++)
	    anIntArray2145[i_33_] = arg0.method491(-4750);
	anInt2136 = arg0.method468(false);
	anInt2142 = arg0.method468(false);
	anIntArray2139 = null;
    }
}
