...
public class RSString implements Interface1
{
	...
	try {
		...
		if ((i_0_ ^ 0xffffffff) <= -98 && (i_0_ ^ 0xffffffff) >= -123
		    || i_0_ >= -32 && i_0_ <= -2 && (i_0_ ^ 0xffffffff) != 8) {
		    if (bool)
			i_0_ -= 32;
		    bool = false;
		} else if ((i_0_ ^ 0xffffffff) <= -66 && i_0_ <= 90
			   || ((i_0_ ^ 0xffffffff) <= 63 && i_0_ <= -34
			       && i_0_ != -41)) {
		    if (!bool)
			i_0_ += 32;
		    bool = false;
    ...
    public static void method56(int arg0, boolean arg1, byte[] arg2,
				int arg3) {
	anInt1679++;
	...
	try {
	    ...
	    for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > (anInt1680 ^ 0xffffffff);
		 i_2_++) {
		if (aByteArray1692[i_2_] >= 65
		    && (aByteArray1692[i_2_] ^ 0xffffffff) >= -91) {
		    class1.aByteArray1692[i++]
			= (byte) (-65 + aByteArray1692[i_2_] + 97);
		    class1.anInt1680 = i;
		} else if ((aByteArray1692[i_2_] >= 97
			    && (aByteArray1692[i_2_] ^ 0xffffffff) >= -123)
			   || (aByteArray1692[i_2_] >= 48
			       && aByteArray1692[i_2_] <= 57)) {
	...
	try {
		...
		if ((i_3_ ^ 0xffffffff) <= -66 && i_3_ <= 90
		    || ((i_3_ ^ 0xffffffff) <= 63 && (i_3_ ^ 0xffffffff) >= 33
			&& i_3_ != -41))
		    i_3_ += 32;
		if ((i_4_ ^ 0xffffffff) <= -66 && (i_4_ ^ 0xffffffff) >= -91
		    || (i_4_ >= -64 && (i_4_ ^ 0xffffffff) >= 33
			&& (i_4_ ^ 0xffffffff) != 40))
		    i_4_ += 32;
	...
	try {
	    ...
	    try {
		string
		    = new String(aByteArray1692, 0, anInt1680, "ISO-8859-1");
	    } catch (java.io.UnsupportedEncodingException unsupportedencodingexception) {
		string = new String(aByteArray1692, 0, anInt1680);
	    }
	    anInt1660++;
	...
	try {
	    ...
	    Class18.method278(aByteArray1692, arg1, class1.aByteArray1692, 0,
			      class1.anInt1680);
	    return class1;
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
	...
	try {
		...
		int i;
		for (i = 1;
		     (i ^ 0xffffffff) > (arg0.anInt1680 + arg2 ^ 0xffffffff);
		     i += i) {
		    /* empty */
		}
		byte[] is = new byte[i];
	    ...
	    Class18.method278(arg0.aByteArray1692, 0, aByteArray1692, arg2,
			      arg0.anInt1680);
	...
	try {
	    ...
	    Class18.method278(aByteArray1692, 0, class1.aByteArray1692, 0,
			      anInt1680);
	...
	try {
	    ...
	    int i_10_ = (Class26.anInt635
			 + ((Class40_Sub5_Sub13
			     .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3089)
			    >> 1064414503));
	    if ((i ^ 0xffffffff) <= -3054 && i <= 3156 && i_10_ >= 3056
		&& i_10_ <= 3136)
		Class4.anInt182 = 1;
	    anInt1698++;
	    if (i >= 3072 && (i ^ 0xffffffff) >= -3119
		&& (i_10_ ^ 0xffffffff) <= -9493
		&& (i_10_ ^ 0xffffffff) >= -9536)
		Class4.anInt182 = 1;
	    if ((Class4.anInt182 ^ 0xffffffff) == -2
		&& (i ^ 0xffffffff) <= -3140 && i <= 3199 && i_10_ >= 3008
		&& (i_10_ ^ 0xffffffff) >= -3063)
		Class4.anInt182 = 0;
	...
	try {
		...
		throw new IllegalArgumentException();
	    anInt1696 = 0;
	    if ((anInt1680 - -arg0.anInt1680 ^ 0xffffffff)
		< (aByteArray1692.length ^ 0xffffffff)) {
		int i;
		for (i = 1; (i ^ 0xffffffff) > (anInt1680 + arg0.anInt1680
						^ 0xffffffff); i += i) {
		    /* empty */
		}
		byte[] is = new byte[i];
	    ...
	    Class18.method278(arg0.aByteArray1692, 0, aByteArray1692,
    ...
    public static byte[] method74(int arg0, Class6 arg1, int arg2, int arg3,
				  int arg4) {
	try {
	    anInt1686++;
	    if (arg3 >= -98)
		method83((byte) -1);
	    long l = ((long) (arg0 + 37 * arg2 & 0xffff)
		      + ((long) arg4 << -1686849184)
		      - -(long) (arg2 << -1491383504));
	    if (aClass9_1684 != null) {
		Class40_Sub5_Sub6 class40_sub5_sub6
		    = (Class40_Sub5_Sub6) aClass9_1684.method231(l, (byte) 85);
	...
	try {
		...
		if ((aByteArray1692[i] ^ 0xffffffff)
		    != (arg1.aByteArray1692[i] ^ 0xffffffff))
		    return false;
	    }
	    return true;
	} catch (RuntimeException runtimeexception) {
	...
	try {
		...
		throw new IllegalArgumentException();
	    anInt1696 = 0;
	    if ((aByteArray1692.length ^ 0xffffffff)
		== (anInt1680 ^ 0xffffffff)) {
		int i;
	...
	try {
	    ...
	    for (int i = 0; (i ^ 0xffffffff) > (is_15_.length ^ 0xffffffff);
		 i++)
		is_15_[i] = arg0.anInt1680;
	    if (arg2 != true)
		aClass1_1691 = null;
	    for (int i = 1; (arg0.anInt1680 ^ 0xffffffff) <= (i ^ 0xffffffff);
		 i++) {
		is[-1 + i] = (arg0.anInt1680 << 828194177) - i;
		is_15_[Class66.method1021(arg0.aByteArray1692[-1 + i], 255)]
		    = arg0.anInt1680 - i;
	    }
		...
		is_14_[i_16_ - 1] = i;
		for (/**/;
		     ((arg0.anInt1680 ^ 0xffffffff) <= (i ^ 0xffffffff)
		      && (arg0.aByteArray1692[i - 1]
			  != arg0.aByteArray1692[-1 + i_16_]));
		     i = is_14_[-1 + i]) {
		    if ((-i_16_ + arg0.anInt1680 ^ 0xffffffff)
			>= (is[i - 1] ^ 0xffffffff))
		...
		for (/**/;
		     i_19_ >= 1 && (arg0.aByteArray1692[-1 + i_20_]
				    != arg0.aByteArray1692[-1 + i_19_]);
		     i_19_ = is_14_[-1 + i_19_]) {
		    /* empty */
		}
		i_19_++;
	    }
		...
		for (int i_21_ = i_18_; i_17_ >= i_21_; i_21_++) {
		    if ((-i_21_ + i_17_ + arg0.anInt1680 ^ 0xffffffff)
			>= (is[i_21_ + -1] ^ 0xffffffff))
	    ...
	    int i_22_;
	    for (int i_23_ = -1 + (arg1 + arg0.anInt1680); i_23_ < anInt1680;
		 i_23_ += Math.max(is_15_[aByteArray1692[i_23_] & 0xff],
				   is[i_22_])) {
		for (i_22_ = arg0.anInt1680 + -1;
		     i_22_ >= 0 && ((arg0.aByteArray1692[i_22_] ^ 0xffffffff)
				    == (aByteArray1692[i_23_] ^ 0xffffffff));
		     i_22_--)
		    i_23_--;
	...
	try {
	    ...
	    for (int i_24_ = 0; (i ^ 0xffffffff) < (i_24_ ^ 0xffffffff);
		 i_24_++) {
		if ((arg0.aByteArray1692[i_24_] ^ 0xffffffff)
		    < (aByteArray1692[i_24_] ^ 0xffffffff))
		    return -1;
		if ((aByteArray1692[i_24_] ^ 0xffffffff)
		    < (arg0.aByteArray1692[i_24_] ^ 0xffffffff))
		    return 1;
	    }
	    if (arg1 < 75)
		method78(8, -101);
	...
	try {
		...
		if ((i_25_ ^ 0xffffffff) == -96) {
		    ...
		    bool = true;
		} else if (i_25_ < 97 || (i_25_ ^ 0xffffffff) < -123
			   || !bool) {
	...
	try {
	    ...
	    int i = 0;
	    int i_31_ = anInt1680;
	    for (/**/; ((i ^ 0xffffffff) > (anInt1680 ^ 0xffffffff)
			&& (aByteArray1692[i] >= 0 && aByteArray1692[i] <= 32
			    || (0xff & aByteArray1692[i]) == 160)); i++) {
		/* empty */
	    }
	    if (arg0 != false)
		aClass1_1717 = null;
	    for (/**/; ((i_31_ ^ 0xffffffff) < (i ^ 0xffffffff)
			&& ((aByteArray1692[i_31_ + -1] >= 0
			     && aByteArray1692[-1 + i_31_] <= 32)
			    || (aByteArray1692[i_31_ + -1] & 0xff
				^ 0xffffffff) == -161)); i_31_--) {
		/* empty */
	    }
	    ...
	    for (int i_32_ = 0;
		 (class1.anInt1680 ^ 0xffffffff) < (i_32_ ^ 0xffffffff);
		 i_32_++)
    ...
    /*synthetic*/ public static Class method90(String arg0) {
	try {
