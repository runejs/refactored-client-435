...
public class Class64 implements Runnable {
        ...
        try {
            ...
            if (Class68.method1043(arg0, 126)) {
                Class40_Sub5_Sub12[] class40_sub5_sub12s
                        = Class59.aClass40_Sub5_Sub12ArrayArray1390[arg0];
                if (arg1 != 2)
                    method1013(true);
                for (int i = 0; class40_sub5_sub12s.length > i; i++) {
                    Class40_Sub5_Sub12 class40_sub5_sub12
                            = class40_sub5_sub12s[i];
                    if (class40_sub5_sub12.anObjectArray2677 != null)
                        Class43.method891(class40_sub5_sub12.anObjectArray2677,
                                0, 0, class40_sub5_sub12, 0, false);
                }
            }
        } catch (RuntimeException runtimeexception) {
            throw Class8.method216(runtimeexception,
    ...
    public static void method1013(boolean arg0) {
        try {
            ...
            if (arg0 != false)
                method1013(false);
            if ((Class8.anInt301 ^ 0xffffffff) == -1
                    && Main.anInt1773 == 0) {
                Class46.anInt1091++;
                Floor.method558(0, Class22_Sub2.aClass1_1876,
                        Landscape.anInt1166, -501,
                        Class13.anInt420, 7,
                        Class66.aClass1_1567);
            }
            int i_1_ = 0;
            for (/**/; ((Model.anInt3220 ^ 0xffffffff)
                ...
                if (i != i_2_) {
                    ...
                    if (i_5_ == 2
                        ...
                        if ((Class8.anInt301 ^ 0xffffffff) == -2) {
                                            ...
                                            (Class40_Sub5_Sub17_Sub6.method832
                                                    (106,
                                                            (new RSString[]
                                                                    {(NPC
                                                                            .aClass1_3295),
                                                                            Class40_Sub5_Sub1.aClass1_2277,
                                                                            class40_sub5_sub8.aClass1_2549}))));
                            Class44.anInt1045++;
                        } else if (Main.anInt1773 != 1) {
                            RSString[] class1s
                                    = class40_sub5_sub8.aClass1Array2508;
                            ...
                            Floor.method558
                                    (class40_sub5_sub8.anInt2538 << 2045308238,
                                            Class40_Sub5_Sub15.aClass1_2774, i_4_, -501,
                                            i_3_, 1004,
                                            (Class40_Sub5_Sub17_Sub6.method832
                                                    (113,
                                                            (new RSString[]
                            ...
                            Class40_Sub5_Sub17.anInt2863++;
                            Floor.method558
                                    (i_2_, Class38_Sub1.aClass1_1918, i_4_, -501,
                                            i_3_, 32,
                                            (Class40_Sub5_Sub17_Sub6.method832
                                                    (111,
                                                            (new RSString[]
                    ...
                    if (i_5_ == 1) {
                        NPC class40_sub5_sub17_sub4_sub2
                                = (Class6_Sub1
                                .aClass40_Sub5_Sub17_Sub4_Sub2Array1813[i_6_]);
                        if (((class40_sub5_sub17_sub4_sub2
                                .aClass40_Sub5_Sub5_3300.anInt2374)
                                ^ 0xffffffff) == -2
                                && ((class40_sub5_sub17_sub4_sub2.anInt3098 & 0x7f)
                                == 64)
                                && ((0x7f & class40_sub5_sub17_sub4_sub2.anInt3089)
                                == 64)) {
                            for (int i_9_ = 0;
                                 ((Class40_Sub5_Sub8.anInt2558 ^ 0xffffffff)
                                         < (i_9_ ^ 0xffffffff));
                                 i_9_++) {
                                NPC class40_sub5_sub17_sub4_sub2_10_
                                        = (Class6_Sub1
                                        .aClass40_Sub5_Sub17_Sub4_Sub2Array1813
                                        [Class40_Sub3.anIntArray2016[i_9_]]);
                                if (class40_sub5_sub17_sub4_sub2_10_ != null
                                        && (class40_sub5_sub17_sub4_sub2_10_
                            ...
                            for (int i_11_ = 0; i_11_ < Class60.anInt1407;
                                ...
                                if (class40_sub5_sub17_sub4_sub1 != null
                                        ...
                                        .anInt3089)
                                        ^ 0xffffffff)))
                                    Class40_Sub5_Sub1.method545
                                            (i_4_, false, i_3_,
                                                    class40_sub5_sub17_sub4_sub1,
                                                    Class57.anIntArray1334[i_11_]);
                            }
                        }
                        Class66.method1025(0, i_3_, i_4_, i_6_,
                                (class40_sub5_sub17_sub4_sub2
                                        .aClass40_Sub5_Sub5_3300));
                    }
                    if (i_5_ == 0) {
                        Player class40_sub5_sub17_sub4_sub1
                                = (Class40_Sub5_Sub17_Sub4
                                .aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i_6_]);
                        if ((0x7f & class40_sub5_sub17_sub4_sub1.anInt3098
                                ^ 0xffffffff) == -65
                                && (0x7f & class40_sub5_sub17_sub4_sub1.anInt3089
                                ^ 0xffffffff) == -65) {
                            for (int i_12_ = 0; ((i_12_ ^ 0xffffffff)
                                    > (Class40_Sub5_Sub8.anInt2558
                                    ^ 0xffffffff)); i_12_++) {
                                NPC class40_sub5_sub17_sub4_sub2
                                        = (Class6_Sub1
                                        .aClass40_Sub5_Sub17_Sub4_Sub2Array1813
                                        [Class40_Sub3.anIntArray2016[i_12_]]);
                            ...
                            for (int i_13_ = 0;
                                 ...
                                 i_13_++) {
                                Player class40_sub5_sub17_sub4_sub1_14_
                                        = (Class40_Sub5_Sub17_Sub4
                                        .aClass40_Sub5_Sub17_Sub4_Sub1Array3156
                                        [Class57.anIntArray1334[i_13_]]);
                                if (class40_sub5_sub17_sub4_sub1_14_ != null
                                        && (class40_sub5_sub17_sub4_sub1_14_
                                        != class40_sub5_sub17_sub4_sub1)
                                        && (((class40_sub5_sub17_sub4_sub1_14_
                                        .anInt3098)
                                        ^ 0xffffffff)
                        ...
                        Class40_Sub5_Sub1.method545
                                (i_4_, false, i_3_, class40_sub5_sub17_sub4_sub1,
                                        i_6_);
                    }
                        ...
                        if (class45 != null) {
                            for (Class40_Sub5_Sub17_Sub3 class40_sub5_sub17_sub3
                                ...
                                if (Class8.anInt301 == 1) {
                                    ...
                                    Floor.method558
                                            (class40_sub5_sub17_sub3.anInt3067,
                                                    Main.aClass1_1763, i_4_, -501, i_3_,
                                                    47,
                                                    (Class40_Sub5_Sub17_Sub6.method832
                                                            (115,
                                                                    (new RSString[]
                                                                            {(NPC
                                                                                    ...
                                                                                    (class40_sub5_sub16
                                                                                            .aClass1_2796)}))));
                                } else if ((Main.anInt1773 ^ 0xffffffff)
                                        != -2) {
                                    RSString[] class1s
                                            = class40_sub5_sub16.groundOptions;
                                    Class56.anInt1319++;
                                    if (Class60.aBoolean1402)
                                        class1s
                                                = Class56.method968(class1s, arg0);
                                    for (int i_15_ = 4;
                                        ...
                                        if (class1s == null
                                            ...
                                            if (i_15_ == 2) {
                                                ...
                                                Floor.method558
                                                        ((class40_sub5_sub17_sub3
                                                                        .anInt3067),
                                                                Class27.takeStringInstance, i_4_,
                                                                -501, i_3_, 3,
                                    ...
                                    Floor.method558
                                            (class40_sub5_sub17_sub3.anInt3067,
                                                    Class40_Sub5_Sub15.aClass1_2774, i_4_,
                                                    -501, i_3_, 1003,
                                                    (Class40_Sub5_Sub17_Sub6.method832
                                                            (89,
                                                                    new RSString[]{Class46.aClass1_1114,
                                                                            (class40_sub5_sub16
                                                                                    .aClass1_2796)})));
                                } else if ((0x1 & ItemDefinition.anInt2815)
                                        == 1) {
                                    Floor.method558
                                            (class40_sub5_sub17_sub3.anInt3067,
                                                    Class38_Sub1.aClass1_1918, i_4_, -501,
                                                    i_3_, 15,
                                                    (Class40_Sub5_Sub17_Sub6.method832
                                                            (-67,
                                                                    new RSString[]{Class25.aClass1_611,
                                                                            Class5.aClass1_206,
                                                                            (class40_sub5_sub16
                                                                                    .aClass1_2796)})));
                                    Class58.anInt1368++;
    ...
    public static void method1015(int arg0) {
        try {
            synchronized (Class40_Sub5_Sub17_Sub2.aClass62_3019) {
                ...
                Class40_Sub5_Sub8.aLong2561 = Floor.aLong2344;
    ...
    public void method1008(int arg0, int arg1, int arg2, byte[] arg3)
            throws IOException {
        try {
            anInt1522++;
    ...
    public void method1010(int arg0, byte arg1, int arg2, byte[] arg3)
            throws IOException {
        try {
            anInt1525++;
            if (!aBoolean1513) {
                ...
                synchronized (this) {
                    for (int i = 0; (arg0 ^ 0xffffffff) < (i ^ 0xffffffff);
                         i++) {
            ...
            try {
                for (; ; ) {
                    ...
                    synchronized (this) {
                        ...
                        if ((anInt1520 ^ 0xffffffff)
                                >= (anInt1509 ^ 0xffffffff))
                    ...
                    if (i > 0) {
                        ...
                        try {
                            if ((anInt1509 ^ 0xffffffff)
                                    == (anInt1520 ^ 0xffffffff))
