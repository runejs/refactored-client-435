...
public class Class35 implements Interface3 {
    ...
    public Class35(Class6 arg0, Class6 arg1, int arg2, double arg3, int arg4) {
        ...
        try {
            ...
            int i = is.length;
            aClass40_Sub10Array1740
                    = new EntryTable[arg0.method190(0, (byte) 120)];
            for (int i_4_ = 0; i > i_4_; i_4_++) {
                Buffer class40_sub1
                        = new Buffer(arg0.method172(is[i_4_], 120, 0));
                aClass40_Sub10Array1740[is[i_4_]]
                        = new EntryTable(class40_sub1);
            }
    ...
    public static Class40_Sub5_Sub15 method421
            (Class6 arg0, byte arg1, int arg2, Class6 arg3, boolean arg4) {
        try {
            if (arg1 < 40)
                return null;
            anInt1739++;
            ...
            for (int i = 0; (i ^ 0xffffffff) > (is.length ^ 0xffffffff); i++) {
                ...
                if (is_0_ == null)
                    ...
                    int i_1_
                            = 0xff & is_0_[1] | (0xff & is_0_[0]) << -1471118168;
                    byte[] is_2_;
                    if (arg4)
    ...
    public void method422(int arg0) {
        try {
            anInt1723++;
            for (int i = arg0; ((aClass40_Sub10Array1740.length ^ 0xffffffff)
                    < (i ^ 0xffffffff)); i++) {
    ...
    public int[] method12(int arg0, int arg1) {
        try {
            ...
            if (class40_sub10 != null) {
                ...
                boolean bool = class40_sub10.method869(aDouble1750, anInt1748,
                        aClass6_1749);
                if (bool) {
                    if ((anInt1753 ^ 0xffffffff) == -1) {
                        EntryTable class40_sub10_3_
                                = ((EntryTable)
                                aClass45_1727.method899((byte) 87));
    ...
    public void method425(byte arg0, int arg1) {
        try {
            ...
            int i = 0;
            if (arg0 == 6) {
                for (/**/; (i ^ 0xffffffff) > (aClass40_Sub10Array1740.length
                        ^ 0xffffffff); i++) {
                    EntryTable class40_sub10 = aClass40_Sub10Array1740[i];
                    if (class40_sub10 != null
                            && (class40_sub10.anInt2136 ^ 0xffffffff) != -1
                            && class40_sub10.aBoolean2146) {
