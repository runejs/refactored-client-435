...
public class Class58 {
    ...
    public static void method976(byte arg0, Widget arg1) {
        ...
        if(i >= 1 && i <= 100 || i >= 701 && i <= 800) {
            if(i == 1 && Class12.anInt380 == 0) {
                arg1.text = Class13.aClass1_405;
                arg1.menuType = 0;
            } else if(i == 1 && Class12.anInt380 == 1) {
                arg1.text = HuffmanEncoding.aClass1_1552;
                arg1.menuType = 0;
            } else if(i == 2 && Class12.anInt380 != 2) {
                arg1.menuType = 0;
        ...
        } else if(i >= 101 && i <= 200 || i >= 801 && i <= 900) {
            if(i <= 800)
                i -= 101;
            else
                i -= 701;
            ...
            if(i >= i_1_) {
                ...
                if(Class40_Sub7.anIntArray2131[i] != 0) {
                    if(Class40_Sub7.anIntArray2131[i] < 5000) {
                        if(Class40_Sub7.anIntArray2131[i] != Class13.worldid)
                    ...
                    } else if(Class13.worldid != Class40_Sub7.anIntArray2131[i])
            ...
            if(i == 203) {
                ...
                i -= 401;
                if(i == 0 && Class12.anInt380 == 0) {
                    arg1.text = Class49.aClass1_1148;
                    arg1.menuType = 0;
                } else if(i == 1 && Class12.anInt380 == 0) {
                    arg1.text = PacketBuffer.aClass1_2240;
                    arg1.menuType = 0;
                } else {
                    int i_4_ = Class42.anInt1008;
                    if(Class12.anInt380 == 0)
                        i_4_ = 0;
                    if((i_4_ <= i)) {
                        arg1.menuType = 0;
                        arg1.text = HuffmanEncoding.blank_string;
    ...
    public static void method979(boolean arg0) {
        ...
        if(!Class19.aBoolean490) {
            if(Class40_Sub5_Sub15.inputType != 1) {
                if(Class40_Sub5_Sub15.inputType == 2) {
