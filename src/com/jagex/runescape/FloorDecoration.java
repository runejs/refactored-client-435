        ...
        if(Class58.aBoolean1349) {
            ...
            for(int i_26_ = 0; (i_25_ ^ 0xffffffff) < (i_26_ ^ 0xffffffff); i_26_++) {
                for(int i_27_ = 0; i_27_ < 4; i_27_++)
                    Class44.anIntArrayArray1030[i_26_][i_27_] = Cache.outgoingbuffer.getIntME();
            }
    ...
    public static Object[] method345(byte arg0, Buffer arg1) {
        ...
        int i = arg1.getUnsignedByte();
            ...
            for(int i_31_ = 0; i_31_ < i; i_31_++) {
                ...
                if(i_32_ == 0)
                    objects[i_31_] = new Integer(arg1.readInt());
                else if(i_32_ == 1)
            ...
            try {
                ...
                for(int i_33_ = 0; i_33_ < 100; i_33_++) {
                    ...
                    if(i_35_ <= 0) {
                        ...
                        if((Class40_Sub5_Sub13.aClass40_Sub1_2752.currentPosition ^ 0xffffffff) == (i_36_ ^ 0xffffffff)) {
				...
				if (((com.jagex.runescape.PacketBuffer
				    ...
				    return false;
                                ...
                                for(int i_40_ = 0; i_40_ < 256; i_40_++) {
                                    ...
                                    if(class6_sub1 != null) {
                                        ...
                                        int i_41_ = Class48.aClass40_Sub1_1132.readInt();
