...
public class ChatBox {
    public static void renderChatbox(boolean arg0) {
        ...
        if(InteractiveObject.messagePromptRaised) {
            ...
            Class40_Sub5_Sub17_Sub6.fontBold.method686(Class40_Sub5_Sub6.aClass1_2446, 239, 40, 0);
            Class40_Sub5_Sub17_Sub6.fontBold.method686((RSString.linkRSStrings(new RSString[]{HuffmanEncoding.inputInputMessage, InteractiveObject.aClass1_478})), 239, 60, 128);
            ...
            if(HuffmanEncoding.inputInputMessage.length() != 0) {
                if(VertexNormal.itemSearchResultCount == 0)
                    Class40_Sub5_Sub17_Sub6.fontBold.method686(Class40_Sub6.aClass1_2097, 239, 40, 0);
            } else
                Class40_Sub5_Sub17_Sub6.fontBold.method686(Class35.aClass1_1747, 239, 40, 255);
                ...
                if(Class48.anInt1138 == -1) {
                    ...
                    for(int i_8_ = 0; i_8_ < 100; i_8_++) {
                        if((Actor.chatMessages[i_8_]) != null) {
                            ...
                            if(type == 5 && CollisionMap.anInt165 == 0 && Class4.privateChatMode < 2) {
                                if(y > 0 && y < 110)
                                    typeFace.drawString((Actor.chatMessages[i_8_]), 4, y, 8388608);
                                line++;
                            }
                            if(type == 6 && CollisionMap.anInt165 == 0 && Class4.privateChatMode < 2) {
                                if(y > 0 && (y < 110)) {
            ...
            Class40_Sub5_Sub17_Sub6.fontBold.method686(RSApplet.aClass1_8, 239, 40, 0);
