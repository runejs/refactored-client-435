...
public class CollisionMap {
    ...
    public static boolean parsePackets(boolean arg0) {
        ...
        try {
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -116) {
                ...
                Widget widget = Class68.method1045(i_10_, (byte) -92);
                widget.aBoolean2750 = bool;
                Class57.incomingPacket = -1;
                return true;
            }
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -251) {
                ...
                Widget widget = Class68.method1045(i_22_, (byte) -87);
                widget.anInt2673 = i_21_;
                widget.anInt2687 = 1;
                Class57.incomingPacket = -1;
                return true;
            }
                ...
                if(!class1.method87(103, Class40_Sub5_Sub7.aClass1_2472)) {
                    if(!class1.method87(104, Class40_Sub5_Sub6.aClass1_2434)) {
                        if(!class1.method87(81, Node.aClass1_948))
                            ...
                            RSString class1_27_ = (class1.substring(0, class1.method60(Class43.aClass1_1027)));
                            ...
                            if(!bool && (Class4.anInt182 ^ 0xffffffff) == -1) {
                                RSString class1_29_ = (class1.substring((1 + class1.method60((Class43.aClass1_1027))), -9 + class1.length()));
                    ...
                    RSString class1_32_ = class1.substring(0, class1.method60((Class43.aClass1_1027)));
            ...
            if(Class57.incomingPacket == 182) {
                ...
                Widget widget = Class68.method1045(i_35_, (byte) -61);
                Class57.incomingPacket = -1;
                if(widget != null && (widget.type ^ 0xffffffff) == -1) {
                    if((i_34_ ^ 0xffffffff) > -1)
                        i_34_ = 0;
                    if((-widget.anInt2643 + widget.anInt2720) < i_34_)
                        i_34_ = (-widget.anInt2643 + widget.anInt2720);
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -175) {
                ...
                Widget widget = Class68.method1045(i_36_, (byte) -115);
                if(widget.aBoolean2636) {
                    Widget[] widgets = (Class59.aWidgetArrayArray1390[i_36_ >> -1339248816]);
                    for(int i_37_ = 0; i_37_ < widgets.length; i_37_++) {
                        Widget widget_38_ = widgets[i_37_];
                        if(((widget_38_.anInt2648 & 0xffff ^ 0xffffffff) == (0xffff & widget.anInt2689 ^ 0xffffffff)) && widget_38_.anInt2736 > 0) {
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -25) {
                ...
                Widget widget = Class68.method1045(i_44_, (byte) -82);
                if(((widget.anInt2659 ^ 0xffffffff) != (i_43_ ^ 0xffffffff)) || (i_43_ ^ 0xffffffff) == 0) {
                    widget.anInt2660 = 0;
                    widget.anInt2654 = 0;
                    widget.anInt2659 = i_43_;
                }
                Class57.incomingPacket = -1;
                return true;
            }
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -118) {
                ...
                Widget widget = Class68.method1045(i_48_, (byte) -100);
                Class57.incomingPacket = -1;
            ...
            if(Class57.incomingPacket == 254) {
                Floor.anInt2318 = Cache.outgoingbuffer.putUnsignedPreNegativeOffsetByte();
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -143) {
                ...
                Widget widget = Class68.method1045(i_79_, (byte) -86);
                Class57.incomingPacket = -1;
                widget.anInt2657 = i_76_;
                widget.anInt2728 = i_77_;
                widget.anInt2690 = i_78_;
                return true;
            }
            ...
            if(Class57.incomingPacket == 160) {
                ...
                Widget widget = Class68.method1045(i_82_, (byte) -67);
                widget.anInt2687 = 2;
                Class57.incomingPacket = -1;
                widget.anInt2673 = i_81_;
                return true;
            }
            if(Class57.incomingPacket == 132) {
                ...
                Class57.incomingPacket = -1;
                Class66.aClass1_1543 = Class66.blank_string;
            ...
            if(Class57.incomingPacket == 210) {
                ...
                Widget widget = Class68.method1045(i_83_, (byte) -107);
                widget.anInt2687 = 3;
            ...
            if(Class57.incomingPacket == 110) {
                ...
                RSString class1 = Cache.outgoingbuffer.getRSString();
                Widget widget = Class68.method1045(i_84_, (byte) -73);
                widget.aClass1_2668 = class1;
                if(Class40_Sub5_Sub11.tabWidgetIds[Class5.currentTabId] == i_84_ >> -1297036176)
                    ISAAC.redrawTabArea = true;
                Class57.incomingPacket = -1;
                return true;
            }
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -121) {
                ...
                if((i_86_ ^ 0xffffffff) == -65536)
                    i_86_ = -1;
                Widget widget = Class68.method1045(i_87_, (byte) -102);
                if(!widget.aBoolean2636) {
                    if(i_86_ == -1) {
                        Class57.incomingPacket = -1;
                        widget.anInt2687 = 0;
                    ...
                    widget.anInt2673 = i_86_;
                    widget.anInt2687 = 4;
                    widget.anInt2728 = 100 * class40_sub5_sub16.modelZoom / i_85_;
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -4) {
                ...
                Widget widget = Class68.method1045(i_102_, (byte) -86);
                widget.anInt2656 = widget.anInt2649 + i_104_;
                Class57.incomingPacket = -1;
                widget.anInt2696 = widget.anInt2743 + i_103_;
                return true;
            }
            ...
            if((Class57.incomingPacket ^ 0xffffffff) == -232) {
                ...
                Widget widget = Class68.method1045(i_114_, (byte) -103);
                Class57.incomingPacket = -1;
                int i_117_ = i_113_ & 0x1f;
                widget.anInt2647 = ((i_116_ << -1232932181) + (i_115_ << -1927757997) + (i_117_ << 770125059));
                return true;
            }
            ...
            String string = ("T2 - " + Class57.incomingPacket + "," + Cache.anInt324 + "," + Class49.anInt1151 + " - " + Widget.packetsize + "," + (Class40_Sub5_Sub2.anInt2307 + (Player.localPlayer.anIntArray3088[0])) + "," + ((Player.localPlayer.anIntArray3135[0]) + Class26.anInt635) + " - ");
    ...
    public boolean method153(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        if((i + 1 ^ 0xffffffff) == (arg7 ^ 0xffffffff) && arg4 <= arg6 && arg6 <= i_121_ && (anIntArrayArray150[arg7 - anInt140][arg6 + -anInt151] & 0x80) == 0 && (0x2 & arg5 ^ 0xffffffff) == -1)
            return true;
        if((arg6 ^ 0xffffffff) == (arg4 - 1 ^ 0xffffffff) && arg2 <= arg7 && i >= arg7 && (anIntArrayArray150[arg7 - anInt140][arg6 - anInt151] & 0x2 ^ 0xffffffff) == -1 && (arg5 & 0x4) == 0)
            return true;
        return (1 + i_121_ ^ 0xffffffff) == (arg6 ^ 0xffffffff) && arg7 >= arg2 && arg7 <= i && (anIntArrayArray150[-anInt140 + arg7][arg6 - anInt151] & 0x20) == 0 && (0x1 & arg5 ^ 0xffffffff) == -1;
    }
    ...
    public boolean method155(int arg0, boolean arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        ...
        if((arg2 ^ 0xffffffff) == -1) {
            if((arg5 ^ 0xffffffff) != -1) {
                ...
                if(arg6 + -1 == arg0 && arg4 == arg3)
                    return true;
                if(arg6 == arg0 && (arg3 + 1 ^ 0xffffffff) == (arg4 ^ 0xffffffff) && (anIntArrayArray150[arg0][arg4] & 0x1280120 ^ 0xffffffff) == -1)
                    return true;
            ...
            if(arg5 != 0) {
                if((arg5 ^ 0xffffffff) != -2) {
                    if(arg5 != 2) {
                        ...
                        if((arg0 ^ 0xffffffff) == (arg6 + -1 ^ 0xffffffff) && arg4 == arg3 && (anIntArrayArray150[arg0][arg4] & 0x1280108) == 0)
                            return true;
                    ...
                    if(arg0 == -1 + arg6 && arg4 == arg3 && ((anIntArrayArray150[arg0][arg4] & 0x1280108) == 0))
                        return true;
                    if(arg0 == arg6 && (arg3 + 1 ^ 0xffffffff) == (arg4 ^ 0xffffffff))
                        return true;
                    if(arg0 == arg6 + 1 && arg3 == arg4)
                        return true;
        ...
        if((arg2 ^ 0xffffffff) == -10) {
            if(arg6 == arg0 && arg4 == 1 + arg3 && ((0x20 & anIntArrayArray150[arg0][arg4] ^ 0xffffffff) == -1))
                return true;
            if(arg0 == arg6 && (-1 + arg3 ^ 0xffffffff) == (arg4 ^ 0xffffffff) && (0x2 & anIntArrayArray150[arg0][arg4]) == 0)
                return true;
    ...
    public boolean method158(int arg0, int arg1, int arg2, int arg3, int arg4, byte arg5, int arg6) {
        ...
        if((arg6 ^ 0xffffffff) == -7 || (arg6 ^ 0xffffffff) == -8) {
            ...
            if((arg1 ^ 0xffffffff) == -1) {
                if((arg4 ^ 0xffffffff) == (1 + arg3 ^ 0xffffffff) && arg2 == arg0 && (anIntArrayArray150[arg4][arg2] & 0x80) == 0)
                    return true;
                if(arg3 == arg4 && (arg2 ^ 0xffffffff) == (-1 + arg0 ^ 0xffffffff) && (0x2 & anIntArrayArray150[arg4][arg2]) == 0)
                    return true;
            } else if((arg1 ^ 0xffffffff) != -2) {
                if((arg1 ^ 0xffffffff) == -3) {
                    if((arg3 + -1 ^ 0xffffffff) == (arg4 ^ 0xffffffff) && arg0 == arg2 && (anIntArrayArray150[arg4][arg2] & 0x8 ^ 0xffffffff) == -1)
                        return true;
                    ...
                    if(arg3 + 1 == arg4 && arg0 == arg2 && (anIntArrayArray150[arg4][arg2] & 0x80) == 0)
                        return true;
                    if(arg4 == arg3 && (arg0 + 1 ^ 0xffffffff) == (arg2 ^ 0xffffffff) && (0x20 & anIntArrayArray150[arg4][arg2] ^ 0xffffffff) == -1)
                        return true;
                }
            } else {
                if(arg4 == arg3 + -1 && arg0 == arg2 && ((anIntArrayArray150[arg4][arg2] & 0x8 ^ 0xffffffff) == -1))
                    return true;
                if(arg4 == arg3 && (arg0 + -1 ^ 0xffffffff) == (arg2 ^ 0xffffffff) && (anIntArrayArray150[arg4][arg2] & 0x2) == 0)
                    return true;
            }
        }
        if((arg6 ^ 0xffffffff) == -9) {
            if(arg4 == arg3 && (arg0 + 1 ^ 0xffffffff) == (arg2 ^ 0xffffffff) && (anIntArrayArray150[arg4][arg2] & 0x20) == 0)
                return true;
            if(arg3 == arg4 && (arg0 + -1 ^ 0xffffffff) == (arg2 ^ 0xffffffff) && (anIntArrayArray150[arg4][arg2] & 0x2) == 0)
                return true;
            if((arg3 - 1 ^ 0xffffffff) == (arg4 ^ 0xffffffff) && arg0 == arg2 && (anIntArrayArray150[arg4][arg2] & 0x8) == 0)
                return true;
            return (arg4 ^ 0xffffffff) == (1 + arg3 ^ 0xffffffff) && arg2 == arg0 && ((0x80 & anIntArrayArray150[arg4][arg2] ^ 0xffffffff) == -1);
        }
        return false;
    }
}
