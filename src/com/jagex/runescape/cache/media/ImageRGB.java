...
public class ImageRGB extends Rasterizer {
    ...
    public void method716(int arg0, int arg1, int arg2, int arg3, int arg4) {
        if(arg2 > 0 && arg3 > 0) {
            ...
            int i_12_ = arg0 + arg1 * Rasterizer.width;
            int i_13_ = Rasterizer.width - arg2;
            if(arg1 + arg3 > Rasterizer.viewport_bottom)
                arg3 -= arg1 + arg3 - Rasterizer.viewport_bottom;
            if(arg1 < Rasterizer.viewport_top) {
                int i_14_ = Rasterizer.viewport_top - arg1;
                arg3 -= i_14_;
                i_12_ += i_14_ * Rasterizer.width;
                i_5_ += i_9_ * i_14_;
            }
            if(arg0 + arg2 > Rasterizer.viewport_right) {
                int i_15_ = arg0 + arg2 - Rasterizer.viewport_right;
                arg2 -= i_15_;
                i_13_ += i_15_;
            }
            if(arg0 < Rasterizer.viewport_left) {
                int i_16_ = Rasterizer.viewport_left - arg0;
                arg2 -= i_16_;
                i_12_ += i_16_;
                i_4_ += i_8_ * i_16_;
                i_13_ += i_16_;
            }
            method733(Rasterizer.pixels, pixels, 0, i_4_, i_5_, i_12_, i_13_, arg2, arg3, i_8_, i_9_, i, arg4);
        }
    }
    ...
    public void drawImage(int x, int y) {
        ...
        if(y < Rasterizer.viewport_top) {
            int clip_height = Rasterizer.viewport_top - y;
            line_count -= clip_height;
            y = Rasterizer.viewport_top;
            source_offset += clip_height * line_width;
            dest_offset += clip_height * Rasterizer.width;
        }
        if(y + line_count > Rasterizer.viewport_bottom)
            line_count -= y + line_count - Rasterizer.viewport_bottom;
        if(x < Rasterizer.viewport_left) {
            int clip_width = Rasterizer.viewport_left - x;
        ...
        if(x + line_width > Rasterizer.viewport_right) {
            int clip_width = x + line_width - Rasterizer.viewport_right;
            line_width -= clip_width;
            line_offset_source += clip_width;
            line_offset_dest += clip_width;
        }
        if(line_width > 0 && line_count > 0)
            blockCopyTrans(Rasterizer.pixels, pixels, 0, source_offset, dest_offset, line_width, line_count, line_offset_dest, line_offset_source);
    }
    ...
    public void method722(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        if(arg5 != 0) {
            ...
            i_46_ >>= 4;
            i_47_ = i_47_ + 15 >> 4;
            if(i_44_ < Rasterizer.viewport_left)
                i_44_ = Rasterizer.viewport_left;
            if(i_45_ > Rasterizer.viewport_right)
                i_45_ = Rasterizer.viewport_right;
            if(i_46_ < Rasterizer.viewport_top)
                i_46_ = Rasterizer.viewport_top;
            if(i_47_ > Rasterizer.viewport_bottom)
                i_47_ = Rasterizer.viewport_bottom;
            i_45_ = i_44_ - i_45_;
            if(i_45_ < 0) {
                i_47_ = i_46_ - i_47_;
                if(i_47_ < 0) {
                    int i_48_ = i_46_ * Rasterizer.width + i_44_;
                    ...
                    if(i_51_ == 0) {
                            ...
                            while(i_56_ < 0) {
                                ...
                                if(i_58_ >= 0 && i_59_ >= 0 && i_58_ - (image_width << 12) < 0 && i_59_ - (image_height << 12) < 0) {
                                    for(/**/; i_60_ < 0; i_60_++) {
                                        ...
                                        if(i_61_ != 0)
                                            Rasterizer.pixels[i_57_++] = i_61_;
                                        else
                                            i_57_++;
                                    }
                                }
                                i_56_++;
                                i_48_ += Rasterizer.width;
                            }
                        } else if(i_50_ < 0) {
                            int i_62_ = i_47_;
                            while(i_62_ < 0) {
                        ...
                        while(i_98_ < 0) {
                            ...
                            if(i_101_ >= 0 && i_101_ - (image_height << 12) < 0) {
                                ...
                                for(/**/; i_102_ < 0; i_102_++) {
                                    ...
                                    if(i_105_ != 0)
                                        Rasterizer.pixels[i_99_++] = i_105_;
                                    else
                                        i_99_++;
                                    i_100_ += i_51_;
                                }
                        ...
                        while(i_106_ < 0) {
                            ...
                            for(/**/; i_110_ < 0; i_110_++) {
                                ...
                                if(i_113_ != 0)
                                    Rasterizer.pixels[i_107_++] = i_113_;
                                else
                                    i_107_++;
                                i_108_ += i_51_;
                                i_109_ += i_50_;
                        ...
                        while(i_114_ < 0) {
                            ...
                            for(/**/; i_118_ < 0; i_118_++) {
                                ...
                                if(i_121_ != 0)
                                    Rasterizer.pixels[i_115_++] = i_121_;
                                else
                                    i_115_++;
                                i_116_ += i_51_;
                                i_117_ += i_50_;
    ...
    public void drawTo(IndexedImage indexedImage, int x, int y) {
        ...
        if(y < Rasterizer.viewport_top) {
            ...
            dest_ptr += clip_height * Rasterizer.width;
        }
        if(y + line_count > Rasterizer.viewport_bottom)
            line_count -= y + line_count - Rasterizer.viewport_bottom;
        if(x < Rasterizer.viewport_left) {
    ...
    public void method727(int arg0, int arg1) {
        ...
        int i_145_ = 0;
        if(arg1 < Rasterizer.viewport_top) {
            int i_146_ = Rasterizer.viewport_top - arg1;
            i_142_ -= i_146_;
            arg1 = Rasterizer.viewport_top;
            i_141_ += i_146_ * i_143_;
            i += i_146_ * Rasterizer.width;
        }
        if(arg1 + i_142_ > Rasterizer.viewport_bottom)
            i_142_ -= arg1 + i_142_ - Rasterizer.viewport_bottom;
        if(arg0 < Rasterizer.viewport_left) {
            int i_147_ = Rasterizer.viewport_left - arg0;
            i_143_ -= i_147_;
        ...
        if(arg0 + i_143_ > Rasterizer.viewport_right) {
            int i_148_ = arg0 + i_143_ - Rasterizer.viewport_right;
            i_143_ -= i_148_;
            i_145_ += i_148_;
            i_144_ += i_148_;
        }
        if(i_143_ > 0 && i_142_ > 0)
            method731(Rasterizer.pixels, pixels, i_141_, i, i_143_, i_142_, i_144_, i_145_);
    }
    ...
    public void method728(int arg0, int arg1, int arg2) {
        ...
        int i_153_ = 0;
        if(arg1 < Rasterizer.viewport_top) {
            int i_154_ = Rasterizer.viewport_top - arg1;
            i_150_ -= i_154_;
            arg1 = Rasterizer.viewport_top;
            i_149_ += i_154_ * i_151_;
            i += i_154_ * Rasterizer.width;
        }
        if(arg1 + i_150_ > Rasterizer.viewport_bottom)
            i_150_ -= arg1 + i_150_ - Rasterizer.viewport_bottom;
        if(arg0 < Rasterizer.viewport_left) {
            int i_155_ = Rasterizer.viewport_left - arg0;
            i_151_ -= i_155_;
            arg0 = Rasterizer.viewport_left;
            i_149_ += i_155_;
            i += i_155_;
        ...
        if(arg0 + i_151_ > Rasterizer.viewport_right) {
            int i_156_ = arg0 + i_151_ - Rasterizer.viewport_right;
            i_151_ -= i_156_;
            i_153_ += i_156_;
            i_152_ += i_156_;
        }
        if(i_151_ > 0 && i_150_ > 0)
            method730(Rasterizer.pixels, pixels, 0, i_149_, i, i_151_, i_150_, i_152_, i_153_, arg2);
    }
    ...
    public void method732(int arg0, int arg1, int arg2, int arg3) {
        if(arg2 > 0 && arg3 > 0) {
            ...
            int i_180_ = arg0 + arg1 * Rasterizer.width;
            int i_181_ = Rasterizer.width - arg2;
            if(arg1 + arg3 > Rasterizer.viewport_bottom)
                arg3 -= arg1 + arg3 - Rasterizer.viewport_bottom;
            if(arg1 < Rasterizer.viewport_top) {
                int i_182_ = Rasterizer.viewport_top - arg1;
                arg3 -= i_182_;
                i_180_ += i_182_ * Rasterizer.width;
                i_173_ += i_177_ * i_182_;
            }
            if(arg0 + arg2 > Rasterizer.viewport_right) {
                int i_183_ = arg0 + arg2 - Rasterizer.viewport_right;
                arg2 -= i_183_;
                i_181_ += i_183_;
            }
            if(arg0 < Rasterizer.viewport_left) {
                int i_184_ = Rasterizer.viewport_left - arg0;
                arg2 -= i_184_;
                i_180_ += i_184_;
                i_172_ += i_176_ * i_184_;
                i_181_ += i_184_;
            }
            method715(Rasterizer.pixels, pixels, 0, i_172_, i_173_, i_180_, i_181_, arg2, arg3, i_176_, i_177_, i);
        }
    }
}
