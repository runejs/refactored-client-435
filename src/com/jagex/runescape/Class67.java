...
public class Class67 {
    ...
    public static RSString aClass1_1591 = Class58.method978("Update)2Liste geladen)3");
    ...
    static {
        ...
        aClass1_1613 = Class58.method978("60 Sekunden noch einmal)3)3)3");
    ...
    public void method1033(int arg0, int arg1, int arg2, byte[] arg3) throws IOException {
        ...
        try {
            ...
            if(((long) arg2 + aLong1578 ^ 0xffffffffffffffffL) < (aLong1602 ^ 0xffffffffffffffffL))
                aLong1602 = (long) arg2 + aLong1578;
            if((aLong1593 ^ 0xffffffffffffffffL) != 0L && (aLong1578 < aLong1593 || ((aLong1578 ^ 0xffffffffffffffffL) < (aLong1593 + (long) anInt1595 ^ 0xffffffffffffffffL))))
                method1039(-1);
            if(aLong1593 != -1L && (((long) arg2 + aLong1578 ^ 0xffffffffffffffffL) < (aLong1593 + (long) aByteArray1592.length ^ 0xffffffffffffffffL))) {
        ...
        try {
            ...
            if(aLong1593 != -1L) {
                ...
                if((l ^ 0xffffffffffffffffL) < (aLong1593 ^ 0xffffffffffffffffL) || (((long) i + l ^ 0xffffffffffffffffL) >= (aLong1593 ^ 0xffffffffffffffffL))) {
                    ...
                    l_8_ = aLong1593;
                if(l_8_ > -1L && ((l_8_ ^ 0xffffffffffffffffL) > (l_7_ ^ 0xffffffffffffffffL))) {
    ...
    public void method1039(int arg0) throws IOException {
        ...
        if(arg0 == -1) {
            if((aLong1593 ^ 0xffffffffffffffffL) != 0L) {
                if((aLong1600 ^ 0xffffffffffffffffL) != (aLong1593 ^ 0xffffffffffffffffL)) {
                ...
                if(l > -1L && ((l_10_ ^ 0xffffffffffffffffL) < (l ^ 0xffffffffffffffffL))) {
                    int i = (int) (-l + l_10_);
