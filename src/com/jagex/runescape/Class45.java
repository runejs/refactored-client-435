...
public class Class45 {
    ...
    public static RSString method903(int arg0, byte arg1) {
        ...
        if(arg1 >= -13)
            ...
            for(int i = -3 + class1.method59(-3136); (i ^ 0xffffffff) < -1; i -= 3)
            ...
            if(class1.method59(-3136) > 8)
                class1 = (Class40_Sub5_Sub17_Sub6.method832(-69, (new RSString[]{Landscape.aClass1_1162, class1.method68(0, -8 + class1.method59(-3136)), Class40_Sub5_Sub9.aClass1_2577, Class52.aClass1_1213, class1, Class51.aClass1_1199})));
            else if(class1.method59(-3136) > 4)
                class1 = (Class40_Sub5_Sub17_Sub6.method832(-115, (new RSString[]{Renderable.aClass1_2862, class1.method68(0, class1.method59(-3136) + -4), Class40_Sub5_Sub10.aClass1_2593, Class52.aClass1_1213, class1, Class51.aClass1_1199})));
