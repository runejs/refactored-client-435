...
public class Class36
{
	...
	for (int i_0_ = 0; i_0_ < 10; i_0_++) {
	    if (aClass63Array856[i_0_] != null
		&& (aClass63Array856[i_0_].anInt1494
		    + aClass63Array856[i_0_].anInt1476) > i)
		i = (aClass63Array856[i_0_].anInt1494
		     + aClass63Array856[i_0_].anInt1476);
	}
	if (i == 0)
	    return new byte[0];
	...
	for (int i_2_ = 0; i_2_ < 10; i_2_++) {
		...
		int[] is_5_
		    = aClass63Array856[i_2_]
			  .method1007(i_3_, aClass63Array856[i_2_].anInt1494);
	...
	for (int i_8_ = 0; i_8_ < 10; i_8_++) {
	    if (aClass63Array856[i_8_] != null
		&& aClass63Array856[i_8_].anInt1476 / 20 < i)
	...
	byte[] is = method426();
	return new Class40_Sub12_Sub1(22050, is, 22050 * anInt857 / 1000,
				      22050 * anInt858 / 1000);
    }
