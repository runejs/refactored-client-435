...
public class HashTable {
    ...
    public static void method327(boolean arg0, Class6_Sub1 arg1, int arg2,
                                 int arg3, byte arg4, int arg5, byte arg6) {
        try {
            int i = 14 % ((arg6 - 5) / 62);
            long l = (long) (arg3 + (arg2 << -1726391664));
            Class40_Sub5_Sub13 class40_sub5_sub13
                    = ((Class40_Sub5_Sub13)
                    Class51.aClass23_1194.method331(l, 6120));
            anInt561++;
            if (class40_sub5_sub13 == null) {
                class40_sub5_sub13 = ((Class40_Sub5_Sub13)
                        Class37.aClass23_869.method331(l, 6120));
                if (class40_sub5_sub13 == null) {
                    class40_sub5_sub13
                            = ((Class40_Sub5_Sub13)
                    ...
                    if (class40_sub5_sub13 != null) {
                        if (arg0) {
                            ...
                            Class51.aClass23_1194.put(class40_sub5_sub13,
                                    (byte) 116, l);
                            anInt554--;
                            Class68.anInt1618++;
                        }
                        ...
                        if (!arg0) {
                            class40_sub5_sub13
                                    = ((Class40_Sub5_Sub13)
                                    Class34.aClass23_841.method331(l, 6120));
                            if (class40_sub5_sub13 != null)
                                return;
                        }
                        ...
                        if (!arg0) {
                            Class19.aClass27_485.method352(126,
                                    class40_sub5_sub13);
                            Class40_Sub5_Sub8.aClass23_2545
                                    .put(class40_sub5_sub13, (byte) 109, l);
                            anInt554++;
                        } else {
                            Class51.aClass23_1194.put(class40_sub5_sub13,
                                    (byte) 54, l);
    ...
    public static void method335(byte arg0) {
        try {
            ...
            Class40_Sub5_Sub17_Sub1 class40_sub5_sub17_sub1
                    ...
                    Class43.aClass45_1022.method902((byte) -90));
            if (arg0 == 61) {
                for (/**/; class40_sub5_sub17_sub1 != null;
                         class40_sub5_sub17_sub1
                                 = ((Class40_Sub5_Sub17_Sub1)
                                 Class43.aClass45_1022.method909(arg0 + -65))) {
                    if ((Player.anInt3267
                            == class40_sub5_sub17_sub1.anInt2981)
                            && (Node.anInt926
                            <= class40_sub5_sub17_sub1.anInt2971)) {
                        if (class40_sub5_sub17_sub1.anInt2974
                                <= Node.anInt926) {
                            if ((class40_sub5_sub17_sub1.anInt2961
                                    ^ 0xffffffff)
                                    < -1) {
                                NPC class40_sub5_sub17_sub4_sub2
                                        = (Class6_Sub1
                                        .aClass40_Sub5_Sub17_Sub4_Sub2Array1813
                                        [-1 + (class40_sub5_sub17_sub1
                                        .anInt2961)]);
                                            ...
                                            (Node.anInt926, arg0 + -61,
                                                    ...
                                                    ((Class37.method430
                                                            ((byte) -127,
                                                                    ...
                                                                    (class40_sub5_sub17_sub4_sub2
                                                                            .anInt3089)))
                                                            - class40_sub5_sub17_sub1.anInt2960),
                                                    (class40_sub5_sub17_sub4_sub2
                                                            .anInt3098));
                            }
                            if ((class40_sub5_sub17_sub1.anInt2961
                                    ...
                                    > -1) {
                                int i
                                        = -1 + -class40_sub5_sub17_sub1.anInt2961;
                                Player class40_sub5_sub17_sub4_sub1;
                                if ((Class30.anInt708 ^ 0xffffffff)
                                        != (i ^ 0xffffffff))
                            ...
                            class40_sub5_sub17_sub1.method765(51,
                                    Class5.anInt199);
                            NPC.aClass2_3301.method134
                                    (Player.anInt3267,
                                            (int) class40_sub5_sub17_sub1.aDouble2980,
                                            (int) class40_sub5_sub17_sub1.aDouble2993,
                                            (int) class40_sub5_sub17_sub1.aDouble2992, 60,
                                            class40_sub5_sub17_sub1,
                                            class40_sub5_sub17_sub1.anInt3013, -1, false);
                        }
                    } else
    ...
    public Node method331(long arg0, int arg1) {
        try {
            ...
            anInt568++;
            Node class40
                    = nodes[(int) ((long) (size + -1) & arg0)];
            for (aClass40_566 = class40.aClass40_950; class40 != aClass40_566;
    ...
    public Node method336(byte arg0) {
        try {
            ...
            if (arg0 > -26)
                aClass40_566 = null;
            if ((anInt572 ^ 0xffffffff) < -1
                    && aClass40_574 != nodes[anInt572 - 1]) {
