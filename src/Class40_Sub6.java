...
public class Class40_Sub6 extends Node {
    ...
    public static int[] anIntArray2106
    ...
    public static void method836(int arg0) {
        ...
        for (int i_6_ = 1; i_6_ < i - 1; i_6_++) {
            for (int i_7_ = 1; i_7_ < 127; i_7_++) {
                ...
                Class40_Sub5_Sub17_Sub6.anIntArray3255[i_8_]
                        = (Class4.anIntArray178[i_8_ + 1]
                        + Class4.anIntArray178[i_8_ - 1]
                        - (-Class4.anIntArray178[-128 + i_8_]
                        - Class4.anIntArray178[128 + i_8_])) / 4;
            }
        }
        ...
        if (RSRuntimeException.anInt1641 > Landscape.anIntArray1168.length) {
            ...
            Class40_Sub13.method879(-4487,
                    (Class22.aClass40_Sub5_Sub14_Sub2Array535
                            [i_9_]));
        }
        for (int i_10_ = 1; (i_10_ ^ 0xffffffff) > (-1 + i ^ 0xffffffff);
             i_10_++) {
            for (int i_11_ = 1; i_11_ < 127; i_11_++) {
                int i_12_ = i_11_ + (i_10_ << 1567048551);
                int i_13_
                        = (-((Landscape.anIntArray1168
                        [(i_12_ - -RSRuntimeException.anInt1641
                        & -1 + Landscape.anIntArray1168.length)])
                        / 5)
        ...
        for (int i_14_ = 0; (i_14_ ^ 0xffffffff) > (i + -1 ^ 0xffffffff);
             i_14_++)
            Class17.anIntArray466[i_14_] = Class17.anIntArray466[i_14_ - -1];
        Class17.anIntArray466[i - arg0]
                = (int) (16.0 * Math.sin((double) Node.anInt926 / 14.0)
                + 14.0 * Math.sin((double) Node.anInt926 / 15.0)
                + 12.0 * Math.sin((double) Node.anInt926 / 16.0));
        ...
        if (Class40_Sub5_Sub6.anInt2452 == 0
                && Class40_Sub5_Sub10.anInt2613 == 0) {
                ...
                for (int i = arg0;
                    ...
                    if (Class53.aLongArray1267[i] == arg1) {
                        ...
                        for (int i_16_ = i; Class42.anInt1008 > i_16_; i_16_++)
                            Class53.aLongArray1267[i_16_]
                                    = Class53.aLongArray1267[1 + i_16_];
