...
public class Class40_Sub13 extends Node {
    ...
    public static RSString aClass1_2172
            = Class58.method978(-11538, "Service unavailable)3");
    ...
    public static RSString aClass1_2179 = Class58.method978(-11538, "cross");
    ...
    static {
        aBoolean2177 = false;
        aClass1_2181
                = Class58.method978(-11538, "Musik)2Engine vorbereitet)3");
        aClass1_2176
                = (Class58.method978
                (-11538,
                        "Bitte warten Sie )2 es wird versucht)1 die Verbindung wiederherzustellen)3"));
        anInt2183 = 0;
        aClass1_2185 = Class58.method978(-11538, "Titelbild geladen)3");
        aClass1_2174 = Class58.method978(-11538, "rot:");
        aClass1_2187
                = (Class58.method978
                (-11538,
                        "You need a members account to login to this world)3"));
        aClass1_2188 = aClass1_2187;
        aClass1_2186 = Class58.method978(-11538, " hat sich eingeloggt)3");
    ...
    public Class40_Sub13(int arg0, byte[] arg1) {
        try {
            ...
            for (int i = 0; (i ^ 0xffffffff) > (anInt2171 ^ 0xffffffff); i++)
                anIntArrayArray2168[i]
                        = new int[class40_sub1.method468(false)];
            for (int i = 0; i < anInt2171; i++) {
                for (int i_38_ = 0; anIntArrayArray2168[i].length > i_38_;
                     i_38_++)
                    anIntArrayArray2168[i][i_38_]
    ...
    public static DirectColorSprite method876(int arg0, int arg1,
                                              int arg2, int arg3) {
        try {
            anInt2182++;
            if (arg3 == 0) {
                DirectColorSprite class40_sub5_sub14_sub4
                        = ((DirectColorSprite)
                        Buffer.aClass9_1933.method231((long) arg2,
                                (byte) 56));
                if (class40_sub5_sub14_sub4 != null
                        && class40_sub5_sub14_sub4.anInt2952 != arg1
                        && (class40_sub5_sub14_sub4.anInt2952 ^ 0xffffffff) != 0) {
            ...
            ItemDefinition class40_sub5_sub16
                    = Class44.method897(arg2, 10);
            if (class40_sub5_sub16.anIntArray2831 == null)
                arg1 = -1;
            if ((arg1 ^ 0xffffffff) < -2) {
                int i = -1;
                for (int i_0_ = 0; (i_0_ ^ 0xffffffff) > -11; i_0_++) {
                    if (arg1 >= class40_sub5_sub16.anIntArray2834[i_0_]
                            && class40_sub5_sub16.anIntArray2834[i_0_] != 0)
            ...
            DirectColorSprite class40_sub5_sub14_sub4_10_
                    = new DirectColorSprite(32, 32);
            Rasterizer
                    .method669(class40_sub5_sub14_sub4_10_.anIntArray2955, 32, 32);
            Class40_Sub5_Sub17_Sub6.anIntArray3253
                    = R3D
                    .method708(Class40_Sub5_Sub17_Sub6.anIntArray3253);
            ...
            int i_12_ = ((R3D.sinetable
                    [class40_sub5_sub16.anInt2844]) * i_11_
                    >> -1598852880);
            int i_13_ = (i_11_ * (R3D.cosinetable
                    [class40_sub5_sub16.anInt2844])
                    >> -2129368336);
            class40_sub5_sub17_sub5.method799();
            class40_sub5_sub17_sub5.method812
                    (0, class40_sub5_sub16.anInt2830, class40_sub5_sub16.anInt2827,
                            class40_sub5_sub16.anInt2844, class40_sub5_sub16.anInt2806,
                            (class40_sub5_sub16.anInt2810
                                    + class40_sub5_sub17_sub5.anInt2861 / 2 + i_12_),
                            i_13_ + class40_sub5_sub16.anInt2810);
            for (int i_14_ = 31; i_14_ >= 0; i_14_--) {
                for (i_13_ = 31; i_13_ >= 0; i_13_--) {
                    if (((class40_sub5_sub14_sub4_10_.anIntArray2955
                            [i_14_ + 32 * i_13_])
                            ^ 0xffffffff)
                            == -1) {
                        if ((i_14_ ^ 0xffffffff) < -1
                                && (class40_sub5_sub14_sub4_10_.anIntArray2955
                                [i_13_ * 32 + (-1 + i_14_)]) > 1)
                            class40_sub5_sub14_sub4_10_.anIntArray2955
                                    [i_13_ * 32 + i_14_]
                                    = 1;
                            ...
                            if (i_15_ > 0
                                ...
                                if ((i_15_ ^ 0xffffffff) <= -32
                                    ...
                                    if ((i_13_ ^ 0xffffffff) > -32
                                            ...
                                            ^ 0xffffffff) == -2)
                                        class40_sub5_sub14_sub4_10_
                                                .anIntArray2955[i_13_ * 32 + i_15_]
                                                = arg3;
                                } else
                                    class40_sub5_sub14_sub4_10_
                                            .anIntArray2955[i_15_ - -(i_13_ * 32)]
                                            = arg3;
                            } else
                                class40_sub5_sub14_sub4_10_.anIntArray2955
                                        [i_15_ - -(i_13_ * 32)]
            ...
            if (arg3 == 0)
                Buffer.aClass9_1933.method230
                        (-7208, (long) arg2, class40_sub5_sub14_sub4_10_);
    ...
    public static Class40_Sub5_Sub12 method878(int arg0,
                                               Class40_Sub5_Sub12 arg1) {
        try {
            anInt2169++;
            int i;
            ...
            if ((arg1.anInt2738 ^ 0xffffffff) <= -1)
                return (Class59.aClass40_Sub5_Sub12ArrayArray1390[i]
                        [0xffff & arg1.anInt2738]);
            Class40_Sub5_Sub12 class40_sub5_sub12
                    = (Class59.aClass40_Sub5_Sub12ArrayArray1390[i]
                    [(0x7fff99d9 & arg1.anInt2738) >> -88908881]);
            return (class40_sub5_sub12.aClass40_Sub5_Sub12Array2713
                    [arg1.anInt2738 & 0x7fff]);
        } catch (RuntimeException runtimeexception) {
            throw Class8.method216(runtimeexception,
                    ("va.D(" + arg0 + ','
                            + (arg1 != null ? "{...}" : "null")
    ...
    public static void method879(int arg0, IndexedColorSprite arg1) {
        ...
        for (int i_22_ = 0; (i_22_ ^ 0xffffffff) > -21; i_22_++) {
            for (int i_23_ = 1;
                 (-1 + i_19_ ^ 0xffffffff) < (i_23_ ^ 0xffffffff); i_23_++) {
                for (int i_24_ = 1; i_24_ < 127; i_24_++) {
                    int i_25_ = (i_23_ << 2116521895) + i_24_;
                    Class61.anIntArray1445[i_25_]
                            = (Landscape.anIntArray1168[i_25_ - 128]
                            + Landscape.anIntArray1168[i_25_ + -1]
                            + (Landscape.anIntArray1168[i_25_ - -1]
                            - -Landscape.anIntArray1168[128 + i_25_])) / 4;
                }
            }
        ...
        if (arg1 != null) {
            ...
            for (int i_27_ = 0; arg1.anInt2926 > i_27_; i_27_++) {
                for (int i_28_ = 0;
                     (i_28_ ^ 0xffffffff) > (arg1.anInt2921 ^ 0xffffffff);
                     i_28_++) {
    ...
    public static void method880(byte arg0, int arg1, int arg2) {
        try {
            ...
            Class45 class45
                    ...
                    [Player.anInt3267][arg2][arg1]);
            if (class45 == null)
                NPC.aClass2_3301.method125
                        (Player.anInt3267, arg2, arg1);
            else {
                int i = -99999999;
                Class40_Sub5_Sub17_Sub3 class40_sub5_sub17_sub3 = null;
                for (Class40_Sub5_Sub17_Sub3 class40_sub5_sub17_sub3_32_
                     = ((Class40_Sub5_Sub17_Sub3)
                        class45.method902((byte) -90));
                     class40_sub5_sub17_sub3_32_ != null;
                     class40_sub5_sub17_sub3_32_
                             = (Class40_Sub5_Sub17_Sub3) class45.method909(-4)) {
                    ItemDefinition class40_sub5_sub16
                            = Class44.method897((class40_sub5_sub17_sub3_32_
                                    .anInt3067),
                            10);
                ...
                if (class40_sub5_sub17_sub3 == null)
                    ...
                    for (Class40_Sub5_Sub17_Sub3 class40_sub5_sub17_sub3_36_
                         = ((Class40_Sub5_Sub17_Sub3)
                            class45.method902((byte) -90));
                         class40_sub5_sub17_sub3_36_ != null;
                         class40_sub5_sub17_sub3_36_
                                 = ((Class40_Sub5_Sub17_Sub3)
                                 class45.method909(-4))) {
                        if ((class40_sub5_sub17_sub3_36_.anInt3067
                                ^ 0xffffffff)
                                != (class40_sub5_sub17_sub3.anInt3067
                                ^ 0xffffffff)) {
                            if (class40_sub5_sub17_sub3_35_ == null)
                                class40_sub5_sub17_sub3_35_
                                        = class40_sub5_sub17_sub3_36_;
                            if ((class40_sub5_sub17_sub3_35_.anInt3067
                                    != class40_sub5_sub17_sub3_36_.anInt3067)
                                    && class40_sub5_sub17_sub3_34_ == null)
                                class40_sub5_sub17_sub3_34_
                                        = class40_sub5_sub17_sub3_36_;
                        }
                    }
                    int i_37_ = 1610612736 + (arg1 << 512988999) + arg2;
                    NPC.aClass2_3301.method139
                            (Player.anInt3267, arg2, arg1,
                                    Class37.method430((byte) -126,
                                            (Player
                                                    .anInt3267),
                                            64 + 128 * arg2, 64 + 128 * arg1),
                                    class40_sub5_sub17_sub3, i_37_,
                                    class40_sub5_sub17_sub3_35_,
                                    class40_sub5_sub17_sub3_34_);
                }
            }
