...
public class Class16
{
	...
	if (i != 0) {
		...
		for (int i_2_ = 0; i_2_ < anIntArray444[i_1_]; i_2_++) {
		    anIntArrayArrayArray439[i_1_][0][i_2_]
			= arg0.method469(65280);
		    anIntArrayArrayArray445[i_1_][0][i_2_]
			= arg0.method469(65280);
		}
	    }
		...
		for (int i_4_ = 0; i_4_ < anIntArray444[i_3_]; i_4_++) {
			...
			anIntArrayArrayArray439[i_3_][1][i_4_]
			    = arg0.method469(65280);
			anIntArrayArrayArray445[i_3_][1][i_4_]
			    = arg0.method469(65280);
		    } else {
			anIntArrayArrayArray439[i_3_][1][i_4_]
			    = anIntArrayArrayArray439[i_3_][0][i_4_];
			anIntArrayArrayArray445[i_3_][1][i_4_]
			    = anIntArrayArrayArray445[i_3_][0][i_4_];
		    }
		}
	    }
	...
	float f
	    = ((float) anIntArrayArrayArray445[arg0][0][arg1]
	       + arg2 * (float) (anIntArrayArrayArray445[arg0][1][arg1]
				 - anIntArrayArrayArray445[arg0][0][arg1]));
	f *= 0.0015258789F;
	...
	if (arg0 == 0) {
	    float f = ((float) anIntArray443[0]
		       + (float) (anIntArray443[1] - anIntArray443[0]) * arg1);
	    f *= 0.0030517578F;
	...
	aFloatArrayArray441[arg0][0]
	    = -2.0F * f * (float) Math.cos((double) method271(arg0, 0, arg1));
	aFloatArrayArray441[arg0][1] = f * f;
	for (int i = 1; i < anIntArray444[arg0]; i++) {
	    f = method269(arg0, i, arg1);
	    float f_5_
		= (-2.0F * f
		   * (float) Math.cos((double) method271(arg0, i, arg1)));
	    float f_6_ = f * f;
	    aFloatArrayArray441[arg0][i * 2 + 1]
		= aFloatArrayArray441[arg0][i * 2 - 1] * f_6_;
	    aFloatArrayArray441[arg0][i * 2]
		= (aFloatArrayArray441[arg0][i * 2 - 1] * f_5_
		   + aFloatArrayArray441[arg0][i * 2 - 2] * f_6_);
	    for (int i_7_ = i * 2 - 1; i_7_ >= 2; i_7_--)
		aFloatArrayArray441[arg0][i_7_]
		    += (aFloatArrayArray441[arg0][i_7_ - 1] * f_5_
			+ aFloatArrayArray441[arg0][i_7_ - 2] * f_6_);
	    aFloatArrayArray441[arg0][1]
		+= aFloatArrayArray441[arg0][0] * f_5_ + f_6_;
	...
	for (int i = 0; i < anIntArray444[arg0] * 2; i++)
	    anIntArrayArray440[arg0][i]
		= (int) (aFloatArrayArray441[arg0][i] * 65536.0F);
	return anIntArray444[arg0] * 2;
    }
    
    public float method271(int arg0, int arg1, float arg2) {
	float f
	    = ((float) anIntArrayArrayArray439[arg0][0][arg1]
	       + arg2 * (float) (anIntArrayArrayArray439[arg0][1][arg1]
				 - anIntArrayArrayArray439[arg0][0][arg1]));
	f *= 1.2207031E-4F;
	return method272(f);
    }
