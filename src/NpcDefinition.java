        ...
        try {
            ...
            if(class40_sub5_sub17_sub5 == null) {
                ...
                for(int i = 0; i < anIntArray2405.length; i++) {
                    if(!Class67.aClass6_1577.method173(anIntArray2405[i], (byte) -10, 0))
                        bool = true;
                }
                if(bool)
                    return null;
                        ...
                        if((arg0 ^ 0xffffffff) > -31 || (arg0 ^ 0xffffffff) <= -36) {
                            if((arg0 ^ 0xffffffff) == -41) {
                                ...
                                for(int i_2_ = 0; i_2_ < i; i_2_++) {
                                    anIntArray2428[i_2_] = arg2.method469(65280);
                                    anIntArray2395[i_2_] = arg2.method469(65280);
                                }
                            } else if((arg0 ^ 0xffffffff) != -61) {
                                if(arg0 != 93) {
                                    if((arg0 ^ 0xffffffff) == -96)
                                        anInt2393 = arg2.method469(arg1 + 56315);
                                            ...
                                            if(arg0 != 99) {
                                                if(arg0 != 100) {
                                                    if(arg0 == 101)
                                                        ...
                                                        anInt2391 = (arg2.method469(65280));
                                                    else if((arg0 ^ 0xffffffff) != -107) {
                                                        if(arg0 == 107)
                                                            aBoolean2372 = false;
                                                    } else {
                                                        anInt2411 = (arg2.method469(65280));
                                                        if(anInt2411 == 65535)
                                                            anInt2411 = -1;
                                                        anInt2385 = (arg2.method469(65280));
                                                        if(anInt2385 == 65535)
                                                            anInt2385 = -1;
                                                        int i = (arg2.method468(false));
                                                        anIntArray2426 = new int[i + 1];
                                                        for(int i_3_ = 0; i >= i_3_; i_3_++) {
                                                            anIntArray2426[i_3_] = (arg2.method469(65280));
                                        ...
                                        anInt2407 = arg2.method469(arg1 ^ 0xdc05);
                                } else
                                    aBoolean2430 = false;
                            } else {
                                int i = arg2.method468(false);
                                ...
                                for(int i_4_ = 0; i > i_4_; i_4_++)
                                    anIntArray2375[i_4_] = arg2.method469(65280);
                            }
                        } else {
    ...
    public Model method575(byte arg0) {
        try {
            ...
            for(int i = 0; i < anIntArray2375.length; i++) {
                if(!Class67.aClass6_1577.method173(anIntArray2375[i], (byte) -10, 0))
                    bool = true;
            }
            if(arg0 < 108)
