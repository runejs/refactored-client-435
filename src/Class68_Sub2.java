    ...
    public void method1041(int arg0, int arg1, Component arg2, int arg3) {
        ...
        if (arg0 > 4) {
            ...
            DataBufferInt databufferint
                    = new DataBufferInt(anIntArray1621, anIntArray1621.length);
            DirectColorModel directcolormodel
                    = new DirectColorModel(32, 16711680, 65280, 255);
            WritableRaster writableraster
                    = (Raster.createWritableRaster
                    (directcolormodel.createCompatibleSampleModel(anInt1619,
                            anInt1617),
                            databufferint, null));
            anImage1625 = new BufferedImage(directcolormodel, writableraster,
                    false, new Hashtable());
            aComponent2214 = arg2;
            method1046((byte) 90);
        }
