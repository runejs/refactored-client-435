/* Class40_Sub5_Sub14_Sub1 - Decompiled by JODE
...
public class RSFont extends Rasterizer {
    ...
    public RSFont(int[] arg0, int[] arg1, int[] arg2,
                  int[] arg3, byte[][] arg4) {
        anInt2910 = 0;
    ...
    public void method671(int[] arg0, byte[] arg1, int arg2, int arg3,
    ...
    public void method672(RSString arg0, int arg1, int arg2, int arg3, int arg4,
                          int arg5, boolean arg6, int arg7, int arg8,
                          int arg9) {
        if (arg0 != null) {
            int i = 0;
            int i_3_ = 0;
            ...
            for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
                ...
                if (i_10_ == 64 && i_9_ + 4 < i_8_
                        && arg0.method55(i_9_ + 4, false) == 64) {
                    class1_6_ = arg0.method68(0, i_9_, i_9_ + 5);
                    class1.method72(class1_6_, (byte) -87);
                    i_9_ += 4;
                } else if (i_10_ == 92 && i_9_ + 1 < i_8_
                        && arg0.method55(i_9_ + 1, false) == 110) {
                    class1_6_ = null;
                    aClass1Array2897[i_7_++]
                            = class1.method68(0, i_3_, class1.method59(-3136))
                            .method89(false);
                    ...
                    if (bool && i > arg3 && i_4_ >= 0) {
                        aClass1Array2897[i_7_++]
                                = class1.method68(0, i_3_, i_4_).method89(false);
                        i_3_ = i_4_;
                        i_4_ = -1;
                        i -= i_5_;
            ...
            if (arg8 == 0)
                ...
                i_11_ = arg2 + anInt2920 + (arg4 - anInt2920 - anInt2919
                        - (i_7_ - 1) * arg9) / 2;
            else if (arg8 == 2)
                i_11_ = arg2 + arg4 - anInt2919 - (i_7_ - 1) * arg9;
            else {
                int i_12_ = ((arg4 - anInt2920 - anInt2919 - (i_7_ - 1) * arg9)
                        / (i_7_ + 1));
                if (i_12_ < 0)
                    i_12_ = 0;
            ...
            for (int i_13_ = 0; i_13_ < i_7_; i_13_++) {
                if (arg7 == 0)
                    method683(aClass1Array2897[i_13_], arg1, i_11_, arg5,
                            arg6);
                else if (arg7 == 1)
                    method688(aClass1Array2897[i_13_], arg1 + arg3 / 2, i_11_,
                            arg5, arg6);
                else if (arg7 == 2)
                    method677(aClass1Array2897[i_13_], arg1 + arg3, i_11_,
                            arg5, arg6);
                else if (i_13_ == i_7_ - 1)
                    method683(aClass1Array2897[i_13_], arg1, i_11_, arg5,
                            arg6);
                else
                    method680(aClass1Array2897[i_13_], arg1, i_11_, arg5, arg6,
                            arg3);
                i_11_ += arg9;
            }
        }
    ...
    public void method673(RSString arg0, int arg1, int arg2, int arg3,
                          int arg4) {
        if (arg0 != null) {
            ...
            for (int i = 0; i < arg0.anInt1680; i++) {
                ...
                if (i_14_ != 32)
                    method682(aByteArrayArray2914[i_14_], arg1,
                            (arg2 + anIntArray2911[i_14_]
                                    + (int) (Math.sin((double) i / 2.0
                                    + (double) arg4 / 5.0)
                                    * 5.0)),
                            anIntArray2907[i_14_], anIntArray2915[i_14_],
                            arg3);
    ...
    public void method674(int[] arg0, byte[] arg1, int arg2, int arg3,
                          int arg4, int arg5, int arg6, int arg7, int arg8,
                          int arg9) {
        ...
        for (int i = -arg6; i < 0; i++) {
            for (int i_15_ = -arg5; i_15_ < 0; i_15_++) {
                if (arg1[arg3++] != 0) {
                    int i_16_ = arg0[arg4];
                    arg0[arg4++] = ((((i_16_ & 0xff00ff) * arg9 & ~0xff00ff)
                            + ((i_16_ & 0xff00) * arg9 & 0xff0000))
                            >> 8) + arg2;
                } else
                    arg4++;
            }
    ...
    public void method675(RSString arg0, int arg1, int arg2, int arg3,
                          int arg4) {
        if (arg0 != null) {
            arg1 -= method685(arg0) / 2;
            arg2 -= anInt2910;
            for (int i = 0; i < arg0.method59(-3136); i++) {
                ...
                if (i_17_ != 32)
                    method682(aByteArrayArray2914[i_17_],
                            arg1 + (int) (Math.sin((double) i / 5.0
                                    + (double) arg4 / 5.0)
                                    * 5.0),
                            (arg2 + anIntArray2911[i_17_]
                                    + (int) (Math.sin((double) i / 3.0
                                    + (double) arg4 / 5.0)
                                    * 5.0)),
                            anIntArray2907[i_17_], anIntArray2915[i_17_],
                            arg3);
    ...
    public void method677(RSString arg0, int arg1, int arg2, int arg3,
                          boolean arg4) {
        method683(arg0, arg1 - method681(arg0), arg2, arg3, arg4);
    }

    public void method678(RSString arg0, int arg1, int arg2, int arg3, int arg4,
                          int arg5) {
        if (arg0 != null) {
            ...
            for (int i = 0; i < arg0.method59(-3136); i++) {
                ...
                if (i_18_ != 32)
                    method682(aByteArrayArray2914[i_18_], arg1,
                            (arg2 + anIntArray2911[i_18_]
                                    + (int) (Math.sin((double) i / 1.5
                                    + (double) arg4)
                                    * d)),
                            anIntArray2907[i_18_], anIntArray2915[i_18_],
                            arg3);
    ...
    public void method679(byte[] arg0, int arg1, int arg2, int arg3, int arg4,
                          int arg5, int arg6) {
        ...
        if (arg3 > 0 && arg4 > 0)
            method674(Rasterizer.anIntArray2766, arg0, arg5, i_21_, i,
                    arg3, arg4, i_19_, i_20_, arg6);
    }

    public void method680(RSString arg0, int arg1, int arg2, int arg3,
        ...
        if (arg0 != null) {
            ...
            for (int i_29_ = 0; i_29_ < arg0.anInt1680; i_29_++) {
                if (arg0.aByteArray1692[i_29_] == 64
                        && i_29_ + 4 < arg0.anInt1680
                        && arg0.aByteArray1692[i_29_ + 4] == 64) {
                    int i_30_
                            = method670(arg0.method68(0, i_29_ + 1, i_29_ + 4));
                    if (i_30_ != -1)
                        arg3 = i_30_;
                    i_29_ += 4;
                } else {
                    ...
                    if (i_31_ != 32) {
                        if (arg4)
                            method682(aByteArrayArray2914[i_31_], arg1 + 1,
                                    arg2 + anIntArray2911[i_31_] + 1,
                                    anIntArray2907[i_31_],
                                    anIntArray2915[i_31_], 0);
                        method682(aByteArrayArray2914[i_31_], arg1,
                                arg2 + anIntArray2911[i_31_],
                                anIntArray2907[i_31_], anIntArray2915[i_31_],
                                arg3);
                    }
            ...
            if (aBoolean2918)
                Rasterizer.method659(i_28_,
                        arg2 + (int) ((double) anInt2910
                                * 0.7),
                        arg1 - i_28_, 8388608);
        }
    }
    ...
    public int method681(RSString arg0) {
        ...
        for (int i_32_ = 0; i_32_ < arg0.anInt1680; i_32_++) {
            if (arg0.aByteArray1692[i_32_] == 64 && i_32_ + 4 < arg0.anInt1680
                    && arg0.aByteArray1692[i_32_ + 4] == 64)
                i_32_ += 4;
            else
    ...
    public void method682(byte[] arg0, int arg1, int arg2, int arg3, int arg4,
                          int arg5) {
        int i = arg1 + arg2 * Rasterizer.anInt2768;
        ...
        if (arg3 > 0 && arg4 > 0)
            method671(Rasterizer.anIntArray2766, arg0, arg5, i_35_, i,
                    arg3, arg4, i_33_, i_34_);
    }

    public void method683(RSString arg0, int arg1, int arg2, int arg3,
                          boolean arg4) {
        aBoolean2918 = false;
        int i = arg1;
        if (arg0 != null) {
            ...
            for (int i_39_ = 0; i_39_ < arg0.anInt1680; i_39_++) {
                if (arg0.aByteArray1692[i_39_] == 64
                        && i_39_ + 4 < arg0.anInt1680
                        && arg0.aByteArray1692[i_39_ + 4] == 64) {
                    int i_40_
                            = method670(arg0.method68(0, i_39_ + 1, i_39_ + 4));
                    if (i_40_ != -1)
                        arg3 = i_40_;
                    i_39_ += 4;
                } else {
                    ...
                    if (i_41_ != 32) {
                        if (arg4)
                            method682(aByteArrayArray2914[i_41_], arg1 + 1,
                                    arg2 + anIntArray2911[i_41_] + 1,
                                    anIntArray2907[i_41_],
                                    anIntArray2915[i_41_], 0);
                        method682(aByteArrayArray2914[i_41_], arg1,
                                arg2 + anIntArray2911[i_41_],
                                anIntArray2907[i_41_], anIntArray2915[i_41_],
                                arg3);
                    }
    ...
    public void method684(RSString arg0, int arg1, int arg2, int arg3,
                          boolean arg4, int arg5) {
        if (arg0 != null) {
            ...
            for (int i_42_ = 0; i_42_ < arg0.anInt1680; i_42_++) {
                if (arg0.aByteArray1692[i_42_] == 64
                        && i_42_ + 4 < arg0.anInt1680
                        && arg0.aByteArray1692[i_42_ + 4] == 64) {
                    int i_43_
                            = method670(arg0.method68(0, i_42_ + 1, i_42_ + 4));
                    if (i_43_ != -1)
                        arg3 = i_43_;
                    i_42_ += 4;
                } else {
                    ...
                    if (i_44_ != 32) {
                        if (arg4)
                            method679(aByteArrayArray2914[i_44_], arg1 + 1,
                                    arg2 + anIntArray2911[i_44_] + 1,
                                    anIntArray2907[i_44_],
                                    anIntArray2915[i_44_], 0, 192);
                        method679(aByteArrayArray2914[i_44_], arg1,
                                arg2 + anIntArray2911[i_44_],
                                anIntArray2907[i_44_], anIntArray2915[i_44_],
                                arg3, i);
                    }
    ...
    public void method688(RSString arg0, int arg1, int arg2, int arg3,
                          boolean arg4) {
    ...
    public void method690(RSString arg0, int arg1, int arg2, int arg3) {
        if (arg0 != null) {
            ...
            for (int i = 0; i < arg0.anInt1680; i++) {
                ...
                if (i_46_ != 32)
                    method682(aByteArrayArray2914[i_46_], arg1,
                            arg2 + anIntArray2911[i_46_],
                            anIntArray2907[i_46_], anIntArray2915[i_46_],
                            arg3);
