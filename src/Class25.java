...
public class Class25
{
    ...
    public static void method342(int arg0, int arg1,
				 Class40_Sub5_Sub17_Sub4 arg2) {
	try {
	    Class22_Sub1.method312(arg1, arg2.anInt3089, arg2.anInt3098,
				   4976905);
	    int i = -63 % ((41 - arg0) / 41);
	    anInt598++;
	...
	if (Class58.aBoolean1349) {
		...
		for (int i_5_ = 0; i_5_ < 13; i_5_++) {
			...
			int i_7_ = Cache.outgoingbuffer
				       .putBits(1, (byte) -65);
			if (i_7_ != 1)
			    Floor.anIntArrayArrayArray2333
				[i_4_][i_5_][i_6_]
				= -1;
			else
			    Floor.anIntArrayArrayArray2333
	    ...
	    int i_8_ = ((-Cache.outgoingbuffer.offset
			 + Class40_Sub5_Sub12.packetsize)
			/ 16);
	    Class44.anIntArrayArray1030 = new int[i_8_][4];
	    for (int i_9_ = 0; i_8_ > i_9_; i_9_++) {
		for (int i_10_ = 0; i_10_ < 4; i_10_++)
		    Class44.anIntArrayArray1030[i_9_][i_10_]
			= Cache.outgoingbuffer.method507(-64);
	    }
		...
		for (int i_12_ = 0; i_12_ < 13; i_12_++) {
			...
			int i_14_ = (Floor.anIntArrayArrayArray2333
				     [i_11_][i_12_][i_13_]);
			if ((i_14_ ^ 0xffffffff) != 0) {
				...
				Class45.anIntArray1071[i_8_]
				    = (Class40_Sub5_Sub17.aClass6_Sub1_2857
					   .method183
				       (RSApplet.method27(arg1, 5688),
					 ...
					 (85,
					  (new RSString[]
					   { Class45.aClass1_1085,
					     (HashTable.method334
					      (i_20_,
					       RSApplet.method27(arg1,
								    -5689))),
					     Class8.aClass1_303,
					     HashTable.method334(i_19_,
							       -1) })))));
				Class13.anIntArray421[i_8_]
				    = (Class40_Sub5_Sub17.aClass6_Sub1_2857
					   .method183
				       (0,
					(Class40_Sub5_Sub17_Sub6.method832
	    ...
	    Class40_Sub5_Sub17_Sub4.method789(i_0_, arg1 + -6688, i_3_, i_1_,
					      i, i_2_);
	} else {
	    ...
	    int i_25_ = ((Class40_Sub5_Sub12.packetsize
			  - Cache.outgoingbuffer.offset)
			 / 16);
	    Class44.anIntArrayArray1030 = new int[i_25_][4];
	    for (int i_26_ = 0; (i_25_ ^ 0xffffffff) < (i_26_ ^ 0xffffffff);
		 i_26_++) {
		for (int i_27_ = 0; i_27_ < 4; i_27_++)
		    Class44.anIntArrayArray1030[i_26_][i_27_]
			= Cache.outgoingbuffer.method470(-128);
	    }
	    ISAAC.anIntArray528 = new int[i_25_];
	    RSString.aByteArrayArray1715 = new byte[i_25_][];
	    boolean bool = false;
	    Class52.aByteArrayArray1217 = new byte[i_25_][];
	    if (((i_21_ / 8 ^ 0xffffffff) == -49 || i_21_ / 8 == 49)
		&& i_23_ / 8 == 48)
		bool = true;
	    Class45.anIntArray1071 = new int[i_25_];
	    if ((i_21_ / 8 ^ 0xffffffff) == -49
		&& (i_23_ / 8 ^ 0xffffffff) == -149)
		bool = true;
	    Class13.anIntArray421 = new int[i_25_];
	    i_25_ = 0;
	    for (int i_28_ = (-6 + i_21_) / 8; i_28_ <= (6 + i_21_) / 8;
		 i_28_++) {
		for (int i_29_ = (-6 + i_23_) / 8; (6 + i_23_) / 8 >= i_29_;
		     i_29_++) {
		    int i_30_ = i_29_ + (i_28_ << 13360776);
		    if (!bool
			|| (i_29_ != 49 && (i_29_ ^ 0xffffffff) != -150
			    && (i_29_ ^ 0xffffffff) != -148
			    && (i_28_ ^ 0xffffffff) != -51
			    && (i_28_ != 49 || (i_29_ ^ 0xffffffff) != -48))) {
			ISAAC.anIntArray528[i_25_] = i_30_;
			Class45.anIntArray1071[i_25_]
			    = (Class40_Sub5_Sub17.aClass6_Sub1_2857.method183
			       (0,
				(Class40_Sub5_Sub17_Sub6.method832
				 (RSApplet.method27(arg1, -5655),
				  new RSString[] { Class45.aClass1_1085,
						 HashTable.method334(i_28_, -1),
						 Class8.aClass1_303,
						 HashTable.method334(i_29_,
								   -1) }))));
			Class13.anIntArray421[i_25_]
			    = (Class40_Sub5_Sub17.aClass6_Sub1_2857.method183
			       (0,
				(Class40_Sub5_Sub17_Sub6.method832
				 (-84,
	    ...
	    Class40_Sub5_Sub17_Sub4.method789(i_22_, -1000, i_23_, i_21_, i,
					      i_24_);
	}
	anInt596++;
	if (arg1 != 5688)
	...
	try {
		...
		if (i_32_ == 0)
		    objects[i_31_]
			= new Integer(arg1.method491
				      (RSApplet.method27(arg0, -4821)));
		else if (i_32_ == 1)
	...
	try {
		...
		return false;
	    Class22.anInt547 += i;
	    if (Class42.anInt1006 == 0 && Class17.anInt464 == 0
		&& HashTable.anInt554 == 0 && Class68.anInt1618 == 0)
		return true;
		...
		for (/**/; (Class17.anInt464 ^ 0xffffffff) > -21;
		     Class17.anInt464++) {
		    if ((Class68.anInt1618 ^ 0xffffffff) >= -1)
			break;
		    Class40_Sub5_Sub13 class40_sub5_sub13
			= ((Class40_Sub5_Sub13)
			   Class51.aClass23_1194.method329(false));
		    Buffer class40_sub1 = new Buffer(4);
		    class40_sub1.put(1, (byte) -128);
		    class40_sub1.putTri((int) class40_sub5_sub13.key,
					   13723);
		    Class57.aClass64_1345.method1010(4, (byte) -19, 0,
						     (class40_sub1
						      .payload));
		    Class37.aClass23_869.put(class40_sub5_sub13,
						   (byte) -115,
						   (class40_sub5_sub13
						    .key));
		    Class68.anInt1618--;
		}
		for (/**/; Class42.anInt1006 < 20 && HashTable.anInt554 > 0;
		     HashTable.anInt554--) {
		    Class40_Sub5_Sub13 class40_sub5_sub13
			= ((Class40_Sub5_Sub13)
			   Class19.aClass27_485.method362(-113));
		    Buffer class40_sub1 = new Buffer(4);
		    ...
		    Class34.aClass23_841.put(class40_sub5_sub13,
						   (byte) -122,
						   (class40_sub5_sub13
						    .key));
		    Class42.anInt1006++;
		...
		for (int i_33_ = 0; i_33_ < 100; i_33_++) {
			...
			i_35_ = 1;
		    if (i_35_ <= 0) {
			int i_36_ = ((Class40_Sub5_Sub13.aClass40_Sub1_2752
				      .payload).length
				     + -(PacketBuffer
					 .aClass40_Sub5_Sub13_2250.aByte2758));
			int i_37_ = -Landscape.anInt1157 + 512;
			if (((-Class40_Sub5_Sub13.aClass40_Sub1_2752.offset
			      + i_36_)
			     ^ 0xffffffff)
			    > (i_37_ ^ 0xffffffff))
			    i_37_ = i_36_ - (Class40_Sub5_Sub13
					     .aClass40_Sub1_2752.offset);
			if (i_37_ > i_34_)
			    i_37_ = i_34_;
			Class57.aClass64_1345.method1008((Class40_Sub5_Sub13
							  .aClass40_Sub1_2752
							  .offset),
							 i_37_, -127,
							 (Class40_Sub5_Sub13
			...
			if ((Class8.aByte302 ^ 0xffffffff) != -1) {
			    for (int i_38_ = 0;
				 ...
				 i_38_++)
				Class40_Sub5_Sub13.aClass40_Sub1_2752
				    .payload
				    [(Class40_Sub5_Sub13.aClass40_Sub1_2752
				      .offset) + i_38_]
				    = (byte) (RSApplet.method27
					      ((Class40_Sub5_Sub13
						.aClass40_Sub1_2752
						.payload
						[(Class40_Sub5_Sub13
			...
			Class40_Sub5_Sub13.aClass40_Sub1_2752.offset
			    += i_37_;
			Landscape.anInt1157 += i_37_;
			if ((Class40_Sub5_Sub13.aClass40_Sub1_2752.offset
			     ^ 0xffffffff)
			    == (i_36_ ^ 0xffffffff)) {
			    if (((PacketBuffer.aClass40_Sub5_Sub13_2250
				  .key)
				 ^ 0xffffffffffffffffL)
				!= -16711936L) {
				/*aCRC32_590.reset();
				...
				Class34.anInt813 = 0;
				PacketBuffer.aClass40_Sub5_Sub13_2250
				    .aClass6_Sub1_2754.method196
				    (((PacketBuffer
				       .aClass40_Sub5_Sub13_2250.key)
				      & 0xff0000L) == 16711680L,
				     false,
				     (int) ((PacketBuffer
					     .aClass40_Sub5_Sub13_2250
					     .key)
					    & 0xffffL),
				     NPC.aBoolean3298,
				     (Class40_Sub5_Sub13.aClass40_Sub1_2752
				...
				Class48.aClass40_Sub1_1132
				    = Class40_Sub5_Sub13.aClass40_Sub1_2752;
				for (int i_40_ = 0; i_40_ < 256; i_40_++) {
				    Class6_Sub1 class6_sub1
					= Class24.aClass6_Sub1Array580[i_40_];
				    if (class6_sub1 != null) {
					Class48.aClass40_Sub1_1132.offset
					    = 4 * i_40_ - -5;
					int i_41_ = Class48
							.aClass40_Sub1_1132
							.method491(-4750);
			...
			int i_42_
			    = -Class45.aClass40_Sub1_1081.offset + i_35_;
			if (i_42_ > i_34_)
			    i_42_ = i_34_;
			Class57.aClass64_1345.method1008
			    (Class45.aClass40_Sub1_1081.offset, i_42_, -128,
			     Class45.aClass40_Sub1_1081.payload);
			if ((Class8.aByte302 ^ 0xffffffff) != -1) {
			    for (int i_43_ = 0; i_42_ > i_43_; i_43_++)
				Class45.aClass40_Sub1_1081.payload
				    [(Class45.aClass40_Sub1_1081.offset
				      + i_43_)]
				    = (byte) (RSApplet.method27
					      ((Class45.aClass40_Sub1_1081
						.payload
						[(Class45.aClass40_Sub1_1081
						  .offset) + i_43_]),
					       Class8.aByte302));
			...
			if (PacketBuffer.aClass40_Sub5_Sub13_2250
			    ...
			    int i_44_
				= Class45.aClass40_Sub1_1081.method468(false);
			    int i_45_
				= Class45.aClass40_Sub1_1081.method469(65280);
			    int i_46_
				= Class45.aClass40_Sub1_1081.method468(false);
			    int i_47_ = Class45.aClass40_Sub1_1081
					    .method491(arg0 ^ ~0x12bd);
			    long l_48_ = (long) ((i_44_ << 58201072) - -i_45_);
			    Class40_Sub5_Sub13 class40_sub5_sub13
				= ((Class40_Sub5_Sub13)
				   Class37.aClass23_869.method331(l_48_,
								  6120));
			    NPC.aBoolean3298 = true;
			    if (class40_sub5_sub13 == null) {
				class40_sub5_sub13
				    = ((Class40_Sub5_Sub13)
				       Class34.aClass23_841.method331(l_48_,
								      6120));
				NPC.aBoolean3298
				    = false;
			    }
			    ...
			    if ((Class45.aClass40_Sub1_1081.payload[0]
				 ^ 0xffffffff)
				!= 0)
				PacketBuffer.aClass40_Sub5_Sub13_2250
				    = null;
    ...
    public static RSFont method347(Class6 arg0, int arg1,
	...
	try {
	    ...
	    return Class40_Sub5_Sub17_Sub1.method760(i_50_, (byte) -124, arg0,
						     i);
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
				   ("id.G(" + (arg0 != null ? "{...}" : "null")
