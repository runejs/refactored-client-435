...
public abstract class Class6 {
    ...
    public Class6(boolean arg0, boolean arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.<init>(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public static void method184(byte[] arg0, int arg1) {
        try {
            ...
            class40_sub1.offset = arg0.length + -7 + -(Class40_Sub5_Sub9.anInt2581 * 8);
            ...
            for(int i_35_ = arg1; i_35_ < Class40_Sub5_Sub9.anInt2581; i_35_++)
                Class40_Sub5_Sub17_Sub4.anIntArray3111[i_35_] = class40_sub1.method469(arg1 + 65280);
            ...
            for(int i_37_ = 0; Class40_Sub5_Sub9.anInt2581 > i_37_; i_37_++)
                NPC.anIntArray3312[i_37_] = class40_sub1.method469(65280);
            class40_sub1.offset = arg0.length - (7 + (Class40_Sub5_Sub9.anInt2581 * 8 + (-3 + i * 3)));
            ...
            throw Class8.method216(runtimeexception, ("bd.N(" + (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
        }
    }
    ...
    public byte[] method170(RSString arg0, RSString arg1, int arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.CA(" + (arg0 != null ? "{...}" : "null") + ',' + (arg1 != null ? "{...}" : "null") + ',' + arg2 + ')'));
        }
    }
    ...
    public void method171(int arg0, int arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.E(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public byte[] method172(int arg0, int arg1, int arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.B(" + arg0 + ',' + arg1 + ',' + arg2 + ')'));
        }
    }
    ...
    public boolean method173(int arg0, byte arg1, int arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.G(" + arg0 + ',' + arg1 + ',' + arg2 + ')'));
        }
    }
    ...
    public void method174(int arg0, byte arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.M(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public byte[] method176(int arg0, int arg1, int[] arg2, int arg3) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.L(" + arg0 + ',' + arg1 + ',' + (arg2 != null ? "{...}" : "null") + ',' + arg3 + ')'));
        }
    }
    ...
    public void method177(int arg0, int arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.W(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public void method178(int arg0, byte[] arg1) {
        ...
        if((i ^ 0xffffffff) == -6) {
            ...
            for(int i_6_ = 0; i_6_ < anInt221; i_6_++)
                anIntArray252[anIntArray227[i_6_]] = class40_sub1.method491(-4750);
            for(int i_7_ = 0; i_7_ < anInt221; i_7_++)
                anIntArray224[anIntArray227[i_7_]] = class40_sub1.method491(-4750);
            for(int i_8_ = 0; (anInt221 ^ 0xffffffff) < (i_8_ ^ 0xffffffff); i_8_++)
                anIntArray261[anIntArray227[i_8_]] = class40_sub1.method469(RSApplet.method27(arg0, -44367));
            for(int i_9_ = 0; (i_9_ ^ 0xffffffff) > (anInt221 ^ 0xffffffff); i_9_++) {
                ...
                for(int i_13_ = 0; i_12_ > i_13_; i_13_++) {
                    int i_14_ = (anIntArrayArray243[i_10_][i_13_] = i_1_ += (class40_sub1.method469(RSApplet.method27(arg0, -44367))));
                    if(i_14_ > i_11_)
                        i_11_ = i_14_;
                }
            ...
            if(i_2_ != 0) {
                ...
                for(int i_15_ = 0; (anInt221 ^ 0xffffffff) < (i_15_ ^ 0xffffffff); i_15_++) {
                    ...
                    for(int i_18_ = 0; i_17_ > i_18_; i_18_++)
                        anIntArrayArray236[i_16_][(anIntArrayArray243[i_16_][i_18_])] = class40_sub1.method491(arg0 + 16321);
    ...
    public int method179(int arg0, int arg1, RSString arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.O(" + arg0 + ',' + arg1 + ',' + (arg2 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    public boolean method181(int arg0, int arg1, int[] arg2) {
        try {
            ...
            try {
                ...
                throw Class8.method216(runtimeexception, ("T3 - " + (arg2 != null) + "," + arg0 + "," + is_21_.length + "," + Class40_Sub2.method525(is_21_, is_21_.length, (byte) -68) + "," + Class40_Sub2.method525(is_21_, (is_21_.length + -2), (byte) -68) + "," + anIntArray252[arg0] + "," + anInt216));
            }
            if(aBoolean233)
            ...
            throw Class8.method216(runtimeexception, ("bd.T(" + arg0 + ',' + arg1 + ',' + (arg2 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    public byte[] method182(int arg0, int arg1, int arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.H(" + arg0 + ',' + arg1 + ',' + arg2 + ')'));
        }
    }
    ...
    public int method183(int arg0, RSString arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.R(" + arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    public boolean method186(int arg0, int arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.DA(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public byte[] method187(int arg0, byte arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.C(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public int method190(int arg0, byte arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.D(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public int[] method192(int arg0, boolean arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.U(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public byte[] method193(byte arg0, int arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "bd.BA(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public boolean method194(RSString arg0, RSString arg1, int arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.AA(" + (arg0 != null ? "{...}" : "null") + ',' + (arg1 != null ? "{...}" : "null") + ',' + arg2 + ')'));
        }
    }
    ...
    public void method195(int arg0, RSString arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("bd.J(" + arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
        }
    }
}
