        ...
        try {
            ...
            for (; ; ) {
                Class40_Sub5_Sub13 class40_sub5_sub13
                        = ((Class40_Sub5_Sub13)
                        Class37.aClass23_869.method329(false));
                if (class40_sub5_sub13 == null)
                    break;
                Class51.aClass23_1194.put(class40_sub5_sub13, (byte) 126,
                        class40_sub5_sub13.key);
                anInt464--;
                Class68.anInt1618++;
            }
            for (; ; ) {
                Class40_Sub5_Sub13 class40_sub5_sub13
                        = ((Class40_Sub5_Sub13)
                        Class34.aClass23_841.method329(false));
                if (class40_sub5_sub13 == null)
                    break;
                Class19.aClass27_485.method367(true, class40_sub5_sub13);
                Class40_Sub5_Sub8.aClass23_2545.put(class40_sub5_sub13,
                        (byte) -121,
                        (class40_sub5_sub13
                                .key));
                Class42.anInt1006--;
        ...
        try {
            ...
            if (arg1 != 0L) {
                if (Class42.anInt1008 >= 100)
                    Class44.method895(arg0 ^ 0x603f, 0, Landscape.aClass1_1180,
                            Class66.aClass1_1567);
                else {
                    RSString class1 = Class60.method991(arg0 ^ ~0x6004, arg1)
                            .method85(-4305);
                    for (int i = 0;
                         (Class42.anInt1008 ^ 0xffffffff) < (i ^ 0xffffffff);
                         i++) {
                        if ((Class53.aLongArray1267[i] ^ 0xffffffffffffffffL)
                                == (arg1 ^ 0xffffffffffffffffL)) {
                            Class44.method895(114, 0,
                                    (Class40_Sub5_Sub17_Sub6
                                            .method832
                                                    (arg0 ^ ~0x604a,
                                                            (new RSString[]
                                                                    {class1,
                                                                            Class68.aClass1_1628}))),
                                    Class66.aClass1_1567);
                            return;
                        }
                    }
                    for (int i = 0; Class40_Sub5_Sub17_Sub3.anInt3060 > i;
                         i++) {
                        if ((arg1 ^ 0xffffffffffffffffL)
                                == (Class59.aLongArray1397[i]
                                ^ 0xffffffffffffffffL)) {
                            Class44.method895(112, 0,
                                    (Class40_Sub5_Sub17_Sub6
                                            .method832
                                                    (-100, (new RSString[]
                                                            {Class44.aClass1_1032,
                                                                    class1,
                                                                    (Class40_Sub5_Sub17
                                                                            .aClass1_2864)}))),
                                    Class66.aClass1_1567);
                    ...
                    if (!class1.method54((Class40_Sub5_Sub13
                        ...
                        Class32.packetBuffer.putPacket(arg0 + -13233,
                                251);
        ...
        try {
            ...
            for (int i = arg0; Class60.anInt1407 > i; i++) {
                ...
                if (class40_sub5_sub17_sub4_sub1 != null)
                    Class13.method241(class40_sub5_sub17_sub4_sub1, 1,
                            (byte) 107);
            }
        } catch (RuntimeException runtimeexception) {
