...
public class Class58
{
	...
	if (i >= 1 && i <= 100
	    || (i ^ 0xffffffff) <= -702 && (i ^ 0xffffffff) >= -801) {
	    if ((i ^ 0xffffffff) == -2
		&& (Class12.anInt380 ^ 0xffffffff) == -1) {
	...
	} else if (i >= 101 && (i ^ 0xffffffff) >= -201
		   || (i ^ 0xffffffff) <= -802 && (i ^ 0xffffffff) >= -901) {
	    if (i <= 800)
		i -= 101;
	    else
		i -= 701;
		...
		if ((Class40_Sub7.anIntArray2131[i] ^ 0xffffffff) != -1) {
		    if ((Class40_Sub7.anIntArray2131[i] ^ 0xffffffff)
			> -5001) {
			if ((Class13.worldid ^ 0xffffffff)
			    != (Class40_Sub7.anIntArray2131[i] ^ 0xffffffff))
			    arg1.aClass1_2668
				= (Class40_Sub5_Sub17_Sub6.method832
				   (86,
				    (new RSString[]
				     { Class54.aClass1_1283,
				       Class26.aClass1_634,
				       HashTable.method334((Class40_Sub7
							  .anIntArray2131[i]),
							 -1) })));
			else
			    arg1.aClass1_2668
				    ...
				    (new RSString[]
				     { Landscape.aClass1_1162,
				       ...
				       HashTable.method334((Class40_Sub7
							  .anIntArray2131[i]),
							 -1) })));
		    } else if ((Class40_Sub7.anIntArray2131[i] ^ 0xffffffff)
			       != (Class13.worldid ^ 0xffffffff))
			arg1.aClass1_2668
			    = (Class40_Sub5_Sub17_Sub6.method832
			       (53,
				(new RSString[]
				 { Class54.aClass1_1283, Cache.aClass1_333,
				   HashTable.method334(((Class40_Sub7
						       .anIntArray2131[i])
						      + -5000),
						     -1) })));
			...
			arg1.aClass1_2668
			    = (Class40_Sub5_Sub17_Sub6.method832
			       (-111,
				(new RSString[]
				 { Landscape.aClass1_1162, Cache.aClass1_333,
				   HashTable.method334(-5000 + (Class40_Sub7
							      .anIntArray2131
							      [i]),
						     -1) })));
		} else
		    arg1.aClass1_2668
			= (Class40_Sub5_Sub17_Sub6.method832
			   (104, new RSString[] { Class25.aClass1_610,
						Class27.aClass1_664 }));
		arg1.anInt2714 = 1;
	    }
	} else {
		...
		if ((arg1.anInt2643 ^ 0xffffffff)
		    <= (arg1.anInt2720 ^ 0xffffffff))
		...
		arg1.anInt2690 = 150;
		arg1.anInt2657
		    = 0x7ff & (int) (256.0 * Math.sin((double) Node.anInt926
						      / 40.0));
		arg1.anInt2673 = 0;
		arg1.anInt2687 = 5;
	    } else if (i == 328) {
		...
		arg1.aClass1_2668
		    = (Class40_Sub5_Sub17_Sub6.method832
		       (-128, new RSString[] { Class66.aClass1_1550,
					     Class22_Sub2.aClass1_1878 }));
	    else if (i == 620) {
	...
	try {
		...
		PacketBuffer.anInt2257
		    = Class49.aClass6_1150.method190(3, (byte) 8);
	    }
	...
	try {
		...
		if ((Class40_Sub5_Sub15.anInt2780 ^ 0xffffffff) != -2) {
			...
			Class40_Sub5_Sub17_Sub6
			    ...
			    (Class40_Sub5_Sub6.aClass1_2446, 239, 40, 0);
			Class40_Sub5_Sub17_Sub6
			    .aClass40_Sub5_Sub14_Sub1_3246.method686
			    ((Class40_Sub5_Sub17_Sub6.method832
			      (-50, new RSString[] { Class66.aClass1_1543,
						   Class19.aClass1_478 })),
			     239, 60, 128);
			...
			if (RSApplet.aClass1_8 == null) {
				...
				if ((Class48.anInt1138 ^ 0xffffffff) != 0) {
				    boolean bool = (Class40_Sub5_Sub6.method583
						    (0, Class48.anInt1138, 96,
						     (byte) -5, 0, 3, 479));
				    if (!bool)
				    ...
				    Rasterizer.method655(0, 0, 463,
								 77);
				    for (int i_8_ = 0;
					 (i_8_ ^ 0xffffffff) > -101; i_8_++) {
					if ((Class40_Sub5_Sub17_Sub4
					     .aClass1Array3160[i_8_])
					    != null) {
					    int i_9_
						= Class66.anIntArray1569[i_8_];
					    RSString class1
						= (Class40_Sub5_Sub17
						   .aClass1Array2856[i_8_]);
					    int i_10_
						= (Class40_Sub5_Sub8.anInt2557
						   + 70 + -(i * 14));
					    int i_11_ = 0;
					    if (class1 != null
						&& (class1.method75
						...
						if ((i_10_ ^ 0xffffffff) < -1
						    ...
						    if (i_11_ == 1) {
							Class40_Sub5_Sub13
							    .aClass40_Sub5_Sub14_Sub2Array2753
							    [0].method692
							    (i_12_,
							     i_10_ + -12);
							i_12_ += 14;
					...
					((Class40_Sub5_Sub17_Sub6.method832
					  (71, (new RSString[]
						{ Class66.aClass1_1556,
						  Class19.aClass1_478 }))),
					 ((class40_sub5_sub14_sub1.method685
					   (Class40_Sub5_Sub17_Sub6.method832
					    (-99, (new RSString[]
						   { class1,
						     ISAAC.aClass1_515 }))))
				...
				.method686(RSApplet.aClass1_8, 239, 40, 0);
			    Class40_Sub5_Sub17_Sub6
				.aClass40_Sub5_Sub14_Sub1_3246
				.method686(Class34.aClass1_829, 239, 60, 128);
			}
		    } else {
			if (Class66.aClass1_1543 != Class66.aClass1_1542) {
			    Class40_Sub5_Sub17_Sub2
				.method773((byte) -96, Class66.aClass1_1543);
			    Class66.aClass1_1542 = Class66.aClass1_1543;
			}
			RSFont class40_sub5_sub14_sub1
			    = Class53.aClass40_Sub5_Sub14_Sub1_1268;
			Rasterizer.method655(0, 0, 463, 77);
			for (int i = 0; ((Class46.anInt1110 ^ 0xffffffff)
					 < (i ^ 0xffffffff)); i++) {
			    int i_14_ = i * 14 + (18 - Class26.anInt617);
			    if ((i_14_ ^ 0xffffffff) < -1
				&& (i_14_ ^ 0xffffffff) > -111)
				class40_sub5_sub14_sub1.method686
				    (Class22_Sub1.aClass1Array1844[i], 239,
				     i_14_, 0);
			}
			Rasterizer.method662();
			if ((Class46.anInt1110 ^ 0xffffffff) < -6)
			    Class27.method355(0, Class26.anInt617,
					      7 + 14 * Class46.anInt1110, 463,
					      77, 0);
			if (Class66.aClass1_1543.method59(-3136) != 0) {
			    if ((Class46.anInt1110 ^ 0xffffffff) == -1)
				Class40_Sub5_Sub17_Sub6
				    .aClass40_Sub5_Sub14_Sub1_3246.method686
				    (Class40_Sub6.aClass1_2097, 239, 40, 0);
			} else
			    Class40_Sub5_Sub17_Sub6
				.aClass40_Sub5_Sub14_Sub1_3246
				.method686(Class35.aClass1_1747, 239, 40, 255);
			class40_sub5_sub14_sub1.method686
			    ((Class40_Sub5_Sub17_Sub6.method832
			      (-122, new RSString[] { Class66.aClass1_1543,
						    Class19.aClass1_478 })),
			     239, 90, 0);
			...
			.method686(Landscape.aClass1_1174, 239, 40, 0);
		    Class40_Sub5_Sub17_Sub6.aClass40_Sub5_Sub14_Sub1_3246
			.method686
			((Class40_Sub5_Sub17_Sub6.method832
			  (73, new RSString[] { Class66.aClass1_1543,
					      Class19.aClass1_478 })),
			 239, 60, 128);
		}
	    } else {
		Class40_Sub5_Sub17_Sub6.aClass40_Sub5_Sub14_Sub1_3246
		    .method686(Class66.aClass1_1563, 239, 40, 0);
		Class40_Sub5_Sub17_Sub6.aClass40_Sub5_Sub14_Sub1_3246.method686
		    (Class40_Sub5_Sub17_Sub6.method832(-117,
						       (new RSString[]
    ...
    public static void method980(int arg0, Class6 arg1, boolean arg2,
				 Class6 arg3) {
	try {
