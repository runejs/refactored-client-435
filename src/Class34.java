...
public class Class34
{
	...
	try {
		...
		|| PacketBuffer.aClass40_Sub5_Sub13_2250.key != l)
		return 0;
	    int i = 34 % ((arg0 - -46) / 45);
	    return 1 + (Class40_Sub5_Sub13.aClass40_Sub1_2752.offset * 99
	...
	try {
		...
		if ((Class52.anInt1214 ^ 0xffffffff)
		    == (Class59.anInt1389 ^ 0xffffffff))
		    return false;
		ItemDefinition.anInt2854
		    = Class40_Sub6.anIntArray2113[Class59.anInt1389];
		Class59.anInt1388
		    = Class40_Sub5_Sub13.anIntArray2764[Class59.anInt1389];
		if (arg0 > -21)
		    aClass1_829 = null;
	...
	try {
	    ...
	    if (arg0 != 0)
		return null;
	    Class40_Sub5_Sub4 class40_sub5_sub4
		= ((Class40_Sub5_Sub4)
		   Class57.aClass9_1331.method231((long) arg1, (byte) 111));
	    ...
	    Class57.aClass9_1331.method230(-7208, (long) arg1,
					   class40_sub5_sub4);
	    return class40_sub5_sub4;
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
	...
	try {
	    ...
	    while ((Cache.outgoingbuffer
			.method510(125, Class40_Sub5_Sub12.packetsize)
		    ^ 0xffffffff)
		   <= -12) {
		int i_0_
		    = Cache.outgoingbuffer.putBits(11, (byte) -65);
		if ((i_0_ ^ 0xffffffff) == -2048)
		    break;
		boolean bool = false;
		if ((Class40_Sub5_Sub17_Sub4
		     .aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i_0_])
		    == null) {
			...
			Class40_Sub5_Sub17_Sub4
			    .aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i_0_]
			    .method791
			    ((byte) -114, Class22.aClass40_Sub1Array534[i_0_]);
		    bool = true;
		}
		...
		if ((i_5_ ^ 0xffffffff) == -2)
			...
			= i_0_;
		class40_sub5_sub17_sub4_sub1.method787
		    (i_2_ + (Class40_Sub5_Sub13
			     .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anIntArray3135
			     [0]),
		     -7717, (i_4_ ^ 0xffffffff) == -2,
		     (Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
		      .anIntArray3088[0]) + i_1_);
	    }
