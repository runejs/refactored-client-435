...
public class Class48
{
    ...
    public static void method922(int arg0, int arg1, Buffer arg2,
				 int arg3, int arg4, int arg5, int arg6,
				 int arg7) {
	anInt1139++;
	if (arg0 >= 0 && (arg0 ^ 0xffffffff) > -105
	    && (arg4 ^ 0xffffffff) <= -1 && (arg4 ^ 0xffffffff) > -105) {
	    Floor.aByteArrayArrayArray2323[arg7][arg0][arg4]
		= (byte) 0;
	    for (;;) {
		int i = arg2.method468(false);
		if ((i ^ 0xffffffff) == -1) {
		    if (arg7 == 0)
			Class40_Sub6.anIntArrayArrayArray2099[0][arg0][arg4]
			    = -Class42.method888(arg6 + (arg0 + 932731),
						 (byte) -45,
						 arg5 + 556238 + arg4) * 8;
		    else
			Class40_Sub6.anIntArrayArrayArray2099[arg7][arg0][arg4]
			    = -240 + (Class40_Sub6.anIntArrayArrayArray2099
				      [arg7 + -1][arg0][arg4]);
		    break;
		}
		if (i == 1) {
			...
			Class40_Sub6.anIntArrayArrayArray2099[arg7][arg0][arg4]
			    = (Class40_Sub6.anIntArrayArrayArray2099[-1 + arg7]
			       [arg0][arg4]) + -(8 * i_0_);
		    else
			Class40_Sub6.anIntArrayArrayArray2099[0][arg0][arg4]
			    = 8 * -i_0_;
		...
		if (i <= 49) {
		    Class62.aByteArrayArrayArray1473[arg7][arg0][arg4]
			= arg2.get(105);
		    Floor.aByteArrayArrayArray2335[arg7][arg0]
			[arg4]
			= (byte) ((i + -2) / 4);
		    Class35.aByteArrayArrayArray1745[arg7][arg0][arg4]
			= (byte) Class66.method1021(arg1 + -2 + i, 3);
		} else if (i <= 81)
		    Floor.aByteArrayArrayArray2323[arg7][arg0]
			[arg4]
			= (byte) (-49 + i);
		else
		    Class42.aByteArrayArrayArray993[arg7][arg0][arg4]
			= (byte) (-81 + i);
	    }
	} else {
	    for (;;) {
    ...
    public static void method925(int arg0, Class40_Sub5_Sub12[] arg1, int arg2,
				 int arg3, int arg4, int arg5, int arg6,
				 int arg7, int arg8, int arg9, int arg10,
				 int arg11) {
	try {
	    anInt1141++;
	    if (arg2 <= arg8 && arg4 >= arg9
		&& (arg8 ^ 0xffffffff) > (arg11 ^ 0xffffffff)
		...
		for (int i = arg5; arg1.length > i; i++) {
			...
			&& arg6 == class40_sub5_sub12.anInt2648) {
			int i_1_
			    = class40_sub5_sub12.anInt2696 - (-arg9 + arg3);
			int i_2_
			    = -arg10 + (class40_sub5_sub12.anInt2656 - -arg2);
			if (class40_sub5_sub12.anInt2683 == 8
			    && (i_2_ ^ 0xffffffff) >= (arg8 ^ 0xffffffff)
			    && i_1_ <= arg4
			    && arg8 < i_2_ + class40_sub5_sub12.anInt2692
			    && ((arg4 ^ 0xffffffff)
			...
			if ((class40_sub5_sub12.anInt2721 >= 0
			    ...
			    if (class40_sub5_sub12.anInt2721 >= 0)
				Floor.anInt2328
				    = class40_sub5_sub12.anInt2721;
			    else
				Floor.anInt2328 = i;
			}
			if (class40_sub5_sub12.anInt2683 == 0) {
			    if (!class40_sub5_sub12.aBoolean2750
				|| Class29.method371(8247, arg7, i)
				|| PacketBuffer.aBoolean2236) {
				method925(i_1_ + class40_sub5_sub12.anInt2643,
					  arg1, i_2_,
					  class40_sub5_sub12.anInt2731, arg4,
					  arg5, i, arg7, arg8, i_1_,
				...
				if ((class40_sub5_sub12
					...
					(i_1_ - -class40_sub5_sub12.anInt2643,
					 (class40_sub5_sub12
					  .aClass40_Sub5_Sub12Array2713),
					 i_2_, class40_sub5_sub12.anInt2731,
					 arg4, 0, class40_sub5_sub12.anInt2689,
					 arg7, arg8, i_1_,
					 class40_sub5_sub12.anInt2746,
					 class40_sub5_sub12.anInt2692 + i_2_);
				if ((class40_sub5_sub12.anInt2643 ^ 0xffffffff)
				    > (class40_sub5_sub12.anInt2720
				       ^ 0xffffffff))
				    Class5.method168
					(class40_sub5_sub12.anInt2643, arg4,
					 arg8, class40_sub5_sub12.anInt2720,
					 (byte) 69, class40_sub5_sub12,
					 class40_sub5_sub12.anInt2692 + i_2_,
					 arg7, i_1_);
			    }
			} else {
			    if (class40_sub5_sub12.anInt2714 == 1
				&& (i_2_ ^ 0xffffffff) >= (arg8 ^ 0xffffffff)
				&& (i_1_ ^ 0xffffffff) >= (arg4 ^ 0xffffffff)
				&& (class40_sub5_sub12.anInt2692 + i_2_
				    ^ 0xffffffff) < (arg8 ^ 0xffffffff)
				&& (class40_sub5_sub12.anInt2643 + i_1_
				    ^ 0xffffffff) < (arg4 ^ 0xffffffff)) {
				boolean bool = false;
				if (class40_sub5_sub12.anInt2639 != 0)
				    bool = (Class68_Sub1.method1051
					    (300, class40_sub5_sub12));
				if (!bool) {
				    Class32.anInt754++;
				    Floor.method558
					(0, class40_sub5_sub12.aClass1_2676,
					 class40_sub5_sub12.anInt2689, -501, 0,
					 42, Class66.aClass1_1567);
				}
			    }
			    if (((class40_sub5_sub12.anInt2714 ^ 0xffffffff)
				 == -3)
				&& (Main.anInt1773 ^ 0xffffffff) == -1
				&& arg8 >= i_2_
				&& (arg4 ^ 0xffffffff) <= (i_1_ ^ 0xffffffff)
				&& arg8 < class40_sub5_sub12.anInt2692 + i_2_
				&& ((arg4 ^ 0xffffffff)
				    > (i_1_ - -class40_sub5_sub12.anInt2643
				       ^ 0xffffffff))) {
				Floor.method558
				    (0, class40_sub5_sub12.aClass1_2664,
				     class40_sub5_sub12.anInt2689, -501, 0, 33,
			    ...
			    if (((class40_sub5_sub12.anInt2714 ^ 0xffffffff)
				 == -4)
				&& (arg8 ^ 0xffffffff) <= (i_2_ ^ 0xffffffff)
				&& (arg4 ^ 0xffffffff) <= (i_1_ ^ 0xffffffff)
				&& i_2_ + class40_sub5_sub12.anInt2692 > arg8
				&& (arg4
				    < i_1_ + class40_sub5_sub12.anInt2643)) {
				Floor.anInt2347++;
				int i_3_;
				...
				Floor.method558
				    (0, class40_sub5_sub12.aClass1_2676,
				     class40_sub5_sub12.anInt2689, -501, 0, 23,
				     Class66.aClass1_1567);
				Class40_Sub5_Sub17_Sub4.anInt3128++;
			    }
			    if (class40_sub5_sub12.anInt2714 == 5
				&& (i_2_ ^ 0xffffffff) >= (arg8 ^ 0xffffffff)
				&& i_1_ <= arg4
				&& arg8 < i_2_ - -class40_sub5_sub12.anInt2692
				&& (i_1_ + class40_sub5_sub12.anInt2643
				...
				Floor.method558
				    (0, class40_sub5_sub12.aClass1_2676,
				     class40_sub5_sub12.anInt2689, -501, 0, 57,
				     Class66.aClass1_1567);
			    }
			    if (class40_sub5_sub12.anInt2714 == 6
				&& (Class6_Sub1.anInt1819 ^ 0xffffffff) == 0
				&& (i_2_ ^ 0xffffffff) >= (arg8 ^ 0xffffffff)
				&& i_1_ <= arg4
				&& arg8 < i_2_ - -class40_sub5_sub12.anInt2692
				&& ((arg4 ^ 0xffffffff)
				...
				Floor.method558
				    (0, class40_sub5_sub12.aClass1_2676,
				     class40_sub5_sub12.anInt2689, -501, 0, 54,
				     Class66.aClass1_1567);
				Class46.anInt1101++;
			    }
				...
				for (int i_5_ = 0;
				    ...
				    for (int i_6_ = 0;
					 ...
					 i_6_++) {
					int i_7_ = (i_6_ * ((class40_sub5_sub12
							     .anInt2749)
							    + 32)
						    + i_2_);
					int i_8_
					    = (i_1_
						   ...
						   * i_5_));
					if (i_4_ < 20) {
					    i_7_ += (class40_sub5_sub12
						     .anIntArray2699[i_4_]);
					    i_8_ += (class40_sub5_sub12
						     .anIntArray2708[i_4_]);
					}
					if (arg8 >= i_7_ && i_8_ <= arg4
					    && i_7_ + 32 > arg8
					    && ((arg4 ^ 0xffffffff)
						> (32 + i_8_ ^ 0xffffffff))) {
				...
				&& ((class40_sub5_sub12.anInt2718 ^ 0xffffffff)
				    != 0)
				&& (arg8 ^ 0xffffffff) <= (i_2_ ^ 0xffffffff)
				&& (arg4 ^ 0xffffffff) <= (i_1_ ^ 0xffffffff)
				&& ((arg8 ^ 0xffffffff)
				...
				if (class40_sub5_sub12.aBoolean2727) {
				    RSString[] class1s
					= class40_sub5_sub16.options;
				    if (Class60.aBoolean1402)
					class1s = Class56.method968(class1s,
								    false);
				    if (class1s == null || class1s[4] == null)
					Floor.method558
					    (class40_sub5_sub16.anInt2852,
					     Cache.dropStringInstance,
					     class40_sub5_sub12.anInt2689,
					     -501,
					     -1 + class40_sub5_sub12.anInt2736,
					     11,
					     (Class40_Sub5_Sub17_Sub6.method832
					      (107, (new RSString[]
						     { Class46.aClass1_1114,
					...
					Floor.method558
					    (class40_sub5_sub16.anInt2852,
					     ...
					     class40_sub5_sub12.anInt2689,
					     -501,
					     class40_sub5_sub12.anInt2736 + -1,
					     11,
					     (Class40_Sub5_Sub17_Sub6.method832
					      (-41, (new RSString[]
						     { Class46.aClass1_1114,
				...
				if (class40_sub5_sub12.anInt2689 >= 0)
				    Floor.method558
					(class40_sub5_sub16.anInt2852,
					 Class40_Sub5_Sub15.aClass1_2774,
					 class40_sub5_sub12.anInt2689, -501,
					 -1, 1007,
					 (Class40_Sub5_Sub17_Sub6.method832
					  (98,
					   new RSString[] { Class46.aClass1_1114,
							  (class40_sub5_sub16
							   .aClass1_2796) })));
				else
				    Floor.method558
					(class40_sub5_sub16.anInt2852,
					 Class40_Sub5_Sub15.aClass1_2774,
					 class40_sub5_sub12.anInt2648, -501,
					 class40_sub5_sub12.anInt2689 & 0x7fff,
					 1007,
					 (Class40_Sub5_Sub17_Sub6.method832
					  (68,
					   new RSString[] { Class46.aClass1_1114,
				...
				&& class40_sub5_sub12.aClass1Array2661 != null
				&& (i_2_ ^ 0xffffffff) >= (arg8 ^ 0xffffffff)
				&& (i_1_ ^ 0xffffffff) >= (arg4 ^ 0xffffffff)
				&& class40_sub5_sub12.anInt2692 + i_2_ > arg8
				&& (arg4
				    < i_1_ + class40_sub5_sub12.anInt2643)) {
				...
				for (int i_15_ = ((class40_sub5_sub12
						   .aClass1Array2661).length
						  - 1);
				     (i_15_ ^ 0xffffffff) <= -1; i_15_--) {
					...
					if (class40_sub5_sub12.anInt2689 < 0)
						...
						(i_15_ + 1,
						 (class40_sub5_sub12
						  .aClass1Array2661[i_15_]),
						 class40_sub5_sub12.anInt2648,
						 arg5 ^ ~0x1f4,
						 0x7fff & (class40_sub5_sub12
							   .anInt2689),
						 50, class1);
					else
					    Floor.method558
	...
	try {
		...
		for (int i_25_ = 0; (i_25_ ^ 0xffffffff) > (arg0 ^ 0xffffffff);
		     i_25_++) {
			...
			double d_29_ = d_26_;
			double d_30_
			    = 3.141592653589793 * (-d + (double) i_27_);
			if (d_30_ < -1.0E-4 || d_30_ > 1.0E-4)
			    d_29_ *= Math.sin(d_30_) / d_30_;
			d_29_
			    *= 0.54 + 0.46 * Math.cos(0.2243994752564138
						      * (-d + (double) i_27_));
    ...
    public static DirectColorSprite method927(int arg0, Class6 arg1,
