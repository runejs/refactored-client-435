...
public class RSRuntimeException extends RuntimeException
{
	...
	try {
		...
		if ((l ^ 0xffffffffffffffffL)
		    < (Class8.aLong288 ^ 0xffffffffffffffffL)) {
		    Class3.aClass8_166.method212(l);
		    int i = (int) (-Class8.aLong288 + l);
		    Class8.aLong288 = l;
		    synchronized (aClass1654 != null ? aClass1654
				  : (aClass1654 = method1058("Class8"))) {
			if (arg0 <= 81)
			    method1054((byte) -96);
			SubNode.anInt2081 += Class3.anInt141 * i;
			int i_0_ = ((-(2000 * Class3.anInt141)
				     + SubNode.anInt2081)
				    / 1000);
    ...
    public static void method1055(byte[] arg0, byte arg1, Class56 arg2,
				  int arg3) {
	try {
	    int i = 0 / ((arg1 - 17) / 35);
	    anInt1646++;
    ...
    /*synthetic*/ public static Class method1058(String arg0) {
	try {
