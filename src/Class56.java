...
public class Class56 {
    ...
    public static RSString[] method968(RSString[] arg0, boolean arg1) {
        try {
            ...
            for (int i = 0; (i ^ 0xffffffff) > -6; i++) {
                class1s[i] = (Class40_Sub5_Sub17_Sub6.method832
                        (-69, new RSString[]{HashTable.method334(i, -1),
                                ISAAC.aClass1_515}));
        ...
        try {
            ...
            synchronized (aClass67_1309) {
                try {
                    ...
                    aClass67_1313.method1035(0, (byte) -49, 6,
                            NpcDefinition.aByteArray2416);
                    int i_0_
                            = ((0xff00 & (NpcDefinition.aByteArray2416[4]
                            << 2112382504))
                            + ((0xff & NpcDefinition.aByteArray2416[3])
                            << -1692209456)
                            + (0xff & NpcDefinition.aByteArray2416[5]));
                    int i_1_
                            = ((0xff & NpcDefinition.aByteArray2416[2])
                            + (((NpcDefinition.aByteArray2416[0] & 0xff)
                            << 2016836816)
                            - -((0xff & NpcDefinition.aByteArray2416[1])
                            << 1439956072)));
                    if (i_1_ < 0
                            || (i_1_ ^ 0xffffffff) < (anInt1321 ^ 0xffffffff))
                        return null;
                    if (i_0_ <= 0 || (((long) i_0_ ^ 0xffffffffffffffffL)
                            < (aClass67_1309.method1032(0) / 520L
                            ^ 0xffffffffffffffffL)))
                        return null;
                    int i_2_ = 0;
                    int i_3_ = 0;
                    ...
                    while ((i_1_ ^ 0xffffffff) < (i_2_ ^ 0xffffffff)) {
                        ...
                        if ((i_4_ ^ 0xffffffff) < -513)
                            i_4_ = 512;
                        aClass67_1309.method1035(0, (byte) -14, 8 + i_4_,
                                (NpcDefinition
                                        .aByteArray2416));
                        int i_5_
                                = ((0xff00 & (NpcDefinition.aByteArray2416[0]
                                << -1509655160))
                                + (0xff & NpcDefinition.aByteArray2416[1]));
                        int i_6_
                                = ((NpcDefinition.aByteArray2416[6] & 0xff)
                                + ((0xff & NpcDefinition.aByteArray2416[5])
                                << -109515864)
                                + ((0xff & NpcDefinition.aByteArray2416[4])
                                << -873067312));
                        int i_7_
                                = ((0xff00 & (NpcDefinition.aByteArray2416[2]
                                << 52160136))
                                - -(0xff
                                & NpcDefinition.aByteArray2416[3]));
                        int i_8_ = 0xff & NpcDefinition.aByteArray2416[7];
                        if ((i_5_ ^ 0xffffffff) != (arg0 ^ 0xffffffff)
                                || (i_7_ ^ 0xffffffff) != (i_3_ ^ 0xffffffff)
                                || (i_8_ ^ 0xffffffff) != (anInt1324 ^ 0xffffffff))
                            return null;
                        if ((i_6_ ^ 0xffffffff) > -1
                                || (((long) i_6_ ^ 0xffffffffffffffffL)
                                < (aClass67_1309.method1032(0) / 520L
                                ^ 0xffffffffffffffffL)))
                            return null;
                        i_3_++;
                        for (int i_9_ = 0;
                             (i_9_ ^ 0xffffffff) > (i_4_ ^ 0xffffffff); i_9_++)
                            is[i_2_++]
                                    = NpcDefinition.aByteArray2416[8 + i_9_];
                        i_0_ = i_6_;
                    }
                    return is;
    ...
    public boolean method970(byte[] arg0, int arg1, boolean arg2, int arg3,
                             byte arg4) {
        try {
            anInt1325++;
            synchronized (aClass67_1309) {
                try {
                    ...
                    int i;
                    if (arg2) {
                        if (aClass67_1313.method1032(0)
                                < (long) (6 + 6 * arg3))
                            return false;
                        aClass67_1313.method1031(0, (long) (arg3 * 6));
                        aClass67_1313.method1035(0, (byte) -111, 6,
                                (NpcDefinition
                                        .aByteArray2416));
                        i = ((NpcDefinition.aByteArray2416[5] & 0xff)
                                + (((NpcDefinition.aByteArray2416[3] & 0xff)
                                << 244380432)
                                - -((NpcDefinition.aByteArray2416[4]
                                & 0xff)
                                << -1843041752)));
                        if ((i ^ 0xffffffff) >= -1
                        ...
                        i = (int) ((519L + aClass67_1309.method1032(0))
                                / 520L);
                        if (i == 0)
                            i = 1;
                    }
                    NpcDefinition.aByteArray2416[0]
                            = (byte) (arg1 >> -897009424);
                    NpcDefinition.aByteArray2416[1]
                            = (byte) (arg1 >> 2120801992);
                    ...
                    aClass67_1313.method1031(0, (long) (arg3 * 6));
                    aClass67_1313.method1033(0, -16777216, 6,
                            NpcDefinition.aByteArray2416);
                    int i_12_;
                    for (/**/; i_10_ < arg1; i_10_ += i_12_) {
                        ...
                        if (arg2) {
                            ...
                            try {
                                aClass67_1309.method1035(0, (byte) -106, 8,
                                        (NpcDefinition
                                                .aByteArray2416));
                            ...
                            i_13_
                                    ...
                                    [5]) << -83110776)));
                            i_12_
                                    = ((NpcDefinition.aByteArray2416[1] & 0xff)
                                    + ((NpcDefinition.aByteArray2416[0]
                                    << 1593639048)
                                    & 0xff00));
                            int i_14_
                                    = NpcDefinition.aByteArray2416[7] & 0xff;
                            int i_15_
                                    = ((NpcDefinition.aByteArray2416[3] & 0xff)
                                    + ((0xff
                                    & NpcDefinition.aByteArray2416[2])
                                    << -1878865912));
                            if (arg3 != i_12_
                                    || (i_15_ ^ 0xffffffff) != (i_11_ ^ 0xffffffff)
                                    || (i_14_ ^ 0xffffffff) != (anInt1324
                                    ^ 0xffffffff))
                                return false;
                            if (i_13_ < 0
                                    || (aClass67_1309.method1032(0) / 520L
                        ...
                        if (i_13_ == 0) {
                            arg2 = false;
                            i_13_ = (int) ((519L + aClass67_1309.method1032(0))
                                    / 520L);
                        ...
                        if ((i_12_ ^ 0xffffffff) < -513)
                            i_12_ = 512;
                        NpcDefinition.aByteArray2416[2]
                                = (byte) (i_11_ >> 436921608);
                        NpcDefinition.aByteArray2416[3] = (byte) i_11_;
                        NpcDefinition.aByteArray2416[4]
                                = (byte) (i_13_ >> 1862596560);
                        NpcDefinition.aByteArray2416[5]
                                = (byte) (i_13_ >> 154341896);
                        i_11_++;
                        NpcDefinition.aByteArray2416[6] = (byte) i_13_;
                        NpcDefinition.aByteArray2416[7] = (byte) anInt1324;
                        aClass67_1309.method1031(0, (long) (520 * i));
                        aClass67_1309.method1033(0, -16777216, 8,
                                (NpcDefinition
                                        .aByteArray2416));
                        i = i_13_;
                        aClass67_1309.method1033(i_10_, -16777216, i_12_,
                                arg0);
                    }
                    return true;
                } catch (java.io.IOException ioexception) {
