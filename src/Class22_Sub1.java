...
public class Class22_Sub1 extends Class22 {
    ...
    public static RSString aClass1_1848
            = Class58.method978(-11538, "This computers address has been blocked");
    ...
    static {
        aClass1_1845
                = Class58.method978(-11538, "Enter your username (V password)3");
        aClass1_1849 = Class58.method978(-11538, "welle:");
        aClass1_1857 = aClass1_1845;
        aClass1_1867 = Class58.method978(-11538, "Loaded interfaces");
        aClass1_1838 = Class58.method978(-11538, "T");
        aClass1_1863
                = Class58.method978(-11538,
                "Please wait 5 minutes before trying again)3");
        aClass1_1861 = Class58.method978(-11538, "headicons_prayer");
        anIntArray1846 = new int[5];
        aClass1_1868 = Class58.method978(-11538, "Report abuse");
        aClass1_1858 = aClass1_1867;
        aClass1_1870 = aClass1_1863;
        aClass1_1865 = aClass1_1868;
        aClass1_1873 = Class58.method978(-11538, "Password: ");
        aClass1_1864 = aClass1_1873;
        aClass1_1871 = Class58.method978(-11538, "Verbindung abgebrochen)3");
    ...
    public static void method312(int arg0, int arg1, int arg2, int arg3) {
        try {
            anInt1859++;
            if ((arg2 ^ 0xffffffff) > -129 || (arg1 ^ 0xffffffff) > -129
                    || arg2 > 13056 || arg1 > 13056) {
                Class44.anInt1048 = -1;
                ISAAC.anInt522 = -1;
            } else {
                int i
                        = Class37.method430((byte) -122,
                        Player.anInt3267,
                        arg2, arg1) + -arg0;
                arg1 -= Class40_Sub5_Sub6.anInt2443;
                i -= Class32.anInt769;
                int i_1_
                        = Model.anIntArray3217[Class26.anInt627];
                int i_2_
                        = Model.anIntArray3215[Class26.anInt627];
                arg2 -= Class12.anInt388;
                int i_3_ = (Model.anIntArray3215
                        [Class68_Sub1.anInt2210]);
                int i_4_ = (Model.anIntArray3217
                        [Class68_Sub1.anInt2210]);
        ...
        try {
            ...
            for (int i = -1; Class60.anInt1407 > i; i++) {
                ...
                if (class40_sub5_sub17_sub4_sub1 != null
                        && ((class40_sub5_sub17_sub4_sub1.anInt3078 ^ 0xffffffff)
                        < -1)) {
                    class40_sub5_sub17_sub4_sub1.anInt3078--;
                    if ((class40_sub5_sub17_sub4_sub1.anInt3078 ^ 0xffffffff)
                            == -1)
            ...
            for (int i_7_ = 0; i_7_ < Class40_Sub5_Sub8.anInt2558; i_7_++) {
                ...
                NPC class40_sub5_sub17_sub4_sub2
                        = Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813[i_8_];
                if (class40_sub5_sub17_sub4_sub2 != null
                        && class40_sub5_sub17_sub4_sub2.anInt3078 > 0) {
                    class40_sub5_sub17_sub4_sub2.anInt3078--;
                    if ((class40_sub5_sub17_sub4_sub2.anInt3078 ^ 0xffffffff)
                            == -1)
    ...
    public void method303(byte arg0) {
        try {
            ...
            if (aBoolean1835) {
                try {
                    Class28.method369(aClass31_1872.anApplet740,
    ...
    public void method302(int arg0) {
        ...
        if (aClass15_1836 != null
                && (aClass15_1836.anInt434 ^ 0xffffffff) != -1) {
            if ((aClass15_1836.anInt434 ^ 0xffffffff) == -2) {
                Class47 class47 = (Class47) aClass15_1836.anObject437;
                try {
                    class47.method918(aByteArray1866, 0, aByteArray1866.length,
                            false);
                    class47.method917(1);
                    try {
                        Class28.method369(aClass31_1872.anApplet740,
                                ("midibox.loop="
                                        ...
                                        : "\"infinite\"")
                                        + "; midibox.src=\""
                                        + class47.method915(false).getPath
                                        ().replace('\\', '/')
                                        + "\"; midibox.volume=" + anInt1860
                                        + ";"),
                                -28497);
                        aBoolean1835 = true;
                    } catch (Throwable throwable) {
