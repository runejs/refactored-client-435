/* Class40_Sub5_Sub7 - Decompiled by JODE
...
public class Class40_Sub5_Sub7 extends SubNode {
    ...
    public static RSString aClass1_2472
            = Class58.method978(-11538, ":tradereq:");
    ...
    public static RSString aClass1_2481
            = (Class58.method978
            (-11538,
    ...
    static {
        anInt2480 = 0;
        aClass1_2488 = Class58.method978(-11538, "titlebox");
        aClass1_2475
                = Class58.method978(-11538, "Bitte versuchen Sie es erneut)3");
        aClass1_2487 = Class58.method978(-11538, "sch-Utteln:");
    }
    ...
    public static void method592(Class3[] arg0, int arg1, byte[] arg2,
            ...
            for (int i = 0; i < 4; i++) {
                for (int i_1_ = 0; (i_1_ ^ 0xffffffff) > -65; i_1_++) {
                    for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > -65; i_2_++) {
                        if ((arg4 - -i_1_ ^ 0xffffffff) < -1
                                && (i_1_ + arg4 ^ 0xffffffff) > -104
                                && arg5 + i_2_ > 0 && i_2_ + arg5 < 103)
                            arg0[i].anIntArrayArray150[i_1_ + arg4][(i_2_
                                    + arg5)]
                                    = Class66.method1021((arg0[i]
                                            .anIntArrayArray150
                                            [i_1_ + arg4]
                                            [i_2_ + arg5]),
                                    -16777217);
                ...
                for (int i = 0; i < 4; i++) {
                    for (int i_3_ = 0; i_3_ < 64; i_3_++) {
                        for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -65; i_4_++)
                            Class48.method922(i_3_ - -arg4, 0, class40_sub1,
                                    -99, i_4_ + arg5, arg6, arg1, i);
                    }
                }
            }
        } catch (RuntimeException runtimeexception) {
        ...
        try {
            ...
            if (i_16_ != 10 && i_16_ != 11 && i_16_ != 22)
                ...
                Class40_Sub5_Sub8 class40_sub5_sub8
                        = Class40_Sub4.method535(i, (byte) 127);
                ...
                Class38_Sub1.method448(i_18_, i_17_,
                        (Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anIntArray3088[0]),
                        arg0, (byte) 94, 0, true, 0, i_19_,
                        (Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anIntArray3135[0]),
                        arg3, 2);
    ...
    public Model method590(Model arg0,
        ...
        try {
            ...
            Class40_Sub5_Sub15 class40_sub5_sub15
                    = Class55.method960((byte) -99, arg2 >> 1563712080);
            arg2 &= 0xffff;
            if (class40_sub5_sub15 == null)
                return arg1.method599(arg3, arg0, false);
            arg3 = arg1.anIntArray2485[arg3];
            Class40_Sub5_Sub15 class40_sub5_sub15_0_
                    = Class55.method960((byte) -99, arg3 >> -874318832);
            arg3 &= 0xffff;
            if (class40_sub5_sub15_0_ == null) {
                Model class40_sub5_sub17_sub5
                        = arg0.method817(!class40_sub5_sub15.method737(arg2, 124));
            ...
            if (arg4 != 63)
                return null;
            Model class40_sub5_sub17_sub5
                    = arg0.method817(!class40_sub5_sub15.method737(arg2, 122)
                    & !class40_sub5_sub15_0_.method737(arg3,
                    123));
            class40_sub5_sub17_sub5.method809(class40_sub5_sub15, arg2,
                    class40_sub5_sub15_0_, arg3,
                    anIntArray2473);
            return class40_sub5_sub17_sub5;
        } catch (RuntimeException runtimeexception) {
            throw Class8.method216(runtimeexception,
    ...
    public Model method593
            (int arg0, boolean arg1, Model arg2, int arg3) {
        try {
            anInt2468++;
            arg0 = anIntArray2485[arg0];
            Class40_Sub5_Sub15 class40_sub5_sub15
                    = Class55.method960((byte) -99, arg0 >> 1269230160);
            if (arg1 != false)
                anIntArray2479 = null;
            arg0 &= 0xffff;
            if (class40_sub5_sub15 == null)
            ...
            arg3 &= 0x3;
            Model class40_sub5_sub17_sub5
                    = arg2.method817(!class40_sub5_sub15.method737(arg0, 124));
        ...
        try {
            ...
            if (arg1 == 1) {
                ...
                for (int i_6_ = 0; (i_5_ ^ 0xffffffff) < (i_6_ ^ 0xffffffff);
                     i_6_++)
                    anIntArray2466[i_6_] = arg2.method469(65280);
                anIntArray2485 = new int[i_5_];
                for (int i_7_ = 0; (i_5_ ^ 0xffffffff) < (i_7_ ^ 0xffffffff);
                     i_7_++)
                    anIntArray2485[i_7_] = arg2.method469(65280);
                for (int i_8_ = 0; (i_8_ ^ 0xffffffff) > (i_5_ ^ 0xffffffff);
                     i_8_++)
                    anIntArray2485[i_8_]
                            = ((arg2.method469(65280) << -1678933328)
                            + anIntArray2485[i_8_]);
            } else if ((arg1 ^ 0xffffffff) == -3)
                anInt2497 = arg2.method469(65280);
            else if (arg1 != 3) {
                if ((arg1 ^ 0xffffffff) != -5) {
                    if ((arg1 ^ 0xffffffff) == -6)
                        anInt2494 = arg2.method468(false);
                    else if (arg1 != 6) {
                        if (arg1 != 7) {
                            if ((arg1 ^ 0xffffffff) == -9)
                                anInt2495 = arg2.method468(false);
                            else if (arg1 == 9)
                                anInt2470 = arg2.method468(false);
                            else if (arg1 != 10) {
                                if ((arg1 ^ 0xffffffff) == -12)
                                    anInt2483 = arg2.method468(false);
                                    ...
                                    for (int i_10_ = 0;
                                         ((i_10_ ^ 0xffffffff)
                                                 > (i_9_ ^ 0xffffffff));
                                         i_10_++)
                                        anIntArray2479[i_10_]
                                                = arg2.method469(65280);
                                    for (int i_11_ = 0;
                                         ((i_9_ ^ 0xffffffff)
                                                 < (i_11_ ^ 0xffffffff));
                                         i_11_++)
                                        anIntArray2479[i_11_]
                                                = ((arg2.method469(65280)
                                                << -416587984)
                                                + anIntArray2479[i_11_]);
                                }
                            } else
                                anInt2476 = arg2.method468(false);
                        } else
                            anInt2489 = arg2.method469(65280);
                    } else
                        anInt2477 = arg2.method469(65280);
                } else
                    aBoolean2496 = true;
            } else {
                int i_12_ = arg2.method468(false);
    ...
    public Model method597
            (byte arg0, Model arg1, int arg2) {
        try {
            arg2 = anIntArray2485[arg2];
            anInt2467++;
            Class40_Sub5_Sub15 class40_sub5_sub15
                    = Class55.method960((byte) -99, arg2 >> 1539434320);
            arg2 &= 0xffff;
            if (class40_sub5_sub15 == null)
            ...
            if (arg0 != -87)
                return null;
            Model class40_sub5_sub17_sub5
                    = arg1.method806(!class40_sub5_sub15.method737(arg2, 124));
            class40_sub5_sub17_sub5.method825(class40_sub5_sub15, arg2);
            return class40_sub5_sub17_sub5;
        } catch (RuntimeException runtimeexception) {
            throw Class8.method216(runtimeexception,
    ...
    public Model method598
            (int arg0, Model arg1, boolean arg2) {
        try {
            anInt2493++;
            int i = anIntArray2485[arg0];
            Class40_Sub5_Sub15 class40_sub5_sub15
                    = Class55.method960((byte) -99, i >> 189349456);
            i &= 0xffff;
            if (class40_sub5_sub15 == null)
            ...
            if (anIntArray2479 != null
                    && (anIntArray2479.length ^ 0xffffffff) < (arg0
                    ^ 0xffffffff)) {
                i_21_ = anIntArray2479[arg0];
                class40_sub5_sub15_20_
                        = Class55.method960((byte) -99, i_21_ >> -878340016);
                i_21_ &= 0xffff;
            }
            if (class40_sub5_sub15_20_ == null
                    || (i_21_ ^ 0xffffffff) == -65536) {
                Model class40_sub5_sub17_sub5
                        = arg1.method817(!class40_sub5_sub15.method737(i, 126));
                class40_sub5_sub17_sub5.method825(class40_sub5_sub15, i);
                return class40_sub5_sub17_sub5;
            }
            Model class40_sub5_sub17_sub5
                    = arg1.method817(!class40_sub5_sub15.method737(i, 121)
                    & !class40_sub5_sub15_20_.method737(i_21_,
                    123));
            class40_sub5_sub17_sub5.method825(class40_sub5_sub15, i);
    ...
    public Model method599
        ...
        try {
            ...
            anInt2471++;
            Class40_Sub5_Sub15 class40_sub5_sub15
                    = Class55.method960((byte) -99, arg0 >> 1994825616);
            arg0 &= 0xffff;
            if (class40_sub5_sub15 == null)
                return arg1.method817(true);
            Model class40_sub5_sub17_sub5
                    = arg1.method817(!class40_sub5_sub15.method737(arg0, 126));
            class40_sub5_sub17_sub5.method825(class40_sub5_sub15, arg0);
            return class40_sub5_sub17_sub5;
        } catch (RuntimeException runtimeexception) {
            throw Class8.method216(runtimeexception,
