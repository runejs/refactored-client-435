        ...
        int i = 3 / ((arg0 + 12) / 51);
            ...
            if(arg1 == 1) {
                ...
                for(int i_8_ = 0; (i_8_ ^ 0xffffffff) > (i_5_ ^ 0xffffffff); i_8_++)
                    anIntArray2485[i_8_] = ((arg2.method469(65280) << -1678933328) + anIntArray2485[i_8_]);
                            ...
                            if((arg1 ^ 0xffffffff) == -9)
                                ...
                                if((arg1 ^ 0xffffffff) == -12)
                                    ...
                                    for(int i_10_ = 0; ((i_10_ ^ 0xffffffff) > (i_9_ ^ 0xffffffff)); i_10_++)
                                        anIntArray2479[i_10_] = arg2.method469(65280);
                                    for(int i_11_ = 0; ((i_9_ ^ 0xffffffff) < (i_11_ ^ 0xffffffff)); i_11_++)
                                        anIntArray2479[i_11_] = ((arg2.method469(65280) << -416587984) + anIntArray2479[i_11_]);
                                }
                            } else
