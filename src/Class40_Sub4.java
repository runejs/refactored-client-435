...
public class Class40_Sub4 extends Node {
    ...
    public static RSString method532(byte arg0, Class40_Sub5_Sub12 arg1,
                                     RSString arg2) {
        try {
            anInt2045++;
            if (arg0 != 20)
            ...
            if (arg2.method60(Class44.aClass1_1041, arg0 + 12) != -1) {
                for (; ; ) {
                    ...
                    if (i == -1)
                        break;
                    arg2 = (Class40_Sub5_Sub17_Sub6.method832
                            (-37, (new RSString[]
                                    {arg2.method68(0, 0, i),
                                            (Class40_Sub11.method872
                                                    (999999999,
                                                            Class66.method1029(0, false, arg1))),
                                            arg2.method50((byte) 95, 2 + i)})));
                }
                for (; ; ) {
                    ...
                    arg2 = (Class40_Sub5_Sub17_Sub6.method832
                            (72, (new RSString[]
                                    {arg2.method68(0, 0, i),
                                            (Class40_Sub11.method872
                                                    (999999999,
                                                            Class66.method1029(1, false, arg1))),
                                            arg2.method50((byte) 95, i + 2)})));
                }
                for (; ; ) {
                    ...
                    arg2 = (Class40_Sub5_Sub17_Sub6.method832
                            (-121, (new RSString[]
                                    {arg2.method68(arg0 ^ 0x14, 0, i),
                                            (Class40_Sub11.method872
                                                    (999999999,
                                                            Class66.method1029(2, false, arg1))),
                                            arg2.method50((byte) 95, 2 + i)})));
                }
                for (; ; ) {
                    ...
                    arg2 = (Class40_Sub5_Sub17_Sub6.method832
                            (125, (new RSString[]
                                    {arg2.method68(0, 0, i),
                                            (Class40_Sub11.method872
                                                    (arg0 ^ 0x3b9ac9eb,
                                                            Class66.method1029(3, false, arg1))),
                                            arg2.method50((byte) 95, i + 2)})));
                }
                for (; ; ) {
                    ...
                    arg2 = (Class40_Sub5_Sub17_Sub6.method832
                            (-43, (new RSString[]
                                    {arg2.method68(0, 0, i),
                                            (Class40_Sub11.method872
                                                    (999999999,
                                                            Class66.method1029(4, false, arg1))),
                                            arg2.method50((byte) 95, i - -2)})));
                }
                for (; ; ) {
                    int i = arg2.method60(Class40_Sub5_Sub8.aClass1_2526,
                            arg0 ^ 0x34);
                    if ((i ^ 0xffffffff) == 0)
                        break;
                    RSString class1 = Class66.aClass1_1567;
                    if (Class12.aClass15_394 != null) {
                        class1 = Class6_Sub1.method204((Class12.aClass15_394
                                        .anInt432),
                                255);
                        if (Class12.aClass15_394.anObject437 != null) {
                            byte[] is = ((String)
                                    Class12.aClass15_394.anObject437)
                                    .getBytes(StandardCharsets.ISO_8859_1);
                            class1 = Class19.method279(is, true, 0,
                                    is.length);
                        }
                    }
                    arg2
                            ...
                            (124,
                                    new RSString[]{arg2.method68(0, 0, i), class1,
                                            arg2.method50((byte) 95, i + 4)}));
                }
            }
            return arg2;
        } catch (RuntimeException runtimeexception) {
    ...
    public static void method533(int arg0, int arg1,
                                 DirectColorSprite arg2, byte arg3) {
        try {
            anInt2052++;
            if (arg2 != null) {
                ...
                if (i_0_ <= 6400) {
                    ...
                    if ((i_0_ ^ 0xffffffff) < -2501)
                        arg2.method725(Class34.aClass40_Sub5_Sub14_Sub2_855,
                                98 + i_3_ + -(arg2.anInt2954 / 2),
                                -(arg2.anInt2952 / 2) + (-i_4_ + 79));
                    else
                        arg2.method721(4 + -(arg2.anInt2954 / 2) + (i_3_ + 94),
                                -4 + (-i_4_
                                        + (83 + -(arg2.anInt2952 / 2))));
                }
            }
    ...
    public static Class40_Sub5_Sub8 method535(int arg0, byte arg1) {
        try {
            Class40_Sub5_Sub8 class40_sub5_sub8
                    = ((Class40_Sub5_Sub8)
                    Class58.aClass9_1364.method231((long) arg0, (byte) 61));
            anInt2040++;
            ...
            Class58.aClass9_1364.method230(-7208, (long) arg0,
                    class40_sub5_sub8);
            if (arg1 <= 121)
    ...
    public static void method537(int arg0) {
        try {
            anInt2041++;
            if (NpcDefinition.anInt2394 >= 2
                    || (Class8.anInt301 ^ 0xffffffff) != -1
                    || (Main.anInt1773 ^ 0xffffffff) != -1) {
                RSString class1;
                if (Class8.anInt301 == 1
                        && (NpcDefinition.anInt2394 ^ 0xffffffff) > -3)
                    class1
                            = (Class40_Sub5_Sub17_Sub6.method832
                            (-74, (new RSString[]
                                    {Main.aClass1_1763, Class46.aClass1_1117,
                                            NPC.aClass1_3295,
                                            Class38.aClass1_894})));
                else if (Main.anInt1773 != 1
                        || NpcDefinition.anInt2394 >= 2)
                    class1 = (Landscape.aClass1Array1184
                            [-1 + NpcDefinition.anInt2394]);
                else
                    class1 = (Class40_Sub5_Sub17_Sub6.method832
                            (-57, new RSString[]{Class38_Sub1.aClass1_1918,
                ...
                if ((NpcDefinition.anInt2394 ^ 0xffffffff) < -3)
                    class1
                            = (Class40_Sub5_Sub17_Sub6.method832
                            (56,
                                    new RSString[]{class1, Class53.aClass1_1243,
                                            HashTable.method334((NpcDefinition
                                                            .anInt2394) + -2,
                                                    -1),
                                            Class39.aClass1_904}));
                if (arg0 == 4)
