    ...
    public static void method736(boolean arg0, Actor arg1) {
        ...
        if(arg1.anInt3077 != -1) {
            ...
            if(animationSequence == null || animationSequence.frameIds == null) {
                ...
                arg1.anInt3120++;
                if(arg1.anInt3116 < animationSequence.frameIds.length &&
                        animationSequence.frameLengths[arg1.anInt3116] < arg1.anInt3120) {
                    arg1.anInt3116++;
                    arg1.anInt3120 = 1;
                }
        ...
        if(arg1.graphicId != -1 && MovedStatics.pulseCycle >= arg1.graphicDelay) {
            ...
            if(i == -1) {
                ...
                if(animationSequence == null || animationSequence.frameIds == null) {
                    ...
                    arg1.anInt3129++;
                    if(animationSequence.frameIds.length > arg1.anInt3140 &&
                            arg1.anInt3129 > animationSequence.frameLengths[arg1.anInt3140]) {
                        arg1.anInt3129 = 1;
                        arg1.anInt3140++;
                    }
                    if(animationSequence.frameIds.length <= arg1.anInt3140 &&
                            (arg1.anInt3140 < 0 || animationSequence.frameIds.length <= arg1.anInt3140)) {
                        arg1.graphicId = -1;
                    }
                }
            }
        ...
        if(arg0) {
            if(arg1.playingAnimation != -1 && arg1.playingAnimationDelay <= 1) {
                ...
                if(animationSequence.precedenceAnimating == 1 && arg1.anInt3094 > 0 &&
                        arg1.anInt3112 <= MovedStatics.pulseCycle && MovedStatics.pulseCycle > arg1.anInt3107) {
            ...
            if(arg1.playingAnimation != -1 && arg1.playingAnimationDelay == 0) {
                ...
                if(animationSequence != null && animationSequence.frameIds != null) {
                    ...
                    if(animationSequence.frameIds.length > arg1.anInt3104 &&
                            animationSequence.frameLengths[arg1.anInt3104] < arg1.anInt3115) {
                        arg1.anInt3104++;
                        arg1.anInt3115 = 1;
                    }
                    if(animationSequence.frameIds.length <= arg1.anInt3104) {
