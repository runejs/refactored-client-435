...
public class English {
    ...
    public static RSString enterYourUsernameAndPassword = RSString.CreateString("Enter your username (V password)3");
    public static RSString loadedInterfaces = RSString.CreateString("Loaded interfaces");
