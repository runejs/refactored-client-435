        ...
        for(int i = 0; i < 4; i++) {
            ...
            for(int i_5_ = 1; i_5_ < 103; i_5_++) {
                for(int i_6_ = 1; i_6_ < 103; i_6_++) {
                    int i_7_ =
                            -MovedStatics.tile_height[i][i_6_ - 1][i_5_] + MovedStatics.tile_height[i][1 + i_6_][i_5_];
                    int i_8_ =
                            MovedStatics.tile_height[i][i_6_][i_5_ + 1] + -MovedStatics.tile_height[i][i_6_][i_5_ + -1];
                    int i_9_ = (int) Math.sqrt(i_8_ * i_8_ + i_7_ * i_7_ + 65536);
                    int i_10_ = 65536 / i_9_;
                    int i_11_ = (is[i_6_][i_5_] >> 1) + (is[i_6_][-1 + i_5_] >> 2) + (is[1 + i_6_][i_5_] >> 3) +
                            (is[i_6_ - 1][i_5_] >> 2) + (is[i_6_][1 + i_5_] >> 3);
            ...
            for(int i_16_ = -5; i_16_ < 109; i_16_++) {
                ...
                if(i_16_ >= 1 && i_16_ < 103) {
                    ...
                    for(int i_27_ = -5; i_27_ < 109; i_27_++) {
                        ...
                        if(i_27_ >= 1 && i_27_ < 103 && (!VertexNormal.lowMemory ||
                                (0x2 & OverlayDefinition.tile_flags[0][i_16_][i_27_]) != 0 ||
                                (0x10 & OverlayDefinition.tile_flags[i][i_16_][i_27_]) == 0 &&
                                        MovedStatics.onBuildTimePlane == Class59.getVisibilityPlaneFor(
                                                i, i_27_, 0, i_16_))) {
                            ...
                            if(i_30_ > 0 || i_31_ > 0) {
                                ...
                                if(i > 0) {
                                    ...
                                    if(bool && i_32_ == i_33_ && i_34_ == i_32_ && i_32_ == i_35_) {
                                        MovedStatics.anIntArrayArrayArray262[i][i_16_][i_27_] = UnderlayDefinition
                                                .bitWiseOR(MovedStatics.anIntArrayArrayArray262[i][i_16_][i_27_], 2340);
                                    }
                                }
                                int i_45_ = 0;
                                if(i_41_ != -1) {
                                ...
                                if(i_31_ != 0) {
                                    ...
                                    arg0.addTile(i, i_16_, i_27_, i_46_, i_47_, i_48_, i_32_, i_33_, i_34_, i_35_,
                                            ...
                                            MovedStatics.method420(i_49_, i_40_, true), i_45_, i_53_
                                    );
                                } else {
                ...
                for(int i_63_ = 0; i_63_ <= 104; i_63_++) {
                    for(int i_64_ = 0; i_64_ <= 104; i_64_++) {
                        if((MovedStatics.anIntArrayArrayArray262[i_62_][i_64_][i_63_] & i) != 0) {
                            ...
                            for(
                                    i_65_ = i_63_; i_65_ > 0 &&
                                    (i & MovedStatics.anIntArrayArrayArray262[i_62_][i_64_][-1 + i_65_]) != 0; i_65_--
                            ) {
                                /* empty */
                            }
                            int i_66_;
                            for(
                                    i_66_ = i_63_; i_66_ < 104 &&
                                    (MovedStatics.anIntArrayArrayArray262[i_62_][i_64_][i_66_ + 1] & i) != 0; i_66_++
                            ) {
                                /* empty */
                            }
                            int i_67_ = i_62_;
                        ...
                        if((i_59_ & MovedStatics.anIntArrayArrayArray262[i_62_][i_64_][i_63_]) != 0) {
                            ...
                            for(
                                    i_77_ = i_64_; i_77_ > 0 &&
                                    (i_59_ & MovedStatics.anIntArrayArrayArray262[i_62_][i_77_ - 1][i_63_]) != 0;
                                    i_77_--
                            ) {
                                /* empty */
                            }
                            ...
                            if(i_83_ >= 8) {
                                ...
                                for(int i_87_ = i_80_; i_78_ >= i_87_; i_87_++) {
                                    for(int i_88_ = i_77_; i_88_ <= i_79_; i_88_++) {
                                        MovedStatics.anIntArrayArrayArray262[i_87_][i_88_][i_63_] = HuffmanEncoding
                                                .method1021(MovedStatics.anIntArrayArrayArray262[i_87_][i_88_][i_63_],
                                                        i_59_ ^ 0xffffffff
                                                );
                                    }
                                }
