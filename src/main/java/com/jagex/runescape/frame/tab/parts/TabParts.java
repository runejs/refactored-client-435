...
public class TabParts {
    ...
    private static void CreateParts() {
        ...
        TabParts.combat = new ImageRGB(Base64.getDecoder().decode(combat), MouseHandler.aCanvas1469);
        TabParts.emotes = new ImageRGB(Base64.getDecoder().decode(emotes), MouseHandler.aCanvas1469);
        TabParts.equipment = new ImageRGB(Base64.getDecoder().decode(equipment), MouseHandler.aCanvas1469);
        TabParts.friends = new ImageRGB(Base64.getDecoder().decode(friends), MouseHandler.aCanvas1469);
        TabParts.ignores = new ImageRGB(Base64.getDecoder().decode(ignores), MouseHandler.aCanvas1469);
        TabParts.inventory = new ImageRGB(Base64.getDecoder().decode(inventory), MouseHandler.aCanvas1469);
        TabParts.large_left_right = new ImageRGB(Base64.getDecoder().decode(large_left_right), MouseHandler.aCanvas1469);
        TabParts.large_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(large_left_right_hovered), MouseHandler.aCanvas1469);
        TabParts.large_left_right_selected = new ImageRGB(Base64.getDecoder().decode(large_left_right_selected), MouseHandler.aCanvas1469);
        TabParts.large_middle = new ImageRGB(Base64.getDecoder().decode(large_middle), MouseHandler.aCanvas1469);
        TabParts.large_middle_hovered = new ImageRGB(Base64.getDecoder().decode(large_middle_hovered), MouseHandler.aCanvas1469);
        TabParts.large_middle_selected = new ImageRGB(Base64.getDecoder().decode(large_middle_selected), MouseHandler.aCanvas1469);
        TabParts.logout = new ImageRGB(Base64.getDecoder().decode(logout), MouseHandler.aCanvas1469);
        TabParts.logout_small = new ImageRGB(Base64.getDecoder().decode(logout_small), MouseHandler.aCanvas1469);
        TabParts.magic = new ImageRGB(Base64.getDecoder().decode(magic), MouseHandler.aCanvas1469);
        TabParts.medium_left_right = new ImageRGB(Base64.getDecoder().decode(medium_left_right), MouseHandler.aCanvas1469);
        TabParts.medium_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(medium_left_right_hovered), MouseHandler.aCanvas1469);
        TabParts.medium_left_right_selected = new ImageRGB(Base64.getDecoder().decode(medium_left_right_selected), MouseHandler.aCanvas1469);
        TabParts.medium_middle = new ImageRGB(Base64.getDecoder().decode(medium_middle), MouseHandler.aCanvas1469);
        TabParts.medium_middle_hovered = new ImageRGB(Base64.getDecoder().decode(medium_middle_hovered), MouseHandler.aCanvas1469);
        TabParts.medium_middle_selected = new ImageRGB(Base64.getDecoder().decode(medium_middle_selected), MouseHandler.aCanvas1469);
        TabParts.music = new ImageRGB(Base64.getDecoder().decode(music), MouseHandler.aCanvas1469);
        TabParts.options = new ImageRGB(Base64.getDecoder().decode(options), MouseHandler.aCanvas1469);
        TabParts.prayer = new ImageRGB(Base64.getDecoder().decode(prayer), MouseHandler.aCanvas1469);
        TabParts.quests = new ImageRGB(Base64.getDecoder().decode(quests), MouseHandler.aCanvas1469);
        TabParts.side_border_bottom = new ImageRGB(Base64.getDecoder().decode(side_border_bottom), MouseHandler.aCanvas1469);
        TabParts.side_border_bottom_selected = new ImageRGB(Base64.getDecoder().decode(side_border_bottom_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_bottom_left = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_left), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_bottom_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_left_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_bottom_right = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_right), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_bottom_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_bottom_right_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_top_left = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_left), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_top_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_left_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_top_right = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_right), MouseHandler.aCanvas1469);
        TabParts.side_border_edge_top_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_edge_top_right_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_left = new ImageRGB(Base64.getDecoder().decode(side_border_left), MouseHandler.aCanvas1469);
        TabParts.side_border_left_selected = new ImageRGB(Base64.getDecoder().decode(side_border_left_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_middle = new ImageRGB(Base64.getDecoder().decode(side_border_middle), MouseHandler.aCanvas1469);
        TabParts.side_border_right = new ImageRGB(Base64.getDecoder().decode(side_border_right), MouseHandler.aCanvas1469);
        TabParts.side_border_right_selected = new ImageRGB(Base64.getDecoder().decode(side_border_right_selected), MouseHandler.aCanvas1469);
        TabParts.side_border_top = new ImageRGB(Base64.getDecoder().decode(side_border_top), MouseHandler.aCanvas1469);
        TabParts.side_border_top_selected = new ImageRGB(Base64.getDecoder().decode(side_border_top_selected), MouseHandler.aCanvas1469);
        TabParts.small_left_right = new ImageRGB(Base64.getDecoder().decode(small_left_right), MouseHandler.aCanvas1469);
        TabParts.small_left_right_hovered = new ImageRGB(Base64.getDecoder().decode(small_left_right_hovered), MouseHandler.aCanvas1469);
        TabParts.small_left_right_selected = new ImageRGB(Base64.getDecoder().decode(small_left_right_selected), MouseHandler.aCanvas1469);
        TabParts.small_middle = new ImageRGB(Base64.getDecoder().decode(small_middle), MouseHandler.aCanvas1469);
        TabParts.small_middle_hovered = new ImageRGB(Base64.getDecoder().decode(small_middle_hovered), MouseHandler.aCanvas1469);
        TabParts.small_middle_selected = new ImageRGB(Base64.getDecoder().decode(small_middle_selected), MouseHandler.aCanvas1469);
        TabParts.stats = new ImageRGB(Base64.getDecoder().decode(stats), MouseHandler.aCanvas1469);
        TabParts.stone_bottom_left_selected = new ImageRGB(Base64.getDecoder().decode(stone_bottom_left_selected), MouseHandler.aCanvas1469);
        TabParts.stone_bottom_right_selected = new ImageRGB(Base64.getDecoder().decode(stone_bottom_right_selected), MouseHandler.aCanvas1469);
        TabParts.stone_middle_selected = new ImageRGB(Base64.getDecoder().decode(stone_middle_selected), MouseHandler.aCanvas1469);
        TabParts.stone_top_left_selected = new ImageRGB(Base64.getDecoder().decode(stone_top_left_selected), MouseHandler.aCanvas1469);
        TabParts.stone_top_right_selected = new ImageRGB(Base64.getDecoder().decode(stone_top_right_selected), MouseHandler.aCanvas1469);
        TabParts.side_panel_background = new ImageRGB(Base64.getDecoder().decode(side_panel_background), MouseHandler.aCanvas1469);
        TabParts.side_panel_edge_left = new ImageRGB(Base64.getDecoder().decode(side_panel_edge_left), MouseHandler.aCanvas1469);
        TabParts.side_panel_edge_right = new ImageRGB(Base64.getDecoder().decode(side_panel_edge_right), MouseHandler.aCanvas1469);
        TabParts.tabs_bottom_row = new ImageRGB(Base64.getDecoder().decode(tabs_bottom_row), MouseHandler.aCanvas1469);
        TabParts.tab_stone_middle = new ImageRGB(Base64.getDecoder().decode(tab_stone_middle), MouseHandler.aCanvas1469);
        TabParts.tab_stone_middle_selected = new ImageRGB(Base64.getDecoder().decode(tab_stone_middle_selected), MouseHandler.aCanvas1469);
        TabParts.tabs_top_row = new ImageRGB(Base64.getDecoder().decode(tabs_top_row), MouseHandler.aCanvas1469);
        TabParts.setup = true;
