        ...
        for(int i_22_ = 0; i_22_ < 20; i_22_++) {
            for(int i_23_ = 1; -1 + i_19_ > i_23_; i_23_++) {
                for(int i_24_ = 1; i_24_ < 127; i_24_++) {
                    ...
                    MovedStatics.anIntArray1445[i_25_] =
                            (Landscape.anIntArray1168[i_25_ - 128] + Landscape.anIntArray1168[i_25_ + -1] +
                                    Landscape.anIntArray1168[i_25_ + 1] + Landscape.anIntArray1168[128 + i_25_]) / 4;
                }
            }
    ...
    public static void spawnGroundItem(int arg1, int arg2) {
        ...
        if(linkedList == null) {
            ...
            if(item == null) {
                ...
                Npc.currentScene.addGroundItemTile(arg2, arg1, Player.worldLevel,
                        Class37.getFloorDrawHeight(Player.worldLevel, 64 + 128 * arg2, 64 + 128 * arg1), i_37_, item,
                        item_35_, item_34_
                );
            }
        }
