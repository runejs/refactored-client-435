        ...
        if(IncomingPackets.incomingPacket == 49) {
                ...
                if(i_5_ == 0) {
                    ...
                    if(wall != null) {
                        ...
                        if(i_3_ == 2) {
                            ...
                            wall.secondary = new GameObject(
                                    i_11_, 2, 0x3 & i_4_ + 1, i_7_, i_8_, i_9_, i_10_, i_6_, false);
                        } else {
                ...
                if(i_5_ == 1) {
                    ...
                    if(wallDecoration != null) {
                        wallDecoration.renderable = new GameObject(
                                (0x1fffe268 & wallDecoration.hash) >> 14, 4, 0, i_7_, i_8_, i_9_, i_10_, i_6_, false);
                    }
                }
                if(i_5_ == 2) {
                    ...
                    if(interactiveObject != null) {
                        interactiveObject.renderable = new GameObject(interactiveObject.hash >> 14 & 0x7fff, i_3_, i_4_,
                                i_7_, i_8_, i_9_, i_10_, i_6_, false
                        );
                    }
                }
                if(i_5_ == 3) {
                    FloorDecoration floorDecoration = Npc.currentScene.getFloorDecoration(
                            Player.worldLevel, i_1_, i_0_);
                    if(floorDecoration != null) {
                        floorDecoration.renderable = new GameObject(
                                0x7fff & floorDecoration.hash >> 14, 22, i_4_, i_7_, i_8_, i_9_, i_10_, i_6_, false);
                    }
                }
            }
            ...
            if(IncomingPackets.incomingPacket == 9) {
                ...
                if(localY >= 0 && localX >= 0 && localY < 104 && localX < 104) {
                    int i_26_ = 1 + radius;
                    if(Player.localPlayer.pathY[0] >= localY - i_26_ && Player.localPlayer.pathY[0] <= localY + i_26_ &&
                            localX - i_26_ <= Player.localPlayer.pathX[0] &&
                            localX + i_26_ >= Player.localPlayer.pathX[0] && RSCanvas.anInt65 != 0 && volume > 0 &&
                            PacketBuffer.currentSound < 50) {
                        ...
                        MovedStatics.anIntArray1916[PacketBuffer.currentSound] =
                                radius + (localX << 8) + (localY << 16);
            ...
            if(IncomingPackets.incomingPacket == 202) {
                ...
                if(IncomingPackets.incomingPacket == 229) {
                    ...
                    if(class40_sub5_sub17_sub4_sub1 != null) {
                        ...
                        Model class40_sub5_sub17_sub5 = gameObjectDefinition.createTerrainObjectModel(
                                i_59_, i_58_, i_47_, i_57_, i_48_, i_60_);
                        if(class40_sub5_sub17_sub5 != null) {
                            ...
                            GameObjectDefinition.method609(
                                    -1, i_52_, 0, 1 + i_56_, Player.worldLevel, i_51_, i_49_, 0, 1 + i_53_);
                ...
                if(IncomingPackets.incomingPacket == 74) { // remove world item
                    ...
                    if(i_69_ >= 0 && i_68_ >= 0 && i_69_ < 104 && i_68_ < 104 && i_70_ >= 0 && i_71_ >= 0 &&
                            i_70_ < 104 && i_71_ < 104 && i_73_ != 65535) {
                        i_70_ = 64 + 128 * i_70_;
                        i_69_ = 64 + 128 * i_69_;
                        i_68_ = i_68_ * 128 + 64;
                    ...
                    if(IncomingPackets.incomingPacket == 19) { // update world item amount
                        ...
                        if(i_83_ >= 0 && i_84_ >= 0 && i_83_ < 104 && i_84_ < 104 &&
                                PlayerAppearance.anInt708 != i_80_) {
                            Item item = new Item();
                            item.itemId = i_81_;
                            item.itemCount = i;
        ...
        do {
            ...
            if(Class51.currentAction == 10) {
                ...
                if(Class26.loginScreenState == 0) {
                    ...
                    y1 += 15;
                    y1 += 10;
                    fontBold.drawShadowedString(English.username + Native.username +
                            (MovedStatics.pulseCycle % 40 < 20 & MovedStatics.loginScreenFocus == 0
                                    ? Native.justAnotherYellowBar
                                    : ""), 90, y1, true, 16777215);
                    y1 += 15;
                    fontBold.drawShadowedString(English.password + Native.password.method61() +
                            (MovedStatics.pulseCycle % 40 < 20 & MovedStatics.loginScreenFocus == 1
                                    ? Native.justAnotherYellowBar
                                    : ""), 92, y1, true, 16777215);
                    ...
                    i_93_ += 15;
                    fontBold.drawShadowedStringCenter(
                            English.goBackToTheMainRunescapeWebPage, 180, i_93_, 16777215, true);
                    i_93_ += 15;
                    fontBold.drawShadowedStringCenter(English.andChooseTheCreateAccount, 180, i_93_, 16777215, true);
                    i_93_ += 15;
                    fontBold.drawShadowedStringCenter(
                            English.suffixButtonNearTheTopOfThatPage, 180, i_93_, 16777215, true);
