                ...
                if(actor != null && actor.isVisible(1)) {
                    ...
                    if(Player.localPlayerCount <= i) {
                        ...
                        if(class40_sub5_sub17_sub4_sub1.isSkulled != -1 ||
                                class40_sub5_sub17_sub4_sub1.headIcon != -1) {
                            FloorDecoration.method342(15 + actor.anInt3117, actor);
                            if(ISAAC.anInt522 > -1) {
                                if(class40_sub5_sub17_sub4_sub1.isSkulled != -1) {
                    ...
                    if(actor.forcedChatMessage != null &&
                            (i >= Player.localPlayerCount || ChatBox.publicChatMode == 0 ||
                                    ChatBox.publicChatMode == 3 || ChatBox.publicChatMode == 1 && Player.hasFriend(
                                    ((Player) actor).playerName))) {
                    ...
                    if(MovedStatics.pulseCycle < actor.anInt3139) {
                        ...
                        if(ISAAC.anInt522 > -1) {
                            ...
                            Rasterizer.drawFilledRectangle(
                                    -15 + ISAAC.anInt522, Class44.anInt1048 + -3, i_1_, 5, 65280);
                            Rasterizer.drawFilledRectangle(
                                    -15 + ISAAC.anInt522 + i_1_, Class44.anInt1048 + -3, 30 + -i_1_, 5, 16711680);
                        }
                    }
                    for(int i_2_ = 0; i_2_ < 4; i_2_++) {
                        if(MovedStatics.pulseCycle < actor.anIntArray3136[i_2_]) {
                            ...
                            if(ISAAC.anInt522 > -1) {
                                ...
                                AnimationSequence.aClass40_Sub5_Sub14_Sub4Array2474[actor.anIntArray3086[i_2_]]
                                        .drawImage(ISAAC.anInt522 + -12, -12 + Class44.anInt1048);
            ...
            for(int i = 0; SceneCluster.anInt770 > i; i++) {
                ...
                if(MovedStatics.anInt2280 == 0) {
                    ...
                    if(PlayerAppearance.anIntArray695[i] == 1) {
                        TypeFace.fontBold.drawCenteredStringWaveY(
                                class1, ISAAC.anInt522, Class44.anInt1048 + 1, 0, Class40_Sub5_Sub11.anInt2628);
                        TypeFace.fontBold.drawCenteredStringWaveY(
                                class1, ISAAC.anInt522, Class44.anInt1048, i_8_, Class40_Sub5_Sub11.anInt2628);
                    }
                    if(PlayerAppearance.anIntArray695[i] == 2) {
                        TypeFace.fontBold.drawCenteredStringWaveXY(
                                class1, ISAAC.anInt522, 1 + Class44.anInt1048, 0, Class40_Sub5_Sub11.anInt2628);
                        TypeFace.fontBold.drawCenteredStringWaveXY(
                                class1, ISAAC.anInt522, Class44.anInt1048, i_8_, Class40_Sub5_Sub11.anInt2628);
                    }
                ...
                if(is != null) {
                    if(MovedStatics.anInt255 < 0) {
                        if(MovedStatics.anInt1806 < 0) {
                            ...
                            VarbitDefinition.method566(
                                    OverlayDefinition.anInt2342, Main.aBoolean1790, MovedStatics.anInt1806, is);
                        }
                    } else {
