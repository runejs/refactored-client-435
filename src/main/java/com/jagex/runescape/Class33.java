...
public class Class33 {
    ...
    public static synchronized void method403(
            int arg0, boolean arg1, int arg2, int arg3, CacheArchive arg4, int arg5, int arg6, boolean arg7
    ) {
        if(Class24.method340()) {
        ...
        for(int i = -1; Player.localPlayerCount + Player.npcCount > i; i++) {
            ...
            if(actor != null && actor.isVisible()) {
                ...
                if(Player.localPlayerCount <= i) {
                    ActorDefinition class40_sub5_sub5 = ((Npc) actor).actorDefinition;
                    if(class40_sub5_sub5.headIcon >= 0 && class40_sub5_sub5.headIcon <
                            ProducingGraphicsBuffer_Sub1.aClass40_Sub5_Sub14_Sub4Array2204.length) {
                        FloorDecoration.method342(actor.anInt3117 + 15, actor);
                        if(ISAAC.anInt522 > -1) {
                            ProducingGraphicsBuffer_Sub1.aClass40_Sub5_Sub14_Sub4Array2204[class40_sub5_sub5.headIcon]
                                    .drawImage(-12 + ISAAC.anInt522, Class44.anInt1048 + -30);
                        }
                    }
                    if(Player.headIconDrawType == 1 &&
                            HuffmanEncoding.anInt1545 == Player.npcIds[-Player.localPlayerCount + i] &&
                            MovedStatics.pulseCycle % 20 < 10) {
                        FloorDecoration.method342(15 + actor.anInt3117, actor);
                        if(ISAAC.anInt522 > -1) {
                            UnderlayDefinition.aClass40_Sub5_Sub14_Sub4Array2567[0].drawImage(
                                    ISAAC.anInt522 + -12, Class44.anInt1048 + -28);
                        }
                    }
                } else {
                    ...
                    if(class40_sub5_sub17_sub4_sub1.isSkulled != -1 || class40_sub5_sub17_sub4_sub1.headIcon != -1) {
                        ...
                        if(ISAAC.anInt522 > -1) {
                            if(class40_sub5_sub17_sub4_sub1.isSkulled != -1) {
                                FloorDecoration.aClass40_Sub5_Sub14_Sub4Array603[class40_sub5_sub17_sub4_sub1.isSkulled]
                                        .drawImage(ISAAC.anInt522 - 12, Class44.anInt1048 - i_0_);
                                i_0_ += 25;
                            }
                            if(class40_sub5_sub17_sub4_sub1.headIcon != -1) {
                                ProducingGraphicsBuffer_Sub1.aClass40_Sub5_Sub14_Sub4Array2204[class40_sub5_sub17_sub4_sub1.headIcon]
                                        .drawImage(-12 + ISAAC.anInt522, Class44.anInt1048 + -i_0_);
                                i_0_ += 25;
                            }
                        }
                    }
                    if(i >= 0 && Player.headIconDrawType == 10 &&
                            ProducingGraphicsBuffer.anInt1623 == Player.trackedPlayerIndices[i]) {
                        FloorDecoration.method342(actor.anInt3117 + 15, actor);
                        if(ISAAC.anInt522 > -1) {
                            UnderlayDefinition.aClass40_Sub5_Sub14_Sub4Array2567[1].drawImage(
                                    -12 + ISAAC.anInt522, Class44.anInt1048 + -i_0_);
                        }
                    }
                }
                if(actor.forcedChatMessage != null &&
                        (i >= Player.localPlayerCount || ChatBox.publicChatMode == 0 || ChatBox.publicChatMode == 3 ||
                                ChatBox.publicChatMode == 1 && Player.hasFriend(((Player) actor).playerName))) {
                    FloorDecoration.method342(actor.anInt3117, actor);
                    if(ISAAC.anInt522 > -1 && 50 > SceneCluster.anInt770) {
                        PlayerAppearance.anIntArray680[SceneCluster.anInt770] = TypeFace.fontBold.getStringWidth(
                                actor.forcedChatMessage) / 2;
                ...
                if(MovedStatics.pulseCycle < actor.anInt3139) {
                    ...
                    if(ISAAC.anInt522 > -1) {
                        ...
                        Rasterizer.drawFilledRectangle(-15 + ISAAC.anInt522 + i_1_, Class44.anInt1048 + -3, 30 + -i_1_,
                                5, 16711680
                        );
                    }
                }
                for(int i_2_ = 0; i_2_ < 4; i_2_++) {
                    if(MovedStatics.pulseCycle < actor.anIntArray3136[i_2_]) {
                        ...
                        if(ISAAC.anInt522 > -1) {
                            ...
                            AnimationSequence.aClass40_Sub5_Sub14_Sub4Array2474[actor.anIntArray3086[i_2_]].drawImage(
                                    ISAAC.anInt522 + -12, -12 + Class44.anInt1048);
                            TypeFace.fontSmall.drawStringLeft(Integer.toString(actor.anIntArray3087[i_2_]),
                                    ISAAC.anInt522, 4 + Class44.anInt1048, 0
                            );
                            TypeFace.fontSmall.drawStringLeft(Integer.toString(actor.anIntArray3087[i_2_]),
                                    ISAAC.anInt522 - 1, Class44.anInt1048 + 3, 16777215
                            );
                        }
                    }
                }
        ...
        for(int i = 0; SceneCluster.anInt770 > i; i++) {
            ...
            while(bool) {
                ...
                for(int i_7_ = 0; i > i_7_; i_7_++) {
                    if(-PlayerAppearance.anIntArray688[i_7_] + PlayerAppearance.anIntArray685[i_7_] < i_4_ + 2 &&
                            -i_6_ + i_4_ < 2 + PlayerAppearance.anIntArray685[i_7_] &&
                            PlayerAppearance.anIntArray715[i_7_] + PlayerAppearance.anIntArray680[i_7_] >
                                    -i_5_ + i_3_ && i_5_ + i_3_ >
                            -PlayerAppearance.anIntArray680[i_7_] + PlayerAppearance.anIntArray715[i_7_] &&
                            -PlayerAppearance.anIntArray688[i_7_] + PlayerAppearance.anIntArray685[i_7_] < i_4_) {
                        bool = true;
            ...
            if(MovedStatics.anInt2280 == 0) {
                ...
                if(PlayerAppearance.anIntArray695[i] == 1) {
                    TypeFace.fontBold.drawCenteredStringWaveY(class1, ISAAC.anInt522, Class44.anInt1048 + 1, 0,
                            Class40_Sub5_Sub11.anInt2628
                    );
                    TypeFace.fontBold.drawCenteredStringWaveY(class1, ISAAC.anInt522, Class44.anInt1048, i_8_,
                            Class40_Sub5_Sub11.anInt2628
                    );
                }
                if(PlayerAppearance.anIntArray695[i] == 2) {
                    TypeFace.fontBold.drawCenteredStringWaveXY(class1, ISAAC.anInt522, 1 + Class44.anInt1048, 0,
                            Class40_Sub5_Sub11.anInt2628
                    );
                    TypeFace.fontBold.drawCenteredStringWaveXY(class1, ISAAC.anInt522, Class44.anInt1048, i_8_,
                            Class40_Sub5_Sub11.anInt2628
                    );
                }
                if(PlayerAppearance.anIntArray695[i] == 3) {
                    TypeFace.fontBold.drawCenteredStringWaveXYMove(class1, ISAAC.anInt522, Class44.anInt1048 + 1, 0,
                            Class40_Sub5_Sub11.anInt2628, -PlayerAppearance.anIntArray684[i] + 150
                    );
                    TypeFace.fontBold.drawCenteredStringWaveXYMove(class1, ISAAC.anInt522, Class44.anInt1048, i_8_,
                            Class40_Sub5_Sub11.anInt2628, -PlayerAppearance.anIntArray684[i] + 150
                    );
                }
                ...
                if(PlayerAppearance.anIntArray695[i] == 5) {
                    ...
                    Rasterizer.setBounds(0, -1 + -TypeFace.fontBold.characterDefaultHeight + Class44.anInt1048, 512,
                            5 + Class44.anInt1048
                    );
                    if(i_15_ >= 25) {
                        if(i_15_ > 125) {
    ...
    public static synchronized void method412(
            boolean arg0, CacheArchive arg1, int arg2, byte arg3, String arg4, int arg5, String arg6, int arg7
    ) {
        if(Class24.method340()) {
            if(arg3 != 66) {
    ...
    public static synchronized void method413() {
        if(Class24.method340()) {
            if(Class26.aBoolean618) {
                byte[] is = RSString.method74(Class40_Sub5_Sub17_Sub1.anInt3004, Class22_Sub1.aCacheArchive_1855,
                        Class8.anInt289, MovedStatics.anInt2110
                );
                if(is != null) {
                    if(MovedStatics.anInt255 < 0) {
                        if(MovedStatics.anInt1806 < 0) {
                            ...
                            VarbitDefinition.method566(OverlayDefinition.anInt2342, Main.aBoolean1790,
                                    MovedStatics.anInt1806, is
                            );
                        }
                    } else {
                        Class42.method886(OverlayDefinition.anInt2342, Main.aBoolean1790, is, MovedStatics.anInt255);
                    }
                    Class26.aBoolean618 = false;
                    Class22_Sub1.aCacheArchive_1855 = null;
                }
    ...
    public static synchronized void method414(
            boolean arg0, int arg1, int songId, int arg3, int arg4, CacheArchive arg5
    ) {
        if(Class24.method340()) {
