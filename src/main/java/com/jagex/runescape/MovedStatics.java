...
public class MovedStatics {
            ...
            for(int i_1_ = 0; i_1_ < 100; i_1_++) {
                if(ChatBox.chatMessages[i_1_] != null) {
                    ...
                    if((i_2_ == 3 || i_2_ == 7) && (i_2_ == 7 || ChatBox.privateChatMode == 0 ||
                        ...
                        int i_3_ = 329 + -(13 * i);
                        i++;
                        if(Class13.mouseX > 4 && i_3_ + -10 < Landscape.mouseY + -4 &&
                                -4 + Landscape.mouseY <= i_3_ + 3) {
                            int i_4_ = 25 + WallDecoration.fontNormal.getStringWidth(
                                    English.from + Native.prefixColon + class1 + ChatBox.chatMessages[i_1_]);
                            if(i_4_ > 450) {
                                i_4_ = 450;
                            }
                            if(Class13.mouseX < 4 + i_4_) {
                                if(InteractiveObject.playerRights >= 1) {
                                    OverlayDefinition.addActionRow(
                                            English.reportAbuse, 0, 0, 0, 2028, Native.white + class1);
                                }
                ...
                if(Player.worldLevel == class40_sub5_sub17_sub6.anInt3239 && !class40_sub5_sub17_sub6.aBoolean3237) {
                    if(pulseCycle >= class40_sub5_sub17_sub6.anInt3230) {
                        ...
                        if(class40_sub5_sub17_sub6.aBoolean3237) {
                            ...
                            Npc.currentScene.method134(class40_sub5_sub17_sub6.anInt3239,
                                    class40_sub5_sub17_sub6.anInt3244, class40_sub5_sub17_sub6.anInt3235,
                                    class40_sub5_sub17_sub6.anInt3231, 60, class40_sub5_sub17_sub6, 0, -1, false
                            );
                        }
                    }
                } else {
    ...
    public static int method546(int arg0) {
        ...
        if(i + -SceneCluster.cameraZ < 800 &&
                (OverlayDefinition.tile_flags[Player.worldLevel][Class12.cameraX >> 7][Class40_Sub5_Sub6.cameraY >> 7] &
                        0x4) != 0) {
            return Player.worldLevel;
        }
        return 3;
                ...
                if(Player.worldLevel == class40_sub5_sub17_sub1.anInt2981 &&
                    ...
                    if(class40_sub5_sub17_sub1.anInt2974 <= pulseCycle) {
                        if(class40_sub5_sub17_sub1.anInt2961 > 0) {
                            ...
                            if(class40_sub5_sub17_sub4_sub2 != null && class40_sub5_sub17_sub4_sub2.worldX >= 0 &&
                                    class40_sub5_sub17_sub4_sub2.worldX < 13312 &&
                                    class40_sub5_sub17_sub4_sub2.worldY >= 0 &&
                                    class40_sub5_sub17_sub4_sub2.worldY < 13312) {
                                class40_sub5_sub17_sub1.method766(pulseCycle, arg0 + -61,
                                        class40_sub5_sub17_sub4_sub2.worldY,
                                        Class37.getFloorDrawHeight(class40_sub5_sub17_sub1.anInt2981,
                                                class40_sub5_sub17_sub4_sub2.worldX, class40_sub5_sub17_sub4_sub2.worldY
                                        ) - class40_sub5_sub17_sub1.anInt2960, class40_sub5_sub17_sub4_sub2.worldX
                                );
                            }
                        }
                        if(class40_sub5_sub17_sub1.anInt2961 < 0) {
                            ...
                            if(class40_sub5_sub17_sub4_sub1 != null && class40_sub5_sub17_sub4_sub1.worldX >= 0 &&
                                    class40_sub5_sub17_sub4_sub1.worldX < 13312 &&
                                    class40_sub5_sub17_sub4_sub1.worldY >= 0 &&
                                    class40_sub5_sub17_sub4_sub1.worldY < 13312) {
                                class40_sub5_sub17_sub1.method766(pulseCycle, 0, class40_sub5_sub17_sub4_sub1.worldY,
                                        Class37.getFloorDrawHeight(class40_sub5_sub17_sub1.anInt2981,
                                                class40_sub5_sub17_sub4_sub1.worldX, class40_sub5_sub17_sub4_sub1.worldY
                                        ) - class40_sub5_sub17_sub1.anInt2960, class40_sub5_sub17_sub4_sub1.worldX
                                );
                            }
                        }
                        class40_sub5_sub17_sub1.method765(51, anInt199);
                        Npc.currentScene.method134(Player.worldLevel, (int) class40_sub5_sub17_sub1.aDouble2980,
                                (int) class40_sub5_sub17_sub1.aDouble2993, (int) class40_sub5_sub17_sub1.aDouble2992,
                                60, class40_sub5_sub17_sub1, class40_sub5_sub17_sub1.anInt3013, -1, false
                        );
                    }
                } else {
    ...
    public static String method204(int arg0) {
        return (0xff & arg0 >> 24) + Native.period + ((arg0 & 0xffca88) >> 16) + Native.period +
                ((0xfff8 & arg0) >> 8) + Native.period + (0xff & arg0);
    }
    ...
    public static void method836(int arg0) {
        ...
        for(int i_6_ = 1; i_6_ < i - 1; i_6_++) {
            for(int i_7_ = 1; i_7_ < 127; i_7_++) {
                ...
                Class40_Sub5_Sub17_Sub6.anIntArray3255[i_8_] = (anIntArray178[i_8_ + 1] + anIntArray178[i_8_ - 1] -
                        (-anIntArray178[-128 + i_8_] - anIntArray178[128 + i_8_])) / 4;
            }
        }
        ...
        for(int i_10_ = 1; i_10_ < -1 + i; i_10_++) {
            for(int i_11_ = 1; i_11_ < 127; i_11_++) {
                ...
                int i_13_ = -(Landscape.anIntArray1168[i_12_ + RSRuntimeException.anInt1641 &
                        -1 + Landscape.anIntArray1168.length] / 5) +
                        Class40_Sub5_Sub17_Sub6.anIntArray3255[i_12_ + 128];
                if(i_13_ < 0) {
                    i_13_ = 0;
                }
        ...
        Class17.anIntArray466[i - arg0] = (int) (16.0 * Math.sin((double) pulseCycle / 14.0) + 14.0 * Math.sin(
                (double) pulseCycle / 15.0) + 12.0 * Math.sin((double) pulseCycle / 16.0));
    ...
    public static void method522(int arg0, int arg1) {
        ...
        i_3_ <<= i;
        GroundItemTile.varbitMasks[i_0_] = UnderlayDefinition.bitWiseOR(
                HuffmanEncoding.method1021(GroundItemTile.varbitMasks[i_0_], i_3_ ^ 0xffffffff),
                HuffmanEncoding.method1021(i_3_, arg0 << i)
        );
    }
    ...
    public static int calculateDataLoaded(int arg1, int arg2) {
        ...
        return 1 + Class40_Sub5_Sub13.aClass40_Sub1_2752.currentPosition * 99 /
                (Class40_Sub5_Sub13.aClass40_Sub1_2752.buffer.length +
