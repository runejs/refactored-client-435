...
public class Class40_Sub5_Sub17_Sub1 extends Renderable {
    ...
    public static String[] aClass1Array2964 = new String[]{
    ...
    public Class40_Sub5_Sub17_Sub1(
    ...
    public static void method762(Actor actor) {
        if(actor.anInt3113 != 0) {
            ...
            if((actor.facePositionX != 0 || actor.facePositionY != 0) &&
                    (actor.anInt3109 == 0 || actor.anInt3074 > 0)) {
    ...
    public static void method763(Component arg0, CacheArchive arg2) {
        if(!MovedStatics.aBoolean2083) {
            ...
            VarbitDefinition.gameScreenImageProducer = Class40_Sub5_Sub13.createGraphicsBuffer(
                    ...
                    ScreenController.frameMode == ScreenMode.FIXED ? 334 : ScreenController.drawHeight, arg0
            );
            Rasterizer.resetPixels();
            ...
            Class40_Sub5_Sub15.tabIcons = IndexedImage.getMultipleIndexedImages(
                    arg2, Native.aClass1_2787, Native.aClass1_305);
            ...
            for(int y = 0; y < 33; y++) {
                ...
                int i_16_ = 999;
                for(int x = 0; x < 34; x++) {
                    if(MovedStatics.minimapBackgroundImage.imgPixels[MovedStatics.minimapBackgroundImage.imgWidth * y +
                            x] == 0) {
                        if(i_16_ == 999) {
                            i_16_ = x;
                        }
            ...
            for(int y = 5; y < 156; y++) {
                ...
                for(int x = 25; x < 172; x++) {
                    if(MovedStatics.minimapBackgroundImage.imgPixels[x +
                            MovedStatics.minimapBackgroundImage.imgWidth * y] != 0 || x <= 34 && y <= 34) {
                        if(minWidth != 999) {
                            maxWidth = x;
                            break;
                        }
    ...
    public static int method764(byte arg0) {
        ...
        if((OverlayDefinition.tile_flags[Player.worldLevel][Player.localPlayer.worldX >> 7][Player.localPlayer.worldY >>
                7] & 0x4) != 0) {
            i = Player.worldLevel;
        }
        return i;
    ...
    public static void addObject(
            int objectId, int localX, int localY, int plane, int face, int type, Scene scene, CollisionMap collisionMap
    ) {
        if(!VertexNormal.lowMemory || (0x2 & OverlayDefinition.tile_flags[0][localX][localY]) != 0 ||
                (0x10 & OverlayDefinition.tile_flags[plane][localX][localY]) == 0 &&
                        MovedStatics.onBuildTimePlane == Class59.getVisibilityPlaneFor(plane, localY, 0, localX)) {
            ...
            if(type == 22) {
                ...
                if(renderable != null) {
                    ...
                    if(scene.addEntityB(
                            localX, localY, plane, vertexMix, i_42_, i_40_, i_41_, hash, renderable, objectConfig) &&
                            gameObjectDefinition.castsShadow) {
                        Model class40_sub5_sub17_sub5;
                        if(renderable instanceof Model) {
                            class40_sub5_sub17_sub5 = (Model) renderable;
                        } else {
                            class40_sub5_sub17_sub5 = gameObjectDefinition.createTerrainObjectModel(
                                    vertexHeightTopRight, vertexHeightTop, face, vertexHeight, 10, vertexHeightRight);
                        }
                        if(class40_sub5_sub17_sub5 != null) {
                            for(int i_43_ = 0; i_43_ <= i_41_; i_43_++) {
                                for(int i_44_ = 0; i_40_ >= i_44_; i_44_++) {
                                    ...
                                    if(i_45_ > InteractiveObject.aByteArrayArrayArray492[plane][localX + i_43_][localY +
                                            i_44_]) {
                                        InteractiveObject.aByteArrayArrayArray492[plane][i_43_ + localX][localY +
                                                i_44_] = (byte) i_45_;
                                    }
                                }
                            }
                ...
                if(gameObjectDefinition.solid && collisionMap != null) {
                    collisionMap.unmarkSolidOccupant(localX, localY, gameObjectDefinition.sizeX,
                            gameObjectDefinition.sizeY, face, gameObjectDefinition.walkable
                    );
                }
            } else if(type >= 12) {
                Renderable renderable;
                ...
                if(type >= 12 && type <= 17 && type != 13 && plane > 0) {
                    MovedStatics.anIntArrayArrayArray262[plane][localX][localY] = UnderlayDefinition.bitWiseOR(
                            MovedStatics.anIntArrayArrayArray262[plane][localX][localY], 2340);
                }
                if(gameObjectDefinition.solid && collisionMap != null) {
                    collisionMap.unmarkSolidOccupant(localX, localY, gameObjectDefinition.sizeX,
                            gameObjectDefinition.sizeY, face, gameObjectDefinition.walkable
                ...
                if(face == 0) {
                    ...
                    if(gameObjectDefinition.wall) {
                        MovedStatics.anIntArrayArrayArray262[plane][localX][localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX][localY], 585);
                    }
                } else if(face == 1) {
                    if(gameObjectDefinition.castsShadow) {
                        InteractiveObject.aByteArrayArrayArray492[plane][localX][localY + 1] = (byte) 50;
                    ...
                    if(gameObjectDefinition.wall) {
                        MovedStatics.anIntArrayArrayArray262[plane][localX][localY + 1] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX][localY + 1], 1170);
                    }
                } else if(face == 2) {
                    if(gameObjectDefinition.castsShadow) {
                    ...
                    if(gameObjectDefinition.wall) {
                        MovedStatics.anIntArrayArrayArray262[plane][localX + 1][localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX + 1][localY], 585);
                    }
                } else if(face == 3) {
                    if(gameObjectDefinition.castsShadow) {
                        InteractiveObject.aByteArrayArrayArray492[plane][localX][localY] = (byte) 50;
                    ...
                    if(gameObjectDefinition.wall) {
                        MovedStatics.anIntArrayArrayArray262[plane][localX][localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX][localY], 1170);
                    }
                }
                if(gameObjectDefinition.solid && collisionMap != null) {
                ...
                if(gameObjectDefinition.wall) {
                    if(face == 0) {
                        ...
                        MovedStatics.anIntArrayArrayArray262[plane][localX][1 + localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX][1 + localY], 1170);
                        MovedStatics.anIntArrayArrayArray262[plane][1 + localX][localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][1 + localX][localY], 585);
                    } else if(face == 2) {
                        MovedStatics.anIntArrayArrayArray262[plane][localX + 1][localY] = UnderlayDefinition.bitWiseOR(
                                MovedStatics.anIntArrayArrayArray262[plane][localX + 1][localY], 585);
                        MovedStatics.anIntArrayArrayArray262[plane][localX][localY] = UnderlayDefinition.bitWiseOR(
                ...
                Renderable renderable;
                if(gameObjectDefinition.animationId != -1 || gameObjectDefinition.configChangeDest != null) {
                    renderable = new GameObject(objectId, 3, face, vertexHeight, vertexHeightRight,
                            vertexHeightTopRight, vertexHeightTop, gameObjectDefinition.animationId, true
                    );
                } else {
                    renderable = gameObjectDefinition.createTerrainObjectModel(
                ...
                if(type == 4) {
                    ...
                    scene.addWallDecoration(
                            localX, localY, plane, vertexMix, 0, 0, face, hash, renderable, objectConfig, 256);
                } else if(type == 7) {
                    Renderable renderable;
                    if(gameObjectDefinition.animationId == -1 && gameObjectDefinition.configChangeDest == null) {
                        renderable = gameObjectDefinition.createTerrainObjectModel(
                    ...
                    scene.addWallDecoration(
                            localX, localY, plane, vertexMix, 0, 0, face, hash, renderable, objectConfig, 512);
                } else if(type == 8) {
                    Renderable renderable;
                    if(gameObjectDefinition.animationId == -1 && gameObjectDefinition.configChangeDest == null) {
                        renderable = gameObjectDefinition.createTerrainObjectModel(
                    ...
                    scene.addWallDecoration(
                            localX, localY, plane, vertexMix, 0, 0, face, hash, renderable, objectConfig, 768);
                }
            }
        }
