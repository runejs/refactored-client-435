...
//        this.soundStream = stream;
    ...
    public static void processAudio() {
        ...
        if(Class35.songTimeout > 0) {
            ...
            if(Class35.songTimeout == 0 && RSCanvas.musicVolume != 0 && MouseHandler.anInt1457 != -1)
                Class33.method414(false, 0, MouseHandler.anInt1457, RSCanvas.musicVolume, 0, CacheArchive.musicCacheArchive);
        }
    }
