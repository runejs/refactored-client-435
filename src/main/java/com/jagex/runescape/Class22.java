...
public abstract class Class22 {
    ...
    public static void method299(byte arg0, int arg1) {
        ...
        int i_4_ = (-10 + (int) (Math.random() * 20.0) + 238 << 8) + (228 + (int) (Math.random() * 20.0) << 16) + 238 +
                (int) (20.0 * Math.random()) + -10;
            ...
            for(int i_9_ = 0; i_9_ < 104; i_9_++) {
                ...
                if(i_10_ != 0) {
                    ...
                    if(i_11_ >= 0) {
                        int i_12_ = i_9_;
                        int i_13_ = i_8_;
                        if(i_11_ != 22 && i_11_ != 29 && i_11_ != 34 && i_11_ != 36 && i_11_ != 46 && i_11_ != 47 &&
                                i_11_ != 48) {
                            ...
                            for(int i_15_ = 0; i_15_ < 10; i_15_++) {
                                ...
                                if(i_16_ == 0 && i_13_ > 0 && i_13_ > -3 + i_8_ &&
                                        (is_14_[-1 + i_13_][i_12_] & 0x1280108) == 0) {
                                    i_13_--;
                                }
                                if(i_16_ == 1 && i_13_ < 103 && i_13_ < i_8_ + 3 &&
                                        (is_14_[i_13_ + 1][i_12_] & 0x1280180) == 0) {
                                    i_13_++;
                                }
                                if(i_16_ == 2 && i_12_ > 0 && i_12_ > -3 + i_9_ &&
                                        (is_14_[i_13_][i_12_ - 1] & 0x1280102) == 0) {
                                    i_12_--;
                                }
                                if(i_16_ == 3 && i_12_ < 103 && 3 + i_9_ > i_12_ &&
                                        (0x1280120 & is_14_[i_13_][1 + i_12_]) == 0) {
                                    i_12_++;
                                }
                            }
                        }
                ...
                if(i == 3) {
                    ...
                    if(i_22_ != RSCanvas.anInt60) {
                        if(RSCanvas.anInt60 != 0 || MouseHandler.anInt1457 == -1) {
                            ...
                            Class33.method414(
                                    false, 0, MouseHandler.anInt1457, i_22_, 0, CacheArchive.musicCacheArchive);
                            Class35.songTimeout = 0;
                        }
