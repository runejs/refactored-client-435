            ...
            for(int i = 0; gameInterfaces.length > i; i++) {
                ...
                if(gameInterface != null && parentId == gameInterface.parentId) {
                    ...
                    if(gameInterface.type == GameInterfaceType.LAYER) {
                        ...
                        if(gameInterface.actionType == 6 && MovedStatics.lastContinueTextWidget == -1 && i_2_ <= mouseX && i_1_ <= mouseY && mouseX < i_2_ + gameInterface.originalWidth && mouseY < gameInterface.originalHeight + i_1_) {
