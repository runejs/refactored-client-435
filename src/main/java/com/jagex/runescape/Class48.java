...
public class Class48 {
    ...
    public static void method922(int arg0, int arg1, Buffer arg2, int arg4, int arg5, int arg6, int arg7) {
        if(arg0 >= 0 && arg0 < 104 && arg4 >= 0 && arg4 < 104) {
            ...
            for(; ; ) {
                ...
                if(i == 0) {
                    if(arg7 == 0) {
                        MovedStatics.tile_height[0][arg0][arg4] = -Class42.method888(
                                arg6 + arg0 + 932731, (byte) -45, arg5 + 556238 + arg4) * 8;
                    } else {
                        MovedStatics.tile_height[arg7][arg0][arg4] =
                                -240 + MovedStatics.tile_height[arg7 + -1][arg0][arg4];
                    }
                    break;
                }
                if(i == 1) {
                    ...
                    if(arg7 != 0) {
                        MovedStatics.tile_height[arg7][arg0][arg4] =
                                MovedStatics.tile_height[-1 + arg7][arg0][arg4] + -(8 * i_0_);
                    } else {
                ...
                if(i <= 49) {
                    ...
                    Class35.tile_overlay_rotation[arg7][arg0][arg4] = (byte) HuffmanEncoding.method1021(
                            arg1 + -2 + i, 3);
                } else if(i <= 81) {
    ...
    public static void handleInterfaceActions(
            int areaId, int mouseX, int mouseY, int minX, int minY, int maxX, int maxY, GameInterface[] gameInterfaces,
            int parentId, int scrollPosition, int scrollWidth
    ) {
        ...
        if(minX <= mouseX && mouseY >= minY && maxX > mouseX && maxY > mouseY) {
            for(int i = 0; gameInterfaces.length > i; i++) {
                ...
                if(gameInterface != null && parentId == gameInterface.parentId) {
                    ...
                    if(gameInterface.type == GameInterfaceType.IF1_TOOLTIP && i_2_ <= mouseX && i_1_ <= mouseY &&
                            mouseX < i_2_ + gameInterface.originalWidth &&
                            mouseY < gameInterface.originalHeight + i_1_) {
                        Item.anInt3065 = i;
                    }
                    if((gameInterface.hoveredSiblingId >= 0 || gameInterface.hoveredTextColor != 0) && i_2_ <= mouseX &&
                            i_1_ <= mouseY && mouseX < i_2_ + gameInterface.originalWidth &&
                            mouseY < gameInterface.originalHeight + i_1_) {
                    ...
                    if(gameInterface.type == GameInterfaceType.LAYER) {
                        if(!gameInterface.isHidden || Class29.isHovering(areaId, i) || PacketBuffer.hiddenButtonTest) {
                            ...
                            if(gameInterface.children != null) {
                                handleInterfaceActions(areaId, mouseX, mouseY, i_2_, i_1_,
                                        gameInterface.originalWidth + i_2_, i_1_ + gameInterface.originalHeight,
                                        gameInterface.children, gameInterface.id, gameInterface.scrollPosition,
                                        gameInterface.scrollWidth
                                );
                            }
                            if(gameInterface.originalHeight < gameInterface.scrollHeight) {
                                GameInterface.scrollInterface(gameInterface.originalHeight, mouseY, mouseX,
                                        gameInterface.scrollHeight, gameInterface, gameInterface.originalWidth + i_2_,
                                        areaId, i_1_
                                );
                            }
                        }
                    } else {
                        if(gameInterface.actionType == 1 && i_2_ <= mouseX && i_1_ <= mouseY &&
                                gameInterface.originalWidth + i_2_ > mouseX &&
                                gameInterface.originalHeight + i_1_ > mouseY) {
                            boolean bool = false;
                        ...
                        if(gameInterface.actionType == 3 && mouseX >= i_2_ && mouseY >= i_1_ &&
                                i_2_ + gameInterface.originalWidth > mouseX &&
                                mouseY < i_1_ + gameInterface.originalHeight) {
                            int i_3_;
                            if(areaId != 3) {
                                i_3_ = 9;
                        ...
                        if(gameInterface.actionType == 4 && mouseX >= i_2_ && i_1_ <= mouseY &&
                                mouseX < gameInterface.originalWidth + i_2_ &&
                                gameInterface.originalHeight + i_1_ > mouseY) {
                            OverlayDefinition.addActionRow(gameInterface.tooltip, 0, 0, gameInterface.id, 23, "");
                        }
                        if(gameInterface.actionType == 5 && i_2_ <= mouseX && i_1_ <= mouseY &&
                                mouseX < i_2_ + gameInterface.originalWidth &&
                                i_1_ + gameInterface.originalHeight > mouseY) {
                            OverlayDefinition.addActionRow(gameInterface.tooltip, 0, 0, gameInterface.id, 57, "");
                        }
                        if(gameInterface.actionType == 6 && MovedStatics.anInt1819 == -1 && i_2_ <= mouseX &&
                                i_1_ <= mouseY && mouseX < i_2_ + gameInterface.originalWidth &&
                                mouseY < gameInterface.originalHeight + i_1_) {
                                            ...
                                            if(Class8.itemSelected != 1 || !gameInterface.isInventory) {
                                                if(Main.widgetSelected == 1 && gameInterface.isInventory) {
                                                    ...
                                                    examineText.append(MessageFormat
                                                            .format("<col=ff9040>{0}</col>", itemDefinition.name));
                                                    if(Configuration.DEBUG_CONTEXT) {
                                                        examineText.append(" <col=00ff00>(</col>");
                                                        examineText.append(MessageFormat.format("<col=ffffff>{0}</col>",
                        ...
                        if(gameInterface.isNewInterfaceFormat && gameInterface.itemId != -1 && mouseX >= i_2_ &&
                                mouseY >= i_1_ && mouseX < gameInterface.originalWidth + i_2_ &&
                                mouseY < i_1_ + gameInterface.originalHeight) {
                            ...
                            if(gameInterface.isInventory) {
                                ...
                                if(class1s == null || class1s[4] == null) {
                                    OverlayDefinition.addActionRow(English.drop, itemDefinition.id,
                                            -1 + gameInterface.anInt2736, gameInterface.id, 11,
                                            Native.lightRed + itemDefinition.name
                                    );
                                } else {
                                    OverlayDefinition.addActionRow(class1s[4], itemDefinition.id,
                                            gameInterface.anInt2736 + -1, gameInterface.id, 11,
                                            Native.lightRed + itemDefinition.name
                                    );
                                }
                                if(class1s != null && class1s[3] != null) {
                                    OverlayDefinition.addActionRow(class1s[3], itemDefinition.id,
                                            -1 + gameInterface.anInt2736, gameInterface.id, 43,
                                            Native.lightRed + itemDefinition.name
                                    );
                                }
                                if(class1s != null && class1s[2] != null) {
                                    OverlayDefinition.addActionRow(class1s[2], itemDefinition.id,
                                            gameInterface.anInt2736 - 1, gameInterface.id, 31,
                                            Native.lightRed + itemDefinition.name
                                    );
                                }
                                if(class1s != null && class1s[1] != null) {
                                    OverlayDefinition.addActionRow(class1s[1], itemDefinition.id,
                                            -1 + gameInterface.anInt2736, gameInterface.id, 6,
                                            Native.lightRed + itemDefinition.name
                                    );
                                }
                                if(class1s != null && class1s[0] != null) {
                                    OverlayDefinition.addActionRow(class1s[0], itemDefinition.id,
                                            -1 + gameInterface.anInt2736, gameInterface.id, 52,
                                            Native.lightRed + itemDefinition.name
                                    );
                                }
                            }
                            if(gameInterface.id >= 0) {
                                OverlayDefinition.addActionRow(English.examine, itemDefinition.id, -1, gameInterface.id,
                                        1007, Native.lightRed + itemDefinition.name
                                );
                            } else {
                                OverlayDefinition.addActionRow(English.examine, itemDefinition.id,
                                        gameInterface.id & 0x7fff, gameInterface.parentId, 1007,
                                        Native.lightRed + itemDefinition.name
                                );
                            }
                        }
                        if(gameInterface.hasListeners && gameInterface.aClass1Array2661 != null && i_2_ <= mouseX &&
                                i_1_ <= mouseY && gameInterface.originalWidth + i_2_ > mouseX &&
                                mouseY < i_1_ + gameInterface.originalHeight) {
                            String class1 = "";
                            ...
                            for(int i_15_ = gameInterface.aClass1Array2661.length - 1; i_15_ >= 0; i_15_--) {
                                if(gameInterface.aClass1Array2661[i_15_] != null) {
                                    if(gameInterface.id < 0) {
                                        OverlayDefinition.addActionRow(gameInterface.aClass1Array2661[i_15_], i_15_ + 1,
                                                0x7fff & gameInterface.id, gameInterface.parentId, 50, class1
                                        );
                                    } else {
                                        OverlayDefinition.addActionRow(gameInterface.aClass1Array2661[i_15_], i_15_ + 1,
                                                0, gameInterface.id, 50, class1
                                        );
                                    }
                                }
                            }
