...
public class Main extends GameShell {
     ...
     * @return The status of the drawing cycle, true for success and false for failure
     */
    public static boolean drawInterface(
            int areaId, int minX, int minY, int maxX, int maxY, int scrollPosition, int scrollWidth,
            GameInterface[] interfaceCollection, int parentId, boolean drawSuccess
    ) {
        ...
        for(int i = 0; interfaceCollection.length > i; i++) {
            ...
            if(gameInterface != null && gameInterface.parentId == parentId) {
                ...
                if(!gameInterface.isNewInterfaceFormat ||
                        Rasterizer.viewportRight >= absoluteX && Rasterizer.viewportBottom >= absoluteY &&
                                Rasterizer.viewportLeft <= absoluteX + gameInterface.originalWidth &&
                                absoluteY + gameInterface.originalHeight >= Rasterizer.viewportTop) {
                    if(gameInterface.type == GameInterfaceType.LAYER) {
                        ...
                        if(!gameInterface.isNewInterfaceFormat) {
                            if(-gameInterface.originalHeight + gameInterface.scrollHeight <
                                ...
                                gameInterface.scrollPosition =
                                        -gameInterface.originalHeight + gameInterface.scrollHeight;
                            }
                        ...
                        if(gameInterface.children != null) {
                            result &= drawInterface(areaId, absoluteX, absoluteY,
                                    gameInterface.originalWidth + absoluteX, absoluteY + gameInterface.originalHeight,
                                    gameInterface.scrollPosition, gameInterface.scrollWidth, gameInterface.children,
                                    gameInterface.id, true
                            );
                        }
                        Rasterizer.setBounds(minX, minY, maxX, maxY);
                        if(gameInterface.originalHeight < gameInterface.scrollHeight) {
                            GameInterface.drawScrollBar(absoluteX + gameInterface.originalWidth, absoluteY,
                                    gameInterface.originalHeight, gameInterface.scrollPosition,
                                    gameInterface.scrollHeight, 0
                            );
                        }
                    }
                    ...
                    if(gameInterface.type == GameInterfaceType.INVENTORY) {
                        ...
                        for(int i_8_ = 0; i_8_ < gameInterface.originalHeight; i_8_++) {
                            for(int i_9_ = 0; gameInterface.originalWidth > i_9_; i_9_++) {
                                ...
                                if(gameInterface.items[i_7_] <= 0) {
                                    ...
                                    int i_14_ = 0;
                                    if(-32 + Rasterizer.viewportLeft < i_10_ && Rasterizer.viewportRight > i_10_ &&
                                            Rasterizer.viewportTop + -32 < i_11_ && Rasterizer.viewportBottom > i_11_ ||
                                            SceneTile.activeInterfaceType != 0 &&
                                                    GroundItemTile.selectedInventorySlot == i_7_) {
                                        int i_15_ = 0;
                                        if(Class8.itemSelected == 1 && i_7_ == LinkedList.anInt1061 &&
                                                gameInterface.id == ISAAC.anInt525) {
                                            i_15_ = 16777215;
                                        }
                                        ImageRGB imageRGB = ItemDefinition.sprite(
                                                gameInterface.itemAmounts[i_7_], i_13_, i_15_);
                                        if(imageRGB == null) {
                                            result = false;
                                        } else {
                                            if(SceneTile.activeInterfaceType != 0 &&
                                                    GroundItemTile.selectedInventorySlot == i_7_ &&
                                                    gameInterface.id == Class48.modifiedWidgetId) {
                                                ...
                                                if(parentId != -1) {
                                                    ...
                                                    if(Rasterizer.viewportTop > i_14_ + i_11_ &&
                                                            gameInterface_16_.scrollPosition > 0) {
                                                        int i_17_ = MovedStatics.anInt199 *
                                                                (Rasterizer.viewportTop + -i_11_ - i_14_) / 3;
                                                    ...
                                                    if(32 + i_11_ + i_14_ > Rasterizer.viewportBottom &&
                                                            -gameInterface_16_.originalHeight +
                                                                    gameInterface_16_.scrollHeight >
                                                                    gameInterface_16_.scrollPosition) {
                                                        int i_18_ = MovedStatics.anInt199 *
                                                                (-Rasterizer.viewportBottom + 32 + i_11_ + i_14_) / 3;
                                                        if(MovedStatics.anInt199 * 10 < i_18_) {
                                                            i_18_ = 10 * MovedStatics.anInt199;
                                                        }
                                                        if(-gameInterface_16_.scrollPosition +
                                                                gameInterface_16_.scrollHeight +
                                                                -gameInterface_16_.originalHeight < i_18_) {
                                                            i_18_ = -gameInterface_16_.originalHeight +
                                                                    gameInterface_16_.scrollHeight +
                                                                    -gameInterface_16_.scrollPosition;
                                                        }
                                            ...
                                            } else if(Class40_Sub5_Sub17_Sub1.atInventoryInterfaceType == 0 ||
                                                    GenericTile.anInt1233 != i_7_ ||
                                                    gameInterface.id != PlayerAppearance.anInt704) {
                                                imageRGB.drawImage(i_10_, i_11_);
                                            } else {
                        ...
                        if(opacity == 0) {
                            if(!gameInterface.filled) {
                                Rasterizer.drawUnfilledRectangle(absoluteX, absoluteY, gameInterface.originalWidth,
                                        gameInterface.originalHeight, rectangleColor
                                );
                            } else {
                                Rasterizer.drawFilledRectangle(absoluteX, absoluteY, gameInterface.originalWidth,
                                        gameInterface.originalHeight, rectangleColor
                                );
                            }
                        } else if(!gameInterface.filled) {
                            Rasterizer.drawUnfilledRectangleAlpha(absoluteX, absoluteY, gameInterface.originalWidth,
                                    gameInterface.originalHeight, rectangleColor, -(0xff & opacity) + 256
                            );
                        } else {
                            Rasterizer.drawFilledRectangleAlpha(absoluteX, absoluteY, gameInterface.originalWidth,
                                    gameInterface.originalHeight, rectangleColor, -(0xff & opacity) + 256
                            );
                        }
                        ...
                        if(gameInterface.isNewInterfaceFormat) {
                            ...
                            if(spriteRgb != null) {
                                ...
                                if(gameInterface.tiled) {
                                    ...
                                    for(int row = 0; i_31_ > row; row++) {
                                        for(int col = 0; i_32_ > col; col++) {
                                            if(gameInterface.textureId == 0) {
                                                if(opacity == 0) {
                                                    spriteRgb.drawImage(row * spriteWidth + absoluteX,
                                                            col * spriteHeight + absoluteY
                                                    );
                                                } else {
                                                    spriteRgb.drawImageWithOpacity(absoluteX + row * spriteWidth,
                                                            absoluteY + spriteHeight * col, -(opacity & 0xff) + 256
                                                    );
                                                }
                                            } else {
                                                spriteRgb.drawImageWithTexture(
                                                        spriteWidth / 2 + row * spriteWidth + absoluteX,
                                                        spriteHeight / 2 + absoluteY + spriteHeight * col,
                                                        gameInterface.textureId, 4096
                                                );
                                            }
                                        }
                                    }
                                    ...
                                    if(gameInterface.textureId == 0) {
                                        if(opacity == 0) {
                                            if(gameInterface.originalWidth == spriteWidth &&
                                                    gameInterface.originalHeight == spriteHeight) {
                                                spriteRgb.drawImage(absoluteX, absoluteY);
                                            } else {
                                                spriteRgb.method732(absoluteX, absoluteY, gameInterface.originalWidth,
                                                        gameInterface.originalHeight
                                                );
                                            }
                                        } else {
                                            spriteRgb.method716(absoluteX, absoluteY, gameInterface.originalWidth,
                                                    gameInterface.originalHeight, 256 + -(0xff & opacity)
                                            );
                                        }
                                    } else {
                                        spriteRgb.drawImageWithTexture(gameInterface.originalWidth / 2 + absoluteX,
                                                gameInterface.originalHeight / 2 + absoluteY, gameInterface.textureId,
                                                i_26_
                                        );
                                    }
                                }
                            ...
                            ImageRGB imageRGB = gameInterface.getImageRgb(
                                    ItemDefinition.checkForAlternateAction(gameInterface));
                            if(imageRGB != null) {
                        ...
                        if(model != null) {
                            if(gameInterface.isNewInterfaceFormat) {
                                ...
                                if(gameInterface.orthogonal) {
                                    model.drawOrthogonalModel(0, rotationZ, rotationY, rotationX, offsetX2d,
                                            offsetY2d + camHeight + model.modelHeight / 2, camDistance + offsetY2d,
                                            modelZoom
                                    );
                                } else {
                                    model.drawModel(0, rotationZ, rotationY, rotationX, offsetX2d,
                                            offsetY2d + model.modelHeight / 2 + camHeight, camDistance + offsetY2d
                                    );
                                }
                            } else {
                            ...
                            for(int row = 0; row < gameInterface.originalHeight; row++) {
                                for(int col = 0; col < gameInterface.originalWidth; col++) {
                                    if(gameInterface.items[itemSlot] > 0) {
                                        ItemDefinition itemDefinition = ItemDefinition.forId(
                                                -1 + gameInterface.items[itemSlot], 10);
                                        ...
                                        if(gameInterface.xTextAlignment == 0) {
                                            font.drawShadowedString(itemName, itemX, itemY, gameInterface.textShadowed,
                                                    gameInterface.textColor
                                            );
                                        } else if(gameInterface.xTextAlignment == 1) {
                                            font.drawShadowedStringCenter(itemName,
                                                    itemX + gameInterface.originalWidth / 2, itemY,
                                                    gameInterface.textColor, gameInterface.textShadowed
                                            );
                                        } else {
                                            font.drawShadowedStringRight(itemName,
                                                    -1 + gameInterface.originalWidth + itemX, itemY,
                                                    gameInterface.textColor, gameInterface.textShadowed
                                            );
                                        }
                                    }
                        ...
                        if(gameInterface.type == GameInterfaceType.IF1_TOOLTIP && Class37.method438(areaId, i) &&
                                RSString.tooltipDelay == WallDecoration.durationHoveredOverWidget) {
                            int textWidth = 0;
                            int textHeight = 0;
                            ...
                            while(text.length() > 0) {
                                ...
                                class40_sub5_sub14_sub1.drawShadowedString(
                                        textLine, tooltipX + 3, tooltipTitleY, false, 0);
                                tooltipTitleY += 1 + class40_sub5_sub14_sub1.characterDefaultHeight;
                            }
                        }
                        if(gameInterface.type == GameInterfaceType.LINE) {
                            Rasterizer.drawDiagonalLine(absoluteX, absoluteY, gameInterface.originalWidth + absoluteX,
                                    gameInterface.originalHeight + absoluteY, gameInterface.textColor
                            );
                        }
                    }
                }
            ...
            if(IdentityKit.anInt2613 > 0) {
                for(int i = 0; i < 256; i++) {
                    if(IdentityKit.anInt2613 > 768) {
                        Class42.anIntArray1013[i] = UnderlayDefinition.method614(Class51.anIntArray1198[i],
                                Class40_Sub5_Sub17_Sub6.anIntArray3248[i], -IdentityKit.anInt2613 + 1024
                        );
                    } else if(IdentityKit.anInt2613 > 256) {
                        Class42.anIntArray1013[i] = Class40_Sub5_Sub17_Sub6.anIntArray3248[i];
                    } else {
                        Class42.anIntArray1013[i] = UnderlayDefinition.method614(
                                Class40_Sub5_Sub17_Sub6.anIntArray3248[i], Class51.anIntArray1198[i],
                                -IdentityKit.anInt2613 + 256
                        );
                    }
                }
            } else {
            ...
            for(int i = 0; i < 256; i++) {
                if(Class40_Sub5_Sub6.anInt2452 <= 768) {
                    if(Class40_Sub5_Sub6.anInt2452 > 256) {
                        ...
                        Class42.anIntArray1013[i] = UnderlayDefinition.method614(Renderable.anIntArray2865[i],
                                Class51.anIntArray1198[i], -Class40_Sub5_Sub6.anInt2452 + 256
                        );
                    }
                } else {
                    Class42.anIntArray1013[i] = UnderlayDefinition.method614(Class51.anIntArray1198[i],
                            Renderable.anIntArray2865[i], -Class40_Sub5_Sub6.anInt2452 + 1024
                    );
                }
            }
        }
        ...
        for(int i_72_ = 1; i_72_ < -1 + i; i_72_++) {
            ...
            for(int i_75_ = 0; i_75_ < i_74_; i_75_++) {
                ...
                if(i_76_ != 0) {
                    ...
                    GameObject.flameRightBackground.pixels[i_62_++] = HuffmanEncoding.method1021(
                            i_77_ * HuffmanEncoding.method1021(65280, i_76_) +
                                    i_79_ * HuffmanEncoding.method1021(65280, i_78_), 16711680) +
                            HuffmanEncoding.method1021(i_79_ * HuffmanEncoding.method1021(16711935, i_78_) +
    ...
    public static void method353(byte arg0) {
        ...
        if(!Player.cutsceneActive) {
            ...
            Class49.setCameraPosition(
                    i, Class40_Sub5_Sub6.currentCameraPositionH, -50 +
                            Class37.getFloorDrawHeight(Player.worldLevel, Player.localPlayer.worldX,
                                    Player.localPlayer.worldY
                            ), i_0_, MovedStatics.currentCameraPositionV, -1, 3 * i + 600);
        }
        int i;
        if(!Player.cutsceneActive) {
        ...
        for(int i_6_ = 0; i_6_ < 5; i_6_++) {
            if(Class40_Sub5_Sub17_Sub1.aBooleanArray2975[i_6_]) {
                int i_7_ = (int) ((double) (Class8.anIntArray297[i_6_] * 2 + 1) * Math.random() -
                        (double) Class8.anIntArray297[i_6_] + Math.sin((double) Class22_Sub1.anIntArray1846[i_6_] *
                        ((double) GroundItemTile.anIntArray1358[i_6_] / 100.0)) * (double) anIntArray2[i_6_]);
                if(i_6_ == 1) {
    ...
    public static void displayMessageForResponseCode(int responseCode) {
        if(responseCode == -3) {
            ...
            Class33.setLoginScreenMessage(
                    English.yourAccountHasBeenDisabled, English.pleaseCheckYourMessageCenterForDetails, "");
            ...
            Class33.setLoginScreenMessage(
                    English.weSuspectSomeoneKnowsYourPassword, English.pressChangeYourPasswordOnFrontPage, "");
        } else if(responseCode == 12) {
            Class33.setLoginScreenMessage(
                    English.youNeedMembersAccountToLoginToThisWorld, English.pleaseSubscribeOrUseDifferentWorld, "");
            ...
            Class33.setLoginScreenMessage(
                    English.tooManyIncorrectLoginsFromYourAddress, English.pleaseWait5MinutesBeforeTryingAgain, "");
        } else if(responseCode == 17) {
            Class33.setLoginScreenMessage(
                    English.youAreStandingInMembersOnlyArea, English.toPlayOnThisWorldMoveToFreeArea, "");
        } else if(responseCode == 18) {
            Class33.setLoginScreenMessage(
                    English.accountLockedAsWeSuspectItHasBeenStolen, English.pressRecoverLockedAccountOnFrontPage, "");
        } else if(responseCode == 20) {
            Class33.setLoginScreenMessage(
                    English.invalidLoginserverRequested, English.pleaseTryUsingDifferentWorld, "");
            ...
            Class33.setLoginScreenMessage(
                    English.unexpectedLoginserverResponse, English.pleaseTryUsingDifferentWorld, "");
        } else if(responseCode == 26) {
            Class33.setLoginScreenMessage(
                    English.thisComputersAddressHasBeenBlocked, English.asItWasUsedToBreakOurRules, "");
    ...
    public static void method164() {
        ...
        } else if(ScreenController.frameMode == ScreenMode.FIXED && Class40_Sub5_Sub17_Sub1.menuScreenArea == 0) {
    ...
    public static void method165(int arg0) {
        ...
        if(Class40_Sub5_Sub6.cameraY < i) {
            Class40_Sub5_Sub6.cameraY +=
                    MovedStatics.anInt188 + Class59.anInt1386 * (-Class40_Sub5_Sub6.cameraY + i) / 1000;
            if(Class40_Sub5_Sub6.cameraY > i) {
