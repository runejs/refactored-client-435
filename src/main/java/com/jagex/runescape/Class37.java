...
public class Class37 {
    ...
    public static int getFloorDrawHeight(int plane, int x, int y) {
        ...
        int _x = 0x7f & x;
        int _y = y & 0x7f;
        int i2 = (-_x + 128) * MovedStatics.tile_height[groundZ][groundX][groundY] +
                _x * MovedStatics.tile_height[groundZ][groundX + 1][groundY] >> 7;
        int j2 = _x * MovedStatics.tile_height[groundZ][1 + groundX][1 + groundY] +
                MovedStatics.tile_height[groundZ][groundX][1 + groundY] * (128 + -_x) >> 7;
    ...
    public static void renderMinimap() {
        ...
        if(Player.headIconDrawType != 0 && MovedStatics.pulseCycle % 20 < 10) {
            ...
            if(Player.headIconDrawType == 2) {
                ...
                int hintY = 4 * (ProducingGraphicsBuffer.anInt1637 - SpotAnimDefinition.baseX) -
            ...
            if(Player.headIconDrawType == 10 && ProducingGraphicsBuffer.anInt1623 >= 0 &&
                ...
                if(player != null) {
                    ...
                    OverlayDefinition.drawMinimapMark(
                            Class40_Sub3.aClass40_Sub5_Sub14_Sub4Array2019[1], playerY, playerX);
                }
            }
        }
