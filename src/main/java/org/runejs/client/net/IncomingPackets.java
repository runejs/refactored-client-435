...
public class IncomingPackets {
    ...
    public static boolean parseIncomingPackets() {
        ...
        try {
            ...
            if(opcode == PacketType.CREATE_STATIONARY_GFX.getOpcode() || opcode == PacketType.ROTATE_ANIMATE_OBJECT.getOpcode() || opcode == PacketType.REMOVE_OBJECT.getOpcode() || opcode == PacketType.SPAWN_OBJECT.getOpcode()) {
                parseMapIncomingPacket();
                opcode = -1;
                return true;
            }
