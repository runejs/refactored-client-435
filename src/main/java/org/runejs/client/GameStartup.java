...
//            Scene.method95(500, 800, 512, 334, is);
            ...
            CacheArchive.skeletonCacheArchive = Game.loadArchive(0, false, true, true);
            CacheArchive.skinDefinitionCacheArchive = Game.loadArchive(1, false, true, true);
            CacheArchive.gameDefinitionsCacheArchive = Game.loadArchive(2, true, false, true);
            CacheArchive.gameInterfaceCacheArchive = Game.loadArchive(3, false, true, true);
            CacheArchive.soundEffectCacheArchive = Game.loadArchive(4, false, true, true);
            CacheArchive.gameWorldMapCacheArchive = Game.loadArchive(5, true, true, true);
            CacheArchive.musicCacheArchive = Game.loadArchive(6, true, true, false);
            CacheArchive.modelCacheArchive = Game.loadArchive(7, false, true, true);
            CacheArchive.gameImageCacheArchive = Game.loadArchive(8, false, true, true);
            CacheArchive.gameTextureCacheArchive = Game.loadArchive(9, false, true, true);
            CacheArchive.huffmanCacheArchive = Game.loadArchive(10, false, true, true);
            CacheArchive.jingleCacheArchive = Game.loadArchive(11, false, true, true);
            CacheArchive.clientScriptCacheArchive = Game.loadArchive(12, false, true, true);
            startupStage = 40;
