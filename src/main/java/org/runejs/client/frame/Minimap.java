...
public class Minimap extends FramePieceRenderer {
    ...
    public void RenderResizableMiniMapArea(int x, int y) {
        ...
        if(MovedStatics.minimapState == 2) {
            ...
            AnimationSequence.minimapCompass.shapeImageToPixels(5, 5, 33, 33, 25, 25, SceneCamera.cameraTargetYaw, 256, resizableCompasOffsets2, resizableCompasOffsets1);
        ...
        int i_9_ = SceneCamera.cameraTargetYaw & 0x7ff;
        int minimapZoom = 0;
        ...
        shapeImageToPixels(AnimationSequence.minimapCompass, 5, 5, 33, 33, 25, 25, SceneCamera.cameraTargetYaw, 256, resizableCompasOffsets2, resizableCompasOffsets1);
