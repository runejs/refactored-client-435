...
public class Native {
    ...
    public static String backbase1 = "backbase1";
    public static String backhmid2 = "backhmid2";
    public static String backleft1 = "backleft1";
    public static String backleft2 = "backleft2";
    public static String backright1 = "backright1";
    public static String backvmid3 = "backvmid3";
