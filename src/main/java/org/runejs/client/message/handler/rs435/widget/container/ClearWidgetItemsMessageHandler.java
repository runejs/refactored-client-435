    ...
    public void handle(ClearWidgetItemsInboundMessage message) {
        ...
        if(gameInterface.if3) {
            ...
            for(int i_37_ = 0; i_37_ < gameInterfaces.length; i_37_++) {
                ...
                if((0xffff & gameInterface.id) == (gameInterface_38_.layer & 0xffff) && gameInterface_38_.anInt2736 > 0) {
                    gameInterface_38_.itemId = -1;
                    gameInterface_38_.itemAmount = 0;
                }
            }
        } else {
            for(int i_39_ = 0; gameInterface.invSlotObjId.length > i_39_; i_39_++) {
                gameInterface.invSlotObjId[i_39_] = -1;
                gameInterface.invSlotObjId[i_39_] = 0;
            }
        }
    }
}
