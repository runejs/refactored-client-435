    ...
    public static void processMenuActions(int arg1) {
        ...
        if(true) {
            ...
            if(action == ActionRowType.INTERACT_WITH_WORLD_ITEM_OPTION_2.getId()) {
                boolean bool = Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], i, i_10_, 0, 0, 0, 0, false, 0);
                if(!bool) {
                    bool = Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], i, i_10_, 1, 1, 0, 0, false, 0);
                }
            ...
            if(action == ActionRowType.CAST_MAGIC_ON_PLAYER.getId()) {
                ...
                if(class40_sub5_sub17_sub4_sub1 != null) {
                    Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], class40_sub5_sub17_sub4_sub1.pathY[0], class40_sub5_sub17_sub4_sub1.pathX[0], 1, 1, 0, 0, false, 0);
                    ClientScriptRunner.crossX = Class57.clickX;
                    OverlayDefinition.crossIndex = 0;
                    LinkedList.crossType = 2;
                    MovedStatics.crossY = RSString.clickY;
            ...
            if(action == ActionRowType.INTERACT_WITH_PLAYER_OPTION_1.getId()) {
                ...
                if(otherPlayer != null) {
                    Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], otherPlayer.pathY[0], otherPlayer.pathX[0], 1, 1, 0, 0, false, 0);
                    ClientScriptRunner.crossX = Class57.clickX;
                    LinkedList.crossType = 2;
                    MovedStatics.crossY = RSString.clickY;
                    OverlayDefinition.crossIndex = 0;
            ...
            if(action == ActionRowType.SELECT_ITEM_ON_WIDGET.getId()) {
                ...
                if(action == ActionRowType.INTERACT_WITH_NPC_OPTION_2.getId()) {
                    Npc class40_sub5_sub17_sub4_sub2 = Player.npcs[npcIdx];
                    if(class40_sub5_sub17_sub4_sub2 != null) {
                        Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], class40_sub5_sub17_sub4_sub2.pathY[0], class40_sub5_sub17_sub4_sub2.pathX[0], 1, 1, 0, 0, false, 0);
                        OverlayDefinition.crossIndex = 0;
                        ClientScriptRunner.crossX = Class57.clickX;
                        MovedStatics.crossY = RSString.clickY;
                        LinkedList.crossType = 2;
                ...
                if(action == ActionRowType.SELECT_SPELL_ON_WIDGET.getId()) {
                    ...
                    if(action == ActionRowType.CAST_MAGIC_ON_NPC.getId()) {
                        ...
                        if(npc != null) {
                            Pathfinding.doWalkTo(2, Player.localPlayer.pathY[0], Player.localPlayer.pathX[0], npc.pathY[0], npc.pathX[0], 1, 1, 0, 0, false, 0);
                            ClientScriptRunner.crossX = Class57.clickX;
                            MovedStatics.crossY = RSString.clickY;
                            OverlayDefinition.crossIndex = 0;
                            LinkedList.crossType = 2;
