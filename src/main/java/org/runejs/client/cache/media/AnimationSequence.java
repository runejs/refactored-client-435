...
public class AnimationSequence extends CachedNode {
            ...
            for(int i = 0; i < 4; i++) {
                for(int i_3_ = 0; i_3_ < 64; i_3_++) {
                    for(int i_4_ = 0; i_4_ < 64; i_4_++)
                        Class48.decodeTile(class40_sub1, i_3_ + arg4, i_4_ + arg5, i, arg1, arg6, 0);
                }
            }
        }
    }
    ...
    public Model method590(Model arg0, AnimationSequence animationSequence, int arg2, int arg3, byte arg4) {
        arg2 = frameIds[arg2];
        AnimationFrameGroup class40_sub5_sub15 = AnimationFrameGroup.method960(arg2 >> 16);
        arg2 &= 0xffff;
        if(class40_sub5_sub15 == null)
            return animationSequence.method599(arg3, arg0, false);
        arg3 = animationSequence.frameIds[arg3];
        AnimationFrameGroup class40_sub5_sub15_0_ = AnimationFrameGroup.method960(arg3 >> 16);
        arg3 &= 0xffff;
    ...
    public Model method593(int arg0, boolean arg1, Model model, int arg3) {
        arg0 = frameIds[arg0];
        AnimationFrameGroup class40_sub5_sub15 = AnimationFrameGroup.method960(arg0 >> 16);
        if(arg1)
            unknownArray1 = null;
        arg0 &= 0xffff;
        if(class40_sub5_sub15 == null)
    ...
    public Model method598(int arg0, Model arg1, boolean arg2) {
        int i = frameIds[arg0];
        AnimationFrameGroup class40_sub5_sub15 = AnimationFrameGroup.method960(i >> 16);
        i &= 0xffff;
        if(class40_sub5_sub15 == null)
            return arg1.method817(true);
        if(!arg2)
            decodeAllAnimationSequences(null);
        AnimationFrameGroup class40_sub5_sub15_20_ = null;
        int i_21_ = 0;
        if(unknownArray1 != null && arg0 < unknownArray1.length) {
            i_21_ = unknownArray1[arg0];
            class40_sub5_sub15_20_ = AnimationFrameGroup.method960(i_21_ >> 16);
            i_21_ &= 0xffff;
        }
