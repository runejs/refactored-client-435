...
public class CacheArchive {
    ...
    public CacheArchive(CacheIndex dataIndex, CacheIndex metaIndex, int cacheIndexId, boolean arg3, boolean arg4, boolean arg5) {
        ...
        UpdateServer.requestArchiveChecksum(this, this.cacheIndexId);
    }
    ...
    public int getPercentLoaded() {
        ...
        if(aByteArrayArray212 != null)
            return 99;
        int i = UpdateServer.calculatePercentageDataLoaded(255, cacheIndexId);
        if(i >= 100)
            i = 99;
        return i;
    ...
    public void method198(boolean arg1, byte[] arg2, int arg3, CacheIndex arg4) {
        if(metaIndex == arg4) {
            if(aBoolean1800)
                throw new RuntimeException();
            if(arg2 == null) {
                UpdateServer.enqueueFileRequest(true, this, 255, cacheIndexId, (byte) 0,
                        archiveCrcValue);
                return;
            }
            crc32.reset();
            ...
            if(arg2 == null || arg2.length <= 2) {
                ...
                if(aBoolean1811 || arg1)
                    UpdateServer.enqueueFileRequest(arg1, this, cacheIndexId, arg3, (byte) 2, anIntArray252[arg3]);
                return;
            }
            crc32.reset();
    ...
    public void method177(int arg1) {
        if(dataIndex != null && aBooleanArray1796 != null && aBooleanArray1796[arg1])
            ...
            UpdateServer.enqueueFileRequest(true, this, cacheIndexId, arg1, (byte) 2, anIntArray252[arg1]);
    }

    public void method174(int arg0) {
        UpdateServer.moveRequestToPendingQueue(cacheIndexId, arg0);
    }
    ...
    public void requestLatestVersion(int crcValue) {
        ...
        if(metaIndex == null)
            UpdateServer.enqueueFileRequest(true, this, 255, cacheIndexId, (byte) 0, archiveCrcValue);
        else
    ...
    public int method201(int arg0) {
        ...
        if(aBooleanArray1796[arg0])
            return 100;
        return UpdateServer.calculatePercentageDataLoaded(cacheIndexId, arg0);
    }
