...
public class GameObjectDefinition extends CachedNode implements EntityDefinition {
    ...
    public static void method602(CacheArchive arg0, int arg1, CacheIndex arg2) {
        ...
        synchronized(RSCanvas.aLinkedList_53) {
            for(Class40_Sub6 class40_sub6 = (Class40_Sub6) RSCanvas.aLinkedList_53.next(); class40_sub6 != null; class40_sub6 = (Class40_Sub6) RSCanvas.aLinkedList_53.method909()) {
    ...
    public static void method609(int objectId, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        ...
        for(Class40_Sub3 class40_sub3_24_ = (Class40_Sub3) LinkedList.aLinkedList_1064.next(); class40_sub3_24_ != null; class40_sub3_24_ = (Class40_Sub3) LinkedList.aLinkedList_1064.method909()) {
    ...
    public void readValue(Buffer buffer, int opcode) {
        if(opcode == 1) {
            ...
            if(length > 0) {
                if(objectModels == null || TextureStore.aBoolean1734) {
