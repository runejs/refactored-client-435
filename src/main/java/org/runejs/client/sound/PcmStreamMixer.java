...
public class PcmStreamMixer extends PcmStream {
    ...
    public synchronized void skip(int arg0) {
        do {
            ...
            this.anInt2877 += i;
            this.loop0();
            PcmStreamMixerListener class40_sub8 = (PcmStreamMixerListener) this.head.peekFront((byte) -90);
    ...
    private int fill0(int[] arg0, int arg1, int arg2) {
        ...
        if(this.anInt2875 <= 0) {
            ...
            for(int i = 0; i < 8; i++) {
                ...
                for(PcmStream class40_sub9 = (PcmStream) linkedList.peekFront((byte) -90); class40_sub9 != null; class40_sub9 = (PcmStream) linkedList.next(-4)) {
                    int i_1_ = method849(class40_sub9);
                    if(i_1_ != i)
                        this.substreams[i_1_].pushFront(0, class40_sub9);
                }
            }
        }
        for(int i = 0; i < 8; i++) {
            LinkedList linkedList = this.substreams[i];
            for(PcmStream stream = (PcmStream) linkedList.peekFront((byte) -90); stream != null; stream = (PcmStream) linkedList.next(-4)) {
                stream.active = false;
    ...
    private void remove(PcmStreamMixerListener arg0) {
        arg0.remove();
        arg0.remove2();
        Node class40 = this.head.tail.next;
    ...
    private void loop0() {
        if(this.anInt2877 > 0) {
            for(PcmStreamMixerListener class40_sub8 = (PcmStreamMixerListener) this.head.peekFront((byte) -90); class40_sub8 != null; class40_sub8 = (PcmStreamMixerListener) this.head.next(-4))
