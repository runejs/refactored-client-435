...
public class SoundSystem {
	...
	public static void clearObjectSounds() {
		for (ObjectSound class40_sub2 = (ObjectSound) SoundSystem.objectSounds.peekFront((byte) -90); class40_sub2 != null; class40_sub2 = (ObjectSound) SoundSystem.objectSounds.next(-4)) {
