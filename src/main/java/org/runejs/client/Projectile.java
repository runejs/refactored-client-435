...
public class Projectile extends Renderable {
    ...
    public static void method763(Component arg0, CacheArchive arg2) {
        if(!MovedStatics.aBoolean2083) {
            ...
            MovedStatics.tabHighlightImageTopRightEdge = MovedStatics.tabHighlightImageTopLeftEdge.method691();
            MovedStatics.tabHighlightImageTopRightEdge.flipHorizontal();
            WallDecoration.tabHighlightImageTopRight = GameShell.tabHighlightImageTopLeft.method691();
            WallDecoration.tabHighlightImageTopRight.flipHorizontal();
            Renderable.tabHighlightImageBottomLeftEdge = MovedStatics.tabHighlightImageTopLeftEdge.method691();
            Renderable.tabHighlightImageBottomLeftEdge.flipVertical();
            MovedStatics.tabHighlightImageBottomLeft = GameShell.tabHighlightImageTopLeft.method691();
            MovedStatics.tabHighlightImageBottomLeft.flipVertical();
            MovedStatics.tabHighlightImageBottomMiddle = Class35.tabHighlightImageTopMiddle.method691();
            MovedStatics.tabHighlightImageBottomMiddle.flipVertical();
            ISAAC.tabHighlightImageBottomRightEdge = MovedStatics.tabHighlightImageTopLeftEdge.method691();
            ISAAC.tabHighlightImageBottomRightEdge.flipHorizontal();
            ISAAC.tabHighlightImageBottomRightEdge.flipVertical();
            Class13.tabHighlightImageBottomRight = GameShell.tabHighlightImageTopLeft.method691();
