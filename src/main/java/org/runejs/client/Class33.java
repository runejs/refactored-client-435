        ...
        for(int i = -1; Player.localPlayerCount + Player.npcCount > i; i++) {
            ...
            if(actor != null && actor.isInitialized()) {
                ...
                if(Player.localPlayerCount <= i) {
                    ...
                    if(Player.headIconDrawType == 1 && MovedStatics.hintIconNpcTarget == Player.npcIds[-Player.localPlayerCount + i] && MovedStatics.pulseCycle % 20 < 10) {
                        Point2d screenPos = MovedStatics.getProjectedScreenPosition(actor.anInt3117 + 15, actor.worldY, actor.worldX);
                        if(screenPos != null)
                    ...
                    if(i >= 0 && Player.headIconDrawType == 10 && MovedStatics.hintIconPlayerTarget == Player.trackedPlayerIndices[i]) {
                        Point2d screenPos = MovedStatics.getProjectedScreenPosition(actor.anInt3117 + 15, actor.worldY, actor.worldX);
