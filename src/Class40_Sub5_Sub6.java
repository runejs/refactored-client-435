...
public class Class40_Sub5_Sub6 extends SubNode {
    ...
    public static boolean method583(int arg0, int arg1, int arg2, byte arg3,
        ...
        try {
            ...
            if (arg3 != -5)
                return true;
            return Main.method36(arg5, arg0, arg4, 0, -1, arg2, arg6, 0,
            ...
            if (arg0 == -12) {
                ...
                for (; ; ) {
                    Class40_Sub11 class40_sub11
                            = ((Class40_Sub11)
                            Class54.aClass45_1278.method902((byte) -90));
                    if (class40_sub11 == null)
                        break;
                    boolean bool = false;
                    for (int i = 0; ((class40_sub11.anInt2160 ^ 0xffffffff)
                            < (i ^ 0xffffffff)); i++) {
                        if (class40_sub11.aClass15Array2157[i] != null) {
                            if ((class40_sub11.aClass15Array2157[i].anInt434
                                    ^ 0xffffffff)
                                    == -3)
                        ...
                        if (class40_sub11.aClass15Array2156[i] != null) {
                            if (class40_sub11.aClass15Array2156[i].anInt434
                                    == 2)
                    ...
                    for (int i_0_ = 0; class40_sub11.anInt2160 > i_0_;
                         i_0_++) {
                        if ((class40_sub11.anIntArray2155[i_0_] ^ 0xffffffff)
                                != -1)
                            arg2.put(class40_sub11.anIntArray2155[i_0_],
                                    (byte) -128);
                        else {
                            try {
                                int i_1_ = class40_sub11.anIntArray2154[i_0_];
                                if (i_1_ == 0) {
                                    Field field = (Field) (class40_sub11
                                            .aClass15Array2157
                                            [i_0_].anObject437);
            ...
            if (arg0 == 2) {
                while (Class34.method416((byte) -125)) {
                    if (Class66.anInt1560 != -1
                            ...
                            == (Class66.anInt1548 ^ 0xffffffff))) {
                        if ((ItemDefinition.anInt2854 ^ 0xffffffff) == -86
                                && (Class66.aClass1_1550.method59(arg0 ^ ~0xc3d)
                                > 0))
                            Class66.aClass1_1550
                                    = (Class66.aClass1_1550.method68
                                    (0, 0, -1 + Class66.aClass1_1550
                                            .method59(-3136)));
                        if ((Class40_Sub5_Sub15.method735((byte) -37,
                                Class59.anInt1388)
                                || Class59.anInt1388 == 32)
                                && Class66.aClass1_1550.method59(-3136) < 12)
                            Class66.aClass1_1550
                                    = Class66.aClass1_1550
                                    .method70(Class59.anInt1388, 0);
                    } else if (!Class19.aBoolean490) {
                        if (Class40_Sub5_Sub15.anInt2780 == 1) {
                            if (((ItemDefinition.anInt2854 ^ 0xffffffff)
                                    == -86)
                                    && (Class66.aClass1_1543.method59(-3136)
                                    ^ 0xffffffff) < -1) {
                                Class66.aClass1_1543
                                        = (Class66.aClass1_1543.method68
                                        (arg0 + -2, 0,
                                                (Class66.aClass1_1543.method59(-3136)
                                                        - 1)));
                                Class52.aBoolean1221 = true;
                            }
                            if (Class66.method1027(Class59.anInt1388, -58)
                                    && Class66.aClass1_1543.method59(-3136) < 10) {
                                Class66.aClass1_1543
                                        = Class66.aClass1_1543
                                        .method70(Class59.anInt1388, 0);
                                Class52.aBoolean1221 = true;
                            ...
                            if (ItemDefinition.anInt2854 == 84) {
                                if (Class66.aClass1_1543.method59(-3136) > 0) {
                                    Buffer.anInt1937++;
                                    int i = 0;
                                    if (Class66.aClass1_1543
                                            .method82(arg0 + 105))
                                        i = Class66.aClass1_1543
                                                .method52((byte) -34);
                            ...
                            if ((Class40_Sub5_Sub15.anInt2780 ^ 0xffffffff)
                                    == -4) {
                                if ((ItemDefinition.anInt2854
                                        ^ 0xffffffff) == -86
                                        && (Class66.aClass1_1543.method59(-3136)
                                        ^ 0xffffffff) < -1) {
                                    Class66.aClass1_1543
                                            = (Class66.aClass1_1543.method68
                                            (0, 0, -1 + Class66.aClass1_1543
                                                    .method59(-3136)));
                                    Class52.aBoolean1221 = true;
                                }
                                if ((Player.method793
                                        ((byte) 122, Class59.anInt1388))
                                        && (Class66.aClass1_1543.method59(-3136)
                                        ^ 0xffffffff) > -41) {
                                    Class66.aClass1_1543
                                            = Class66.aClass1_1543
                            ...
                            } else if ((Class43.anInt1028 ^ 0xffffffff) == 0
                                    && (NpcDefinition.anInt2433
                                    ^ 0xffffffff) == 0) {
                                if ((ItemDefinition.anInt2854
                                        ^ 0xffffffff) == -86
                                        && (Class66.aClass1_1556.method59(-3136)
                                        > 0)) {
                                    Class66.aClass1_1556
                                            = (Class66.aClass1_1556.method68
                                            (0, 0,
                                                    Class66.aClass1_1556
                                                            .method59(arg0 + -3138) - 1));
                                    Class52.aBoolean1221 = true;
                                }
                                if ((Player.method793
                                        ((byte) 124, Class59.anInt1388))
                                        && Class66.aClass1_1556
                                        .method59(arg0 ^ ~0xc3d) < 80) {
                                    Class66.aClass1_1556
                                            = (Class66.aClass1_1556.method70
                                            (Class59.anInt1388, arg0 + -2));
                                    Class52.aBoolean1221 = true;
                                }
                                if (ItemDefinition.anInt2854 == 84
                                        && (Class66.aClass1_1556.method59(-3136)
                                    ...
                                    if (Class19.anInt493 == 2) {
                                        if (Class66.aClass1_1556.method54
                                                (Class58.aClass1_1359, arg0 + 120))
                                            Class59.method982(2578);
                                        if (Class66.aClass1_1556.method54
                                                (Class40_Sub3.aClass1_2015, 122))
                                            Class19.aBoolean496 = true;
                                        if (Class66.aClass1_1556.method54
                                                (Class40_Sub11.aClass1_2164, 122))
                                            Class19.aBoolean496 = false;
                                        if (Class66.aClass1_1556.method54
                                                (Class40_Sub5_Sub2.aClass1_2290,
                                                        arg0 ^ 0x78)) {
                                            for (int i = 0; i < 4; i++) {
                                                for (int i_9_ = 1;
                                                     ((i_9_ ^ 0xffffffff)
                                        ...
                                        if ((Class66.aClass1_1556.method54
                                                (Class40_Sub5_Sub12.aClass1_2691,
                                                        122))
                                                && (Class44.modewhere
                                                ^ 0xffffffff) == -3)
                                            throw new RuntimeException();
                                        if (Class66.aClass1_1556.method54
                                                (Class4.aClass1_177, 122))
                                            PacketBuffer.aBoolean2236
                                                    = true;
                                    }
                                    if (!Class66.aClass1_1556.method75
                                            ((byte) 116, Class33.aClass1_786)) {
                                        int i = 0;
                                        Class40_Sub5_Sub4.anInt2362++;
                                        RSString class1 = Class66
                                                .aClass1_1556
                                                .method79(-128);
                                        int i_11_ = 0;
                                        if (class1.method75((byte) 116,
                                                (Class40_Sub5_Sub11
                                                        .aClass1_2620))) {
                                            i_11_ = 0;
                                            Class66.aClass1_1556
                                                        ...
                                                        if (!class1.method75
                                                            ...
                                                            if (!class1
                                                                ...
                                                                if (class1
                                                                    ...
                                                                    Class66
                                                                            .aClass1_1556
                                                                            = (Class66.aClass1_1556.method50
                                                                            ((byte) 95,
                                                                                    (Landscape.aClass1_1181.method59
                                                                                            (arg0
                                                                                                    + -3138))));
                                                                } else if (!class1.method75
                                                                        ((byte) 116,
                                                                                Class40_Sub5_Sub12.aClass1_2671)) {
                                                                    if (class1
                                                                            .method75
                                                                                    ((byte) 116,
                                                                                            (Class51
                                                                        ...
                                                                        Class66
                                                                                .aClass1_1556
                                                                                = Class66.aClass1_1556.method50((byte) 95, Class51.aClass1_1196.method59(-3136));
                                                                        i_11_
                                                                                = 11;
                                                                    }
                                                                } else {
                                                                    Class66
                                                                            ...
                                                                            = (Class66.aClass1_1556.method50
                                                                            ((byte) 95,
                                                                                    Class40_Sub5_Sub12.aClass1_2671.method59(-3136)));
                                                                    i_11_ = 10;
                                                                }
                                                            } else {
                                                                i_11_ = 8;
                                        ...
                                        if (class1.method75((byte) 116,
                                            ...
                                            Class66.aClass1_1556
                                                    ...
                                                    .method50
                                                            ((byte) 95,
                                                                    (Class46.aClass1_1097
                                                                            .method59
                                                                                    (arg0 + -3138))));
                                        } else if (class1.method75
                                                ((byte) 116,
                                                        Class62.aClass1_1474)) {
                                            i = 2;
                                            Class66.aClass1_1556
                                                    = (Class66.aClass1_1556
                                                    .method50
                                        ...
                                        Class32.packetBuffer
                                                .put(i, (byte) -128);
                                        Class68_Sub1.method1052
                                                (65, Class66.aClass1_1556,
                                                        Class32.packetBuffer);
                                        Class32.packetBuffer
                                                .finishVarByte
                                                        ((Class32.packetBuffer
                                                                        .offset) + -i_12_,
                                                                (byte) 16);
                                        if ((Class35.anInt1737 ^ 0xffffffff)
                                                == -3) {
                                            Class34.anInt821++;
                            ...
                            if ((Class40_Sub5_Sub15
                                    .method735((byte) -37, Class59.anInt1388)
                                    || Class59.anInt1388 == 32)
                                    && Class66.aClass1_1543.method59(-3136) < 12) {
                                Class66.aClass1_1543
                                        = (Class66.aClass1_1543.method70
                                        (Class59.anInt1388, arg0 ^ 0x2));
                                Class52.aBoolean1221 = true;
                            }
                            if (ItemDefinition.anInt2854 == 84) {
                                if (Class66.aClass1_1543.method59(-3136) > 0) {
                        ...
                        if ((ItemDefinition.anInt2854 ^ 0xffffffff) == -86
                                && (Class66.aClass1_1565.method59(arg0 ^ ~0xc3d)
                                > 0)) {
                            Class66.aClass1_1565
                                    = (Class66.aClass1_1565.method68
                                    (arg0 ^ 0x2, 0,
                                            -1 + Class66.aClass1_1565
                                                    .method59(arg0 + -3138)));
                            Class52.aBoolean1221 = true;
                        }
                        if (Player
                                .method793((byte) 120, Class59.anInt1388)
                                && (Class66.aClass1_1565.method59(-3136)
                                ^ 0xffffffff) > -81) {
                            Class66.aClass1_1565
                                    = Class66.aClass1_1565
                                    .method70(Class59.anInt1388, arg0 ^ 0x2);
                            Class52.aBoolean1221 = true;
                        }
                        if ((ItemDefinition.anInt2854 ^ 0xffffffff)
                                == -85) {
                            ...
                            if ((Class37.anInt876 ^ 0xffffffff) == -2) {
                                long l = Class66.aClass1_1565
                                        .method58((byte) 104);
                                Class40_Sub5_Sub9.method617(l, (byte) -99);
                            }
                            if ((Class37.anInt876 ^ 0xffffffff) == -3
                            ...
                            if ((Class37.anInt876 ^ 0xffffffff) == -4
                                    && Class66.aClass1_1565.method59(-3136) > 0) {
                                Class44.anInt1044++;
                                ...
                                Class32.packetBuffer.putLong
                                        (PacketBuffer.aLong2241, false);
                                Class68_Sub1.method1052
                                        (119, Class66.aClass1_1565,
                                                Class32.packetBuffer);
                                Class32.packetBuffer.finishVarByte
                                        (-i + (Class32.packetBuffer
                                                        .offset),
                                                (byte) 16);
                            ...
                            if ((Class37.anInt876 ^ 0xffffffff) == -5
                                    && (Class42.anInt1008 ^ 0xffffffff) > -101) {
                                long l = Class66.aClass1_1565
                                        .method58((byte) 107);
                                Class17.method275(arg0 ^ 0x606c, l);
                            }
                            if ((Class37.anInt876 ^ 0xffffffff) == -6
                                    && (Class42.anInt1008 ^ 0xffffffff) < -1) {
                                long l = Class66.aClass1_1565
                                        .method58((byte) 109);
    ...
    public static void method588(int arg0) {
        try {
            if (arg0 == -1) {
                ...
                Rasterizer.method656(1 + i, 1 + i_14_, -2 + i_15_, 16,
                        0);
                Rasterizer.method665(i - -1, 18 + i_14_, -2 + i_15_,
                        -19 + i_13_, 0);
                Class40_Sub5_Sub17_Sub6.aClass40_Sub5_Sub14_Sub1_3246.method690
                        (Class40_Sub5_Sub12.aClass1_2684, i - -3, 14 + i_14_,
                                i_16_);
                ...
                for (int i_19_ = 0; i_19_ < NpcDefinition.anInt2394;
                     i_19_++) {
                    int i_20_
                            = (15 * (-i_19_ + NpcDefinition.anInt2394 + -1)
                            + i_14_ - -31);
                    int i_21_ = 16777215;
                    if ((i_17_ ^ 0xffffffff) < (i ^ 0xffffffff)
                            && i - -i_15_ > i_17_
                            && (i_18_ ^ 0xffffffff) < (-13 + i_20_ ^ 0xffffffff)
                            && (i_20_ - -3 ^ 0xffffffff) < (i_18_ ^ 0xffffffff))
                        i_21_ = 16776960;
                    Class40_Sub5_Sub17_Sub6.aClass40_Sub5_Sub14_Sub1_3246
                            .method683
                                    (Landscape.aClass1Array1184[i_19_], i + 3, i_20_, i_21_,
                                            true);
                }
            }
        } catch (RuntimeException runtimeexception) {
