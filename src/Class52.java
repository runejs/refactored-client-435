...
public class Class52
{
    ...
    public static RSString aClass1_1213 = Class58.method978(-11538, " @whi@(X");
    public static int anInt1214;
    public static volatile boolean aBoolean1215;
    public static RSString aClass1_1216 = Class58.method978(-11538, "New User");
	...
	try {
		...
		arg2.method688(NPC.aClass1_3311, 55,
			       41, 65280, true);
	    if (arg4 == 1)
		arg2.method688(Class40_Sub5_Sub15.aClass1_2786, 55, 41,
			       16776960, true);
	    if (arg4 == 2)
		arg2.method688(Class30.aClass1_682, 55, 41, 16711680, true);
	    if (arg4 == 3)
		arg2.method688(Class40_Sub5_Sub11.aClass1_2622, 55, 41, 65535,
			       true);
	    arg2.method688(RSString.aClass1_1703, 184, 28, 16777215, true);
	    if ((arg3 ^ 0xffffffff) == -1)
		arg2.method688(NPC.aClass1_3311, 184,
			       41, 65280, true);
	    if (arg3 == 1)
		arg2.method688(Class40_Sub5_Sub15.aClass1_2786, 184, 41,
			       16776960, true);
	    if (arg3 == 2)
		...
		arg2.method688(NPC.aClass1_3311, 324,
			       41, 65280, true);
	    if (arg0 == 1)
		arg2.method688(Class40_Sub5_Sub15.aClass1_2786, 324, 41,
			       16776960, true);
	    if ((arg0 ^ 0xffffffff) == -3)
		arg2.method688(Class30.aClass1_682, 324, 41, 16711680, true);
	    arg2.method672(Class22_Sub1.aClass1_1865, 417, 17, 85, 25,
			   16777215, true, 1, 1, 0);
	    int i = -50 % ((arg1 - 82) / 38);
	    try {
    ...
    public static DirectColorSprite[] method944(byte arg0, int arg1,
	...
	if (arg5 != 103)
	    anInt1214 = -81;
	if (arg2 >= 1 && (arg0 ^ 0xffffffff) <= -2
	    && (arg2 ^ 0xffffffff) >= -103 && (arg0 ^ 0xffffffff) >= -103) {
	    if (!Class46.aBoolean1112
		|| Player.anInt3267 == arg7) {
		int i = -1;
		int i_0_ = 0;
		boolean bool = false;
		boolean bool_1_ = false;
		if ((arg6 ^ 0xffffffff) == -1)
		    i_0_ = NPC.aClass2_3301
			       .method122(arg7, arg2, arg0);
		if ((arg6 ^ 0xffffffff) == -2)
		    i_0_ = NPC.aClass2_3301
			       .method91(arg7, arg2, arg0);
		if ((arg6 ^ 0xffffffff) == -3)
		    i_0_ = NPC.aClass2_3301
			       .method110(arg7, arg2, arg0);
		if ((arg6 ^ 0xffffffff) == -4)
		    i_0_ = NPC.aClass2_3301
			       .method93(arg7, arg2, arg0);
		if ((i_0_ ^ 0xffffffff) != -1) {
		    i = (i_0_ & 0x1ffff138) >> -587100850;
		    int i_2_ = NPC.aClass2_3301
				   .method141(arg7, arg2, arg0, i_0_);
		    int i_3_ = i_2_ >> -993918554 & 0x3;
		    int i_4_ = 0x1f & i_2_;
		    if ((arg6 ^ 0xffffffff) == -1) {
			NPC.aClass2_3301
			    .method124(arg7, arg2, arg0);
			Class40_Sub5_Sub8 class40_sub5_sub8
			    = Class40_Sub4.method535(i, (byte) 124);
			if (class40_sub5_sub8.aBoolean2501)
			    Landscape.aClass3Array1167[arg7].method148
				(-4, arg2, i_3_,
				 class40_sub5_sub8.aBoolean2528, arg0, i_4_);
		    }
		    if (arg6 == 1)
			NPC.aClass2_3301
			    .method127(arg7, arg2, arg0);
		    if (arg6 == 2) {
			NPC.aClass2_3301
			    .method135(arg7, arg2, arg0);
			Class40_Sub5_Sub8 class40_sub5_sub8
			    = Class40_Sub4.method535(i, (byte) 122);
			if (((arg2 - -class40_sub5_sub8.anInt2503 ^ 0xffffffff)
			     < -104)
			    || arg0 + class40_sub5_sub8.anInt2503 > 103
			    || arg2 + class40_sub5_sub8.anInt2515 > 103
			    || (class40_sub5_sub8.anInt2515 + arg0
				^ 0xffffffff) < -104)
			    return;
			if (class40_sub5_sub8.aBoolean2501)
			    Landscape.aClass3Array1167[arg7].method149
				(class40_sub5_sub8.aBoolean2528, arg0, arg2,
				 i_3_, class40_sub5_sub8.anInt2503, (byte) -55,
				 class40_sub5_sub8.anInt2515);
		    }
		    if ((arg6 ^ 0xffffffff) == -4) {
			NPC.aClass2_3301
			    .method131(arg7, arg2, arg0);
			Class40_Sub5_Sub8 class40_sub5_sub8
			    = Class40_Sub4.method535(i, (byte) 125);
			if (class40_sub5_sub8.aBoolean2501
			    && class40_sub5_sub8.anInt2546 == 1)
			    Landscape.aClass3Array1167[arg7]
				.method145(arg0, arg5 + 28124, arg2);
		    }
		}
		if (arg1 >= 0) {
		    int i_5_ = arg7;
		    if (i_5_ < 3 && ((Floor
				      .aByteArrayArrayArray2323[1][arg2][arg0])
				     & 0x2) == 2)
			i_5_++;
		    Class40_Sub5_Sub1.method543(Landscape.aClass3Array1167[arg7],
						arg1, i_5_, arg7, arg3,
						(NPC
						 .aClass2_3301),
						-22078, arg4, arg0, arg2);
		}
	    }
	}
    }
    ...
    public static boolean method948(int arg0, int arg1, Class6 arg2,
				    int arg3) {
	try {
	    if (arg3 != -3844)
	...
	aClass1_1230 = Class58.method978(-11538, "headicons_hint");
	anInt1219 = 0;
	aClass1_1234 = Class58.method978(-11538, "Connection timed out)3");
	anInt1233 = 0;
	aClass1_1238
	...
	anInt1214 = 0;
	aClass1_1241 = Class58.method978(-11538, "Lade Wordpack )2 ");
    }
}
