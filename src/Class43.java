...
public class Class43
{
    ...
    public static void method891(Object[] arg0, int arg1, int arg2,
				 Class40_Sub5_Sub12 arg3, int arg4,
				 boolean arg5) {
	try {
	    anInt1015++;
	    int i = 0;
	    Class40_Sub5_Sub1 class40_sub5_sub1
		= Class40_Sub5_Sub10.method626(((Integer) arg0[0]).intValue(),
					       76, 27);
	    ...
	    int i_3_ = -1;
	    try {
		SubNode.anIntArray2086
		    = new int[class40_sub5_sub1.anInt2271];
		Class51.aClass1Array1204
		    = new RSString[class40_sub5_sub1.anInt2267];
		int i_4_ = 0;
		int i_5_ = 0;
		if (arg5 != false)
		    anInt1020 = -119;
		...
		for (;;) {
			...
			if (i_3_ == 1) {
			    int i_8_ = is[i_2_];
			    Class67.anIntArray1588[i++]
				= Class58.varbitmasks[i_8_];
			    continue;
			}
			if (i_3_ == 2) {
			    int i_9_ = is[i_2_];
			    Class58.varbitmasks[i_9_]
				= Class67.anIntArray1588[--i];
			    continue;
			}
			if ((i_3_ ^ 0xffffffff) == -4) {
			    Class40_Sub11.aClass1Array2153[i_1_++]
				= class40_sub5_sub1.aClass1Array2270[i_2_];
			    continue;
			}
			if (i_3_ == 6) {
			    i_2_ += is[i_2_];
			...
			if ((i_3_ ^ 0xffffffff) == -8) {
			    i -= 2;
			    if ((Class67.anIntArray1588[i] ^ 0xffffffff)
				!= (Class67.anIntArray1588[1 + i]
				    ^ 0xffffffff))
				i_2_ += is[i_2_];
			    continue;
			}
			if (i_3_ == 8) {
			    i -= 2;
			    if ((Class67.anIntArray1588[1 + i] ^ 0xffffffff)
				== (Class67.anIntArray1588[i] ^ 0xffffffff))
				i_2_ += is[i_2_];
			    continue;
			}
			if ((i_3_ ^ 0xffffffff) == -10) {
			    i -= 2;
			    if (Class67.anIntArray1588[1 + i]
				> Class67.anIntArray1588[i])
				i_2_ += is[i_2_];
			    continue;
			}
			...
			if ((i_3_ ^ 0xffffffff) == -22) {
				...
				Class61 class61 = (Class56.aClass61Array1320
						   [--Class29.anInt678]);
				Class51.aClass1Array1204
				    = class61.aClass1Array1430;
				SubNode.anIntArray2086
				    = class61.anIntArray1420;
				i_2_ = class61.anInt1433;
				class40_sub5_sub1
				    = class61.aClass40_Sub5_Sub1_1419;
			...
			if (i_3_ == 25) {
			    int i_10_ = is[i_2_];
			    Class67.anIntArray1588[i++]
				= Class40_Sub5_Sub6.method585(i_10_, 1369);
			    continue;
			}
			if (i_3_ == 27) {
			    int i_11_ = is[i_2_];
			    Class40_Sub2.method522(Class67.anIntArray1588[--i],
						   i_11_, (byte) 118);
			    continue;
			}
			...
			if (i_3_ == 33) {
			    Class67.anIntArray1588[i++]
				= SubNode.anIntArray2086[is[i_2_]];
			    continue;
			}
			if (i_3_ == 34) {
			    SubNode.anIntArray2086[is[i_2_]]
			...
			if (i_3_ == 35) {
			    Class40_Sub11.aClass1Array2153[i_1_++]
				= Class51.aClass1Array1204[is[i_2_]];
			    continue;
			}
			...
			if ((i_3_ ^ 0xffffffff) == -38) {
			    int i_12_ = is[i_2_];
			    i_1_ -= i_12_;
			    RSString class1 = (Class40_Sub5_Sub10.method627
					     (63, i_12_, i_1_,
					      Class40_Sub11.aClass1Array2153));
			...
			if (i_3_ == 40) {
				...
				= Class40_Sub5_Sub10.method626(i_13_, 73, 65);
			    int[] is_15_
				= new int[class40_sub5_sub1_14_.anInt2271];
			    RSString[] class1s
				= new RSString[class40_sub5_sub1_14_.anInt2267];
			    for (int i_16_ = 0;
				 ((class40_sub5_sub1_14_.anInt2263
				   ^ 0xffffffff)
				  < (i_16_ ^ 0xffffffff));
				 i_16_++)
				is_15_[i_16_]
				    = (Class67.anIntArray1588
				       [i - (class40_sub5_sub1_14_.anInt2263
					     + -i_16_)]);
			    for (int i_17_ = 0;
				 class40_sub5_sub1_14_.anInt2266 > i_17_;
				 i_17_++)
				class1s[i_17_]
				    = (Class40_Sub11.aClass1Array2153
			    ...
			    Class56.aClass61Array1320[Class29.anInt678++]
				= class61;
			    is = class40_sub5_sub1.anIntArray2262;
			...
			if ((i_3_ ^ 0xffffffff) == -43) {
			    Class67.anIntArray1588[i++]
				= Class22_Sub1.anIntArray1847[is[i_2_]];
			    continue;
			}
			...
			if ((i_3_ ^ 0xffffffff) == -101) {
				...
				= Class68.method1045(i_18_, (byte) -108);
			    if (class40_sub5_sub12.aClass40_Sub5_Sub12Array2713
				== null)
				class40_sub5_sub12.aClass40_Sub5_Sub12Array2713
				    = new Class40_Sub5_Sub12[1 + i_20_];
			    if ((i_20_ ^ 0xffffffff)
				<= ((class40_sub5_sub12
				     .aClass40_Sub5_Sub12Array2713).length
				    ^ 0xffffffff)) {
			    ...
			    Class40_Sub5_Sub12 class40_sub5_sub12_22_
				= new Class40_Sub5_Sub12();
			    class40_sub5_sub12_22_.anInt2648
				= class40_sub5_sub12.anInt2689;
			    class40_sub5_sub12_22_.anInt2683 = i_19_;
			    class40_sub5_sub12_22_.anInt2689
				= ((0xffff & class40_sub5_sub12.anInt2689)
				   << -1708169617) + (-2147483648 + i_20_);
			    class40_sub5_sub12.aClass40_Sub5_Sub12Array2713
				[i_20_]
				= class40_sub5_sub12_22_;
			    if (!bool)
				Class22_Sub2.aClass40_Sub5_Sub12_1887
				    = class40_sub5_sub12_22_;
			    else
				Class40_Sub6.aClass40_Sub5_Sub12_2116
				    = class40_sub5_sub12_22_;
			} else if (i_3_ == 101) {
			    Class40_Sub5_Sub12 class40_sub5_sub12
				= (!bool
				   ? Class22_Sub2.aClass40_Sub5_Sub12_1887
				   : Class40_Sub6.aClass40_Sub5_Sub12_2116);
			    Class40_Sub5_Sub12 class40_sub5_sub12_23_
				= Class68.method1045((class40_sub5_sub12
						      .anInt2648),
						     (byte) -100);
			    class40_sub5_sub12_23_
				.aClass40_Sub5_Sub12Array2713
				[Class66.method1021((class40_sub5_sub12
						     .anInt2689),
						    32767)]
				= null;
			} else {
				...
				break;
			    Class40_Sub5_Sub12 class40_sub5_sub12
				= Class68.method1045((Class67.anIntArray1588
						      [--i]),
						     (byte) -83);
			    class40_sub5_sub12.aClass40_Sub5_Sub12Array2713
				= null;
			}
		    } else if (((i_3_ ^ 0xffffffff) <= -1001
				&& (i_3_ ^ 0xffffffff) > -1101)
			       || ((i_3_ ^ 0xffffffff) <= -2001
				   && i_3_ < 2100)) {
			Class40_Sub5_Sub12 class40_sub5_sub12;
			if (i_3_ >= 2000) {
			    class40_sub5_sub12
			    ...
			    class40_sub5_sub12
				= (bool ? Class40_Sub6.aClass40_Sub5_Sub12_2116
				   : Class22_Sub2.aClass40_Sub5_Sub12_1887);
			if ((i_3_ ^ 0xffffffff) == -1001) {
			    i -= 2;
		    ...
		    } else if ((i_3_ ^ 0xffffffff) <= -1101 && i_3_ < 1200
			       || ((i_3_ ^ 0xffffffff) <= -2101
				   && (i_3_ ^ 0xffffffff) > -2201)) {
			Class40_Sub5_Sub12 class40_sub5_sub12;
			...
			if (i_3_ == 1100) {
			    ...
			    class40_sub5_sub12.aBoolean2645
				= Class67.anIntArray1588[--i] == 1;
			else if ((i_3_ ^ 0xffffffff) == -1104)
			    class40_sub5_sub12.anInt2745
				= Class67.anIntArray1588[--i];
			else if ((i_3_ ^ 0xffffffff) == -1105)
			    i--;
			else if (i_3_ == 1105)
			    class40_sub5_sub12.anInt2744
				= Class67.anIntArray1588[--i];
			else if ((i_3_ ^ 0xffffffff) == -1107)
			    class40_sub5_sub12.anInt2751
				= Class67.anIntArray1588[--i];
			else if ((i_3_ ^ 0xffffffff) == -1108)
			    class40_sub5_sub12.aBoolean2641
				= ((Class67.anIntArray1588[--i] ^ 0xffffffff)
				   == -2);
			else if (i_3_ == 1108) {
			    ...
			    i -= 6;
			    class40_sub5_sub12.anInt2737
				= Class67.anIntArray1588[i];
			    class40_sub5_sub12.anInt2679
				= Class67.anIntArray1588[1 + i];
			    class40_sub5_sub12.anInt2690
				= Class67.anIntArray1588[i - -2];
			    class40_sub5_sub12.anInt2657
				= Class67.anIntArray1588[3 + i];
			    class40_sub5_sub12.anInt2725
				= Class67.anIntArray1588[4 + i];
			    class40_sub5_sub12.anInt2728
				= Class67.anIntArray1588[5 + i];
			} else if ((i_3_ ^ 0xffffffff) == -1111)
			    class40_sub5_sub12.anInt2659
				= Class67.anIntArray1588[--i];
			else if (i_3_ == 1111)
			    class40_sub5_sub12.aBoolean2701
				= ((Class67.anIntArray1588[--i] ^ 0xffffffff)
				   == -2);
			else if (i_3_ == 1112)
		    ...
		    } else if ((i_3_ < 1200 || (i_3_ ^ 0xffffffff) <= -1301)
			       && ((i_3_ ^ 0xffffffff) > -2201
				   || i_3_ >= 2300)) {
			if ((i_3_ < 1300 || (i_3_ ^ 0xffffffff) <= -1401)
			    && ((i_3_ ^ 0xffffffff) > -2301
				|| (i_3_ ^ 0xffffffff) <= -2401)) {
			    if (i_3_ < 1500) {
				if (i_3_ == 1400) {
				    i -= 2;
					...
					if (!bool)
					    Class22_Sub2
						.aClass40_Sub5_Sub12_1887
						= (class40_sub5_sub12
						   .aClass40_Sub5_Sub12Array2713
						   [i_28_]);
					else
					    Class40_Sub6
						.aClass40_Sub5_Sub12_2116
						= (class40_sub5_sub12
						   .aClass40_Sub5_Sub12Array2713
						   [i_28_]);
				    }
					...
					= (Class27.method361
					   ((Class59
					     .aClass40_Sub5_Sub12ArrayArray1390
					     [i_30_]),
					    i_31_, true, 0, -1, 0, i_32_,
					    398));
				...
				if (i_3_ == 1500)
				    ...
				    Class67.anIntArray1588[i++]
					= (!class40_sub5_sub12.aBoolean2750 ? 0
					   : 1);
				else {
				    if ((i_3_ ^ 0xffffffff) != -1506)
					break;
				    Class67.anIntArray1588[i++]
					= class40_sub5_sub12.anInt2648;
				}
				...
				if ((i_3_ ^ 0xffffffff) > -2501) {
					...
					int i_40_
					    = Class67.anIntArray1588[i - -2];
					Class40_Sub5_Sub12 class40_sub5_sub12_41_
					    = (Class27.method361
					       ((Class59
						 .aClass40_Sub5_Sub12ArrayArray1390
						 [(class40_sub5_sub12.anInt2689
						...
						i_40_, false,
						class40_sub5_sub12.anInt2731,
						0xffff & (class40_sub5_sub12
							  .anInt2689),
						class40_sub5_sub12.anInt2746,
						i_39_, 398));
					if (class40_sub5_sub12_41_ != null)
					    Class67.anIntArray1588[i++]
						= (class40_sub5_sub12_41_
						   .anInt2689);
					else
					    Class67.anIntArray1588[i++] = -1;
				    }
					...
					if (i_3_ < 3100) {
					    ...
					    RSString class1
						= (Class40_Sub11
						   .aClass1Array2153[--i_1_]);
					    Class44.method895(84, 0, class1,
							      (Landscape
							       .aClass1_1183));
					} else {
					    if (i_3_ != 3101)
				...
				class40_sub5_sub12
				    = (!bool
				       ...
				       : (Class40_Sub6
					  .aClass40_Sub5_Sub12_2116));
			    if ((i_3_ ^ 0xffffffff) <= -1301 && i_3_ <= 1309
				|| i_3_ >= 1314 && i_3_ <= 1317) {
				RSString class1
				    = Class40_Sub11.aClass1Array2153[--i_1_];
				Object[] objects
				    = new Object[class1.method59(-3136) - -1];
				for (int i_84_ = objects.length - 1;
				     (i_84_ ^ 0xffffffff) <= -2; i_84_--) {
				    if (class1.method55(-1 + i_84_, arg5)
					!= 115)
					objects[i_84_]
					    = new Integer(Class67
							  .anIntArray1588
				...
				objects[0]
				    = new Integer(Class67.anIntArray1588[--i]);
				if (i_3_ == 1303)
				    class40_sub5_sub12.anObjectArray2707
					= objects;
				if (i_3_ == 1317)
				    class40_sub5_sub12.anObjectArray2680
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1305)
				    class40_sub5_sub12.anObjectArray2658
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1303)
				    class40_sub5_sub12.anObjectArray2644
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1317)
				    class40_sub5_sub12.anObjectArray2747
					= objects;
				if (i_3_ == 1301)
				    class40_sub5_sub12.anObjectArray2681
					= objects;
				if (i_3_ == 1300)
				    class40_sub5_sub12.anObjectArray2677
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1316)
				    class40_sub5_sub12.anObjectArray2695
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1307)
				    class40_sub5_sub12.anObjectArray2669
					= objects;
				if ((i_3_ ^ 0xffffffff) == -1306)
				    class40_sub5_sub12.anObjectArray2672
					= objects;
				if (i_3_ == 1309)
				    class40_sub5_sub12.anObjectArray2712
					= objects;
				if (i_3_ == 1308)
				    class40_sub5_sub12.anObjectArray2650
					= objects;
				...
				if ((i_85_ ^ 0xffffffff) > -1
				    ...
				    if ((class40_sub5_sub12.aClass1Array2661
					 == null)
					|| (((class40_sub5_sub12
					      .aClass1Array2661).length
					     ^ 0xffffffff)
					    >= (i_85_ ^ 0xffffffff))) {
					RSString[] class1s
					    = new RSString[1 + i_85_];
					if (class40_sub5_sub12.aClass1Array2661
					    != null) {
					    for (int i_86_ = 0;
						 (((class40_sub5_sub12
					...
					class40_sub5_sub12.aClass1Array2661
					    = class1s;
				    }
				    class40_sub5_sub12.aClass1Array2661[i_85_]
					= (Class40_Sub11.aClass1Array2153
					   [--i_1_]);
				}
			    } else if ((i_3_ ^ 0xffffffff) == -1312)
				class40_sub5_sub12.anInt2738
				    = Class67.anIntArray1588[--i];
			    else if (i_3_ == 1312)
				class40_sub5_sub12.aBoolean2694
				    = (Class67.anIntArray1588[--i]
				       ^ 0xffffffff) == -2;
			    else {
			...
			if (i_3_ == 1200) {
				...
				ItemDefinition class40_sub5_sub16
				    = Class44.method897(i_87_, 10);
				class40_sub5_sub12.anInt2687 = 4;
				class40_sub5_sub12.anInt2690
				    = class40_sub5_sub16.anInt2844;
				class40_sub5_sub12.anInt2725
				    = class40_sub5_sub16.anInt2827;
				class40_sub5_sub12.anInt2728
				    = (100 * class40_sub5_sub16.anInt2817
				       / i_88_);
				class40_sub5_sub12.anInt2657
				    = class40_sub5_sub16.anInt2830;
				class40_sub5_sub12.anInt2679
				    = class40_sub5_sub16.anInt2810;
				class40_sub5_sub12.anInt2737
				    = class40_sub5_sub16.anInt2806;
				...
				= Class40_Sub5_Sub13
				      .aClass40_Sub5_Sub17_Sub4_Sub1_2760
				      .aClass30_3282.method374(-20874);
			} else {
			    if (i_3_ != 1203)
				break;
			    Class40_Sub5_Sub12 class40_sub5_sub12_89_
				= (!bool
				   ? Class40_Sub6.aClass40_Sub5_Sub12_2116
				   : Class22_Sub2.aClass40_Sub5_Sub12_1887);
			    class40_sub5_sub12.anInt2738
				= class40_sub5_sub12_89_.anInt2689;
			}
		    }
		}
	...
	try {
		...
		boolean bool
		    = Class40_Sub5_Sub6.method583(0, Class29.anInt673, 261,
						  (byte) -5, 0, 1, 190);
		if (!bool)
		    ISAAC.aBoolean505 = true;
	    } else if ((Class40_Sub5_Sub11.anIntArray2626[Class5.anInt208]
			^ 0xffffffff)
		       != 0) {
		boolean bool
		    = Class40_Sub5_Sub6.method583(0,
						  (Class40_Sub5_Sub11
						   .anIntArray2626
						   [Class5.anInt208]),
						  261, (byte) -5, 0, 1, 190);
		...
		&& (Class40_Sub5_Sub17_Sub1.anInt2983 ^ 0xffffffff) == -2) {
	...
	try {
		...
		if ((NpcDefinition.anInt2433 ^ 0xffffffff) != 0) {
		    ...
		    Floor.anInt2328 = -1;
		    Class13.method243((byte) 89, 0, 765, 503,
				      NpcDefinition.anInt2433, 0,
				      Class13.anInt420, Landscape.anInt1166, 0);
		    ...
		    Floor.anInt2328 = -1;
		    boolean bool = arg0;
		    if (Class13.anInt420 > 4 && Landscape.anInt1166 > 4
			&& Class13.anInt420 < 516
			&& (Landscape.anInt1166 ^ 0xffffffff) > -339) {
			if ((Class66.anInt1560 ^ 0xffffffff) == 0)
			    Class64.method1013(arg0);
			else
			    Class13.method243((byte) 89, 4, 516, 338,
					      Class66.anInt1560, 4,
					      Class13.anInt420,
					      Landscape.anInt1166, 0);
		    }
		    HashTable.anInt573 = Class40_Sub5_Sub17_Sub3.anInt3065;
		    ItemDefinition.anInt2850 = Floor.anInt2328;
		    Class40_Sub5_Sub17_Sub3.anInt3065 = -1;
		    Floor.anInt2328 = -1;
		    if ((Class13.anInt420 ^ 0xffffffff) < -554
			&& Landscape.anInt1166 > 205 && Class13.anInt420 < 743
			&& (Landscape.anInt1166 ^ 0xffffffff) > -467) {
			if ((Class29.anInt673 ^ 0xffffffff) != 0)
			    Class13.method243((byte) 89, 205, 743, 466,
					      Class29.anInt673, 553,
					      Class13.anInt420,
					      Landscape.anInt1166, 1);
		    ...
		    Floor.anInt2328 = -1;
		    if (Class40_Sub5_Sub17_Sub3.anInt3065
			!= Class25.anInt614) {
			Class25.anInt614 = Class40_Sub5_Sub17_Sub3.anInt3065;
			ISAAC.aBoolean505 = true;
		    }
		    Class40_Sub5_Sub17_Sub3.anInt3065 = -1;
		    if (Class13.anInt420 > 17
			&& (Landscape.anInt1166 ^ 0xffffffff) < -358
			&& Class13.anInt420 < 496
			&& (Landscape.anInt1166 ^ 0xffffffff) > -454) {
			if ((anInt1028 ^ 0xffffffff) == 0) {
			    if ((Class48.anInt1138 ^ 0xffffffff) == 0) {
				if (Landscape.anInt1166 < 434
				    && Class13.anInt420 < 426)
				    Class40_Sub11.method873(-17 + (Class13
								   .anInt420),
							    (Landscape.anInt1166
							     + -357),
							    45);
			    } else
				Class13.method243((byte) 89, 357, 496, 453,
						  Class48.anInt1138, 17,
						  Class13.anInt420,
						  Landscape.anInt1166, 3);
			} else
			    Class13.method243((byte) 89, 357, 496, 453,
					      anInt1028, 17, Class13.anInt420,
					      Landscape.anInt1166, 2);
		    }
		    if (((anInt1028 ^ 0xffffffff) != 0
			 || (Class48.anInt1138 ^ 0xffffffff) != 0)
			&& ((Floor.anInt2328 ^ 0xffffffff)
			    != (Class55.anInt1296 ^ 0xffffffff))) {
			Class52.aBoolean1221 = true;
			Class55.anInt1296 = Floor.anInt2328;
		    }
		    if (((anInt1028 ^ 0xffffffff) != 0
			 || Class48.anInt1138 != -1)
			&& ((Class67.anInt1586 ^ 0xffffffff)
			    != (Class40_Sub5_Sub17_Sub3.anInt3065
				^ 0xffffffff))) {
			Class52.aBoolean1221 = true;
		    ...
		    while (!bool) {
			bool = true;
			for (int i = 0; -1 + NpcDefinition.anInt2394 > i;
			     i++) {
			    if (Class38.anIntArray884[i] < 1000
				&& ((Class38.anIntArray884[1 + i] ^ 0xffffffff)
				    < -1001)) {
				bool = false;
				RSString class1 = Landscape.aClass1Array1184[i];
				Landscape.aClass1Array1184[i]
				    = Landscape.aClass1Array1184[i - -1];
				Landscape.aClass1Array1184[i + 1] = class1;
				int i_90_ = Class38.anIntArray884[i];
				Class38.anIntArray884[i]
				    = Class38.anIntArray884[i - -1];
				Class38.anIntArray884[i + 1] = i_90_;
				i_90_ = Class19.anIntArray483[i];
				Class19.anIntArray483[i]
				    = Class19.anIntArray483[1 + i];
				Class19.anIntArray483[1 + i] = i_90_;
				i_90_ = Class59.anIntArray1393[i];
				Class59.anIntArray1393[i]
				    = Class59.anIntArray1393[1 + i];
				Class59.anIntArray1393[i + 1] = i_90_;
				i_90_ = Class33.anIntArray791[i];
				Class33.anIntArray791[i]
				    = Class33.anIntArray791[i - -1];
