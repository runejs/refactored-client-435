...
public class Class5
{
    ...
    public static void method162(int arg0, int arg1, int arg2, int arg3,
				 ...
				 byte[] arg8, Class3[] arg9) {
	try {
	    if (arg1 != 13941)
		method162(53, -59, 8, -121, -68, -3, -42, -91, null, null);
	    for (int i = 0; (i ^ 0xffffffff) > -9; i++) {
		for (int i_0_ = 0; (i_0_ ^ 0xffffffff) > -9; i_0_++) {
		    if ((arg5 + i ^ 0xffffffff) < -1
			&& (i + arg5 ^ 0xffffffff) > -104 && arg0 + i_0_ > 0
			&& i_0_ + arg0 < 103)
			arg9[arg4].anIntArrayArray150[arg5 + i][i_0_ + arg0]
			    = Class66.method1021((arg9[arg4].anIntArrayArray150
						  [arg5 + i][i_0_ + arg0]),
						 -16777217);
		}
	    }
		...
		for (int i_1_ = 0; (i_1_ ^ 0xffffffff) > -65; i_1_++) {
			...
			if ((arg3 ^ 0xffffffff) == (i ^ 0xffffffff)
			    && i_1_ >= arg2 && 8 + arg2 > i_1_ && i_2_ >= arg6
			    && 8 + arg6 > i_2_)
			    Class48.method922
				(arg5 + Class24.method338(arg7, false,
							  i_1_ & 0x7,
							  i_2_ & 0x7),
				 arg7, class40_sub1, arg1 ^ ~0x363e,
				 arg0 - -Class33.method410(i_1_ & 0x7,
							   0x7 & i_2_, arg7,
							   false),
				 0, 0, arg4);
			else
			    Class48.method922(-1, 0, class40_sub1, -116, -1, 0,
					      0, 0);
		    }
		}
	    }
	...
	try {
	    Class40_Sub5_Sub17.method754(arg0 + 29378,
					 NpcDefinition.anInt2433);
	    anInt205++;
	    if (arg0 != (Class40_Sub5_Sub9.anInt2562 ^ 0xffffffff))
		Class40_Sub5_Sub17.method754(arg0 + 29378,
					     Class40_Sub5_Sub9.anInt2562);
	    anInt199 = 0;
	    Class68_Sub1.aClass68_2213.method1046((byte) 90);
	    Player.anIntArray3284
		= R3D
		      .method708(Player.anIntArray3284);
	    Rasterizer.method663();
	    Class40_Sub5_Sub6.method583(0, NpcDefinition.anInt2433, 503,
					(byte) -5, 0, 0, 765);
	    if (Class40_Sub5_Sub9.anInt2562 != -1)
		Class40_Sub5_Sub6.method583(0, Class40_Sub5_Sub9.anInt2562,
					    503, (byte) -5, 0, 0, 765);
	...
	int i_4_ = (Class37.method430((byte) -121,
				      Player.anInt3267,
				      i_3_, i)
		    + -anInt194);
	if ((i_3_ ^ 0xffffffff) < (Class12.anInt388 ^ 0xffffffff)) {
	    Class12.anInt388
		+= (Class59.anInt1386 * (i_3_ + -Class12.anInt388) / 1000
		    + Class4.anInt188);
	...
	if ((i_4_ ^ 0xffffffff) < (Class32.anInt769 ^ 0xffffffff)) {
	    Class32.anInt769
		+= (Class59.anInt1386 * (i_4_ - Class32.anInt769) / 1000
		    + Class4.anInt188);
	    if ((i_4_ ^ 0xffffffff) > (Class32.anInt769 ^ 0xffffffff))
	...
	if ((Class12.anInt388 ^ 0xffffffff) < (i_3_ ^ 0xffffffff)) {
	    Class12.anInt388
		-= Class4.anInt188 - -(Class59.anInt1386
				       * (Class12.anInt388 + -i_3_) / 1000);
	...
	if (Class32.anInt769 > i_4_) {
	    Class32.anInt769
		-= ((Class32.anInt769 + -i_4_) * Class59.anInt1386 / 1000
		    + Class4.anInt188);
	    if ((i_4_ ^ 0xffffffff) < (Class32.anInt769 ^ 0xffffffff))
		Class32.anInt769 = i_4_;
	}
	...
	i_4_ = Class37.method430((byte) -125,
	...
	int i_9_ = 0x7ff & (int) (Math.atan2((double) i_5_, (double) i_8_)
				  * 325.949);
	if (i_9_ < 128)
	    i_9_ = 128;
	int i_10_ = 0x7ff & (int) (-325.949
				   * Math.atan2((double) i_7_, (double) i_6_));
	...
	if ((i_11_ ^ 0xffffffff) < -1) {
		...
		+= Class22_Sub1.anInt1856 * i_11_ / 1000 + Class60.anInt1413;
	    Class68_Sub1.anInt2210 &= 0x7ff;
	}
	if (arg0 > 0) {
	    if (i_11_ < 0) {
		Class68_Sub1.anInt2210
		    -= Class60.anInt1413 - -(Class22_Sub1.anInt1856 * -i_11_
					     / 1000);
		Class68_Sub1.anInt2210 &= 0x7ff;
	    }
	    if (i_9_ > Class26.anInt627) {
		Class26.anInt627
		    += Class60.anInt1413 + (Class22_Sub1.anInt1856
					    * (i_9_ - Class26.anInt627)
					    / 1000);
	    ...
	    if (Class26.anInt627 > i_9_) {
		Class26.anInt627
		    -= (Class22_Sub1.anInt1856 * (Class26.anInt627 + -i_9_)
			/ 1000) + Class60.anInt1413;
		if (Class26.anInt627 < i_9_)
		    Class26.anInt627 = i_9_;
	    }
		...
		i_12_ += 2048;
	    if ((i_12_ ^ 0xffffffff) > -1 && (i_11_ ^ 0xffffffff) < -1
		|| i_12_ > 0 && (i_11_ ^ 0xffffffff) > -1)
	...
	try {
		...
		int i_15_ = (i + -314) / 2;
		int i_16_ = i & 0x1;
		Class45.aClass30_1082
		    .method384(-94, (i_16_ ^ 0xffffffff) == -2, i_15_);
	    }
	    if (arg0 != 88)
		method163((byte) 42);
	    if ((i ^ 0xffffffff) == -325)
		...
		Class45.aClass30_1082
		    .method375(arg0 ^ 0x58, Class32.packetBuffer);
		return true;
	    }
	    if (i == 620)
		...
		if ((Class66.aClass1_1550.method59(arg0 ^ ~0xc67) ^ 0xffffffff)
		    < -1) {
		    Class32.packetBuffer.putPacket(11453, 202);
		    Class46.anInt1096++;
		    Class32.packetBuffer.putLong
			(Class66.aClass1_1550.method58((byte) 102), false);
		    Class32.packetBuffer.put(-601 + i,
							     (byte) -128);
		    Class32.packetBuffer
			.put(Class67.aBoolean1601 ? 1 : 0, (byte) -128);
		}
	    }
	    return false;
	} catch (RuntimeException runtimeexception) {
    ...
    public static void method168(int arg0, int arg1, int arg2, int arg3,
				 byte arg4, Class40_Sub5_Sub12 arg5, int arg6,
				 int arg7, int arg8) {
	try {
	    ...
	    if ((arg6 ^ 0xffffffff) >= (arg2 ^ 0xffffffff) && arg2 < arg6 + 16
		&& arg1 >= arg8 && 16 + arg8 > arg1) {
		arg5.anInt2731 -= NPC.anInt3294 * 4;
		if (arg7 == 1)
		    ISAAC.aBoolean505 = true;
		if (arg7 == 2 || (arg7 ^ 0xffffffff) == -4)
		    Class52.aBoolean1221 = true;
	    } else if ((arg2 ^ 0xffffffff) > (arg6 ^ 0xffffffff)
		       || (arg6 - -16 ^ 0xffffffff) >= (arg2 ^ 0xffffffff)
		       || arg1 < arg8 - -arg0 + -16 || arg1 >= arg8 - -arg0) {
		if (-Landscape.anInt1171 + arg6 <= arg2
		    && (arg2 ^ 0xffffffff) > (16 + (arg6 + Landscape.anInt1171)
					      ^ 0xffffffff)
		    && arg8 - -16 <= arg1 && arg1 < -16 + arg8 + arg0
		    && NPC.anInt3294 > 0) {
