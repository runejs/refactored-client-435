...
public class Class61 {
                ...
                if (Class59.aClass40_Sub5_Sub12ArrayArray1390[arg1] != null) {
                    ...
                    for (int i = 0;
                         ((i ^ 0xffffffff)
                                 ...
                                 ^ 0xffffffff));
                         i++) {
                        if (Class59.aClass40_Sub5_Sub12ArrayArray1390[arg1][i]
                                != null) {
                            if ((Class59.aClass40_Sub5_Sub12ArrayArray1390
                                    [arg1][i].anInt2683)
                                    != 2)
                                Class59.aClass40_Sub5_Sub12ArrayArray1390
                                        [arg1][i]
    ...
    public static void method996(int arg0) {
        try {
            ...
            NpcDefinition.anIntArray2386
                    = R3D
                    .method708(NpcDefinition.anIntArray2386);
        } catch (RuntimeException runtimeexception) {
    ...
    public static void method999(int arg0, byte arg1, int arg2, int arg3,
                                 int arg4) {
        try {
            anInt1434++;
            int i = -112 / ((50 - arg1) / 53);
            for (int i_0_ = arg0;
                 (i_0_ ^ 0xffffffff) >= (arg0 + arg2 ^ 0xffffffff); i_0_++) {
                for (int i_1_ = arg4;
                     (arg3 + arg4 ^ 0xffffffff) <= (i_1_ ^ 0xffffffff);
                     i_1_++) {
                    if (i_1_ >= 0 && (i_1_ ^ 0xffffffff) > -105 && i_0_ >= 0
                            && (i_0_ ^ 0xffffffff) > -105) {
                        Class19.aByteArrayArrayArray492[0][i_1_][i_0_]
                                = (byte) 127;
                        if (arg4 == i_1_ && i_1_ > 0)
                            Class40_Sub6.anIntArrayArrayArray2099[0][i_1_]
                                    [i_0_]
                                    = (Class40_Sub6.anIntArrayArrayArray2099[0]
                                    [-1 + i_1_][i_0_]);
                        if (arg4 + arg3 == i_1_ && (i_1_ ^ 0xffffffff) > -104)
                            Class40_Sub6.anIntArrayArrayArray2099[0][i_1_]
                                    ...
                                    = (Class40_Sub6.anIntArrayArrayArray2099[0]
                                    [i_1_ - -1][i_0_]);
                        if ((arg0 ^ 0xffffffff) == (i_0_ ^ 0xffffffff)
                                && i_0_ > 0)
                            Class40_Sub6.anIntArrayArrayArray2099[0][i_1_]
                                    [i_0_]
                                    = (Class40_Sub6.anIntArrayArrayArray2099[0]
    ...
    public static void method1000(boolean arg0) {
        try {
            if (arg0 == true) {
                anInt1431++;
                for (Class40_Sub5_Sub17_Sub6 class40_sub5_sub17_sub6
                     = ((Class40_Sub5_Sub17_Sub6)
                        Class57.aClass45_1332.method902((byte) -90));
                     class40_sub5_sub17_sub6 != null;
                     class40_sub5_sub17_sub6
                             = ((Class40_Sub5_Sub17_Sub6)
                             Class57.aClass45_1332.method909(-4))) {
                    if (((class40_sub5_sub17_sub6.anInt3239 ^ 0xffffffff)
                            == (Player.anInt3267
                            ^ 0xffffffff))
                            && !class40_sub5_sub17_sub6.aBoolean3237) {
                        if (Node.anInt926
                                >= class40_sub5_sub17_sub6.anInt3230) {
                            class40_sub5_sub17_sub6.method834(8076,
                                    Class5.anInt199);
                            if (class40_sub5_sub17_sub6.aBoolean3237)
                                ...
                                NPC.aClass2_3301
                                        .method134
                                                (class40_sub5_sub17_sub6.anInt3239,
                                                        class40_sub5_sub17_sub6.anInt3244,
                                                        class40_sub5_sub17_sub6.anInt3235,
                                                        class40_sub5_sub17_sub6.anInt3231, 60,
                                                        class40_sub5_sub17_sub6, 0, -1, false);
                        }
                    } else
                        class40_sub5_sub17_sub6.method457(-1);
                }
