        ...
        try {
            ...
            for (int i_1_ = 1; (i_1_ ^ 0xffffffff) > -104; i_1_++) {
                ...
                for (int i_3_ = 1; (i_3_ ^ 0xffffffff) > -104; i_3_++) {
                    if ((0x18 & (Floor.aByteArrayArrayArray2323
                            [arg1][i_3_][i_1_]))
                            == 0)
                        NPC.aClass2_3301
                                .method96(is, i_2_, 512, arg1, i_3_, i_1_);
                    if ((arg1 ^ 0xffffffff) > -4
                            && ((Floor.aByteArrayArrayArray2323
                            [1 + arg1][i_3_][i_1_]) & 0x8
                            ^ 0xffffffff) != -1)
                        NPC.aClass2_3301
                                .method96(is, i_2_, 512, 1 + arg1, i_3_, i_1_);
                    i_2_ += 4;
                }
            }
            Class40_Sub5_Sub13.aClass40_Sub5_Sub14_Sub4_2765.method723();
            int i_4_
                    = ((-10 + (int) (Math.random() * 20.0) + 238 << -838501336)
                    + (228 - -(int) (Math.random() * 20.0) << 1375075344)
                    + (238 - -(int) (20.0 * Math.random())) + -10);
            int i_5_
                    = -10 + ((int) (20.0 * Math.random()) + 238) << 2143047344;
            for (int i_6_ = 1; i_6_ < 103; i_6_++) {
                for (int i_7_ = 1; i_7_ < 103; i_7_++) {
                    if (((Floor.aByteArrayArrayArray2323[arg1]
                            [i_7_][i_6_]) & 0x18
                            ^ 0xffffffff)
                            == -1)
                        Class40_Sub5_Sub17_Sub4.method781(1850, arg1, i_7_,
                                i_4_, i_5_, i_6_);
                    if ((arg1 ^ 0xffffffff) > -4
                            && (0x8 & (Floor.aByteArrayArrayArray2323
                            [1 + arg1][i_7_][i_6_])
                            ^ 0xffffffff) != -1)
                        Class40_Sub5_Sub17_Sub4.method781(1850, 1 + arg1, i_7_,
                                i_4_, i_5_, i_6_);
                }
            }
            ...
            for (int i_8_ = 0; i_8_ < 104; i_8_++) {
                for (int i_9_ = 0; i_9_ < 104; i_9_++) {
                    int i_10_
                            = (NPC.aClass2_3301.method93
                            (Player.anInt3267, i_8_,
                                    i_9_));
                    if (i_10_ != 0) {
                        i_10_ = 0x7fff & i_10_ >> -1684965490;
                        int i_11_ = (Class40_Sub4.method535(i_10_, (byte) 127)
                                .anInt2511);
                        if (i_11_ >= 0) {
                            int i_12_ = i_9_;
                            int i_13_ = i_8_;
                            if ((i_11_ ^ 0xffffffff) != -23 && i_11_ != 29
                                ...
                                for (int i_15_ = 0; (i_15_ ^ 0xffffffff) > -11;
                                    ...
                                    if (i_16_ == 0 && (i_13_ ^ 0xffffffff) < -1
                                            && i_13_ > -3 + i_8_
                                            && ((is_14_[-1 + i_13_][i_12_]
                                            & 0x1280108)
                                            ^ 0xffffffff) == -1)
                                        i_13_--;
                                    if ((i_16_ ^ 0xffffffff) == -2
                                            && i_13_ < 103 && i_13_ < i_8_ + 3
                                            && (is_14_[i_13_ - -1][i_12_]
                                            & 0x1280180) == 0)
                                        i_13_++;
                                    if ((i_16_ ^ 0xffffffff) == -3 && i_12_ > 0
                                            && i_12_ > -3 + i_9_
                                            && ((is_14_[i_13_][i_12_ - 1]
                                            & 0x1280102)
                                            ^ 0xffffffff) == -1)
                                        i_12_--;
                                    if (i_16_ == 3
                            ...
                            Class62.aClass40_Sub5_Sub14_Sub4Array1466
                                    [Class40_Sub5_Sub17_Sub2.anInt3040]
                                    = (Class8.aClass40_Sub5_Sub14_Sub4Array296
                                    [i_11_]);
                            Class40_Sub5_Sub17_Sub4.anIntArray3149
                                    [Class40_Sub5_Sub17_Sub2.anInt3040]
                                    = i_13_;
                            Class45.anIntArray1083[(Class40_Sub5_Sub17_Sub2
                                    .anInt3040)]
                                    = i_12_;
                            Class40_Sub5_Sub17_Sub2.anInt3040++;
                        }
    ...
    public static void method305(byte arg0) {
        do {
            try {
                ...
                anInt539++;
                Class5.anIntArray198
                        = R3D.method708(Class5.anIntArray198);
                if (arg0 > 2)
                    break;
                method305((byte) 88);
            } catch (RuntimeException runtimeexception) {
    ...
    public static RSString method307(Buffer arg0, int arg1, int arg2) {
        try {
            ...
            try {
                ...
                arg0.offset
                        += (Class40_Sub5_Sub10.aClass66_2590.method1023
                        (arg0.payload, class1.anInt1680, 0,
                                class1.aByteArray1692, arg0.offset, -1));
                return class1;
