/* Class40_Sub5_Sub17_Sub1 - Decompiled by JODE
...
public class Class40_Sub5_Sub17_Sub1 extends Class40_Sub5_Sub17 {
    ...
    public static void method758(Class6 arg0, Class6 arg1, Class6 arg2,
                                 byte arg3) {
        do {
            try {
                ...
                Class59.aClass40_Sub5_Sub12ArrayArray1390
                        = (new Class40_Sub5_Sub12
                        [Class40_Sub5_Sub4.aClass6_2349.method175(-82)][]);
                anInt2994++;
                Class68.aBooleanArray1629
                        = (new boolean
    ...
    public static void method759(boolean arg0) {
        try {
            ...
            if((i ^ 0xffffffff)
                    > (Class40_Sub5_Sub8.anInt2558 ^ 0xffffffff)) {
                for(int i_0_ = i; i_0_ < Class40_Sub5_Sub8.anInt2558; i_0_++)
                    Class6.anIntArray225[Class17.anInt460++]
                            = Class40_Sub3.anIntArray2016[i_0_];
            }
            ...
            if(arg0 == false) {
                for(int i_1_ = 0; i_1_ < i; i_1_++) {
                    ...
                    NPC class40_sub5_sub17_sub4_sub2
                            ...
                            [i_2_]);
                    int i_3_
                            = Cache.outgoingbuffer.putBits(1,
                            (byte) -65);
                    if(i_3_ == 0) {
                        Class40_Sub3.anIntArray2016
                                [Class40_Sub5_Sub8.anInt2558++]
                                = i_2_;
                        class40_sub5_sub17_sub4_sub2.anInt3134
                                = Node.anInt926;
                    } else {
                        int i_4_ = Cache.outgoingbuffer
                                .putBits(2, (byte) -65);
                        if((i_4_ ^ 0xffffffff) == -1) {
                            ...
                            class40_sub5_sub17_sub4_sub2.anInt3134
                                    = Node.anInt926;
                            Class24.anIntArray578
                                    [Class40_Sub5_Sub17_Sub4.anInt3153++]
                                    = i_2_;
                            ...
                            class40_sub5_sub17_sub4_sub2.anInt3134
                                    = Node.anInt926;
                            int i_5_ = Cache.outgoingbuffer
                                    .putBits(3, (byte) -65);
                            class40_sub5_sub17_sub4_sub2
                                    .method782(i_5_, (byte) -96, false);
                            int i_6_ = Cache.outgoingbuffer
                                    .putBits(1, (byte) -65);
                            if(i_6_ == 1)
                                Class24.anIntArray578
                                        [Class40_Sub5_Sub17_Sub4.anInt3153++]
                            ...
                            class40_sub5_sub17_sub4_sub2.anInt3134
                                    = Node.anInt926;
                            int i_7_ = Cache.outgoingbuffer
                                    .putBits(3, (byte) -65);
                            class40_sub5_sub17_sub4_sub2
                                    .method782(i_7_, (byte) -96, true);
                            int i_8_ = Cache.outgoingbuffer
                                    .putBits(3, (byte) -65);
                            class40_sub5_sub17_sub4_sub2
                                    .method782(i_8_, (byte) -96, true);
                            int i_9_ = Cache.outgoingbuffer
                                    .putBits(1, (byte) -65);
                            if(i_9_ == 1)
                                Class24.anIntArray578
                                        [Class40_Sub5_Sub17_Sub4.anInt3153++]
    ...
    public static RSFont method760(int arg0, byte arg1,
                                   Class6 arg2, int arg3) {
        try {
            anInt2978++;
    ...
    public Model method756(int arg0) {
        try {
            ...
            Class40_Sub5_Sub2 class40_sub5_sub2
                    = Class37.method431(anInt2962, 13);
            Model class40_sub5_sub17_sub5
                    = class40_sub5_sub2.method549(anInt2982, 2);
    ...
    public static void method762(int arg0, Class40_Sub5_Sub17_Sub4 arg1) {
        try {
            ...
            if(arg0 != (arg1.anInt3113 ^ 0xffffffff)) {
                if(arg1.anInt3137 != -1
                        && (arg1.anInt3137 ^ 0xffffffff) > -32769) {
                    NPC class40_sub5_sub17_sub4_sub2
                            = (Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813
                            [arg1.anInt3137]);
                    if(class40_sub5_sub17_sub4_sub2 != null) {
                        int i = (-class40_sub5_sub17_sub4_sub2.anInt3089
                                + arg1.anInt3089);
                        int i_10_ = (-class40_sub5_sub17_sub4_sub2.anInt3098
                                + arg1.anInt3098);
                ...
                if((arg1.anInt3137 ^ 0xffffffff) <= -32769) {
                    ...
                    if(class40_sub5_sub17_sub4_sub1 != null) {
                        int i_11_ = (arg1.anInt3098
                                - class40_sub5_sub17_sub4_sub1.anInt3098);
                        int i_12_ = (-class40_sub5_sub17_sub4_sub1.anInt3089
                                + arg1.anInt3089);
                        if((i_11_ ^ 0xffffffff) != -1 || i_12_ != 0)
                            arg1.anInt3080 = (int) (Math.atan2((double) i_11_,
                                    (double) i_12_)
                                    * 325.949) & 0x7ff;
                    }
                }
                if((arg1.anInt3148 != 0
                        || (arg1.anInt3100 ^ 0xffffffff) != -1)
                        && ((arg1.anInt3109 ^ 0xffffffff) == -1
                        || (arg1.anInt3074 ^ 0xffffffff) < -1)) {
                    int i = (arg1.anInt3089
                            - 64 * (arg1.anInt3100 - Class26.anInt635
                            - Class26.anInt635));
                    int i_13_
                            = (-((-Class40_Sub5_Sub2.anInt2307 + arg1.anInt3148
                ...
                if((i ^ 0xffffffff) != -1) {
                    ...
                    if(i > 1024) {
                        ...
                        boolean bool = true;
                        if(arg1.anInt3113 > i
                                || ((2048 + -arg1.anInt3113 ^ 0xffffffff)
                                > (i ^ 0xffffffff))) {
                            bool = false;
                            arg1.anInt3118 = arg1.anInt3080;
                        }
                        if((arg1.anInt3077 ^ 0xffffffff) == (arg1.anInt3126
                                ^ 0xffffffff)
                                && ((arg1.anInt3097 ^ 0xffffffff) < -26 || bool)) {
                            if(arg1.anInt3145 != -1)
                        ...
                        boolean bool = true;
                        if(i < arg1.anInt3113
                                || (i ^ 0xffffffff) < (-arg1.anInt3113 + 2048
                                ^ 0xffffffff)) {
                            arg1.anInt3118 = arg1.anInt3080;
                            bool = false;
                        }
                        if(arg1.anInt3077 == arg1.anInt3126
                                && ((arg1.anInt3097 ^ 0xffffffff) < -26 || bool)) {
                            if(arg1.anInt3083 != -1)
    ...
    public static void method763(Component arg0, byte arg1, Class6 arg2) {
        try {
            ...
            if(!SubNode.aBoolean2083) {
                Class25.aClass40_Sub5_Sub14_Sub2_593
                        = Class27.method359(Class27.aClass1_638,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class44.aClass40_Sub5_Sub14_Sub2_1047
                        = Class27.method359(RSString.aClass1_1716,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class34.aClass40_Sub5_Sub14_Sub2_855
                        = Class27.method359(Class46.aClass1_1113,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class57.aClass40_Sub5_Sub14_Sub2_1346
                        = Class27.method359(Class59.aClass1_1395,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class56.aClass40_Sub5_Sub14_Sub2_1329
                        = Class27.method359(Class6.aClass1_256, Class8.aClass1_305,
                        arg2, (byte) -64);
                Buffer.aClass40_Sub5_Sub14_Sub2_1959
                        = Class27.method359(Class10.aClass1_338,
                        Class8.aClass1_305, arg2, (byte) -64);
                RSCanvas.aClass68_64
                        = Class40_Sub5_Sub13.method649(96, 479, arg0, -4875);
                Class44.aClass40_Sub5_Sub14_Sub2_1047.method692(0, 0);
                RSString.aClass68_1665
                        = Class40_Sub5_Sub13.method649(156, 172, arg0, -4875);
                Rasterizer.method663();
                Class34.aClass40_Sub5_Sub14_Sub2_855.method692(0, 0);
                SubNode.aClass68_2091
                        = Class40_Sub5_Sub13.method649(261, 190, arg0, -4875);
                Class25.aClass40_Sub5_Sub14_Sub2_593.method692(0, 0);
                Class40_Sub5_Sub4.aClass68_2350
                        = Class40_Sub5_Sub13.method649(334, 512, arg0, -4875);
                Rasterizer.method663();
                Class66.aClass68_1541
                        = Class40_Sub5_Sub13.method649(50, 496, arg0, -4875);
                RSCanvas.aClass68_59
                        = Class40_Sub5_Sub13.method649(37, 269, arg0, -4875);
                Class19.aClass68_482
                        = Class40_Sub5_Sub13.method649(45, 249, arg0, -4875);
                DirectColorSprite class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class61.aClass1_1440, (byte) 21,
                        Class8.aClass1_305);
                Landscape.aClass68_1185
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                ...
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class43.aClass1_1024, (byte) 21,
                        Class8.aClass1_305);
                Class40_Sub5_Sub1.aClass68_2275
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class8.aClass1_281, (byte) 21,
                        Class8.aClass1_305);
                Class39.aClass68_908
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class53.aClass1_1266, (byte) 21,
                        Class8.aClass1_305);
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Main.aClass1_1788, (byte) 21,
                        Class8.aClass1_305);
                Class40_Sub5_Sub17_Sub6.aClass68_3243
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class58.aClass1_1374, (byte) 21,
                        Class8.aClass1_305);
                Class40_Sub7.aClass68_2123
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class40_Sub5_Sub10.aClass1_2588,
                        (byte) 21, Class8.aClass1_305);
                Class61.aClass68_1441
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class5.aClass1_196, (byte) 21,
                        Class8.aClass1_305);
                Class30.aClass68_714
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                class40_sub5_sub14_sub4.method727(0, 0);
                class40_sub5_sub14_sub4
                        = Class66.method1028(arg2, Class8.aClass1_304, (byte) 21,
                        Class8.aClass1_305);
                Class17.aClass68_462
                        = Class40_Sub5_Sub13.method649((class40_sub5_sub14_sub4
                                .anInt2950),
                        (class40_sub5_sub14_sub4
                                .anInt2951),
                ...
                int i = -80 % ((arg1 - 9) / 40);
                class40_sub5_sub14_sub4.method727(0, 0);
                Class56.aClass40_Sub5_Sub14_Sub2_1315
                        = Class27.method359(SubNode.aClass1_2093,
                        Class8.aClass1_305, arg2, (byte) -64);
                RSApplet.aClass40_Sub5_Sub14_Sub2_1
                        = Class27.method359(Class40_Sub5_Sub17_Sub6.aClass1_3254,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class35.aClass40_Sub5_Sub14_Sub2_1744
                        = Class27.method359(Class64.aClass1_1517,
                        Class8.aClass1_305, arg2, (byte) -64);
                Class40_Sub6.aClass40_Sub5_Sub14_Sub2_2105
                        = Class56.aClass40_Sub5_Sub14_Sub2_1315.method691();
                Class40_Sub6.aClass40_Sub5_Sub14_Sub2_2105.method695();
                Class53.aClass40_Sub5_Sub14_Sub2_1270
                        = RSApplet.aClass40_Sub5_Sub14_Sub2_1.method691();
                ...
                Class40_Sub5_Sub15.aClass40_Sub5_Sub14_Sub2Array2776
                        = Class40_Sub5_Sub2.method550(arg2, (byte) -78,
                        (Class40_Sub5_Sub15
                                .aClass1_2787),
                        Class8.aClass1_305);
                ...
                for(int i_14_ = 0; (i_14_ ^ 0xffffffff) > -34; i_14_++) {
                    ...
                    for(int i_17_ = 0; i_17_ < 34; i_17_++) {
                        if(((Class34.aClass40_Sub5_Sub14_Sub2_855
                                .aByteArray2925
                                [(Class34.aClass40_Sub5_Sub14_Sub2_855.anInt2921
                                * i_14_) + i_17_])
                                ^ 0xffffffff)
                                == -1) {
                ...
                for(int i_18_ = 5; i_18_ < 156; i_18_++) {
                    ...
                    for(int i_21_ = 25; i_21_ < 172; i_21_++) {
                        if((Class34.aClass40_Sub5_Sub14_Sub2_855
                                .aByteArray2925
                                [i_21_ + (Class34.aClass40_Sub5_Sub14_Sub2_855
                                .anInt2921) * i_18_]) != 0
                                || i_21_ <= 34 && (i_18_ ^ 0xffffffff) >= -35) {
    ...
    public static int method764(byte arg0) {
        try {
            ...
            if((Class26.anInt627 ^ 0xffffffff) > -311) {
                ...
                if(((Floor.aByteArrayArrayArray2323
                        [Player.anInt3267][i_23_][i_22_])
                        & 0x4)
                        != 0)
                    i = Player.anInt3267;
                int i_24_ = ((Class40_Sub5_Sub13
                        .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3098)
                        >> -1546085145);
                int i_25_ = ((Class40_Sub5_Sub13
            ...
            if(((Floor.aByteArrayArrayArray2323
                    ...
                    .anInt3098) >> -1782384953]
                    [(Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
                    .anInt3089) >> -1953891737])
                    & 0x4)
                    != 0)
                i = Player.anInt3267;
            return i;
    ...
    public void method765(int arg0, int arg1) {
        ...
        if(arg0 >= 35) {
            aDouble2992 += (aDouble2996 * 0.5 * (double) arg1 * (double) arg1
                    + (double) arg1 * aDouble2972);
            aDouble2972 += (double) arg1 * aDouble2996;
            anInt3013 = 0x7ff & (int) (Math.atan2(aDouble3011, aDouble3001)
                    * 325.949) - -1024;
            anInt2976 = 0x7ff & (int) (325.949
                    * Math.atan2(aDouble2972, aDouble2995));
            if(aClass40_Sub5_Sub7_3006 != null) {
                anInt2973 += arg1;
                while((aClass40_Sub5_Sub7_3006.anIntArray2466[anInt2982]
                        ^ 0xffffffff)
                        > (anInt2973 ^ 0xffffffff)) {
                    anInt2973
                            -= aClass40_Sub5_Sub7_3006.anIntArray2466[anInt2982];
                    anInt2982++;
                    if((aClass40_Sub5_Sub7_3006.anIntArray2485.length
                            ^ 0xffffffff)
                            >= (anInt2982 ^ 0xffffffff))
                        anInt2982 = 0;
                }
            }
        }
    ...
    public void method766(int arg0, int arg1, int arg2, int arg3, int arg4) {
        if(!aBoolean2968) {
            ...
            aDouble2993
                    = (double) anInt2984 + (double) anInt2989 * d_32_ / d_33_;
        ...
        aDouble2995
                = Math.sqrt(aDouble3001 * aDouble3001 + aDouble3011 * aDouble3011);
        anInt3005++;
        if(!aBoolean2968)
            aDouble2972
                    = -aDouble2995 * Math.tan((double) anInt2997 * 0.02454369);
        aDouble2996
                = (-aDouble2992 + (double) arg3 - aDouble2972 * d) * 2.0 / (d * d);
        if(arg1 != 0)
            method759(true);
    }
    ...
    public static void method767(int objectId, int type, int rotation, int plane, Class2 class2, int arg4, int localY, int localX, Class3 class3) {
        try {
            anInt3003++;
            if(!Class46.aBoolean1112 || (0x2 & (Floor.aByteArrayArrayArray2323[0][localX][localY]) ^ 0xffffffff) != -1 ||
					((0x10 & (Floor.aByteArrayArrayArray2323[plane][localX][localY]) ^ 0xffffffff) == -1 &&
							((Class59.method986(plane, localY, 0, localX) ^ 0xffffffff) == (Class40_Sub6.anInt2120 ^ 0xffffffff)))) {
                ...
                if((type ^ 0xffffffff) == -23) {
                    if(!Class46.aBoolean1112
                            || (class40_sub5_sub8.anInt2546 ^ 0xffffffff) != -1
                            || class40_sub5_sub8.aBoolean2547) {
                        Class40_Sub5_Sub17 class40_sub5_sub17;
                        if(class40_sub5_sub8.anInt2506 == -1
                                && class40_sub5_sub8.anIntArray2534 == null)
                            class40_sub5_sub17
                                    = class40_sub5_sub8.method600(i, i_36_, rotation,
                                    i_34_, 22,
                                    (byte) 124,
                                    i_35_);
                        else
                            class40_sub5_sub17
                                    = (new Class40_Sub5_Sub17_Sub2
                                    (objectId, 22, rotation, i_34_, i_35_, i, i_36_,
                                            class40_sub5_sub8.anInt2506, true));
                        class2.method132(plane, localX, localY, i_39_,
                                class40_sub5_sub17, i_37_, i_38_);
                        if(class40_sub5_sub8.aBoolean2501
                                && class40_sub5_sub8.anInt2546 == 1
                                && class3 != null)
                    ...
                    if(class40_sub5_sub8.anInt2506 == -1
                        ...
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, 10, rotation,
                                i_34_, i_35_, i,
                                i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                    ...
                    if(class40_sub5_sub17 != null) {
                        ...
                        if((type ^ 0xffffffff) == -12)
                            i_42_ += 256;
                        if(class2.method137(plane, localX, localY, i_39_, i_41_,
                                i_40_, class40_sub5_sub17, i_42_,
                                i_37_, i_38_)
                                && class40_sub5_sub8.aBoolean2541) {
                            Model class40_sub5_sub17_sub5;
                            if(class40_sub5_sub17
                                    instanceof Model)
                                ...
                                class40_sub5_sub17_sub5
                                        = class40_sub5_sub8.method600(i, i_36_,
                                        rotation, i_34_,
                                        10,
                                        (byte) 124,
                                        i_35_);
                            if(class40_sub5_sub17_sub5 != null) {
                                for(int i_43_ = 0;
                                    ((i_43_ ^ 0xffffffff)
                                            >= (i_41_ ^ 0xffffffff));
                                    i_43_++) {
                                    for(int i_44_ = 0; i_40_ >= i_44_;
                                        i_44_++) {
                                        int i_45_ = (class40_sub5_sub17_sub5
                                                .method805()
                                                / 4);
                                        if(i_45_ > 30)
                                            i_45_ = 30;
                                        if(i_45_
                                                > (Class19.aByteArrayArrayArray492
                                                [plane][localX - -i_43_]
                                                [localY - -i_44_]))
                                            Class19.aByteArrayArrayArray492
                                                    [plane][i_43_ + localX]
                    ...
                    if(class40_sub5_sub8.aBoolean2501 && class3 != null)
                        class3.method154(localX, class40_sub5_sub8.aBoolean2528,
                                120, class40_sub5_sub8.anInt2515, rotation,
                                localY, class40_sub5_sub8.anInt2503);
                } else if(type >= 12) {
                    Class40_Sub5_Sub17 class40_sub5_sub17;
                    if(class40_sub5_sub8.anInt2506 != -1
                            || class40_sub5_sub8.anIntArray2534 != null)
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, type, rotation,
                                i_34_, i_35_, i,
                                i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                        ...
                        class40_sub5_sub17
                                ...
                                i_34_, type,
                                (byte) 124, i_35_);
                    class2.method137(plane, localX, localY, i_39_, 1, 1,
                            class40_sub5_sub17, 0, i_37_, i_38_);
                    if((type ^ 0xffffffff) <= -13
                            && (type ^ 0xffffffff) >= -18 && type != 13
                            && (plane ^ 0xffffffff) < -1)
                        Class6.anIntArrayArrayArray262[plane][localX][localY]
                                = (Class40_Sub5_Sub9.method619
                                ((Class6.anIntArrayArrayArray262[plane][localX]
                                                [localY]),
                                        2340));
                    if(class40_sub5_sub8.aBoolean2501 && class3 != null)
                        class3.method154(localX, class40_sub5_sub8.aBoolean2528,
                                108, class40_sub5_sub8.anInt2515, rotation,
                                localY, class40_sub5_sub8.anInt2503);
                } else if(type == 0) {
                    Class40_Sub5_Sub17 class40_sub5_sub17;
                    if(class40_sub5_sub8.anInt2506 == -1
                        ...
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, 0, rotation, i_34_,
                                i_35_, i, i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                                true);
                    class2.method94(plane, localX, localY, i_39_, class40_sub5_sub17,
                            null, Class32.anIntArray761[rotation], 0, i_37_,
                            i_38_);
                    if((rotation ^ 0xffffffff) != -1) {
                        if((rotation ^ 0xffffffff) == -2) {
                            if(class40_sub5_sub8.aBoolean2541) {
                                Class19.aByteArrayArrayArray492[plane][localX]
                                        [localY - -1]
                                        = (byte) 50;
                                Class19.aByteArrayArrayArray492[plane]
                                        [localX - -1][1 + localY]
                                        = (byte) 50;
                            }
                            if(class40_sub5_sub8.aBoolean2521)
                                Class6.anIntArrayArrayArray262[plane][localX]
                                        [localY + 1]
                                        = (Class40_Sub5_Sub9.method619
                                        ((Class6.anIntArrayArrayArray262[plane]
                                                        [localX][localY + 1]),
                                                1170));
                        ...
                        if(class40_sub5_sub8.aBoolean2541) {
                            Class19.aByteArrayArrayArray492[plane][localX][localY]
                                    = (byte) 50;
                            Class19.aByteArrayArrayArray492[plane][localX][(localY
                                    - -1)]
                                    = (byte) 50;
                    ...
                    if(class40_sub5_sub8.aBoolean2501 && class3 != null)
                        class3.method150(localY, type, rotation, localX,
                                class40_sub5_sub8.aBoolean2528,
                                (byte) 95);
                    if((class40_sub5_sub8.anInt2505 ^ 0xffffffff) != -17)
                        class2.method115(plane, localX, localY,
                                class40_sub5_sub8.anInt2505);
                    ...
                    if(class40_sub5_sub8.anInt2506 == -1
                        ...
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, 1, rotation, i_34_,
                                i_35_, i, i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                                true);
                    class2.method94(plane, localX, localY, i_39_, class40_sub5_sub17,
                            null,
                            Class40_Sub5_Sub15.anIntArray2788[rotation], 0,
                            i_37_, i_38_);
                    if(class40_sub5_sub8.aBoolean2541) {
                        if(rotation == 0)
                            Class19.aByteArrayArrayArray492[plane][localX][(localY
                            ...
                            Class19.aByteArrayArrayArray492[plane][localX + 1]
                                    [1 + localY]
                                    = (byte) 50;
                        else if((rotation ^ 0xffffffff) == -3)
                            Class19.aByteArrayArrayArray492[plane][localX + 1]
                    ...
                    if(class40_sub5_sub8.anInt2506 == -1
                            && class40_sub5_sub8.anIntArray2534 == null) {
                        class40_sub5_sub17
                                = class40_sub5_sub8.method600(i, i_36_, rotation + 4,
                                i_34_, 2, (byte) 124,
                                i_35_);
                        class40_sub5_sub17_47_
                                = class40_sub5_sub8.method600(i, i_36_, i_46_,
                                i_34_, 2, (byte) 124,
                                i_35_);
                    } else {
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, 2, 4 + rotation,
                                i_34_, i_35_, i,
                                i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                                true);
                        class40_sub5_sub17_47_
                                = new Class40_Sub5_Sub17_Sub2(objectId, 2, i_46_,
                                i_34_, i_35_, i,
                                i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                    ...
                    class2.method94(plane, localX, localY, i_39_, class40_sub5_sub17,
                            class40_sub5_sub17_47_,
                            Class32.anIntArray761[rotation],
                            Class32.anIntArray761[i_46_], i_37_, i_38_);
                    if(class40_sub5_sub8.aBoolean2521) {
                        if((rotation ^ 0xffffffff) != -1) {
                            if((rotation ^ 0xffffffff) == -2) {
                                Class6.anIntArrayArrayArray262[plane][localX]
                    ...
                    if(class40_sub5_sub8.anInt2506 != -1
                            || class40_sub5_sub8.anIntArray2534 != null)
                        class40_sub5_sub17
                                = new Class40_Sub5_Sub17_Sub2(objectId, 3, rotation, i_34_,
                                i_35_, i, i_36_,
                                (class40_sub5_sub8
                                        .anInt2506),
                                true);
                    ...
                    if(class40_sub5_sub8.aBoolean2501 && class3 != null)
                        class3.method154(localX, class40_sub5_sub8.aBoolean2528,
                                -36, class40_sub5_sub8.anInt2515, rotation,
                                localY, class40_sub5_sub8.anInt2503);
                } else {
                    ...
                    if(type == 4) {
                        ...
                        if(class40_sub5_sub8.anInt2506 == -1
                                && class40_sub5_sub8.anIntArray2534 == null)
                            class40_sub5_sub17
                                    = class40_sub5_sub8.method600(i, i_36_, 0,
                                    i_34_, 4,
                                    (byte) 124,
                                    i_35_);
                        else
                            class40_sub5_sub17
                                    = (new Class40_Sub5_Sub17_Sub2
                                    (objectId, 4, 0, i_34_, i_35_, i, i_36_,
                                            class40_sub5_sub8.anInt2506, true));
                        class2.method109(plane, localX, localY, i_39_,
                                class40_sub5_sub17,
                                Class32.anIntArray761[rotation], 512 * rotation,
                                0, 0, i_37_, i_38_);
                    } else if((type ^ 0xffffffff) == -6) {
                        int i_51_ = class2.method122(plane, localX, localY);
                        int i_52_ = 16;
                        if((i_51_ ^ 0xffffffff) < -1)
                            i_52_ = (Class40_Sub4.method535
                                    ((0x1fffedf2 & i_51_) >> 1054745038,
                                            (byte) 126)
                                    .anInt2505);
                        Class40_Sub5_Sub17 class40_sub5_sub17;
                        if((class40_sub5_sub8.anInt2506 ^ 0xffffffff) == 0
                                && class40_sub5_sub8.anIntArray2534 == null)
                            class40_sub5_sub17
                                    = class40_sub5_sub8.method600(i, i_36_, 0,
                                    i_34_, 4,
                        ...
                        class2.method109(plane, localX, localY, i_39_,
                                class40_sub5_sub17,
                                Class32.anIntArray761[rotation], rotation * 512,
                                i_52_ * Class27.anIntArray666[rotation],
                                (Class68_Sub1.anIntArray2207[rotation]
                                        * i_52_),
                                i_37_, i_38_);
                    } else if(type == 6) {
                        Class40_Sub5_Sub17 class40_sub5_sub17;
                        if(class40_sub5_sub8.anInt2506 == -1
                            ...
                            class40_sub5_sub17
                                    ...
                                    (objectId, 4, 0, i_34_, i_35_, i, i_36_,
                                            class40_sub5_sub8.anInt2506, true));
                        class2.method109(plane, localX, localY, i_39_,
                                class40_sub5_sub17, 256, rotation, 0, 0,
                                i_37_, i_38_);
                        ...
                        if((class40_sub5_sub8.anInt2506 ^ 0xffffffff) == 0
                            ...
                            class40_sub5_sub17
                                    ...
                                    (objectId, 4, 0, i_34_, i_35_, i, i_36_,
                                            class40_sub5_sub8.anInt2506, true));
                        class2.method109(plane, localX, localY, i_39_,
                                class40_sub5_sub17, 512, rotation, 0, 0,
                                i_37_, i_38_);
                    } else if(type == 8) {
                        Class40_Sub5_Sub17 class40_sub5_sub17;
                        if((class40_sub5_sub8.anInt2506 ^ 0xffffffff) == 0
                            ...
                            class40_sub5_sub17
                                    ...
                                    (objectId, 4, 0, i_34_, i_35_, i, i_36_,
                                            class40_sub5_sub8.anInt2506, true));
                        class2.method109(plane, localX, localY, i_39_,
                                class40_sub5_sub17, 768, rotation, 0, 0,
                                i_37_, i_38_);
                    } else {
    ...
    public Class40_Sub5_Sub17_Sub1(int arg0, int arg1, int arg2, int arg3,
    ...
    static {
        ...
        aClass1Array2964
                ...
                aClass1_2991, aClass1_2969, aClass1_2966,
                aClass1_2965, aClass1_2988, aClass1_2967};
    }
}
