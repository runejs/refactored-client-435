/* Class40_Sub5_Sub15 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class40_Sub5_Sub15 extends SubNode
{
    public static RSString aClass1_2773
	= (Class58.method978
	   (-11538, "Um ein neues Spielkonto zu erstellen)1 m-Ussen Sie"));
    ...
    public static RSString aClass1_2781
	= Class58.method978(-11538, " Sekunde(Xn(Y -Ubertragen)3");
	...
	if ((arg1.anInt3077 ^ 0xffffffff) != 0) {
		...
		= Class68_Sub1.method1050(arg1.anInt3077, 2);
	    if (class40_sub5_sub7 == null
		|| class40_sub5_sub7.anIntArray2485 == null)
		arg1.anInt3077 = -1;
	    else {
		arg1.anInt3120++;
		if (((arg1.anInt3116 ^ 0xffffffff)
		     > (class40_sub5_sub7.anIntArray2485.length ^ 0xffffffff))
		    && (class40_sub5_sub7.anIntArray2466[arg1.anInt3116]
			^ 0xffffffff) > (arg1.anInt3120 ^ 0xffffffff)) {
		    arg1.anInt3116++;
		    arg1.anInt3120 = 1;
		}
		if (class40_sub5_sub7.anIntArray2485.length
		    <= arg1.anInt3116) {
		    arg1.anInt3116 = 0;
		    arg1.anInt3120 = 0;
		}
	...
	if (arg1.anInt3091 != -1
	    && (arg1.anInt3093 ^ 0xffffffff) >= (Node.anInt926
						 ^ 0xffffffff)) {
		...
		Class40_Sub5_Sub7 class40_sub5_sub7
		    = Class68_Sub1.method1050(i, 2);
		if (class40_sub5_sub7 == null
		    || class40_sub5_sub7.anIntArray2485 == null)
		    arg1.anInt3091 = -1;
		else {
		    arg1.anInt3129++;
		    if (((class40_sub5_sub7.anIntArray2485.length ^ 0xffffffff)
			 < (arg1.anInt3140 ^ 0xffffffff))
			&& ((arg1.anInt3129 ^ 0xffffffff)
			    < (class40_sub5_sub7.anIntArray2466[arg1.anInt3140]
			       ^ 0xffffffff))) {
			arg1.anInt3129 = 1;
			arg1.anInt3140++;
		    }
	...
	if (arg0 == true) {
		...
		if (class40_sub5_sub7.anInt2470 == 1
		    && (arg1.anInt3094 ^ 0xffffffff) < -1
		    && arg1.anInt3112 <= Node.anInt926
		    && (arg1.anInt3107 ^ 0xffffffff) > (Node.anInt926
							^ 0xffffffff)) {
		    arg1.anInt3122 = 1;
		    return;
		}
		...
		if (class40_sub5_sub7 != null
		    ...
		    if ((class40_sub5_sub7.anIntArray2485.length
			 > arg1.anInt3104)
			&& (class40_sub5_sub7.anIntArray2466[arg1.anInt3104]
			    < arg1.anInt3115)) {
			arg1.anInt3104++;
			arg1.anInt3115 = 1;
		    }
		    if ((class40_sub5_sub7.anIntArray2485.length ^ 0xffffffff)
			>= (arg1.anInt3104 ^ 0xffffffff)) {
			arg1.anInt3104 -= class40_sub5_sub7.anInt2497;
			arg1.anInt3095++;
			if ((class40_sub5_sub7.anInt2495 ^ 0xffffffff)
			    >= (arg1.anInt3095 ^ 0xffffffff))
			    arg1.anInt3141 = -1;
			if ((arg1.anInt3104 ^ 0xffffffff) > -1
			    || (arg1.anInt3104
				>= class40_sub5_sub7.anIntArray2485.length))
			    arg1.anInt3141 = -1;
		    }
    ...
    public Class40_Sub5_Sub15(Class6 arg0, Class6 arg1, int arg2,
			      boolean arg3) {
	try {
		...
		for (Class40_Sub13 class40_sub13_3_
			 = (Class40_Sub13) class45.method902((byte) -90);
		     class40_sub13_3_ != null;
		     class40_sub13_3_
			 = (Class40_Sub13) class45.method909(-4)) {
		...
		aClass41Array2794[is[i_0_]]
		    = new Class41(is_1_, class40_sub13);
	    }
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
				   ("t.<init>("
	...
	aClass1_2787 = Class58.method978(-11538, "sideicons");
	aBoolean2784 = false;
	aClass1_2790 = Class58.method978(-11538, "Friends");
	aClass1_2792 = Class58.method978(-11538, "Examine");
	aClass1_2786 = aClass1_2790;
	aClass1_2793
	    = Class58.method978(-11538, "Ihr Charakter)2Profil wird in:");
