...
public class Class63 {
    ...
    static {
        ...
        for(int i = 0; i < 32768; i++)
            anIntArray1478[i] = (int) (Math.sin((double) i / 5215.1903) * 16384.0);
    ...
    public int[] method1007(int arg0, int arg1) {
        ...
        if(aClass7_1484 != null) {
            ...
            i = (int) ((double) (aClass7_1484.anInt268 - aClass7_1484.anInt266) * 32.768 / d);
        ...
        if(aClass7_1489 != null) {
            ...
            i_4_ = (int) ((double) (aClass7_1489.anInt268 - aClass7_1489.anInt266) * 32.768 / d);
            i_5_ = (int) ((double) aClass7_1489.anInt266 * 32.768 / d);
        }
        for(int i_7_ = 0; i_7_ < 5; i_7_++) {
            if(anIntArray1485[i_7_] != 0) {
                anIntArray1499[i_7_] = 0;
                anIntArray1495[i_7_] = (int) ((double) anIntArray1483[i_7_] * d);
                anIntArray1492[i_7_] = (anIntArray1485[i_7_] << 14) / 100;
                anIntArray1493[i_7_] = (int) ((double) (aClass7_1488.anInt268 - aClass7_1488.anInt266) * 32.768 * Math.pow(1.0057929410678534, (double) anIntArray1479[i_7_]) / d);
                anIntArray1496[i_7_] = (int) ((double) aClass7_1488.anInt266 * 32.768 / d);
            }
        }
        for(int i_8_ = 0; i_8_ < arg0; i_8_++) {
            ...
            if(aClass7_1489 != null) {
                ...
                i_10_ = i_10_ * ((method1006(i_6_, i_14_, aClass7_1489.anInt267) >> 1) + 32768) >> 15;
            ...
            for(int i_15_ = 0; i_15_ < 5; i_15_++) {
                if(anIntArray1485[i_15_] != 0) {
                    ...
                    if(i_16_ < arg0) {
                        anIntArray1482[i_16_] += method1006(anIntArray1499[i_15_], i_10_ * anIntArray1492[i_15_] >> 15, aClass7_1488.anInt267);
                        anIntArray1499[i_15_] += ((i_9_ * anIntArray1493[i_15_] >> 16) + anIntArray1496[i_15_]);
                    }
                }
            }
        }
        if(aClass7_1497 != null) {
            ...
            for(int i_19_ = 0; i_19_ < arg0; i_19_++) {
                ...
                int i_22_;
                if(bool_18_)
                    i_22_ = aClass7_1497.anInt266 + (((aClass7_1497.anInt268 - aClass7_1497.anInt266) * i_20_) >> 8);
                else
                    i_22_ = aClass7_1497.anInt266 + (((aClass7_1497.anInt268 - aClass7_1497.anInt266) * i_21_) >> 8);
                i_17_ += 256;
                if(i_17_ >= i_22_) {
                    i_17_ = 0;
                    bool_18_ = !bool_18_;
        ...
        if(anInt1477 > 0 && anInt1486 > 0) {
            ...
            for(int i_24_ = i_23_; i_24_ < arg0; i_24_++)
                anIntArray1482[i_24_] += anIntArray1482[i_24_ - i_23_] * anInt1486 / 100;
        }
        if(aClass16_1475.anIntArray444[0] > 0 || aClass16_1475.anIntArray444[1] > 0) {
            ...
            if(arg0 >= i_26_ + i_27_) {
                ...
                for(/**/; i_28_ < i_29_; i_28_++) {
                    int i_30_ = (int) (((long) anIntArray1482[i_28_ + i_26_] * (long) Class16.anInt442) >> 16);
                    for(int i_31_ = 0; i_31_ < i_26_; i_31_++)
                        i_30_ += (int) (((long) (anIntArray1482[i_28_ + i_26_ - 1 - i_31_]) * (long) (Class16.anIntArrayArray440[0][i_31_])) >> 16);
                    for(int i_32_ = 0; i_32_ < i_28_; i_32_++)
                        i_30_ -= (int) (((long) anIntArray1482[i_28_ - 1 - i_32_] * (long) (Class16.anIntArrayArray440[1][i_32_])) >> 16);
                ...
                for(; ; ) {
                    if(i_29_ > arg0 - i_26_)
                        i_29_ = arg0 - i_26_;
                    for(/**/; i_28_ < i_29_; i_28_++) {
                        int i_33_ = (int) (((long) anIntArray1482[i_28_ + i_26_] * (long) Class16.anInt442) >> 16);
                        for(int i_34_ = 0; i_34_ < i_26_; i_34_++)
                            i_33_ += (int) (((long) (anIntArray1482[i_28_ + i_26_ - 1 - i_34_]) * (long) (Class16.anIntArrayArray440[0][i_34_])) >> 16);
                        for(int i_35_ = 0; i_35_ < i_27_; i_35_++)
                            i_33_ -= (int) (((long) (anIntArray1482[i_28_ - 1 - i_35_]) * (long) (Class16.anIntArrayArray440[1][i_35_])) >> 16);
                        anIntArray1482[i_28_] = i_33_;
                        i_25_ = aClass7_1487.method208(arg0 + 1);
                    }
                    if(i_28_ >= arg0 - i_26_)
                        break;
                    i_26_ = aClass16_1475.method270(0, (float) i_25_ / 65536.0F);
                    i_27_ = aClass16_1475.method270(1, (float) i_25_ / 65536.0F);
                    i_29_ += 128;
                }
                for(/**/; i_28_ < arg0; i_28_++) {
                    int i_36_ = 0;
                    for(int i_37_ = i_28_ + i_26_ - arg0; i_37_ < i_26_; i_37_++)
                        i_36_ += (int) (((long) (anIntArray1482[i_28_ + i_26_ - 1 - i_37_]) * (long) (Class16.anIntArrayArray440[0][i_37_])) >> 16);
                    for(int i_38_ = 0; i_38_ < i_27_; i_38_++)
                        i_36_ -= (int) (((long) anIntArray1482[i_28_ - 1 - i_38_] * (long) (Class16.anIntArrayArray440[1][i_38_])) >> 16);
