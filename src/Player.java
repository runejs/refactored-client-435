/* Class40_Sub5_Sub17_Sub4_Sub1 - Decompiled by JODE
...
public class Player extends Class40_Sub5_Sub17_Sub4
{
	...
	try {
		...
		= (anInt3141 == -1 || (anInt3122 ^ 0xffffffff) != -1 ? null
		   : Class68_Sub1.method1050(anInt3141, 2));
	    Class40_Sub5_Sub7 class40_sub5_sub7_0_
		= (((anInt3077 ^ 0xffffffff) != 0 && !aBoolean3287
		    && (anInt3126 != anInt3077 || class40_sub5_sub7 == null))
		   ? Class68_Sub1.method1050(anInt3077, 2) : null);
	    Model class40_sub5_sub17_sub5
		= aClass30_3282.method377(class40_sub5_sub7,
					  class40_sub5_sub7_0_, anInt3116,
					  anInt3104, (byte) -128);
	    if (class40_sub5_sub17_sub5 == null)
		return null;
	    class40_sub5_sub17_sub5.method799();
	    anInt3117 = class40_sub5_sub17_sub5.anInt2861;
	    if (!aBoolean3287 && (anInt3091 ^ 0xffffffff) != 0
		&& anInt3140 != -1) {
		...
		if ((Node.anInt926 ^ 0xffffffff)
		    <= (anInt3274 ^ 0xffffffff))
		    aClass40_Sub5_Sub17_Sub5_3265 = null;
		if (anInt3283 <= Node.anInt926
		    && (anInt3274 ^ 0xffffffff) < (Node.anInt926
						   ^ 0xffffffff)) {
		    Model class40_sub5_sub17_sub5_2_
			= aClass40_Sub5_Sub17_Sub5_3265;
		    class40_sub5_sub17_sub5_2_.method828
			(-anInt3098 + anInt3271, -anInt3276 + anInt3272,
			 anInt3291 + -anInt3089);
		    if (anInt3080 != 512) {
			if (anInt3080 == 1024) {
			...
			class40_sub5_sub17_sub5_2_.method813();
		    class40_sub5_sub17_sub5_2_.method828
			(-anInt3271 + anInt3098, -anInt3272 + anInt3276,
			 anInt3089 - anInt3291);
		}
	    }
	...
	try {
		...
		int i_5_ = arg1.method468(false);
		if ((i_5_ ^ 0xffffffff) == -1)
		    is[i_4_] = 0;
		else {
		    int i_6_ = arg1.method468(false);
		    is[i_4_] = (i_5_ << 292869864) + i_6_;
		    if ((i_4_ ^ 0xffffffff) == -1 && is[0] == 65535) {
			i_3_ = arg1.method469(65280);
			break;
		    }
		    if ((is[i_4_] ^ 0xffffffff) <= -513) {
			int i_7_
			    = Class44.method897(-512 + is[i_4_], 10).anInt2823;
		...
		int i_10_ = arg1.method468(false);
		if ((i_10_ ^ 0xffffffff) > -1
		    || ((Class40_Sub5_Sub17_Sub6.anIntArrayArray3238
			 [i_9_]).length
			^ 0xffffffff) >= (i_10_ ^ 0xffffffff))
		    i_10_ = 0;
		is_8_[i_9_] = i_10_;
	    }
	    anInt3126 = arg1.method469(65280);
	    if ((anInt3126 ^ 0xffffffff) == -65536)
		anInt3126 = -1;
	    anInt3145 = arg1.method469(65280);
	    if (anInt3145 == 65535)
		anInt3145 = -1;
	    anInt3083 = anInt3145;
	    anInt3131 = arg1.method469(65280);
	    if ((anInt3131 ^ 0xffffffff) == -65536)
		anInt3131 = -1;
	    anInt3079 = arg1.method469(65280);
	    if (anInt3079 == 65535)
		anInt3079 = -1;
	    anInt3075 = arg1.method469(65280);
	    if (anInt3075 == 65535)
		anInt3075 = -1;
	    anInt3132 = arg1.method469(65280);
	    if ((anInt3132 ^ 0xffffffff) == -65536)
		anInt3132 = -1;
	    anInt3082 = arg1.method469(65280);
	    if (anInt3082 == 65535)
		anInt3082 = -1;
	    aClass1_3278 = Class60.method991
			       (-127, arg1.method498(1362367312))
			       .method85(-4305);
	    anInt3260 = arg1.method468(false);
	    anInt3257 = arg1.method469(65280);
	    if (aClass30_3282 == null)
	...
	try {
	    ...
	    if (arg0 < 118)
		aByteArray3270 = null;
	    if ((arg1 ^ 0xffffffff) <= -130 && arg1 <= 159)
		return false;
	    return true;
	} catch (RuntimeException runtimeexception) {
	    throw Class8.method216(runtimeexception,
