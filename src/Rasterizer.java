...
public class Rasterizer extends SubNode
{
    ...
    public static void method654(int arg0, int arg1, int arg2, int arg3,
				 int arg4, int arg5) {
    ...
    public static void method656(int arg0, int arg1, int arg2, int arg3,
				 int arg4) {
	if (arg0 < anInt2771) {
	    arg2 -= anInt2771 - arg0;
	    arg0 = anInt2771;
    ...
    public static void method658(int arg0, int arg1, int arg2, int arg3,
				 int arg4) {
	if (arg1 >= anInt2767 && arg1 < anInt2770) {
		...
		int i_11_ = ((i_3_ + i_8_ >> 8 << 16) + (i_4_ + i_9_ >> 8 << 8)
			     + (i_5_ + i_10_ >> 8));
    ...
    public static void method660(int arg0, int arg1, int arg2, int arg3,
				 int arg4) {
	if (arg0 >= anInt2771 && arg0 < anInt2772) {
		...
		int i_21_
		    = ((i_13_ + i_18_ >> 8 << 16) + (i_14_ + i_19_ >> 8 << 8)
		       + (i_15_ + i_20_ >> 8));
    ...
    public static void method664(int arg0, int arg1, int arg2, int arg3,
				 int arg4, int arg5) {
	if (arg0 < anInt2771) {
	    arg2 -= anInt2771 - arg0;
	    arg0 = anInt2771;
	...
	for (int i_28_ = 0; i_28_ < arg3; i_28_++) {
		...
		int i_33_
		    = ((i_23_ + i_30_ >> 8 << 16) + (i_24_ + i_31_ >> 8 << 8)
		       + (i_25_ + i_32_ >> 8));
    ...
    public static void method666(int arg0, int arg1, int arg2, int arg3,
				 int arg4) {
	arg2 -= arg0;
	arg3 -= arg1;
	if (arg3 == 0) {
