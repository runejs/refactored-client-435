...
public class Class21
{
	...
	while (bool_31_) {
		...
		i_32_ = method296(arg0);
		if (i_32_ == 1)
		    arg0.aBooleanArray824[i_34_] = true;
		else
		    arg0.aBooleanArray824[i_34_] = false;
	    }
		...
		method294(arg0.anIntArrayArray835[i_51_],
			  arg0.anIntArrayArray842[i_51_],
			  arg0.anIntArrayArray833[i_51_],
			  arg0.aByteArrayArray822[i_51_], i_52_, i_53_, i_38_);
	    ...
	    int i_65_;
	    int i_66_;
	    for (i_66_ = method295(i_64_, arg0); i_66_ > is[i_64_];
		 i_66_ = i_66_ << 1 | i_65_) {
		i_64_++;
		...
		if (i_67_ == 0 || i_67_ == 1) {
		    ...
		    i_33_
			= (arg0.aByteArray814
			   [arg0.aByteArray840[arg0.anIntArray818[0]] & 0xff]);
			...
			for (/**/; i_71_ > 3; i_71_ -= 4) {
			    ...
			    arg0.aByteArray840[i_73_]
				= arg0.aByteArray840[i_73_ - 1];
			    arg0.aByteArray840[i_73_ - 1]
				= arg0.aByteArray840[i_73_ - 2];
			    arg0.aByteArray840[i_73_ - 2]
				= arg0.aByteArray840[i_73_ - 3];
			    arg0.aByteArray840[i_73_ - 3]
				= arg0.aByteArray840[i_73_ - 4];
			}
			for (/**/; i_71_ > 0; i_71_--)
			    arg0.aByteArray840[i_72_ + i_71_]
				= arg0.aByteArray840[i_72_ + i_71_ - 1];
			...
			for (/**/; i_76_ > arg0.anIntArray818[i_74_]; i_76_--)
			    arg0.aByteArray840[i_76_]
				= arg0.aByteArray840[i_76_ - 1];
			arg0.anIntArray818[i_74_]++;
			for (/**/; i_74_ > 0; i_74_--) {
			    arg0.anIntArray818[i_74_]--;
			    arg0.aByteArray840[arg0.anIntArray818[i_74_]]
				= (arg0.aByteArray840
				   [arg0.anIntArray818[i_74_ - 1] + 16 - 1]);
			}
			...
			if (arg0.anIntArray818[0] == 0) {
				...
				for (int i_79_ = 15; i_79_ >= 0; i_79_--) {
				    arg0.aByteArray840[i_77_]
					= (arg0.aByteArray840
					   [(arg0.anIntArray818[i_78_]
					     + i_79_)]);
				    i_77_--;
				}
		    ...
		    arg0.anIntArray845[(arg0.aByteArray814[i_32_ & 0xff]
					& 0xff)]++;
		    Floor.anIntArray2324[i_62_]
			= arg0.aByteArray814[i_32_ & 0xff] & 0xff;
		    i_62_++;
		    if (i_57_ == 0) {
			i_56_++;
			i_57_ = 50;
		...
		i_33_
		    = (byte) (Floor.anIntArray2324[i_83_] & 0xff);
		Floor.anIntArray2324[(arg0.anIntArray816
						  [i_33_ & 0xff])]
		    |= i_83_ << 8;
		arg0.anIntArray816[i_33_ & 0xff]++;
	    }
	    arg0.anInt820
		= Floor.anIntArray2324[arg0.anInt801] >> 8;
	    arg0.anInt802 = 0;
	    ...
	    arg0.anInt809 = i_62_;
	    method291(arg0);
	    if (arg0.anInt802 == arg0.anInt809 + 1 && arg0.anInt812 == 0)
		bool_31_ = true;
	    else
		bool_31_ = false;
	}
    ...
    public static void method294(int[] arg0, int[] arg1, int[] arg2,
	...
	for (;;) {
		...
		int i_93_
		    = arg1.anInt834 >> arg1.anInt847 - arg0 & (1 << arg0) - 1;
		arg1.anInt847 -= arg0;
		i = i_93_;
		break;
	    }
	    arg1.anInt834 = (arg1.anInt834 << 8
			     | arg1.aByteArray830[arg1.anInt832] & 0xff);
	    arg1.anInt847 += 8;
	    arg1.anInt832++;
	    arg1.anInt831++;
	}
    ...
    public static int method297(byte[] arg0, int arg1, byte[] arg2, int arg3,
				int arg4) {
