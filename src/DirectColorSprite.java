...
public class DirectColorSprite extends Rasterizer
{
	...
	if (arg2 > 0 && arg3 > 0) {
	    ...
	    method733(Rasterizer.anIntArray2766, anIntArray2955, 0,
		      i_4_, i_5_, i_12_, i_13_, arg2, arg3, i_8_, i_9_, i,
		      arg4);
	}
    }
	...
	method722(anInt2954 << 3, anInt2952 << 3, arg0 << 4, arg1 << 4, arg2,
		  arg3);
    }
	...
	if (i_29_ > 0 && i_28_ > 0)
	    method719(Rasterizer.anIntArray2766, anIntArray2955, 0,
		      i_27_, i, i_29_, i_28_, i_30_, i_31_);
    }
    
    public void method722(int arg0, int arg1, int arg2, int arg3, int arg4,
			  int arg5) {
	if (arg5 != 0) {
	    arg0 -= anInt2953 << 4;
	    arg1 -= anInt2949 << 4;
	    ...
	    int i_42_ = (((anInt2951 << 4) - arg0) * i_35_
			 + ((anInt2950 << 4) - arg1) * i);
	    int i_43_ = (-((anInt2951 << 4) - arg0) * i
			 + ((anInt2950 << 4) - arg1) * i_35_);
	    int i_44_;
	    int i_45_;
	    if (i_36_ < i_38_) {
		i_44_ = i_36_;
		...
		if (i_47_ < 0) {
			...
			if (i_50_ == 0) {
				...
				int i_60_ = i_45_;
				if (i_58_ >= 0 && i_59_ >= 0
				    && i_58_ - (anInt2951 << 12) < 0
				    && i_59_ - (anInt2950 << 12) < 0) {
				    for (/**/; i_60_ < 0; i_60_++) {
					int i_61_
					    = (anIntArray2955
					       [((i_59_ >> 12) * anInt2951
				...
				int i_66_ = i_45_;
				if (i_64_ >= 0
				    && i_64_ - (anInt2951 << 12) < 0) {
				    int i_67_;
				    if ((i_67_ = i_65_ - (anInt2950 << 12))
					>= 0) {
			...
			if (i_50_ == 0) {
				...
				int i_81_ = i_45_;
				if (i_80_ >= 0
				    && i_80_ - (anInt2950 << 12) < 0) {
				    int i_82_;
				    if ((i_82_ = i_79_ - (anInt2951 << 12))
					>= 0) {
				...
				if ((i_89_ = (i_87_ - i_50_) / i_50_) > i_88_)
				    i_88_ = i_89_;
				for (/**/; i_88_ < 0; i_88_++) {
				    int i_90_ = (anIntArray2955
						 [((i_87_ >> 12) * anInt2951
						   + (i_86_ >> 12))]);
				    if (i_90_ != 0)
					Rasterizer.anIntArray2766
					    [i_85_++]
					    = i_90_;
				    else
					i_85_++;
				...
				if ((i_96_ = (1 + i_94_ - (anInt2950 << 12)
					      - i_50_) / i_50_)
				    > i_95_)
				    i_95_ = i_96_;
				for (/**/; i_95_ < 0; i_95_++) {
				    int i_97_ = (anIntArray2955
						 [((i_94_ >> 12) * anInt2951
						   + (i_93_ >> 12))]);
				    if (i_97_ != 0)
					Rasterizer.anIntArray2766
			...
			while (i_98_ < 0) {
				...
				int i_104_;
				if ((i_104_ = (1 + i_100_ - (anInt2951 << 12)
					       - i_51_) / i_51_)
				    > i_102_)
				    i_102_ = i_104_;
				for (/**/; i_102_ < 0; i_102_++) {
				    int i_105_ = (anIntArray2955
						  [((i_101_ >> 12) * anInt2951
						    + (i_100_ >> 12))]);
				    if (i_105_ != 0)
					Rasterizer.anIntArray2766
			...
			while (i_106_ < 0) {
			    ...
			    int i_112_;
			    if ((i_112_ = (1 + i_108_ - (anInt2951 << 12)
					   - i_51_) / i_51_)
				> i_110_)
				i_110_ = i_112_;
				...
				int i_113_
				    = (anIntArray2955
				       [(i_109_ >> 12) * anInt2951 + (i_108_
								      >> 12)]);
				if (i_113_ != 0)
				    Rasterizer.anIntArray2766[i_107_++]
					= i_113_;
				else
				    i_107_++;
				i_108_ += i_51_;
			...
			while (i_114_ < 0) {
			    ...
			    int i_120_;
			    if ((i_120_ = (1 + i_116_ - (anInt2951 << 12)
					   - i_51_) / i_51_)
				> i_118_)
				i_118_ = i_120_;
			    if (i_117_ < 0) {
			    ...
			    if ((i_120_ = (1 + i_117_ - (anInt2950 << 12)
					   - i_50_) / i_50_)
				> i_118_)
				i_118_ = i_120_;
			    for (/**/; i_118_ < 0; i_118_++) {
				int i_121_
				    = (anIntArray2955
				       [(i_117_ >> 12) * anInt2951 + (i_116_
								      >> 12)]);
				if (i_121_ != 0)
				    Rasterizer.anIntArray2766[i_115_++]
					= i_121_;
				else
				    i_115_++;
				i_116_ += i_51_;
    ...
    public void method724(int arg0, int arg1, int arg2, int arg3, int arg4,
	...
	try {
		...
		for (arg0 = -arg9[arg1]; arg0 < 0; arg0++) {
		    Rasterizer.anIntArray2766[i_129_++]
			= (anIntArray2955
			   [(i_130_ >> 16) + (i_131_ >> 16) * anInt2951]);
		    i_130_ += i_124_;
		    i_131_ -= i_123_;
		}
		i_125_ += i_123_;
	...
	if (i_134_ > 0 && i_133_ > 0)
	    method718(Rasterizer.anIntArray2766, anIntArray2955, 0,
		      i_132_, i, i_134_, i_133_, i_135_, i_136_,
		      arg0.aByteArray2925);
    }
	...
	if (anInt2951 != anInt2954 || anInt2950 != anInt2952) {
		...
		for (int i_140_ = 0; i_140_ < anInt2951; i_140_++)
		    is[(i + anInt2949) * anInt2954 + (i_140_ + anInt2953)]
			= anIntArray2955[i * anInt2951 + i_140_];
	    }
	    anIntArray2955 = is;
	    anInt2951 = anInt2954;
	    anInt2950 = anInt2952;
	...
	if (i_143_ > 0 && i_142_ > 0)
	    method731(Rasterizer.anIntArray2766, anIntArray2955,
		      i_141_, i, i_143_, i_142_, i_144_, i_145_);
    }
	...
	if (i_151_ > 0 && i_150_ > 0)
	    method730(Rasterizer.anIntArray2766, anIntArray2955, 0,
		      i_149_, i, i_151_, i_150_, i_152_, i_153_, arg2);
    }
    ...
    public void method729(int arg0, int arg1, int arg2, int arg3, int arg4,
    ...
    public static void method730(int[] arg0, int[] arg1, int arg2, int arg3,
				 int arg4, int arg5, int arg6, int arg7,
				 int arg8, int arg9) {
	int i = 256 - arg9;
	for (int i_167_ = -arg6; i_167_ < 0; i_167_++) {
		...
		if (arg2 != 0) {
		    ...
		    arg0[arg4++]
			= (((arg2 & 0xff00ff) * arg9 + (i_169_ & 0xff00ff) * i
			    & ~0xff00ff)
			   + ((arg2 & 0xff00) * arg9 + (i_169_ & 0xff00) * i
			      & 0xff0000)) >> 8;
		} else
		    arg4++;
	    }
    ...
    public static void method731(int[] arg0, int[] arg1, int arg2, int arg3,
				 int arg4, int arg5, int arg6, int arg7) {
	...
	if (arg2 > 0 && arg3 > 0) {
	    ...
	    method715(Rasterizer.anIntArray2766, anIntArray2955, 0,
		      i_172_, i_173_, i_180_, i_181_, arg2, arg3, i_176_,
		      i_177_, i);
	}
    }
    
    public static void method733(int[] arg0, int[] arg1, int arg2, int arg3,
				 int arg4, int arg5, int arg6, int arg7,
				 int arg8, int arg9, int arg10, int arg11,
				 int arg12) {
	int i = 256 - arg12;
	...
	for (int i_186_ = -arg8; i_186_ < 0; i_186_++) {
		...
		if (arg2 != 0) {
		    ...
		    arg0[arg5++]
			= (((arg2 & 0xff00ff) * arg12 + (i_189_ & 0xff00ff) * i
			    & ~0xff00ff)
			   + ((arg2 & 0xff00) * arg12 + (i_189_ & 0xff00) * i
			      & 0xff0000)) >> 8;
		} else
		    arg5++;
		arg3 += arg9;
	...
	try {
		...
		= new PixelGrabber(image, 0, 0, anInt2951, anInt2950,
				   anIntArray2955, 0, anInt2951);
