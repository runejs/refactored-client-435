        ...
        for(int i = 0; i < PacketBuffer.anInt2248; i++) {
            ...
            if(Class40_Sub3.anIntArray2023[i] < -10) {
                ...
                for(int i_9_ = i; ((PacketBuffer.anInt2248 ^ 0xffffffff) < (i_9_ ^ 0xffffffff)); i_9_++) {
                    ...
                    PacketBuffer.aClass36Array2238[i_9_] = PacketBuffer.aClass36Array2238[1 + i_9_];
                ...
                if(class36 == null) {
                    class36 = Class36.method429((Class40_Sub5_Sub17_Sub4.aClass6_Sub1_3157), (Class40_Sub5_Sub10.anIntArray2602[i]), 0);
                    if(class36 == null)
                        continue;
                ...
                if((Class40_Sub3.anIntArray2023[i] ^ 0xffffffff) > -1) {
                    ...
                    if((Class38_Sub1.anIntArray1916[i] ^ 0xffffffff) != -1) {
                        ...
                        int i_14_ = (i_13_ * 128 - -64 + -(Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3089));
                        int i_15_ = (i_12_ * 128 + (64 - (Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3098)));
                        if(i_15_ < 0)
                            i_15_ = -i_15_;
