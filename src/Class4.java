...
public class Class4 {
    ...
    public static int method160(int arg0, int arg1, int arg2, int arg3) {
        try {
            ...
            int i_2_ = arg0 / arg2;
            int i_3_ = Class3.method157(arg1 + -15177, i_2_, i_0_);
            int i_4_ = Class3.method157(arg1 ^ arg1, 1 + i_2_, i_0_);
            int i_5_ = Class3.method157(0, i_2_, 1 + i_0_);
            int i_6_ = Class3.method157(0, 1 + i_2_, 1 + i_0_);
    ...
    public static void method161(int arg0) {
        ...
        for (int i = 0; i < PacketBuffer.anInt2248; i++) {
            ...
            if (Class40_Sub3.anIntArray2023[i] < -10) {
                ...
                for (int i_9_ = i; ((PacketBuffer.anInt2248 ^ 0xffffffff)
                        < (i_9_ ^ 0xffffffff)); i_9_++) {
                    Class40_Sub5_Sub10.anIntArray2602[i_9_]
                            = Class40_Sub5_Sub10.anIntArray2602[i_9_ + 1];
                    PacketBuffer.aClass36Array2238[i_9_]
                            = PacketBuffer.aClass36Array2238[1 + i_9_];
                    ItemDefinition.anIntArray2814[i_9_]
                            = ItemDefinition.anIntArray2814[1 + i_9_];
                    Class40_Sub3.anIntArray2023[i_9_]
                            = Class40_Sub3.anIntArray2023[1 + i_9_];
                    Class38_Sub1.anIntArray1916[i_9_]
                            = Class38_Sub1.anIntArray1916[1 + i_9_];
                }
                i--;
            } else {
                Class36 class36 = PacketBuffer.aClass36Array2238[i];
                if (class36 == null) {
                    class36 = Class36.method429((Class40_Sub5_Sub17_Sub4
                                    .aClass6_Sub1_3157),
                            (Class40_Sub5_Sub10
                                    .anIntArray2602[i]),
                            0);
                    if (class36 == null)
                        continue;
                    Class40_Sub3.anIntArray2023[i] += class36.method427();
                    PacketBuffer.aClass36Array2238[i] = class36;
                }
                if ((Class40_Sub3.anIntArray2023[i] ^ 0xffffffff) > -1) {
                    int i_10_;
                    if ((Class38_Sub1.anIntArray1916[i] ^ 0xffffffff) != -1) {
                        int i_11_
                                = 128 * (Class38_Sub1.anIntArray1916[i] & 0xff);
                        int i_12_
                                = (0xff
                                & Class38_Sub1.anIntArray1916[i] >> 854878096);
                        int i_13_ = ((Class38_Sub1.anIntArray1916[i] & 0xffb8)
                                >> 1161269672);
                        int i_14_ = (i_13_ * 128 - -64
                                + -(Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anInt3089));
                        int i_15_
                                = (i_12_ * 128
                                + (64 - (Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anInt3098)));
                        if (i_15_ < 0)
                            i_15_ = -i_15_;
                    ...
                    Class40_Sub12_Sub1 class40_sub12_sub1
                            = class36.method428().method875(Class55.aClass48_1289);
                    Class40_Sub9_Sub2 class40_sub9_sub2
                            = Class40_Sub9_Sub2.method864(class40_sub12_sub1, 100,
                            i_10_);
                    class40_sub9_sub2
                            .method860(-1 + ItemDefinition.anIntArray2814[i]);
        ...
        if ((Class35.anInt1733 ^ 0xffffffff) < -1) {
            ...
            if ((Class35.anInt1733 ^ 0xffffffff) == -1
                    ...
                    && (Class62.anInt1457 ^ 0xffffffff) != 0)
                Class33.method414(false, 0, Class62.anInt1457,
                        RSCanvas.anInt60, 0,
                        Class55.aClass6_Sub1_1286, -1);
        }
    }
}
