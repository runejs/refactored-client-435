...
public class Class40_Sub5_Sub17_Sub6 extends Class40_Sub5_Sub17 {
    ...
    public Class40_Sub5_Sub17_Sub6(int arg0, int arg1, int arg2, int arg3,
    ...
    public static void method833(int arg0, boolean arg1) {
        try {
            anInt3241++;
            if (((Class40_Sub5_Sub4.anInt2366 ^ 0xffffffff)
                    == ((Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
                    .anInt3098) >> 1533110887
                    ^ 0xffffffff))
                    && ((Class55.anInt1304 ^ 0xffffffff)
                    == ((Class40_Sub5_Sub13.aClass40_Sub5_Sub17_Sub4_Sub1_2760
                    .anInt3089) >> -425626553
                    ^ 0xffffffff)))
            ...
            for (/**/; i > i_0_; i_0_++) {
                ...
                if (arg1) {
                    ...
                    class40_sub5_sub17_sub4_sub1
                            ...
                            [Class57.anIntArray1334[i_0_]]);
                }
                if (class40_sub5_sub17_sub4_sub1 != null
                        && class40_sub5_sub17_sub4_sub1.method784(1)) {
                    class40_sub5_sub17_sub4_sub1.aBoolean3287 = false;
                    int i_2_
                            = class40_sub5_sub17_sub4_sub1.anInt3098 >> 1455652391;
                    int i_3_
                            = class40_sub5_sub17_sub4_sub1.anInt3089 >> -130081305;
                    if (((Class46.aBoolean1112
                            && (Class60.anInt1407 ^ 0xffffffff) < -51)
                            || (Class60.anInt1407 ^ 0xffffffff) < -201)
                            && !arg1
                            && ((class40_sub5_sub17_sub4_sub1.anInt3126
                            ^ 0xffffffff)
                            == (class40_sub5_sub17_sub4_sub1.anInt3077
                            ^ 0xffffffff)))
                        class40_sub5_sub17_sub4_sub1.aBoolean3287 = true;
                    if (i_2_ >= 0 && (i_2_ ^ 0xffffffff) > -105 && i_3_ >= 0
                            && i_3_ < 104) {
                        if ((class40_sub5_sub17_sub4_sub1
                            ...
                            class40_sub5_sub17_sub4_sub1.aBoolean3287 = false;
                            class40_sub5_sub17_sub4_sub1.anInt3276
                                    = (Class37.method430
                                    ((byte) -117,
                                            Player.anInt3267,
                                            class40_sub5_sub17_sub4_sub1.anInt3098,
                                            class40_sub5_sub17_sub4_sub1.anInt3089));
                            NPC.aClass2_3301.method112
                                    (Player.anInt3267,
                                            class40_sub5_sub17_sub4_sub1.anInt3098,
                                            class40_sub5_sub17_sub4_sub1.anInt3089,
                                            class40_sub5_sub17_sub4_sub1.anInt3276, 60,
                                            class40_sub5_sub17_sub4_sub1,
                                            class40_sub5_sub17_sub4_sub1.anInt3118, i_1_,
                            ...
                            if ((0x7f & class40_sub5_sub17_sub4_sub1.anInt3098
                                    ...
                                    & 0x7f)
                                    ^ 0xffffffff) == -65) {
                                if (Class40_Sub5_Sub11.anInt2628
                                        == Class61.anIntArrayArray1435[i_2_][i_3_])
                                    continue;
                                Class61.anIntArrayArray1435[i_2_][i_3_]
                            ...
                            NPC.aClass2_3301.method134
                                    (Player.anInt3267,
                                            ...
                                            class40_sub5_sub17_sub4_sub1,
                                            class40_sub5_sub17_sub4_sub1.anInt3118, i_1_,
                                            class40_sub5_sub17_sub4_sub1.aBoolean3105);
                        }
                    }
                }
            }
    ...
    public Model method756(int arg0) {
        try {
            ...
            Class40_Sub5_Sub2 class40_sub5_sub2
                    = Class37.method431(anInt3249, 13);
            ...
            if (aBoolean3237)
                ...
                class40_sub5_sub17_sub5
                        = class40_sub5_sub2.method549(anInt3240, 2);
    ...
    public void method834(int arg0, int arg1) {
        try {
            ...
            if (!aBoolean3237) {
                anInt3233 += arg1;
                while ((anInt3233 ^ 0xffffffff)
                        < (aClass40_Sub5_Sub7_3242.anIntArray2466[anInt3240]
                        ^ 0xffffffff)) {
                    anInt3233
                            -= aClass40_Sub5_Sub7_3242.anIntArray2466[anInt3240];
                    anInt3240++;
                    if (aClass40_Sub5_Sub7_3242.anIntArray2485.length
                            <= anInt3240) {
                        aBoolean3237 = true;
                        break;
                    }
