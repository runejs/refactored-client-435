...
public class Class37 {
    ...
    public static int method430(byte arg0, int arg1, int arg2, int arg3) {
        try {
            ...
            if ((i_0_ ^ 0xffffffff) > -1 || (i ^ 0xffffffff) > -1
                    || (i_0_ ^ 0xffffffff) < -104 || i > 103)
                return 0;
            int i_1_ = 0x7f & arg2;
            int i_2_ = arg1;
            if (i_2_ < 3
                    && (Floor.aByteArrayArrayArray2323[1][i_0_][i]
                    & 0x2) == 2)
                i_2_++;
            int i_3_ = (((-i_1_ + 128) * (Class40_Sub6.anIntArrayArrayArray2099
                    [i_2_][i_0_][i])
                    - -(i_1_ * (Class40_Sub6.anIntArrayArrayArray2099
                    [i_2_][i_0_ - -1][i])))
                    >> -1503923001);
            int i_4_ = arg3 & 0x7f;
            if (arg0 > -116)
                method432((byte) -86);
            int i_5_
                    = ((i_1_ * (Class40_Sub6.anIntArrayArrayArray2099[i_2_]
                    [1 + i_0_][1 + i])
                    + (Class40_Sub6.anIntArrayArrayArray2099[i_2_][i_0_][1 + i]
                    * (128 + -i_1_)))
                    >> -820366297);
    ...
    public static void method434(int arg0) {
        try {
            ...
            for (int i = 0; ((Class40_Sub5_Sub17_Sub4
                ...
                if ((Class40_Sub5_Sub17_Sub4
                    ...
                    Class40_Sub5_Sub17_Sub4
                            .aClass40_Sub5_Sub17_Sub4_Sub1Array3156[i].anInt3137
                            = -1;
            }
            for (int i = 0;
                 ((Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813.length
                         ^ 0xffffffff)
                         < (i ^ 0xffffffff));
                 i++) {
                if (Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813[i]
                        != null)
                    Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813[i]
                            .anInt3137
                            = -1;
            }
    ...
    public static void method435(boolean arg0) {
        try {
            ...
            if (Class27.anInt658 == 2) {
                ...
                byte[] is_6_
                        = Class34.aClass40_Sub5_Sub14_Sub2_855.aByteArray2925;
                int i = is_6_.length;
                for (int i_7_ = 0; i > i_7_; i_7_++) {
                    if ((is_6_[i_7_] ^ 0xffffffff) == -1)
                        is[i_7_] = 0;
                }
                Class40_Sub5_Sub7.aClass40_Sub5_Sub14_Sub4_2482.method724
                        (0, 0, 33, 33, 25, 25, Class58.anInt1373, 256,
                                RSCanvas.anIntArray62, RSCanvas.anIntArray66);
                NpcDefinition.method574(4);
            } else {
                int i = 48 - -((Class40_Sub5_Sub13
                        .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3098)
                        / 32);
                int i_8_
                        = 464 + -((Class40_Sub5_Sub13
                        .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3089)
                        / 32);
                int i_9_ = Class58.anInt1373 + Class43.anInt1020 & 0x7ff;
                Class40_Sub5_Sub13.aClass40_Sub5_Sub14_Sub4_2765.method724
                        (25, 5, 146, 151, i, i_8_, i_9_, Class51.anInt1187 + 256,
                                Landscape.anIntArray1186, Class34.anIntArray852);
                for (int i_10_ = 0; Class40_Sub5_Sub17_Sub2.anInt3040 > i_10_;
                     i_10_++) {
                    i = 2 + (4 * Class40_Sub5_Sub17_Sub4.anIntArray3149[i_10_]
                            + -((Class40_Sub5_Sub13
                            .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                            .anInt3098)
                            / 32));
                    i_8_ = (2 + 4 * Class45.anIntArray1083[i_10_]
                            - ((Class40_Sub5_Sub13
                            .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3089)
                            / 32));
                    Class40_Sub4.method533(i_8_, i,
                            (Class62
                                    .aClass40_Sub5_Sub14_Sub4Array1466
                                    [i_10_]),
                            (byte) 99);
                }
                for (int i_11_ = 0; (i_11_ ^ 0xffffffff) > -105; i_11_++) {
                    for (int i_12_ = 0; i_12_ < 104; i_12_++) {
                        Class45 class45
                                ...
                                [Player.anInt3267][i_11_]
                                [i_12_]);
                        if (class45 != null) {
                            i_8_ = -((Class40_Sub5_Sub13
                                    .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                    .anInt3089)
                                    / 32) + 2 + i_12_ * 4;
                            i = -((Class40_Sub5_Sub13
                                    .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                    .anInt3098)
                                    / 32) + 2 + i_11_ * 4;
                            Class40_Sub4.method533
                                    (i_8_, i,
                                            Class27.aClass40_Sub5_Sub14_Sub4Array649[0],
                                            (byte) 70);
                        }
                    }
                }
                for (int i_13_ = 0; Class40_Sub5_Sub8.anInt2558 > i_13_;
                     i_13_++) {
                    NPC class40_sub5_sub17_sub4_sub2
                            = (Class6_Sub1.aClass40_Sub5_Sub17_Sub4_Sub2Array1813
                            [Class40_Sub3.anIntArray2016[i_13_]]);
                    if (class40_sub5_sub17_sub4_sub2 != null
                        ...
                        if (class40_sub5_sub5.anIntArray2426 != null)
                            class40_sub5_sub5
                                    = class40_sub5_sub5.method577(-1);
                        if (class40_sub5_sub5 != null
                                && class40_sub5_sub5.aBoolean2430
                                && class40_sub5_sub5.aBoolean2372) {
                            i = (-((Class40_Sub5_Sub13
                                    .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                    .anInt3098)
                                    / 32)
                                    ...
                                    / 32));
                            i_8_ = (class40_sub5_sub17_sub4_sub2.anInt3089 / 32
                                    + -((Class40_Sub5_Sub13
                                    .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                    .anInt3089)
                                    / 32));
                            Class40_Sub4.method533
                                    (i_8_, i,
                                            Class27.aClass40_Sub5_Sub14_Sub4Array649[1],
                                            (byte) 75);
                        }
                    }
                }
                for (int i_14_ = 0;
                     (Class60.anInt1407 ^ 0xffffffff) < (i_14_ ^ 0xffffffff);
                     i_14_++) {
                    Player class40_sub5_sub17_sub4_sub1
                            = (Class40_Sub5_Sub17_Sub4
                            .aClass40_Sub5_Sub17_Sub4_Sub1Array3156
                            [Class57.anIntArray1334[i_14_]]);
                    if (class40_sub5_sub17_sub4_sub1 != null
                            && class40_sub5_sub17_sub4_sub1.method784(1)) {
                        i = (class40_sub5_sub17_sub4_sub1.anInt3098 / 32
                                + -((Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anInt3098)
                                / 32));
                        i_8_ = (-((Class40_Sub5_Sub13
                                ...
                                .anInt3089)
                                / 32)
                                + class40_sub5_sub17_sub4_sub1.anInt3089 / 32);
                        boolean bool = false;
                        long l = class40_sub5_sub17_sub4_sub1.aClass1_3278
                                .method58((byte) 122);
                        for (int i_15_ = 0;
                             Class40_Sub5_Sub17_Sub3.anInt3060 > i_15_;
                             i_15_++) {
                            if (l == Class59.aLongArray1397[i_15_]
                                    && (Class40_Sub7.anIntArray2131[i_15_]
                                    ^ 0xffffffff) != -1) {
                                bool = true;
                                break;
                            }
                        ...
                        if (((Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3266)
                                != 0)
                                && (class40_sub5_sub17_sub4_sub1.anInt3266
                                ^ 0xffffffff) != -1
                                && (((Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anInt3266)
                        ...
                        if (bool)
                            Class40_Sub4.method533
                                    (i_8_, i,
                                            Class27.aClass40_Sub5_Sub14_Sub4Array649[3],
                                            (byte) 46);
                        else if (bool_16_)
                            Class40_Sub4.method533
                                    (i_8_, i,
                                            Class27.aClass40_Sub5_Sub14_Sub4Array649[4],
                                            (byte) 57);
                        else
                            Class40_Sub4.method533
                                    (i_8_, i,
                                            Class27.aClass40_Sub5_Sub14_Sub4Array649[2],
                                            (byte) 80);
                    }
                }
                if ((Player.anInt3288 ^ 0xffffffff) != -1
                        && (Node.anInt926 % 20 ^ 0xffffffff) > -11) {
                    if (Player.anInt3288 == 1
                            && (Class66.anInt1545 ^ 0xffffffff) <= -1
                            && ((Class6_Sub1
                        ...
                        if (class40_sub5_sub17_sub4_sub2 != null) {
                            ...
                            Floor.method560
                                    (i,
                                            (Class40_Sub3
                                                    .aClass40_Sub5_Sub14_Sub4Array2019[1]),
                                            -74, i_8_);
                        }
                    }
                    if ((Player.anInt3288 ^ 0xffffffff)
                        ...
                        i_8_ = (-((Class40_Sub5_Sub13
                                ...
                                / 32)
                                + 2
                                + 4 * (-Class26.anInt635 + Class4.anInt175));
                        i = (4 * (Class68.anInt1637
                                - Class40_Sub5_Sub2.anInt2307)
                                - (-2 - -((Class40_Sub5_Sub13
                                .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                                .anInt3098)
                                / 32)));
                        Floor.method560
                                (i,
                                        Class40_Sub3.aClass40_Sub5_Sub14_Sub4Array2019[1],
                                        75, i_8_);
                    }
                    if (Player.anInt3288 == 10
                            && (Class68.anInt1623 ^ 0xffffffff) <= -1
                            && ((Class40_Sub5_Sub17_Sub4
                            .aClass40_Sub5_Sub17_Sub4_Sub1Array3156).length
                            ^ 0xffffffff) < (Class68.anInt1623 ^ 0xffffffff)) {
                        Player class40_sub5_sub17_sub4_sub1
                                = (Class40_Sub5_Sub17_Sub4
                                .aClass40_Sub5_Sub17_Sub4_Sub1Array3156
                                [Class68.anInt1623]);
                        if (class40_sub5_sub17_sub4_sub1 != null) {
                            i_8_ = (-((Class40_Sub5_Sub13
                                    ...
                                    .anInt3089)
                                    / 32)
                                    + (class40_sub5_sub17_sub4_sub1.anInt3089
                                    / 32));
                            i = (class40_sub5_sub17_sub4_sub1.anInt3098 / 32
                                    - (Class40_Sub5_Sub13
                                    .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                ...
                if ((Class40_Sub5_Sub4.anInt2366 ^ 0xffffffff) != -1) {
                    i = (2 + Class40_Sub5_Sub4.anInt2366 * 4
                            + -((Class40_Sub5_Sub13
                            .aClass40_Sub5_Sub17_Sub4_Sub1_2760.anInt3098)
                            / 32));
                    i_8_ = 2 + (4 * Class55.anInt1304
                            + -((Class40_Sub5_Sub13
                            .aClass40_Sub5_Sub17_Sub4_Sub1_2760
                            .anInt3089)
                            / 32));
            ...
            for (Class40_Sub2 class40_sub2
                ...
                if (class40_sub2.aClass40_Sub9_Sub2_2001 != null) {
                    Class49.aClass40_Sub9_Sub1_1152
                            .method853(class40_sub2.aClass40_Sub9_Sub2_2001);
                    class40_sub2.aClass40_Sub9_Sub2_2001 = null;
                }
                if (class40_sub2.aClass40_Sub9_Sub2_2010 != null) {
                    Class49.aClass40_Sub9_Sub1_1152
                            .method853(class40_sub2.aClass40_Sub9_Sub2_2010);
    ...
    public static void method437(int arg0, boolean arg1, int arg2, int arg3,
                                 int arg4, Class40_Sub5_Sub8 arg5) {
        anInt866++;
        ...
        if (class40_sub2.anIntArray2005 != null)
            class40_sub2.anInt2014
                    = (int) ((double) (class40_sub2.anInt2002
                    - class40_sub2.anInt2012)
                    * Math.random()) + class40_sub2.anInt2012;
    }
    ...
    public static boolean method438(int arg0, int arg1, byte arg2) {
        try {
            ...
            if ((arg0 ^ 0xffffffff) == -1
                    && (HashTable.anInt573 ^ 0xffffffff) == (arg1 ^ 0xffffffff))
                return true;
            if (arg0 == 1
                    && (arg1 ^ 0xffffffff) == (Class25.anInt614 ^ 0xffffffff))
                return true;
            if (((arg0 ^ 0xffffffff) == -3 || (arg0 ^ 0xffffffff) == -4)
                    && (arg1 ^ 0xffffffff) == (Class67.anInt1586 ^ 0xffffffff))
                return true;
            if (arg2 != 52)
                aClass1_860 = null;
            return false;
