...
public class Class22_Sub2_Sub2 extends Class22_Sub2 implements Runnable {
    ...
    public static void method326(int arg0, byte arg1, int arg2, int arg3,
                                 int arg4) {
        try {
            if (arg1 > -44)
                method325((byte) 22);
            ...
            anInt2226 = arg3;
            anIntArray2227[anInt2229++]
                    = (Class40_Sub5_Sub9.method619
                    (Class40_Sub5_Sub9.method619(arg4, arg0 << -777037144),
                            arg2 << -1978505296));
        } catch (RuntimeException runtimeexception) {
            throw runtimeexception;
        }
    ...
    public synchronized void method302(int arg0) {
        try {
            if (aClass14_2225.method257()) {
                if (arg0 != 0)
                    aBoolean2224 = false;
                long l = ((long) (200 + anInt2226
                        + -aRunnable_Impl1_2223.method5(14942))
                        * (long) (aClass14_2225.anInt431 * 1000));
                for (; ; ) {
    ...
    public synchronized void method300(byte[] arg0, boolean arg1, int arg2,
                                       int arg3) {
        try {
            if (arg2 != -15910)
                aClass14_2225 = null;
