...
public class Cache {
    ...
    public Cache(int arg0) {
        try {
            ...
            throw Class8.method216(runtimeexception, "cb.<init>(" + arg0 + ')');
        }
    }
    ...
    public static void method236(boolean arg0, Class6 arg1, Class6 arg2, Class6 arg3) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("cb.A(" + arg0 + ',' + (arg1 != null ? "{...}" : "null") + ',' + (arg2 != null ? "{...}" : "null") + ',' + (arg3 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    public void method230(int arg0, long arg1, SubNode arg2) {
        try {
            ...
            throw Class8.method216(runtimeexception, ("cb.C(" + arg0 + ',' + arg1 + ',' + (arg2 != null ? "{...}" : "null") + ')'));
        }
    }
    ...
    public SubNode method231(long arg0, byte arg1) {
        try {
            ...
            throw Class8.method216(runtimeexception, "cb.D(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public void removeAll(long arg0, int arg1) {
        do {
            try {
                ...
                throw Class8.method216(runtimeexception, "cb.F(" + arg0 + ',' + arg1 + ')');
            }
            break;
        } while(false);
    }
